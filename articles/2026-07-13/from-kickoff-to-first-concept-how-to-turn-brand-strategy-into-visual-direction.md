...
source: "https://smashingmagazine.com/2026/07/how-turn-brand-strategy-into-visual-direction/"
publishedDate: "2026-07-10"
category: "design"
feedName: "Smashing Magazine"
author: "hello@smashingmagazine.com (Anastasia Sycheva)"
---

-   13 min read
-   [Product Strategy](https://smashingmagazine.com/category/product-strategy), [Branding](https://smashingmagazine.com/category/branding), [Business](https://smashingmagazine.com/category/business)
...
[![pre-concept phase: Look and feel (general concept), design code (ideas), brand identity (graphics level)](https://res.cloudinary.com/indysigner/image/fetch/f_auto,q_80/w_400/https://files.smashing.media/articles/how-turn-brand-strategy-into-visual-direction/1-pre-concept-reference-board-brand-identity.png)](https://files.smashing.media/articles/how-turn-brand-strategy-into-visual-direction/1-pre-concept-reference-board-brand-identity.png)

A pre-concept reference board showing how brand character can move from overall look and feel to design code and early brand identity cues. The board uses publicly available visual references to discuss mood, principles, and possible graphic directions before original concept work begins. ([Large preview](https://files.smashing.media/articles/how-turn-brand-strategy-into-visual-direction/1-pre-concept-reference-board-brand-identity.png))

## Stage 1: Research The Brand Context

A brand workshop will naturally cover the standard discovery topics: the business, its goals, the product or service, the competitive landscape, and the target audience. This article will not try to list every question a designer should ask in that workshop. For readers who want a broader starting point, we prepared [a Brand Workshop Toolkit: Questions and Exercises](https://www.figma.com/board/eFYGzJenbwLH9goz9cmVIt/Brand-Workshop-Toolkit--Questions-And-Exercises?node-id=0-1&t=aJvGUUN8TzRumgkh-1), a FigJam framework we use in our studio to structure discovery conversations.
...
Jake Knapp makes a similar point in GV’s [Three-Hour Brand Sprint](https://medium.com/gv-library/the-three-hour-brand-sprint-3ccabf4b768a):
...
[![A completed competitor perception map](https://res.cloudinary.com/indysigner/image/fetch/f_auto,q_80/w_400/https://files.smashing.media/articles/how-turn-brand-strategy-into-visual-direction/2-competitor-perception-map.png)](https://files.smashing.media/articles/how-turn-brand-strategy-into-visual-direction/2-competitor-perception-map.png)

A completed competitor perception map showing how stakeholders positioned category references across two axes: understated to bold and accessible to exclusive. The references are used to discuss perception, not to define final design choices. ([Large preview](https://files.smashing.media/articles/how-turn-brand-strategy-into-visual-direction/2-competitor-perception-map.png))
...
[![A completed Visual Brand Driver exercise](https://res.cloudinary.com/indysigner/image/fetch/f_auto,q_80/w_400/https://files.smashing.media/articles/how-turn-brand-strategy-into-visual-direction/3-visual-brand-driver-exercise.png)](https://files.smashing.media/articles/how-turn-brand-strategy-into-visual-direction/3-visual-brand-driver-exercise.png)

A completed Visual Brand Driver exercise, where stakeholders use images and adjectives to describe how they perceive the company. ([Large preview](https://files.smashing.media/articles/how-turn-brand-strategy-into-visual-direction/3-visual-brand-driver-exercise.png))
...
_Look and feel_ boards are not collections of visuals the team likes. They are **perception boards**. The designer collects references based on the workshop: desired perception, category tension, competitor codes, stakeholder disagreements, and brand character.
...
[![Look And Feel Board](https://res.cloudinary.com/indysigner/image/fetch/f_auto,q_80/w_400/https://files.smashing.media/articles/how-turn-brand-strategy-into-visual-direction/4-look-and-feel-board.png)](https://files.smashing.media/articles/how-turn-brand-strategy-into-visual-direction/4-look-and-feel-board.png)

Look And Feel Board For A Prop Tech PR Agency. The board includes third-party visual references gathered for inspiration and discussion during the design process. ([Large preview](https://files.smashing.media/articles/how-turn-brand-strategy-into-visual-direction/4-look-and-feel-board.png))

### Design Code

_Design code_ makes the direction more specific by translating key brand ideas into visual principles.
...
[![Design Code, which includes Personalized support for your unique journey (Organic shapes, handwritten lines), Parenting is messy and magical (Organic chaos, soft gradients), Research-backed support for real life (Conference photos, calls with doctors, infographics)](https://res.cloudinary.com/indysigner/image/fetch/f_auto,q_80/w_400/https://files.smashing.media/articles/how-turn-brand-strategy-into-visual-direction/5-design-code.png)](https://files.smashing.media/articles/how-turn-brand-strategy-into-visual-direction/5-design-code.png)

Design Code For A Parenting App. The board includes third-party visual references gathered for inspiration and discussion during the design process. ([Large preview](https://files.smashing.media/articles/how-turn-brand-strategy-into-visual-direction/5-design-code.png))
...
[![Brand Asset Direction (logo / color / typography / photo style)](https://res.cloudinary.com/indysigner/image/fetch/f_auto,q_80/w_400/https://files.smashing.media/articles/how-turn-brand-strategy-into-visual-direction/6-brand-asset-direction.png)](https://files.smashing.media/articles/how-turn-brand-strategy-into-visual-direction/6-brand-asset-direction.png)

Early Brand Asset Direction for an Infrastructure AI Startup. The board includes third-party visual references gathered for inspiration and discussion during the design process. ([Large preview](https://files.smashing.media/articles/how-turn-brand-strategy-into-visual-direction/6-brand-asset-direction.png))
...
[![Brand Asset Direction (logo / color / typography / photo style)](https://res.cloudinary.com/indysigner/image/fetch/f_auto,q_80/w_400/https://files.smashing.media/articles/how-turn-brand-strategy-into-visual-direction/7-brand-asset-direction.png)](https://files.smashing.media/articles/how-turn-brand-strategy-into-visual-direction/7-brand-asset-direction.png)

Early Brand Asset Direction For A Parenting App. The board includes third-party visual references gathered for inspiration and discussion during the design process. ([Large preview](https://files.smashing.media/articles/how-turn-brand-strategy-into-visual-direction/7-brand-asset-direction.png))
...
When the team can name those boundaries, the first concept becomes easier to evaluate. The conversation shifts from _“I like it”_ or _“I do not like it”_ to _“Does this express the brand we agreed on?”_
