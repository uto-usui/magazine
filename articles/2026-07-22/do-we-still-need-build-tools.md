...
source: "https://olliewilliams.xyz/blog/no-build/"
...
> ONCE #1 is completely [#NoBuild](https://x.com/hashtag/NoBuild?src=hash&ref_src=twsrc%5Etfw) for the front-end. No bundling, no transpiling, no nothing. Just individual, vanilla CSS and JavaScripts served over HTTP/2. It's amazingly light and amazingly fast with exquisite cache expiration dynamics. Bliss to develop for too! [pic.twitter.com/BdBFX9BkXW](https://t.co/BdBFX9BkXW)
> 
> — DHH (@dhh) [December 18, 2023](https://x.com/dhh/status/1736764094546686331?ref_src=twsrc%5Etfw)
...
> Modern JavaScript can totally be shipped [#nobuild](https://x.com/hashtag/nobuild?src=hash&ref_src=twsrc%5Etfw). When I was in Chrome, we experimented with how feasible this was at scale. You can load around 50-100 smaller scripts/chunks before the cost of IPC benefits from using a bundler/tooling. But you can go pretty far.
> 
> — Addy Osmani (@addyosmani) [May 2, 2026](https://x.com/addyosmani/status/2050720567473614968?ref_src=twsrc%5Etfw)
...
Lea Verou, a former member of the W3C Technical Architecture Group, has written about the topic of web dependencies [at length](https://lea.verou.me/blog/2026/web-deps/#rawdogging-node_modules%2F-imports) and explains the problem of directly using code within node\_modules:

> First, deploying your entire node\_modules directory is both wasteful, and a security risk. In fact, most serverless hosts (e.g. Netlify or Vercel) automatically remove it from the publicly deployed files after the build is finished.
...
![](https://olliewilliams.xyz/michaeljackson.avif)

An [tweet](https://x.com/mjackson/status/1920638972591526307) from React Router creator Michael Jackson
...
![A chart showing build tools in sixth position behind code architecture, state management, managing dependencies, dates, and performance](https://olliewilliams.xyz/pain-point-chart.avif)
