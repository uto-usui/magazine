...
_We built a suite of skills, agents and tools bundled as a plugin to make the Spotify Ads Platform easily accessible to AI agentic tools. The spotify-ads-api plugin is available on_ [_GitHub_](https://github.com/spotify/ads-agentic-tools) _and through Anthropic's_ [_Claude Plugins_](https://claude.com/plugins/spotify-ads-api) _marketplace._ Download it now and create your own advertising campaigns just by asking Claude.
