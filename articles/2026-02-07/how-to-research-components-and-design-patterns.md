...
source: "https://amyhupe.co.uk/articles/how-to-research-components-and-patterns/"
...
_I co-authored this post with [Caroline Jarrett](https://www.effortmark.co.uk/) and  
[Ignacia Orellana](https://twitter.com/ignaciaorellana)_

In our last blog post collaboration, we talked about [how to share research in design systems](https://amyhupe.co.uk/articles/sharing-research-in-design-systems). We explained why it matters and what designers and developers need from it.
...
![a pink post-it on a yellow background. The post-is reads 'share what works and what doesn't' and underneath it is a hand-written note that says 'tell me how it's been tested. Share early, be honest about how much it's been tested, with who, and what the results has been.'](https://amyhupe.co.uk/assets/images/design-systems-research-post-it.jpg)
...
![A question 'Do you live in the United Kingdom' has two answer options: Yes and No presented as radio buttons. The radio buttons have small white targets and there is grey shading behind the button target and the word associated with each target.](https://amyhupe.co.uk/assets/images/old-govuk-radios.png)

Example of the radio style used on GOV.UK services until 2016.
...
![Ask users for Telephone numbers design pattern on the GOV.UK Design System. Below the title of the pattern, there is a tag that is labelled 'experimental', and text that reads: This pattern is currently experimental because more research is needed to validate](https://amyhupe.co.uk/assets/images/govuk-telephone-numbers-pattern.png)

The GOV.UK Design System's pattern for asking users for Telephone numbers uses an experimental status to show that it needs more research to validate it.

![the research section of the Ask users for Telephone numbers design pattern documentation on the GOV.UK Design System. It explains that more research is needed on the best way to handle international numbers, extensions, SMS shortcodes. It invites users to help improve the pattern by taking part in the 'Telephone numbers' discussion on GitHub and sharing their research, or by proposing a change in GitHub.](https://amyhupe.co.uk/assets/images/govuk-telephone-numbers-research-section.png)

The GOV.UK Design System's invites users to share research on experimental patterns to help improve them.
...
In our previous post, we mentioned [the value of observing research that’s happening anyway](https://amyhupe.co.uk/articles/sharing-research-in-design-systems), so that you can see for yourself how a component or pattern is working.
