...
-   [**Turbopack Builds**](https://nextjs.org/blog/next-15-4#turbopack-builds): 100% integration test compatibility for `next build --turbopack`
-   [**Stability Improvements**](https://nextjs.org/blog/next-15-4#notable-changes): Numerous stability and performance improvements to Next.js and Turbopack
