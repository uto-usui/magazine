...
source: "https://reactnative.dev/blog/2023/06/21/package-exports-support"
...
```
import {action} from '@storybook/addon-actions';// -> '@storybook/addon-actions/dist/index.js'import {action} from '@storybook/addon-actions/preview';// -> '@storybook/addon-actions/dist/preview.js'import helpers from '@storybook/addon-actions/src/preset/addArgsHelpers';// Inaccessible - not listed in "exports"!
```
...
![Rollout plan for Package Exports support](https://reactnative.dev/assets/images/package-exports-rollout-4d6544def64335059e0d23df72bfa98a.png)
