...
source: "https://remix.run/blog/rr-governance"
...
React Router has gone through many major evolutions in its 10+ year lifetime, many of those dictated by the evolution of React itself (i.e., the introduction of hooks). With the recent integration of [Remix v2 into React Router v7](https://remix.run/blog/react-router-v7), the API surface has increased even more. And with the arrival of React 19 and [(soon) RSC support](https://remix.run/blog/rsc-preview), React has taken on aspects previously handled by React Router.
...
-   did we mention [RSC](https://remix.run/blog/rsc-preview) yet?
...
-   If the idea of us deprecating and eventually removing APIs in major versions makes you uncomfortable, please see design goal #1, followed by our post-v4 history of backwards compatibility, as well as our blog post ["Future Proofing Your Remix App"](https://remix.run/blog/future-flags).
    -   If you are still upset, please see a Therapist[1](#user-content-fn-1)
...
1.  This is a joke. Therapy is a legitimate and useful tool that has helped countless people (including within our team) deal with mental and emotional issues. It should probably not be used for something as small as periodic breaking changes in open source software. [↩](#user-content-fnref-1)