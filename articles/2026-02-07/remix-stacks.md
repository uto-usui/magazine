---
title: "Remix Stacks"
source: "https://remix.run/blog/remix-stacks"
...
[![Introducing stacks video](https://remix.run/blog-images/posts/stacks-intro-video.png)](https://www.youtube.com/watch?v=mHmgTPjGyc0&list=PLXoynULbYuEC8-gJCqyXo94RufAvSA6R3)
...
[![Desktop showing three websites](https://remix.run/blog-images/posts/stacks.png)](https://github.com/topics/remix-stack)
...
We fully expect the custom stacks to get a LOT of use. We think most people will use custom stacks rather than the ones we build for you. Feel free to fork and modify whatever you like. Read more about creating custom stacks from the [Remix Stacks documentation](https://remix.run/pages/stacks). Check out how quickly you can create a custom stack in [Make your own Remix Stack](https://youtu.be/iAY9MWUF91c?list=PLXoynULbYuEC8-gJCqyXo94RufAvSA6R3):
