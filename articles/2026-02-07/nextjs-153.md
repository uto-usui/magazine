...
-   [**Turbopack for builds (alpha)**](https://nextjs.org/blog/next-15-3#turbopack-builds-alpha): Faster production builds passing 8000+ tests (99%)
-   [**Community support for Rspack (experimental)**](https://nextjs.org/blog/next-15-3#community-support-for-rspack-experimental): Alternative bundler with Webpack compatibility
-   [**Client Instrumentation hook**](https://nextjs.org/blog/next-15-3#client-instrumentation-hook): Early monitoring and analytics setup
-   [**Navigation hooks**](https://nextjs.org/blog/next-15-3#navigation-hooks): Control routing with `onNavigate` and `useLinkStatus`
-   [**TypeScript plugin improvements**](https://nextjs.org/blog/next-15-3#typescript-plugin-performance-improvements): Improved support for large codebases
