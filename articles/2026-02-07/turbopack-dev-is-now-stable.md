...
source: "https://nextjs.org/blog/turbopack-for-development-stable"
...
It's been a long road, but we are happy to announce that `next dev --turbo` is now stable and ready to speed up your development experience. We've been using it to iterate on [vercel.com](http://vercel.com/), [nextjs.org](http://nextjs.org/), [v0](https://v0.app/), and all of our other applications with great results.
...
If your application has webpack customization but only adds webpack loaders, you might be able to already use Turbopack by configuring the loaders for Turbopack. You can [read the documentation](https://nextjs.org/docs/canary/app/api-reference/next-config-js/turbo#webpack-loaders) for webpack loader support in Turbopack.
...
Over the past 3 months, we've already made some significant improvements. Comparing Turbopack in [Next.js 15 RC 2](https://nextjs.org/blog/next-15-rc2) versus Turbopack in [15 RC 1](https://nextjs.org/blog/next-15-rc) shows the results of these optimizations:
...
For the full list, see the [documentation page](https://nextjs.org/docs/canary/architecture/turbopack#unsupported-features).
