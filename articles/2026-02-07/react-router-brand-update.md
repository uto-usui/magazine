...
source: "https://remix.run/blog/react-router-brand-update"
...
![A visual summary of updates to the React Router brand identity, with visible guidelines](https://remix.run/blog-images/posts/react-router-brand-update/update-guidelines.png)

## Updating the logo

![Side by side comparison of the React Router logo before and after the update](https://remix.run/blog-images/posts/react-router-brand-update/logo-before-and-after.png)
...
![The old React Router logo with guidelines showing what to fix](https://remix.run/blog-images/posts/react-router-brand-update/logo-before.png)
...
![The new React Router logo showing what has changed](https://remix.run/blog-images/posts/react-router-brand-update/logo-after.png)
...
![Three iterations of the React Router wordmark](https://remix.run/blog-images/posts/react-router-brand-update/wordmark-iterations.png)
...
![A closeup of the React Router wordmark showing the custom ligature](https://remix.run/blog-images/posts/react-router-brand-update/wordmark.png) ![Stylistic variants for the React Router wordmark in black and white](https://remix.run/blog-images/posts/react-router-brand-update/wordmark-variants.png)
...
![Four iterations of the custom ligature created specifically for the v7 release](https://remix.run/blog-images/posts/react-router-brand-update/v7-ligature-iteration.png)
...
![A closeup of the custom v7 ligature](https://remix.run/blog-images/posts/react-router-brand-update/v7-ligature.png) ![All three updates to the React Router brand identity against a white background](https://remix.run/blog-images/posts/react-router-brand-update/update.png)
...
![Six badges designed in the style of the old web to show how new React Router brand updates can be used](https://remix.run/blog-images/posts/react-router-brand-update/badges.png)