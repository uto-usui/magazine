---
title: "Next.js 12.3"
source: "https://nextjs.org/blog/next-12-3"
...
Fast iterations are critical for your local development workflow. Next.js uses [Fast Refresh](https://nextjs.org/docs/architecture/fast-refresh) for instantaneous feedback on edits made to your React components. Hit save and see your changes reflected in the browser _without_ needing to reload the page.
...
For more information on how to use it today, please refer to the [documentation](https://nextjs.org/docs/pages/building-your-application/optimizing/images) which includes a migration guide.
...
In Next.js 12, we introduced code minification using SWC as part of the experimental features of [Next.js Compiler](https://nextjs.org/docs/architecture/nextjs-compiler). Early results showed that minification with SWC was **7x faster** than the previous version with Terser.
...
-   [New documentation](https://nextjs.org/docs/accessibility) on built-in accessibility features of Next.js.
-   `create-next-app` templates now include dark mode support automatically using your system preference.
-   `src/` is now a default linting directory when using the [integrated ESLint support](https://nextjs.org/docs/pages/building-your-application/configuring/eslint).
