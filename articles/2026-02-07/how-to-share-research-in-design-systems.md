...
source: "https://amyhupe.co.uk/articles/sharing-research-in-design-systems/"
...
![the start of the extensive research section on the ‘step by step navigation’ pattern used on the GOV.UK Design System](https://amyhupe.co.uk/assets/images/step-by-step-pattern-research.png)
...
![the button component only links to justification for the green colour of start buttons.](https://amyhupe.co.uk/assets/images/button-research.png)
