...
With [config-based](https://nextjs.org/docs/app/api-reference/file-conventions/metadata#metadata-object) and new file-based options, you now have a comprehensive Metadata API to cover both static and dynamic metadata.

The Metadata API is available in 13.3 for the App Router (`app`). It is not available in the `pages` directory. Learn more about [file-based metadata and view the API reference](https://nextjs.org/docs/app/api-reference/file-conventions/metadata#file-based-metadata).
...
Learn more about the [Image Response API.](https://nextjs.org/docs/app/building-your-application/optimizing/metadata#dynamic-image-generation)
...
Learn more about [Static Export](https://nextjs.org/docs/app/building-your-application/deploying/static-exports).
...
![Parallel routes and interception enable Instagram-like modal routing.](https://nextjs.org/_next/image?url=https%3A%2F%2Fh8DxKfmAPhn8O0p3.public.blob.vercel-storage.com%2Fstatic%2Fblog%2Fnext-13-3%2Fmodal-routing.png&w=3840&q=75)
...
For more examples and behavior, see the [Parallel](https://nextjs.org/docs/app/building-your-application/routing/parallel-routes) and [Intercepting Routes documentation](https://nextjs.org/docs/app/building-your-application/routing/intercepting-routes).
...
-   **Accessibility:** The App Router now includes the route annoucement from `pages`. This feature announces client-side route transitions to screen readers and other assistive technology. [Learn more](https://nextjs.org/docs/accessibility).
-   **Statically Typed Links**: `redirects` and `rewrites` set in `next.config.js` are now considered during type checking. [Learn more](https://nextjs.org/docs/app/building-your-application/configuring/typescript#statically-typed-links).
...
-   **Route Handlers:** Using `export default` instead of a [supported HTTP verb](https://nextjs.org/docs/app/api-reference/file-conventions/route) now throws a helpful error with `route.ts`. [Learn more about Route Handlers](https://nextjs.org/docs/app/building-your-application/routing/route-handlers).
...
-   **Metadata:** The previous API for metadata (`head.js`), which was deprecated in 13.2, has been removed. Instead, use the built-in support for SEO through the [Metadata](https://nextjs.org/docs/app/api-reference/file-conventions/metadata) API.
...
-   **App Router:** We've added a new `useParams` client component hook to read the dynamic parameters for the given route segment. [Learn more](https://nextjs.org/docs/app/api-reference/functions/use-params).
