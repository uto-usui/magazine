...
Back in May, Michael and Ryan published a blog post called ["Wake up, Remix!"](https://remix.run/blog/wake-up-remix) where they shared the direction they were planning to take Remix. The details at the time were sparse, but they shared that Remix 3 would not be built on React, and would follow [6 principles](https://remix.run/blog/wake-up-remix#principles) for development:
...
![Remix Demo CDs in a display case with a hand reaching in to grab one](https://remix.run/blog-images/posts/remix-jam-2025-recap/remix-demo-cd.webp)
...
1.  Long time community member @rossipedia put up an improved version of the [demo](https://rossipedia.github.io/remix-jam-mk2/) on [GitHub](https://github.com/rossipedia/remix-jam-mk2/tree/main) [↩](#user-content-fnref-1)