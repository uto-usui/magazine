---
title: "Next.js 9.4"
source: "https://nextjs.org/blog/next-9-4"
...
-   **[Configurable Sass Support](#configurable-sass-support)**: [configure `includePaths`](https://sass-lang.com/documentation/js-api#includepaths) and other options of our [built-in Sass support](https://nextjs.org/docs/pages/building-your-application/styling#sass-support)
...
Both incremental features (adding pages and lazily updating them), as well as [preview mode](https://nextjs.org/docs/pages/building-your-application/configuring/preview-mode), are already fully supported by both `next start` and the [Vercel edge platform](https://vercel.com/) out of the box.
...
On the heels of our announcement of [next-gen static site generation](https://nextjs.org/blog/next-9-3#next-gen-static-site-generation-ssg-support), we wanted to share real-world scenarios of fetching content from Headless CMS APIs and rendering it as Next.js HTML.
...
![](https://nextjs.org/_next/image?url=https%3A%2F%2Fh8DxKfmAPhn8O0p3.public.blob.vercel-storage.com%2Fstatic%2Fblog%2Fnext-9-4%2Fblog.png&w=1920&q=75)
...
![DatoCMS achieves impeccable results due to their built-in image optimization support.](https://nextjs.org/_next/image?url=https%3A%2F%2Fh8DxKfmAPhn8O0p3.public.blob.vercel-storage.com%2Fstatic%2Fblog%2Fnext-9-4%2Flighthouse.png&w=1920&q=75)
...
You can read more about the `.env` loading in the [Environment Variables documentation](https://nextjs.org/docs/pages/building-your-application/configuring/environment-variables).
...
![](https://nextjs.org/_next/image?url=https%3A%2F%2Fh8DxKfmAPhn8O0p3.public.blob.vercel-storage.com%2Fstatic%2Fblog%2Fnext-9-4%2Fcore-web-vitals.jpg&w=1920&q=75)
...
To use this method in combination with your analytics service refer to the ["Sending result to Analytics"](https://nextjs.org/docs/pages/building-your-application/optimizing/analytics#sending-results-to-analytics) section of the docs. If you want to learn more about Core Web Vitals you can refer to [web.dev/vitals](https://web.dev/vitals/).
...
![](https://nextjs.org/_next/image?url=https%3A%2F%2Fh8DxKfmAPhn8O0p3.public.blob.vercel-storage.com%2Fstatic%2Fblog%2Fnext-9-4%2Flog-output-previous.png&w=1920&q=75)

Running `next dev` on 9.4

![](https://nextjs.org/_next/image?url=https%3A%2F%2Fh8DxKfmAPhn8O0p3.public.blob.vercel-storage.com%2Fstatic%2Fblog%2Fnext-9-4%2Flog-output-new.png&w=1920&q=75)
