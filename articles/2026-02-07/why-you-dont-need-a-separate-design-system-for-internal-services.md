...
source: "https://amyhupe.co.uk/articles/why-you-dont-need-a-separate-design-system-for-internal-services/"
...
![an illustration showing a simple form with a single button at the bottom](https://amyhupe.co.uk/assets/images/signup.png)

A simple sign up form might include just one main call to action.
...
![an illustration showing a screen similar to an email inbox, with multiple buttons at the top](https://amyhupe.co.uk/assets/images/gmail.png)

A customer account management interface might have multiple buttons of equal importance.
