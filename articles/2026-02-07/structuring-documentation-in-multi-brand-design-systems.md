...
source: "https://amyhupe.co.uk/articles/structuring-documentation-multi-brand-design-systems/"
...
![2 design system documentation site homepages side by side. One is titled Brand A the other Brand B.](https://amyhupe.co.uk/assets/images/separate-site-per-brand.png)
...
![a design system documentation website homepage with 3 panels in the centre labelled Brand A, Brand B and Brand C.](https://amyhupe.co.uk/assets/images/homepage-brand-selection.png)
...
![a components section in a design system documentation website, with subsections in the side-navigation for Brands A, B and C.](https://amyhupe.co.uk/assets/images/brand-specific-subsection.png)
...
![A documentation page for a button component. The top half of the page is labelled universal guidance. The bottom half of the page shows content split across 3 tabs for Brands A, B and C and is labelled brand-specific guidance.](https://amyhupe.co.uk/assets/images/brand-specific-tabs.png)
