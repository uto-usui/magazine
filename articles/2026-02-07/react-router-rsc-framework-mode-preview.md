...
source: "https://remix.run/blog/rsc-framework-mode-preview"
publishedDate: "2025-09-18"
category: "frontend"
feedName: "Remix Blog"
---

Recently we shipped a [preview of React Router with support for React Server Components (RSC)](https://remix.run/blog/rsc-preview) as well as low-level APIs for [RSC support in Data Mode](https://remix.run/blog/react-router-and-react-server-components). With the release of React Router v7.9.2, we're excited to announce that preview support for [RSC](https://react.dev/reference/rsc/server-components) is now also available in Framework Mode.
...
As noted in our post on ["React Router and React Server Components: The Path Forward"](https://remix.run/blog/react-router-and-react-server-components), the great thing about RSC is that this new Framework Mode plugin is much simpler than our earlier non-RSC work. Most of the framework-level complexity is now implemented at a lower level in RSC Data Mode, with RSC Framework Mode being a more lightweight layer on top.
...
With these new plugins, all of the features described in our [RSC preview blog post](https://remix.run/blog/rsc-preview) will be available in your Framework Mode app:
