---
title: "Next.js 7"
source: "https://nextjs.org/blog/next-7"
...
![](https://nextjs.org/_next/image?url=https%3A%2F%2Fh8DxKfmAPhn8O0p3.public.blob.vercel-storage.com%2Fstatic%2Fblog%2Fnext-7%2Fwebpackbar.gif&w=1920&q=75)
...
![The previous overlay left, react-error-overlay right](https://nextjs.org/_next/image?url=https%3A%2F%2Fh8DxKfmAPhn8O0p3.public.blob.vercel-storage.com%2Fstatic%2Fblog%2Fnext-7%2Ferrors.png&w=3840&q=75)
...
**Note:** this upgrade is **fully backwards-compatible**. However, if you are using custom webpack loaders or plugins via [next.config.js](https://nextjs.org/docs#customizing-webpack-config), you might have to upgrade them.
...
![The new nextjs.org](https://nextjs.org/_next/image?url=https%3A%2F%2Fh8DxKfmAPhn8O0p3.public.blob.vercel-storage.com%2Fstatic%2Fblog%2Fnext-7%2Fhomepage.png&w=2048&q=75)

The new nextjs.org

### Get Inspired[](#get-inspired)

As the amount of apps using Next.js is continuously growing, we needed a way to show all these beautiful apps in one overview. Meet the new [`/showcase`](https://nextjs.org/showcase) page:

![Get inspired on nextjs.org/showcase](https://nextjs.org/_next/image?url=https%3A%2F%2Fh8DxKfmAPhn8O0p3.public.blob.vercel-storage.com%2Fstatic%2Fblog%2Fnext-7%2Fshowcase.png&w=2048&q=75)

Get inspired on nextjs.org/showcase

This new showcase allows us to add new apps built with Next.js continuously.

We invite you to visit [`/showcase`](https://nextjs.org/showcase) to get inspired, or submit your app that uses Next.js!
