---
title: "Next.js 10.2"
source: "https://nextjs.org/blog/next-10-2"
...
With Next.js 10.1, we improved [Fast Refresh](https://nextjs.org/blog/next-10-1#3x-faster-refresh) and [decreased installation times](https://nextjs.org/blog/next-10-1#improved-installation-time). We're excited to share additional performance improvements enabled through webpack 5.
...
If your application has a custom webpack configuration, we recommend following [the documentation to enable webpack 5](https://nextjs.org/docs/messages/webpack5). After upgrading to webpack 5 in Next.js, please [share any feedback with us](https://github.com/vercel/next.js/discussions/23498).
...
Next.js [rewrites](https://nextjs.org/docs/pages/api-reference/next-config-js/rewrites), [redirects](https://nextjs.org/docs/pages/api-reference/next-config-js/redirects), and [headers](https://nextjs.org/docs/pages/api-reference/next-config-js/headers) now support a new `has` property allowing you to match against incoming headers, cookies, and query strings.
...
To learn more and explore additional examples, check out [the redirects documentation](https://nextjs.org/docs/pages/api-reference/next-config-js/redirects#header-cookie-and-query-matching).
