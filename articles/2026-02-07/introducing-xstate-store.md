...
source: "https://tkdodo.eu/blog/introducing-x-state-store"
publishedDate: "2024-08-01"
category: "frontend"
feedName: "TkDodo"
---

![Open vintage sign broad through the glass of store window](https://tkdodo.eu/blog/static/9d19ba6ca8a0ee2ff7f7073cc52a23d5/bbe0c/store.jpg "Open vintage sign broad through the glass of store window")

-   [简体中文](https://sorrycc.com/introducing-x-state-store/)
-   [한국어](https://www.gwansik.dev/posts/introducing-x-state-store)
-   [Add translation](https://github.com/TkDodo/blog/blob/main/CONTRIBUTING.md#translations)

I'm super happy with the tech stack I'm currently using, especially around state management. Obviously, server state is managed by [React Query](https://tkdodo.eu/blog/practical-react-query). For forms, I use [React Hook Form](https://tkdodo.eu/blog/react-query-and-forms).
...
Let's take a look at an example, and for easy comparison, I'll be using a similar example as the one from my [working with zustand](https://tkdodo.eu/blog/working-with-zustand) article:
...
### Upgrade to state machines[](#upgrade-to-state-machines)
