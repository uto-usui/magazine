...
-   [**React 19 (stable)**](https://nextjs.org/blog/next-15-1#react-19-stable): Support for React 19 is officially available in both Pages Router & App Router.
-   [**Improved Error Debugging**](https://nextjs.org/blog/next-15-1#improved-error-debugging): Enhanced DX and better source maps for the browser and the terminal.
...
-   [**`forbidden` / `unauthorized` (experimental)**](https://nextjs.org/blog/next-15-1#forbidden-and-unauthorized-experimental): New APIs to enable more granular authentication error handling.
...
![An example of the Next.js error overlay before version 15.1](https://nextjs.org/_next/image?url=https%3A%2F%2Fh8DxKfmAPhn8O0p3.public.blob.vercel-storage.com%2Fstatic%2Fblog%2Fnext-15-1%2Fbefore-light.png&w=2048&q=75)![An example of the Next.js error overlay before version 15.1](https://nextjs.org/_next/image?url=https%3A%2F%2Fh8DxKfmAPhn8O0p3.public.blob.vercel-storage.com%2Fstatic%2Fblog%2Fnext-15-1%2Fbefore-dark.png&w=2048&q=75)

An example of the Next.js error overlay before version 15.1

Error Overlay **After**

![An example of the Next.js error overlay after version 15.1](https://nextjs.org/_next/image?url=https%3A%2F%2Fh8DxKfmAPhn8O0p3.public.blob.vercel-storage.com%2Fstatic%2Fblog%2Fnext-15-1%2Fafter-light.png&w=2048&q=75)![An example of the Next.js error overlay after version 15.1](https://nextjs.org/_next/image?url=https%3A%2F%2Fh8DxKfmAPhn8O0p3.public.blob.vercel-storage.com%2Fstatic%2Fblog%2Fnext-15-1%2Fafter-dark.png&w=2048&q=75)
...
Read more about the [`after`](https://nextjs.org/docs/app/api-reference/functions/after) API and how to leverage it in the documentation.
...
If you’re familiar with the App Router, you’ve likely used [`notFound()`](https://nextjs.org/docs/app/api-reference/file-conventions/not-found) to trigger 404 behavior alongside the customizable `not-found.tsx` file. With version 15.1, we’re extending this approach to authorization errors:
...
> **Good to know:** As with `notFound()` errors, the status code will be `200` if the error is triggered after initial response headers have been sent. [Learn more](https://nextjs.org/docs/app/building-your-application/routing/loading-ui-and-streaming#status-codes).

### Enabling the feature[](#enabling-the-feature)

As this feature is still experimental, you’ll need to enable it in your `next.config.ts` file:

> **Note:** `next.config.ts` support was introduced in Next.js 15. [Learn more](https://nextjs.org/docs/app/api-reference/config/next-config-js#typescript).
...
Read the documentation for the [`unauthorized`](https://nextjs.org/docs/app/api-reference/functions/unauthorized) and [`forbidden`](https://nextjs.org/docs/app/api-reference/functions/forbidden) APIs for more details.
