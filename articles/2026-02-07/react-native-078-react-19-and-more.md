...
source: "https://reactnative.dev/blog/2025/02/19/react-native-0.78"
...
-   [React 19](https://reactnative.dev/blog/2025/02/19/react-native-0.78#react-19)
...
```
// via require<Image  source={require('./img/my_icon.xml')}  style={{width: 40, height: 40}}/>;// or via importimport MyIcon from './img/my_icon.xml';<Image source={MyIcon} style={{width: 40, height: 40}} />;
```
