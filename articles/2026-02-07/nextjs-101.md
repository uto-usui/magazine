---
title: "Next.js 10.1"
source: "https://nextjs.org/blog/next-10-1"
...
Starting with [v9.4](https://nextjs.org/blog/next-9-4), Next.js brought Facebook's [Fast Refresh](https://nextjs.org/docs/architecture/fast-refresh) into open-source for instantaneous feedback on edits made to your React components.
...
To learn more about how Webpack 5 is being rolled out to your application in a backward-compatible way, check out [the documentation](https://nextjs.org/docs/messages/webpack5).
...
For more information, check out the [`layout` documentation](https://nextjs.org/docs/pages/api-reference/components/image#layout).

#### Improved Image Optimization Support[](#improved-image-optimization-support)

We've expanded on the [built-in image loaders](https://nextjs.org/docs/pages/building-your-application/optimizing/images#loader) for `next/image` with the ability to add any custom loader. By using the new `loader` prop, you can **optimize images with any provider or CDN**.

For more information, check out the [`next/image` documentation](https://nextjs.org/docs/pages/api-reference/components/image#loader).
...
![Lighthouse metrics for Next.js Commerce around the globe.](https://nextjs.org/_next/image?url=https%3A%2F%2Fh8DxKfmAPhn8O0p3.public.blob.vercel-storage.com%2Fstatic%2Fblog%2Fnext-10-1%2Flighthouse.png&w=1920&q=75)
...
Try it out today and let us know your feedback. For more information, check out the [PostCSS Config documentation](https://nextjs.org/docs/pages/building-your-application/configuring/post-css).
...
For more information, check out the [TypeScript documentation](https://nextjs.org/docs/pages/building-your-application/configuring/typescript).
...
For more information, check out the [Preview Mode documentation](https://nextjs.org/docs/pages/building-your-application/configuring/preview-mode).
...
For more information, check out the [`next/router` documentation](https://nextjs.org/docs/pages/api-reference/functions/use-router).
...
-   [Authentication](https://nextjs.org/docs/pages/building-your-application/routing/authenticating)
-   [Deploying with Docker](https://nextjs.org/docs/pages/building-your-application/deploying#docker-image)
