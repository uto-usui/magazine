---
title: "Layouts RFC"
source: "https://nextjs.org/blog/layouts-rfc"
...
![](https://nextjs.org/_next/image?url=https%3A%2F%2Fh8DxKfmAPhn8O0p3.public.blob.vercel-storage.com%2Fstatic%2Fblog%2Flayouts-rfc%2Fterminology.png&w=3840&q=75)

-   **URL Path:** Part of the URL that comes after the domain.
-   **URL Segment:** Part of the URL path delimited by slashes.

![](https://nextjs.org/_next/image?url=https%3A%2F%2Fh8DxKfmAPhn8O0p3.public.blob.vercel-storage.com%2Fstatic%2Fblog%2Flayouts-rfc%2Furl-anatomy.png&w=3840&q=75)

## How Routing Currently Works[](#how-routing-currently-works)

Today, Next.js uses the file system to map individual folders and files in the [Pages](https://nextjs.org/docs/pages/building-your-application/routing/pages-and-layouts) directory to routes accessible through URLs. Each **page** file exports a React Component and has an associated **route** based on its file name. For example:

![](https://nextjs.org/_next/image?url=https%3A%2F%2Fh8DxKfmAPhn8O0p3.public.blob.vercel-storage.com%2Fstatic%2Fblog%2Flayouts-rfc%2Frouting-today.png&w=3840&q=75)

-   **Dynamic Routes:** Next.js supports [Dynamic Routes](https://nextjs.org/docs/pages/building-your-application/routing/dynamic-routes) (including catch all variations) with the `[param].js`, `[...param].js` and `[[...param]].js` conventions.
-   **Layouts:** Next.js offers support for simple [component-based](https://nextjs.org/docs/pages/building-your-application/routing/pages-and-layouts#layout-pattern) layouts, per-page layouts using a component [property pattern](https://nextjs.org/docs/pages/building-your-application/routing/pages-and-layouts#layout-pattern#per-page-layouts), and a single global layout using a [custom app](https://nextjs.org/docs/pages/building-your-application/routing/pages-and-layouts#layout-pattern#single-shared-layout-with-custom-app).
-   **Data Fetching:** Next.js provides data fetching methods ([`getStaticProps`](https://nextjs.org/docs/pages/building-your-application/data-fetching/get-static-props), [`getServerSideProps`](https://nextjs.org/docs/pages/building-your-application/data-fetching/get-server-side-props)) which can be used at the page (route) level. These methods are used to determine if a page should be Statically Generated ([`getStaticProps`](https://nextjs.org/docs/pages/building-your-application/data-fetching/get-static-props)) or Server-Side Rendered ([`getServerSideProps`](https://nextjs.org/docs/pages/building-your-application/data-fetching/get-server-side-props)). In addition, you can use [Incremental Static Regeneration (ISR)](https://nextjs.org/docs/pages/building-your-application/data-fetching/incremental-static-regeneration) to create or update static pages after a site is built.
...
![](https://nextjs.org/_next/image?url=https%3A%2F%2Fh8DxKfmAPhn8O0p3.public.blob.vercel-storage.com%2Fstatic%2Fblog%2Flayouts-rfc%2Fapp-folder.png&w=3840&q=75)
...
![](https://nextjs.org/_next/image?url=https%3A%2F%2Fh8DxKfmAPhn8O0p3.public.blob.vercel-storage.com%2Fstatic%2Fblog%2Flayouts-rfc%2Froutes.png&w=3840&q=75)
...
> -   This allows you to colocate your own project files (UI components, test files, stories, etc) inside the `app` directory. Currently this is only possible with the [pageExtensions config](https://nextjs.org/docs/pages/api-reference/next-config-js/pageExtensions#including-non-page-files-in-the-pages-directory).
...
![](https://nextjs.org/_next/image?url=https%3A%2F%2Fh8DxKfmAPhn8O0p3.public.blob.vercel-storage.com%2Fstatic%2Fblog%2Flayouts-rfc%2Froute-segments.png&w=3840&q=75)
...
![](https://nextjs.org/_next/image?url=https%3A%2F%2Fh8DxKfmAPhn8O0p3.public.blob.vercel-storage.com%2Fstatic%2Fblog%2Flayouts-rfc%2Froot-layout.png&w=3840&q=75)

> **Note:**
> 
> -   The root layout replaces the need for a [custom App (`_app.js`)](https://nextjs.org/docs/pages/building-your-application/routing/custom-app) and [custom Document (`_document.js`)](https://nextjs.org/docs/pages/building-your-application/routing/custom-document) since it applies to all routes.
...
![](https://nextjs.org/_next/image?url=https%3A%2F%2Fh8DxKfmAPhn8O0p3.public.blob.vercel-storage.com%2Fstatic%2Fblog%2Flayouts-rfc%2Fregular-layouts.png&w=3840&q=75)
...
![](https://nextjs.org/_next/image?url=https%3A%2F%2Fh8DxKfmAPhn8O0p3.public.blob.vercel-storage.com%2Fstatic%2Fblog%2Flayouts-rfc%2Fnested-layouts.png&w=3840&q=75)
...
![](https://nextjs.org/_next/image?url=https%3A%2F%2Fh8DxKfmAPhn8O0p3.public.blob.vercel-storage.com%2Fstatic%2Fblog%2Flayouts-rfc%2Fnested-layouts-example.png&w=3840&q=75)
...
![](https://nextjs.org/_next/image?url=https%3A%2F%2Fh8DxKfmAPhn8O0p3.public.blob.vercel-storage.com%2Fstatic%2Fblog%2Flayouts-rfc%2Fpage.png&w=3840&q=75)
...
![](https://nextjs.org/_next/image?url=https%3A%2F%2Fh8DxKfmAPhn8O0p3.public.blob.vercel-storage.com%2Fstatic%2Fblog%2Flayouts-rfc%2Fpage-example.png&w=3840&q=75)
...
![](https://nextjs.org/_next/image?url=https%3A%2F%2Fh8DxKfmAPhn8O0p3.public.blob.vercel-storage.com%2Fstatic%2Fblog%2Flayouts-rfc%2Fpage-nested.png&w=3840&q=75)
...
![](https://nextjs.org/_next/image?url=https%3A%2F%2Fh8DxKfmAPhn8O0p3.public.blob.vercel-storage.com%2Fstatic%2Fblog%2Flayouts-rfc%2Fbasic-example.png&w=3840&q=75)
...
![](https://nextjs.org/_next/image?url=https%3A%2F%2Fh8DxKfmAPhn8O0p3.public.blob.vercel-storage.com%2Fstatic%2Fblog%2Flayouts-rfc%2Fserver-components.png&w=3840&q=75)
...
![](https://nextjs.org/_next/image?url=https%3A%2F%2Fh8DxKfmAPhn8O0p3.public.blob.vercel-storage.com%2Fstatic%2Fblog%2Flayouts-rfc%2Fparallel.png&w=3840&q=75)
...
![](https://nextjs.org/_next/image?url=https%3A%2F%2Fh8DxKfmAPhn8O0p3.public.blob.vercel-storage.com%2Fstatic%2Fblog%2Flayouts-rfc%2Fpartial-example.png&w=3840&q=75)
...
![](https://nextjs.org/_next/image?url=https%3A%2F%2Fh8DxKfmAPhn8O0p3.public.blob.vercel-storage.com%2Fstatic%2Fblog%2Flayouts-rfc%2Froute-group-opt-out-before.png&w=3840&q=75)

After:

![](https://nextjs.org/_next/image?url=https%3A%2F%2Fh8DxKfmAPhn8O0p3.public.blob.vercel-storage.com%2Fstatic%2Fblog%2Flayouts-rfc%2Froute-group-opt-out-after.png&w=3840&q=75)
...
![](https://nextjs.org/_next/image?url=https%3A%2F%2Fh8DxKfmAPhn8O0p3.public.blob.vercel-storage.com%2Fstatic%2Fblog%2Flayouts-rfc%2Froute-group-organisation.png&w=3840&q=75)
...
![](https://nextjs.org/_next/image?url=https%3A%2F%2Fh8DxKfmAPhn8O0p3.public.blob.vercel-storage.com%2Fstatic%2Fblog%2Flayouts-rfc%2Froute-group-multiple-root.png&w=3840&q=75)
...
![](https://nextjs.org/_next/image?url=https%3A%2F%2Fh8DxKfmAPhn8O0p3.public.blob.vercel-storage.com%2Fstatic%2Fblog%2Flayouts-rfc%2Fserver-side-routing.png&w=3840&q=75)
...
![](https://nextjs.org/_next/image?url=https%3A%2F%2Fh8DxKfmAPhn8O0p3.public.blob.vercel-storage.com%2Fstatic%2Fblog%2Flayouts-rfc%2Floading.png&w=3840&q=75)
...
![](https://nextjs.org/_next/image?url=https%3A%2F%2Fh8DxKfmAPhn8O0p3.public.blob.vercel-storage.com%2Fstatic%2Fblog%2Flayouts-rfc%2Ferror.png&w=3840&q=75)
...
![](https://nextjs.org/_next/image?url=https%3A%2F%2Fh8DxKfmAPhn8O0p3.public.blob.vercel-storage.com%2Fstatic%2Fblog%2Flayouts-rfc%2Ftemplate.png&w=3840&q=75)
...
![](https://nextjs.org/_next/image?url=https%3A%2F%2Fh8DxKfmAPhn8O0p3.public.blob.vercel-storage.com%2Fstatic%2Fblog%2Flayouts-rfc%2Fintercepted-routes-before.png&w=3840&q=75)
...
![](https://nextjs.org/_next/image?url=https%3A%2F%2Fh8DxKfmAPhn8O0p3.public.blob.vercel-storage.com%2Fstatic%2Fblog%2Flayouts-rfc%2Fintercepted-routes-after.png&w=3840&q=75)
...
![](https://nextjs.org/_next/image?url=https%3A%2F%2Fh8DxKfmAPhn8O0p3.public.blob.vercel-storage.com%2Fstatic%2Fblog%2Flayouts-rfc%2Fintercepted-route.png&w=3840&q=75)
...
![](https://nextjs.org/_next/image?url=https%3A%2F%2Fh8DxKfmAPhn8O0p3.public.blob.vercel-storage.com%2Fstatic%2Fblog%2Flayouts-rfc%2Fparallel-routes.png&w=3840&q=75)
...
![](https://nextjs.org/_next/image?url=https%3A%2F%2Fh8DxKfmAPhn8O0p3.public.blob.vercel-storage.com%2Fstatic%2Fblog%2Flayouts-rfc%2Fparallel-routes-children.png&w=3840&q=75)
...
![](https://nextjs.org/_next/image?url=https%3A%2F%2Fh8DxKfmAPhn8O0p3.public.blob.vercel-storage.com%2Fstatic%2Fblog%2Flayouts-rfc%2Fparallel-routes-complete.png&w=3840&q=75)
...
![](https://nextjs.org/_next/image?url=https%3A%2F%2Fh8DxKfmAPhn8O0p3.public.blob.vercel-storage.com%2Fstatic%2Fblog%2Flayouts-rfc%2Fintercepted-route-modal.png&w=3840&q=75)
