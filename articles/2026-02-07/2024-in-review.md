...
source: "https://tkdodo.eu/blog/2024-in-review"
publishedDate: "2024-12-29"
category: "frontend"
feedName: "TkDodo"
---

![a number of letters with confetti falling around them](https://tkdodo.eu/blog/static/cd1686e65c88ebb83f9d2d3f1de2b61e/bbe0c/2024.jpg "a number of letters with confetti falling around them")
...
On a technical level, this pivot gave us the opportunity to start building something new, which is always exciting. It was going to be a single page application, and the biggest architectural decisions you can take for those evolves around two topics: Routing and Data Management.
...
![Comparison of available routing solutions, grouped by File-Based Routing, Type Safety, Nested Routes, Granular Data Loading, Suspense Integration and SSR capabilities](https://tkdodo.eu/blog/static/4a460930ecb1fa4651d74da08dfe305f/f7244/router-comparisons.webp "Comparison of available routing solutions, grouped by File-Based Routing, Type Safety, Nested Routes, Granular Data Loading, Suspense Integration and SSR capabilities")

It probably won't come as a surprise to anyone that we settled on TanStack Router together with TanStack Query. I'm totally aware that the Router is still young and far from being "battle-tested", but what convinced me about it is that it got the important parts right, conceptually: type safety, URL state management (this one didn't even make the chart, not sure why 😂) and suspense integration.
...
📢 I'm so stoked to announce that today, 🔮 query.gg - the brand new, official @tan\_stack React Query course - is live and available for everyone 🎉

![Query.gg - The Official React Query Course](https://tkdodo.eu/blog/static/9aefb3516b7e5f9d7214585ce9e983df/e41c0/eC_qCxd4.jpg)
...
](https://x.com/TkDodo/status/1795748489026314604)
...
## SuspenseGate[](#suspensegate)

The course was released, but we were still missing two modules. While researching for the suspense lesson, I stumbled upon the sibling pre-rendering changes in v19. I wrote [a full blogpost](https://tkdodo.eu/blog/react-19-and-suspense-a-drama-in-3-acts) about that saga, so I won't go into detail again. Let's just say I felt that I got way too much credit for what happened here. I didn't really "do" anything except using my reach and connections to highlight an issue that somebody else discovered before me.
...
I was asked to give talks at conferences before, and I had done a [remote talk](https://tkdodo.eu/blog/thinking-in-react-query) for React Summit in 2022, but never anything in person other than the occasional meetup talk.
...
All those things together were enough to convince me to give [my first ever in-person conference talk](https://tkdodo.eu/blog/react-query-api-design-lessons-learned), and it really was a blast. I didn't know that I would keynote the conference at that time - really, who puts a first-time speaker up first. 😂
...
### Pushing your boundaries[](#pushing-your-boundaries)
