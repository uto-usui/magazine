---
title: "Next.js 11"
source: "https://nextjs.org/blog/next-11"
publishedDate: "2021-06-16"
category: "frontend"
feedName: "Next.js Blog"
author: "JJ Kasper"
---

As we announced at [Next.js Conf](https://nextjs.org/conf), our mission to create the best developer experience continues with Next.js 11, featuring:
...
-   [**Webpack 5**](#webpack-5): Now enabled by default for all Next.js applications, bringing [these benefits](https://nextjs.org/blog/next-10-2#webpack-5) to all Next.js developers.
...
For example, using the [built-in Image component](https://nextjs.org/docs/pages/building-your-application/optimizing/images) is now even easier:
...
With Next.js 10.2, we expanded the rollout of webpack 5 to all applications without a custom webpack configuration in their `next.config.js`. Today, we're making **webpack 5 the default for all Next.js applications**, which will provide a [variety of features and improvements](https://nextjs.org/blog/next-10-2#webpack-5)**.**
...
If your application has a custom webpack configuration, we recommend following [the upgrade documentation for webpack 5](https://nextjs.org/docs/messages/webpack5). If you run into any issues, [please share feedback with us](https://github.com/vercel/next.js/discussions/23498).

## CRA Migration[](#cra-migration)

Over the past six months, we've seen an increase in applications [migrating from Create React App](https://nextjs.org/docs/app/building-your-application/upgrading/from-create-react-app) to Next.js to leverage many of the developer experience and end-user performance improvements Next.js provides.
...
By leveraging the new transform, you can [incrementally adopt Next.js](https://nextjs.org/docs/migrating/incremental-adoption) while maintaining the functionality of the existing Create React App application.
...
![](https://nextjs.org/_next/image?url=https%3A%2F%2Fh8DxKfmAPhn8O0p3.public.blob.vercel-storage.com%2Fstatic%2Fblog%2Fnext-11%2FBrowser.png&w=1920&q=75)

To learn more about Next.js Live and how you can pair it with Vercel's real-time collaboration engine, see the [Next.js Live](https://nextjs.org/live) section of the documentation.

![](https://nextjs.org/_next/image?url=https%3A%2F%2Fh8DxKfmAPhn8O0p3.public.blob.vercel-storage.com%2Fstatic%2Fblog%2Fnext-11%2FToolbar.png&w=1200&q=75)
...
The following features were mentioned in Next.js Conf, but were shipped early through versions [10.1](https://nextjs.org/blog/next-10-1) and [10.2](https://nextjs.org/blog/next-10-2):

-   **Automatic Webfont Optimization:** Improved performance by inlining font CSS.
-   **Faster Refresh**: 100ms to 200ms faster refresh.
-   [**`next/image` Improvements**](https://nextjs.org/blog/next-10-1#nextimage-improvements): Apple Silicon (M1) Support, plus more layout and loader options.
-   [**Next.js Commerce Shopify Integration**](https://nextjs.org/blog/next-10-1#nextjs-commerce-shopify-integration): Flexible data layer for composable e-commerce apps. Next.js Commerce currently supports Shopify, BigCommerce, Saleor, Swell, and Vendure.