...
source: "https://reactnative.dev/blog/2025/12/10/react-native-0.83"
...
-   [React 19.2](https://reactnative.dev/blog/2025/12/10/react-native-0.83#react-192)
-   [New DevTools features](https://reactnative.dev/blog/2025/12/10/react-native-0.83#new-devtools-features)
-   [Intersection Observers (Canary)](https://reactnative.dev/blog/2025/12/10/react-native-0.83#intersection-observers-canary)
-   [Web Performance APIs as stable](https://reactnative.dev/blog/2025/12/10/react-native-0.83#web-performance-apis-as-stable)
...
![](https://reactnative.dev/assets/images/0.83-react-19.2-no-activity-61b910cc3d32753f1432f8d365963dab.gif)

![](https://reactnative.dev/assets/images/0.83-react-19.2-activity-c374acc50fc57945dd0ef92ab6d119fe.gif)
...
![Network panel list in React Native DevTools](https://reactnative.dev/assets/images/debugging-rndt-network-462cd5e39a5525592501627bb0087747.jpg)
...
![A performance trace in React Native DevTools](https://reactnative.dev/assets/images/debugging-rndt-performance-084166527768b90dbb936b240707bdcb.jpg)
...
Learn more about our newest [React Native DevTools features](https://reactnative.dev/docs/react-native-devtools) and [React Performance tracks](https://react.dev/reference/dev-tools/react-performance-tracks).
...
![React Native DevTools icon in the macOS Dock](https://reactnative.dev/assets/images/0.83-rndt-desktop-app-99c6ef69aebde93fc5775942e660518c.jpg)
...
![Hermes logo](https://reactnative.dev/assets/images/0.83-hermes-v1-15f50ba6bcc70a8b99e4c3e13bd17ac8.jpg)
...
4.  To confirm if your app is running Hermes V1, execute the following code within your app or the DevTools console. This code will return the Hermes version, which should match the version specified in step 1 (250829098.0.1):
    ...
    ```
    // expecting "250829098.0.1" in Hermes V1HermesInternal.getRuntimeProperties()['OSS Release Version'];
    ```
...
```
# From the ios folder of your projectbundle exec pod cache clean --allbundle exec pod deintegrateRCT_USE_RN_DEP=1 RCT_USE_PREBUILT_RNCORE=1RCT_SYMBOLICATE_PREBUILT_FRAMEWORKS=1 bundle exec pod installopen <your-project>.xcworkspace
```
...
```
# If you are running the app in the simulatoradd-dsym <path-to-your-app>/ios/Pods/React-Core-prebuilt/React.xcframework/ios-arm64_x86_64-simulator/React.framework/dSYMs/React.framework.dSYM# If you are running the app on a physical deviceadd-dsym <path-to-your-app>/ios/Pods/React-Core-prebuilt/React.xcframework/ios-arm64/React.framework/dSYMs/React.framework.dSYM
```
...
To learn more about what we consider a breaking change, have a look at [this article](https://reactnative.dev/docs/releases/versioning-policy#what-is-a-breaking-change).
