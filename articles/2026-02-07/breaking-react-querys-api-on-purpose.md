...
source: "https://tkdodo.eu/blog/breaking-react-querys-api-on-purpose"
publishedDate: "2023-04-16"
category: "frontend"
feedName: "TkDodo"
---

16.04.2023 — [ReactJs](https://tkdodo.eu/blog/tags/react-js), [React Query](https://tkdodo.eu/blog/tags/react-query), [JavaScript](https://tkdodo.eu/blog/tags/java-script), [TypeScript](https://tkdodo.eu/blog/tags/type-script), [API Design](https://tkdodo.eu/blog/tags/api-design) — 7 min read

![glass breaking](https://tkdodo.eu/blog/static/1a55df19d27d0a6a5b11ffceb8b46513/bbe0c/breaking-glass.jpg "glass breaking")

-   [한국어](https://velog.io/@cnsrn1874/breaking-react-querys-api-on-purpose)
...
![Avatar for willmcgugan](https://tkdodo.eu/blog/static/bc15b940a523f0bd7f585db6d4f8c849/47930/willmcgugan.jpg)
...
](https://x.com/willmcgugan/status/1423678688802058244)
...
](https://x.com/TkDodo/status/1647341498227097600)
...
![Avatar for michaelc_1991](https://tkdodo.eu/blog/static/8aa3dbc5fceb86e662a2d9f33e731518/47930/michaelc_1991.jpg)
...
](https://x.com/michaelc_1991/status/1647540073100091393)
...
But no, we are not leaving you to write `useEffect` for this scenario. As I just pointed out, the effect is equally flawed. There _is_ a callback that is only invoked once per Query, and I've written about that solution before in - [#11: React Query Error Handling](https://tkdodo.eu/blog/react-query-error-handling#the-global-callbacks).
...
### Defining on-demand messages[](#defining-on-demand-messages)
...
#### An additional render cycle[](#an-additional-render-cycle)
...
Now of course, the simple fix is to _derive state_. I have an old article on that topic as well, - [Don't over useState](https://tkdodo.eu/blog/dont-over-use-state). For this example, it merely means:
...
There is no way how this can get ever out of sync. Have a look at the [fixed sandbox](https://codesandbox.io/p/sandbox/brave-fog-eev3b9?file=%2Fsrc%2FApp.tsx). If you want to get fancy or your calculation is more expensive than that, have a look at [the select option](https://tkdodo.eu/blog/react-query-data-transformations#3-using-the-select-option).

#### The callbacks might not run[](#the-callbacks-might-not-run)
...
Using the `onSuccess` callback here can get into real troubles if we use [React Query as an Async State Manager](https://tkdodo.eu/blog/react-query-as-a-state-manager) and read data from the cache only by having `staleTime` defined. Let's add a `filters` argument and `staleTime`:
...
![Avatar for t3dotgg](https://tkdodo.eu/blog/static/e7d7798b4a6b2b16b2727034d9278130/47930/theo_twitter.jpg)
...
](https://x.com/t3dotgg/status/1647451137652686848)
