...
-   [**Turbopack Builds (beta)**](https://nextjs.org/blog/next-15-5#turbopack-builds-beta): Production turbopack builds (`next build --turbopack`) now in beta
...
-   [**TypeScript Improvements**](https://nextjs.org/blog/next-15-5#typescript-improvements): Typed routes, route export validation, and route types helpers
-   [**`next lint`**](https://nextjs.org/blog/next-15-5#next-lint-deprecation): Deprecation of `next lint` command
-   [**Next.js 16**](https://nextjs.org/blog/next-15-5#deprecation-warnings-for-nextjs-16): Deprecation warnings for Next.js 16
...
After introducing experimental support for the Node.js runtime in our [15.2 release](https://nextjs.org/blog/next-15-2) and testing extensively on our production applications, we're excited to announce stable support for Node.js middleware runtime.
