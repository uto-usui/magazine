...
> This post is based on my recent talk, Building conscious design systems, which I gave at WDC and GOV Design Systems Day.
> 
...
![A dropdown field asking 'How would you like to be contacted?, providing phone, email and text message options.](https://amyhupe.co.uk/assets/images/dropdown-illustration.jpg)
...
We can start with a common pattern - how we ask users for their name. This is something most design systems include.
...
![Material UI's text fields, which are rendered as an underline for users to type onto](https://amyhupe.co.uk/assets/images/material-ui-text-fields.png)

This unconventional approach raised concerns with some designers and developers, who suspected that the affordance of the line would cause confusion for some people, and impact usability. But this was Google - so a lot of those people who had concerns, found themselves shouting into the void.
...
-   [Your design system contribution practice is doomed](https://amyhupe.co.uk/articles/your-contribution-model-is-doomed/)
...
-   [5 lessons in enabling contribution](https://amyhupe.co.uk/articles/5-lessons-on-enabling-design-system-contribution/)
...
-   [Crediting contributors in design systems](https://amyhupe.co.uk/articles/crediting-design-system-contributors/)
...
The book says: _“Real life is complicated… We might experience harassment or abuse, lose a loved one, become chronically ill, get into an accident, have a financial emergency, or simply be vulnerable for not fitting into society’s expectations.”_
