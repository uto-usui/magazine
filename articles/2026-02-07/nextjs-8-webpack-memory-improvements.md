...
source: "https://nextjs.org/blog/webpack-memory"
...
Recently [Next.js 8](https://nextjs.org/blog/next-8) was introduced. The release included a massive build-time memory usage reduction. This blog post will explore how we have helped optimize webpack for the community.
...
While implementing [Serverless Next.js](https://nextjs.org/blog/next-8#serverless-nextjs) it quickly became apparent that running `next build` on a project with hundreds of pages caused high memory usage. Sometimes exceeding the approximately 1.4 GB memory heap limit that Node.js has.
...
![The Chrome Developer Tools memory profiler showed 548 MB being allocated at once](https://nextjs.org/_next/image?url=https%3A%2F%2Fh8DxKfmAPhn8O0p3.public.blob.vercel-storage.com%2Fstatic%2Fblog%2Fwebpack-memory%2Fallocation-before.png&w=1920&q=75)
...
![The profiler now showed chunks of 34 MB being allocated over time](https://nextjs.org/_next/image?url=https%3A%2F%2Fh8DxKfmAPhn8O0p3.public.blob.vercel-storage.com%2Fstatic%2Fblog%2Fwebpack-memory%2Fafter-limiting.png&w=1920&q=75)
...
![After all optimizations the profiler shows chunks of 184 KB being allocated over time](https://nextjs.org/_next/image?url=https%3A%2F%2Fh8DxKfmAPhn8O0p3.public.blob.vercel-storage.com%2Fstatic%2Fblog%2Fwebpack-memory%2Fallocation-after.png&w=1920&q=75)

After all optimizations the profiler shows chunks of 184 KB being allocated over time

[Next.js 8](https://nextjs.org/blog/next-8) already has all these optimizations built-in. There is no need to change anything when using Next.js.
