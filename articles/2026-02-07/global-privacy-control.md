---
title: "Global Privacy Control という法的効力を持つヘッダ"
source: "https://blog.jxck.io/entries/2026-02-05/gpc.html"
...
-   3PCA 9 日目: DNT | blog.jxck.io
    -   [https://blog.jxck.io/entries/2023-12-09/3pca-dnt.html](https://blog.jxck.io/entries/2023-12-09/3pca-dnt.html)
...
-   Global Privacy Control (GPC) Legal and Implementation Considerations Guide
    -   [https://w3c.github.io/gpc/explainer#411-the-california-consumer-privacy-act](https://w3c.github.io/gpc/explainer#411-the-california-consumer-privacy-act)
...
> 
> — [https://oag.ca.gov/privacy/ccpa/gpc](https://oag.ca.gov/privacy/ccpa/gpc)

すでに 2022 年には、Sephora 社は GPC を無視したとして $1.2 億ドルの罰金を求められた事例がある。

-   [https://oag.ca.gov/news/press-releases/attorney-general-bonta-announces-settlement-sephora-part-ongoing-enforcement](https://oag.ca.gov/news/press-releases/attorney-general-bonta-announces-settlement-sephora-part-ongoing-enforcement)
...
-   AB-566 California Consumer Privacy Act of 2018: opt-out preference signal.
    -   [https://leginfo.legislature.ca.gov/faces/billNavClient.xhtml?bill\_id=202520260AB566](https://leginfo.legislature.ca.gov/faces/billNavClient.xhtml?bill_id=202520260AB566)
...
-   California's Opt Me Out Act is a Win for Privacy - Open Policy & Advocacy
    -   [https://blog.mozilla.org/netpolicy/2025/10/29/californias-opt-me-out-act-is-a-win-for-privacy/](https://blog.mozilla.org/netpolicy/2025/10/29/californias-opt-me-out-act-is-a-win-for-privacy/)
...
-   Use HTTP structured field values · Issue #6 · w3c/gpc
    -   [https://github.com/w3c/gpc/issues/6](https://github.com/w3c/gpc/issues/6)
...
## [GPC Support Resource](#gpc-support-resource)
...
-   Spec
    -   Global Privacy Control (GPC)
        -   [https://w3c.github.io/gpc/](https://w3c.github.io/gpc/)
    -   Global Privacy Control (GPC) Legal and Implementation Considerations Guide
        -   [https://w3c.github.io/gpc/explainer](https://w3c.github.io/gpc/explainer)
-   Explainer
    -   gpc/explainer.md
        -   [https://github.com/w3c/gpc/blob/main/explainer.md](https://github.com/w3c/gpc/blob/main/explainer.md)
-   Requirements Doc
-   Mozilla Standard Position
    -   Global Privacy Control (GPC)
        -   [https://github.com/mozilla/standards-positions/issues/867](https://github.com/mozilla/standards-positions/issues/867)
-   WebKit Position
-   TAG Design Review
-   Intents
    -   Intent to Prototype: Global Privacy Control
        -   [https://groups.google.com/a/chromium.org/g/blink-dev/c/ztV1otnl\_NQ/m/4S-V4iXWBgAJ](https://groups.google.com/a/chromium.org/g/blink-dev/c/ztV1otnl_NQ/m/4S-V4iXWBgAJ)
-   Chrome Platform Status
    -   Global Privacy Control - Chrome Platform Status
        -   [https://chromestatus.com/feature/5137324344213504](https://chromestatus.com/feature/5137324344213504)
-   WPT (Web Platform Test)
    -   web-platform-tests dashboard
        -   [https://wpt.fyi/results/gpc?label=master&label=experimental&aligned&q=gpc](https://wpt.fyi/results/gpc?label=master&label=experimental&aligned&q=gpc)
-   DEMO
-   Blog
-   Presentation
-   Issues
    -   Add Global Privacy Control (GPC) support to Chrome (feature request) \[40745270\]
        -   [https://bugs.chromium.org/p/chromium/issues/detail?id=40745270](https://bugs.chromium.org/p/chromium/issues/detail?id=40745270)
-   Other