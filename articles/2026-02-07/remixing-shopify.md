...
source: "https://remix.run/blog/remixing-shopify"
...
Remix is also leading the way for the React community and setting a new standard for web frameworks. This past week [React Router](https://reactrouter.com/), the heart of Remix, was [installed for the 1 billionth time](https://twitter.com/mjackson/status/1585830846887362561). Additionally, last month we released React Router 6.4—our most advanced and polished release yet with an unparalleled story for both data loading and mutations. And we’re just getting started!
