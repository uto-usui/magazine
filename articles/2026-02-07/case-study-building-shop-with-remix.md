...
source: "https://remix.run/blog/shop-case-study"
publishedDate: "2024-03-20"
category: "frontend"
feedName: "Remix Blog"
---

Building good software is largely about understanding your constraints and then picking the right tools. When Shopify decided to build a web version of [Shop](https://apps.apple.com/ca/app/shop-all-your-favorite-brands/id1223471316), it was important to:
...
We on the Remix team sat down with our colleagues [Sebastian Ekström](https://github.com/sebastianekstrom) and [Dominic Lind](https://github.com/linddominic) from the Shop team to discuss why they chose Remix for this project and how it went. This is the story about how [Shop.app](https://shop.app/) was built with Remix.

## What is Shop?

![Shop app on Apple Play Store. Title says 'Shop: All your favorite brands'](https://remix.run/blog-images/posts/shop-case-study/shop-app-ios.jpg)
...
![Diagram of a long lived feature branch for implementing the changes from a migration guide](https://remix.run/blog-images/posts/shop-case-study/shop-web.png)

For a long time [Shop.app](https://shop.app/) consisted of a few simple landing pages encouraging users to download the iOS or Android app. There was no functionality — no way to browse categories or products, no way to add items to your cart, and certainly no way to purchase anything.
...
> Shop smarter with [https://t.co/7YAW0Tk8Rh](https://t.co/7YAW0Tk8Rh)! We've brought our ChatGPT-powered shopping assistant to the web — try it out, and don’t forget to sign in with Shop to save your faves 💜 [pic.twitter.com/DpSdLEr4QD](https://t.co/DpSdLEr4QD)
> 
> — Shop (@shop) [March 15, 2023](https://twitter.com/shop/status/1636022946127831040?ref_src=twsrc%5Etfw)

[Shop.ai](https://shop.ai/) now redirects to [Shop.app](https://shop.app/). However, the initial version was a single webpage showing off a Shop chatbot built on top of OpenAI's newly released ChatGPT.
...
> “With Shop.app we wanted to reuse a lot of the code we had from the \[native\] app. Remix allowed us to do that without being a hurdle. It allowed us to migrate piece by piece.”

[![](https://remix.run/blog-images/posts/shop-case-study/dominic-lind.png)
...
> “I have never produced so much, in such a short amount of time, with such good results.”

[![](https://remix.run/blog-images/posts/shop-case-study/sebastian-ekstrom.jpg)
...
](https://github.com/sebastianekstrom)
...
Luckily we were already working on a solution. The Shop team was ecstatic when they learned that the Remix team was [changing the compiler to be a Vite plugin](https://remix.run/blog/remix-heart-vite). They were so confident in the new Vite plugin and the DX benefits it would give their team that they didn't hesitate to start using it, even before [it was marked as stable](https://remix.run/blog/remix-vite-stable).

Migrating to Vite immediately improved their HMR times to 2.3s.

These were just the initial numbers. The team was able to reduce HMR times even further by parallelizing the build process for their style system, [Tailwind CSS](https://tailwindcss.com/). Once parallelized, HMR times decreased all the way down to 0.1s.
...
The move to Vite further accelerated the development process, drastically improving HMR times and boosting productivity. The team was able to accomplish this before Vite was stabilized due to Remix's continuous delivery with [unstable and future flags](https://remix.run/blog/future-flags).
