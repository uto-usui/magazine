---
title: "Next.js 9.3"
source: "https://nextjs.org/blog/next-9-3"
...
Today we're incredibly excited to announce two new data fetching methods: [`getStaticProps`](https://nextjs.org/docs/pages/building-your-application/data-fetching) and [`getServerSideProps`](https://nextjs.org/docs/pages/building-your-application/data-fetching). We also include a way to provide parameters to statically generate static pages for dynamic routes: [`getStaticPaths`](https://nextjs.org/docs/pages/building-your-application/data-fetching).
...
-   `getStaticPaths` (Static Generation): Specify [dynamic routes](https://nextjs.org/docs/pages/building-your-application/routing/dynamic-routes) to prerender based on data.
...
-   `params`: `params` contains the route parameters for pages using dynamic routes. For example, if the page name is `[id].js` , then `params` will look like `{ id: ... }`. To learn more, take a look at the [Dynamic Routing documentation](https://nextjs.org/docs/pages/building-your-application/routing/dynamic-routes). You should use this together with `getStaticPaths`, which we'll explain later.
...
To learn more about `getStaticProps` refer to the [Data Fetching Documentation](https://nextjs.org/docs/pages/building-your-application/data-fetching).

### getStaticPaths[](#getstaticpaths)

If a page has [dynamic routes](https://nextjs.org/docs/pages/building-your-application/routing/dynamic-routes) and uses `getStaticProps` it needs to define a list of paths that have to be rendered to HTML at build time.
...
To learn more about `getStaticPaths` refer to the [Data Fetching Documentation](https://nextjs.org/docs/pages/building-your-application/data-fetching).
...
-   `params`: If this page uses a dynamic route, `params` contains the route parameters. If the page name is `[id].js` , then `params` will look like `{ id: ... }`. To learn more, take a look at the [Dynamic Routing documentation](https://nextjs.org/docs/pages/building-your-application/routing/dynamic-routes).
...
To learn more about `getServerSideProps` refer to the [Data Fetching Documentation](https://nextjs.org/docs/pages/building-your-application/data-fetching).
...
Preview Mode is already available when using `next start`, or seamlessly by [deploying](https://nextjs.org/docs/pages/building-your-application/deploying) to the [Vercel Edge Network](https://vercel.com/docs/edge-network).

Try it out preview mode yourself on [https://next-preview.vercel.app/](https://next-preview.vercel.app/)

Learn more about [Preview Mode](https://nextjs.org/docs/pages/building-your-application/configuring/preview-mode) by referencing [the documentation](https://nextjs.org/docs/pages/building-your-application/configuring/preview-mode).
...
Since stylesheets are global by nature, they must be imported in the [Custom `<App>` component](https://nextjs.org/docs/pages/building-your-application/routing/custom-app). This is necessary to avoid class name and ordering conflicts for global styles.
