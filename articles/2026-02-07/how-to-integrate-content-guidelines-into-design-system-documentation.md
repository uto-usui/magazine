...
source: "https://amyhupe.co.uk/articles/integrating-content-guidelines-in-design-systems/"
...
I wrote before about [why design system teams need content designers](https://amyhupe.co.uk/articles/why-design-systems-need-content-designers/) and what happens when they don’t include one.
...
![a made up design system homepage depicting a components and patterns section, with a link at the bottom to content guidelines. There is a red cross to indicate that this is the wrong approach.](https://amyhupe.co.uk/assets/images/linking-out-to-content-guidelines.png)
...
![the same made up design system homepage shown above, this time depicting separate components, patterns and content guidleines sections. There is a red cross to indicate that this is the wrong approach.](https://amyhupe.co.uk/assets/images/content-guidelines-section.png)
...
![a made up design system component documentation page, showing content guidelines being linked to underneath the component example and design guidelines. There is a red cross to indicate that this is the wrong approach.](https://amyhupe.co.uk/assets/images/content-guidelines-linked-to-from-component-page.png)

Using placeholder content, like "error message goes here" in component examples is a missed opportunity to demonstrate what good content design looks like. (For more on this particular subject, see my post on [handling example copy in design systems](https://amyhupe.co.uk/articles/example-copy-in-design-systems/).)
...
![the same made up design system component documentation page shown in the previous example, this time showing content guidelines and design guidelines included directly on the page. There is a green tick to indicate that this is the right approach.](https://amyhupe.co.uk/assets/images/integrated-content-and-design-guidelines.png)
