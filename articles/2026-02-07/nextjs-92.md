---
title: "Next.js 9.2"
source: "https://nextjs.org/blog/next-9-2"
...
CSS Modules are an _optional_ feature and are only enabled for files with the `.module.css` extension. Regular [`<link>` stylesheets](https://nextjs.org/docs/pages/api-reference/components/head) and [global CSS files](#built-in-css-support-for-global-stylesheets) are still supported.
...
Today, we're happy to announce this new chunking behavior is enabled by default in Next.js 9.2. We'd like to extend deep gratitude to the [Google Chrome team](https://nextjs.org/blog/next-9#google-chrome-collaboration) and [Alex Castle](https://twitter.com/atcastle) for contributing this change. This change reflects the cumulative effort of weeks of research, lab testing, real-world testing, and implementation.
