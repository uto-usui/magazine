...
source: "https://reactnative.dev/blog/2023/01/12/version-071"
...
![Two diagrams. On the left it shows a skeleton of an app with three boxes that have margin around them cause the boxes to have margin around all sides. On the right, the same diagram is shown highlighted to demonstrate the margin on all sides.](https://reactnative.dev/assets/images/FlexboxGapBefore-df4400a35538a4cc6118d5eaf6ffeb1c.png)
...
![Two diagrams. On the left it shows a skeleton of an app with three boxes that have margin only on the inner sides and not the outer sides of the boxes due to the Flexbox gap property. On the right, the same diagram is shown highlighted to demonstrate the margin only on the inner sides.](https://reactnative.dev/assets/images/FlexboxGapAfter-be4a3ee8b621e11a32f9096e72ac2a65.png)
