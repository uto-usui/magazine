...
source: "https://css-irl.info/disentangling-frameworks/"
...
![UI layout with two widgets side-by-side](https://css-irl.info/disentangling-frameworks-01.svg)

When we have two widgets to display, the left one should have centered text

![UI layout with one wide widget, with a horizontal layout](https://css-irl.info/disentangling-frameworks-02.svg)

When the right-hand widget is absent, we should left-align the text of the other one, and display is as two columns
