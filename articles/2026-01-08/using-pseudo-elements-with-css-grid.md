...
source: "https://css-irl.info/using-pseudo-elements/"
...
See the Pen [CSS Grid – CSS Layout News example](https://codepen.io/michellebarker/pen/VxYzyW/) by Michelle Barker ([@michellebarker](https://codepen.io/michellebarker)) on [CodePen](https://codepen.io/).
