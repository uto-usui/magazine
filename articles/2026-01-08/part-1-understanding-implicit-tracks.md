...
source: "https://css-irl.info/debugging-css-grid-part-1-understanding-implicit-tracks/"
...
![Seven grid items laid out over two rows](https://css-irl.info/debugging-css-grid-1_03.png)

Our grid has four columns. The items fill the first row, then a new one is created.
...
![Orange grid item placed at the bottom left of the grid](https://css-irl.info/debugging-css-grid-1_06.png)
...
![Orange grid item placed at the bottom left of the grid](https://css-irl.info/debugging-css-grid-1_04.png)
...
![A grid layout with two overlapping items](https://css-irl.info/debugging-css-grid-1_01.png)
...
![A grid layout with the second item pushed to the right](https://css-irl.info/debugging-css-grid-1_02.png)
