...
source: "https://csswizardry.com/2011/03/coding-up-a-semantic-lean-timeline/"
...
2.  [The CSS](#the-css)
    1.  [The spine](#the-spine)
    2.  [The arrow and dot](#the-arrow-and-dot)
    3.  [The branches](#the-branches)
    4.  [Odd/even styling](#oddeven-styling)
3.  [CSS feature detection?](#css-feature-detection)
...
After [Séan](https://twitter.com/walshybhoy) shared [the Financial Times’ timeline](http://aboutus.ft.com/corporate-information/history/) I got to wondering how I’d code my own (albeit massively more simple) timeline.

This is what I came up with: [HTML/CSS timeline](https://dl.dropbox.com/u/2629908/timeline/index.html).
...
I was initially marking the dates up as `<b>`s but as [Mark](https://twitter.com/Renniks/) pointed out [I could use the new HTML5 `<time>` element](https://twitter.com/Renniks/status/47336115753070592).
