...
source: "https://csswizardry.com/2011/01/html5-and-text-level-semantics/"
publishedDate: "2011-01-23"
category: "css"
...
1.  [The `<del>` element](#the-del-element)
2.  [The `<s>` element](#the-s-element)
3.  [The `<ins>` element](#the-ins-element)
4.  [The `<strong>` element](#the-strong-element)
5.  [The `<small>` element](#the-small-element)
6.  [The `<b>` element](#the-b-element)
7.  [The `<cite>` element](#the-cite-element)
8.  [The `<i>` element](#the-i-element)
9.  [The `<q>` element](#the-q-element)
10.  [The `<em>` element](#the-em-element)
11.  [The `<code>` element](#the-code-element)
12.  [The `<mark>` element](#the-mark-element)
...
Hi there, I’m Harry Roberts, I am a web developer at [BSkyB](http://sky.com/). I specialise in web standards, accessibility, Ruby, design and build, mobile development, typography and more. I have been in the industry for three four years.

**Please note:** I am not a programmer.

![A photo of me](https://csswizardry.com/wp-content/uploads/2009/12/harry-roberts.jpg)**Above:** A photo of me.

I write at my personal blog [CSS Wizardry](https://csswizardry.com/) and tweet at [@csswizardry](https://twitter.com/csswizardry). I love the uppercase _R_ in Helvetica. My motto on web development is ‘Always code like you’re working in a team, even when you’re not.’ I absolutely _love_ the web.
...
There are more than I’ve outlined here, I may revisit the blog post and add them, but the ones I’ve covered are the ones _I_ find most commonly occurring. In the meantime, why not give [the HTML spec a quick read](https://www.whatwg.org/html/)?
