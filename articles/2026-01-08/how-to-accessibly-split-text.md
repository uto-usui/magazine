...
source: "https://css-irl.info/how-to-accessibly-split-text/"
publishedDate: "2019-08-27"
category: "css"
feedName: "CSS IRL"
---

I recently published an article on [animating variable fonts](https://css-irl.info/variable-font-animation-with-css-and-splitting-js) with the help of the Javascript library [Splitting.js](https://splitting.js.org/). A few people asked about the accessibility implications of this, so in this article we’ll take a look at why splitting a string of text can be problematic from an accessibility point of view, and what we can do to make sure that split text is accessible to everyone.
