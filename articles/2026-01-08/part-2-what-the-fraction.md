...
source: "https://css-irl.info/debugging-css-grid-part-2-what-the-fraction/"
...
![Three grid items of 200px and one grid item of 1fr](https://css-irl.info/debugging-css-grid-2-03.png)

_Fig 01_ Four equal width tracks (each sized at 1fr)
...
![Three grid items of 200px and one grid item of 1fr](https://css-irl.info/debugging-css-grid-2-02.png)

_Fig 02_ The 1fr column on the right expands to fill all of the remaining space, once the fixed tracks are taken into account.
...
![Four grid items of differing widths](https://css-irl.info/debugging-css-grid-2-01.png)
