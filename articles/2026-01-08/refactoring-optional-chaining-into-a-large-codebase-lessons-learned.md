...
source: "https://lea.verou.me/2020/06/refactoring-optional-chaining-into-a-large-codebase-lessons-learned/"
...
## [Patterns to search for](#patterns-to-search-for)
...
### [Don’t overdo it](#don%E2%80%99t-overdo-it)
...
### [You still need to check before assignment](#you-still-need-to-check-before-assignment)
...
### [It’s very easy to put the ?. in the wrong place or forget some ?.](#it%E2%80%99s-very-easy-to-put-the-%3F.-in-the-wrong-place-or-forget-some-%3F.)
...
### [It can introduce bugs if you’re not careful](#it-can-introduce-bugs-if-you%E2%80%99re-not-careful)
...
#### [Operator precedence slips](#operator-precedence-slips)
...
#### [Sometimes, it can fix bugs too!](#sometimes%2C-it-can-fix-bugs-too!)
...
#### [Finding usages becomes trickier](#finding-usages-becomes-trickier)
