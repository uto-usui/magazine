...
source: "https://css-irl.info/building-the-zig-zag-gradient-lab/"
publishedDate: "2020-08-13"
category: "css"
feedName: "CSS IRL"
---

![Opening slide from the talk, titled Building the Zig-Zag Gradient Lab, with colourful zig-zag background](https://css-irl.info/building-the-zig-zag-gradient-lab-01.jpg)
...
![A 45 degree diagonal gradient](https://css-irl.info/building-the-zig-zag-gradient-lab-01a.jpg)

_Fig 01_ Gradient with consecutive colour stops
...
![A two-tone repeating gradient which creates a triangle pattern](https://css-irl.info/building-the-zig-zag-gradient-lab-02.jpg)

_Fig 02_ Gradient with fixed background size
...
![Concentric circles fusing with one another in psychedelic colours](https://css-irl.info/building-the-zig-zag-gradient-lab-03.jpg)

_Fig 03_ Repeating radial gradients with fixed background size
...
![Different variations of the concentric circle pattern](https://css-irl.info/building-the-zig-zag-gradient-lab-04.jpg)

_Fig 04_ Adjusting the different property values gives us very different results.
...
![Repeating striped background](https://css-irl.info/building-the-zig-zag-gradient-lab-05.jpg)

_Fig 05_ Striped background with repeating linear gradient and fixed size

Then I used an absolute-positioned pseudo-element with the same background at the opposite angle. (Fig 06)

![The previous gradient with the opposite angle (-45 degrees)](https://css-irl.info/building-the-zig-zag-gradient-lab-06.jpg)
...
![Showing the areas revealed by the mask-image property](https://css-irl.info/building-the-zig-zag-gradient-lab-07.jpg)

_Fig 07_ The two gradients overlaid. The semi-transparent areas show where the pattern below will be visible.

This is the actual result. (Fig 08)

![Zig-zag striped gradient pattern](https://css-irl.info/building-the-zig-zag-gradient-lab-08.jpg)

_Fig 08_ The resulting zig-zag pattern
...
![Slide with a code example, showing a zig-zag background with thinner, wider stripes](https://css-irl.info/building-the-zig-zag-gradient-lab-09.jpg)

_Fig 09_ Changing the custom properties changes the appearance of the zig-zag stripes
...
![Colour wheel illustration showing how the hues are calculated](https://css-irl.info/building-the-zig-zag-gradient-lab-10.jpg)

_Fig 10_ Split complementary colour scheme with custom properties
