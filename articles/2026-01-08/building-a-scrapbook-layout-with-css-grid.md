...
source: "https://css-irl.info/building-a-scrapbook-layout-with-css-grid/"
...
![Child’s preschool scrapbook spread titled ‘Hector’s Adventures with George’](https://css-irl.info/building-a-scrapbook-layout_02.jpg)
...
![A 4-column grid over a 5-column grid](https://css-irl.info/building-a-scrapbook-layout_03a.png)

_Fig 2_ We start with a 4-column and a 5-column grid

![4-column and 5-column grids superimposed, with the result shown below](https://css-irl.info/building-a-scrapbook-layout_04a.png)

_Fig 3_ The grids are superimposed, one on top of the other. The result is a compound grid.
...
![Screenshot of the compound grid generator tool](https://css-irl.info/building-a-scrapbook-layout_01.png)
...
To maintain a sense of vertical rhythm, I decided the photos should each overlap by the same amount. I assigned this amount to a custom property so that it could be used thoughout the page and updated if necessary (_Fig 4_).

![Grid with items overlapping vertically](https://css-irl.info/building-a-scrapbook-layout_05a.png)

_Fig 4_ Images overlap vertically
...
![Grid showing padding rows between images and text blocks](https://css-irl.info/building-a-scrapbook-layout_06a.png)

_Fig 5_ “Padding” rows allow a minimum space to be maintained between the end of a text block and the start of the next image.
...
![Screenshot of grid rows](https://css-irl.info/building-a-scrapbook-layout_08.jpg)

_Fig 7_ Screenshot from the Firefox grid inspector in the dev tools layout panel, showing our grid columns and rows
...
![Names grid area defined by grid lines](https://css-irl.info/building-a-scrapbook-layout_09.png)

_Fig 8_ Suffixing line names with -start and -end creates a grid area
...
![Full page screenshot of the finished layout](https://css-irl.info/building-a-scrapbook-layout_10.jpg)
