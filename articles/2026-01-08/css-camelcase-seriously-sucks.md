...
source: "https://csswizardry.com/2010/12/css-camel-case-seriously-sucks/"
...
1.  [CSS is a hyphen-delimited syntax](#css-is-a-hyphen-delimited-syntax)
    1.  [XHTML is a lower-case language](#xhtml-is-a-lower-case-language)
    2.  [Inconsistency within your own rules](#inconsistency-within-your-own-rules)
2.  [It’s harder to read](#its-harder-to-read)
    1.  [Scannability](#scannability)
3.  [Hyphens work better in text editors](#hyphens-work-better-in-text-editors)
...
![Selecting camel case strings](https://csswizardry.com/wp-content/uploads/2010/12/camel-case-select.gif)
...
![Selecting hyphenated strings](https://csswizardry.com/wp-content/uploads/2010/12/hyphen-select.gif)
