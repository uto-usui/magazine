...
source: "https://css-irl.info/controlling-leftover-grid-items/"
publishedDate: "2019-04-13"
category: "css"
feedName: "CSS IRL"
---

I recently wrote about [some of the cases where you might want to use Grid instead of flexbox](https://css-irl.info/to-grid-or-to-flex), and vice-versa. One of the scenarios I pointed out _might_ be a better case for using flexbox is when you want to control the behaviour of any leftover grid items that don’t fill an entire row.

![10 items on a 4x4 grid](https://css-irl.info/controlling-leftover-grid-items-01.svg)

As there are only 10 items in this grid rather than 12, we may want to control how those last two items are displayed.
...
![Two flexbox layout examples](https://css-irl.info/to-grid-or-to-flex-01.svg)
...
![A grid with the two leftover items centred](https://css-irl.info/controlling-leftover-grid-items-02.svg)
