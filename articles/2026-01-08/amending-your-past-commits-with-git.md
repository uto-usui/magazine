...
source: "https://css-irl.info/amending-your-past-commits-with-git/"
...
![Illustration showing a git master branch in the centre with two other branches merging in a linear fashion](https://css-irl.info/amending-your-past-commits-with-git-01.png)
...
![Illustration showing the master branch being merged into the feature branch](https://css-irl.info/amending-your-past-commits-with-git-02.png)

Merging an upstream master branch into your feature branch results in a large commit in the feature branch

![Illustration showing the feature branch being rebased from master](https://css-irl.info/amending-your-past-commits-with-git-03.png)

Rebasing moves the base of your feature branch along to include the new commits from the master branch
