...
source: "https://css-irl.info/dont-forget-the-lang-attribute/"
...
> I use a Chrome extension Read Aloud to read the web pages for improving my English. The reading voice for most web pages is American accent, but when it reads [@CSSInRealLife](https://twitter.com/CSSInRealLife?ref_src=twsrc%5Etfw), it switches to British, which is very interesting.😁
> 
> — CY is here 👩🏻‍💻🚀🖖🏻 (@cyishere) [November 29, 2021](https://twitter.com/cyishere/status/1465312612074147847?ref_src=twsrc%5Etfw)
