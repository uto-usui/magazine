...
source: "https://css-irl.info/how-to-enable-experimental-web-platform-features/"
publishedDate: "2019-06-21"
category: "css"
feedName: "CSS IRL"
---

![Chrome and Firefox logos](https://css-irl.info/how-to-enable-experimental-features.jpg)
...
![Screenshot from caniuse.com showing Grid implementation state in different browsers](https://css-irl.info/how-to-enable-experimental-features-05.png)
...
2.  If you haven’t visited this URL before, you’ll get a warning that looks like this:
    ...
    ![Firefox screenshot](https://css-irl.info/how-to-enable-experimental-features-02.png)
...
3.  Use the search bar to search for the name of the feature you want to enable. For example, if we search for `subgrid` we’ll find the following:
    ...
    ![Firefox screenshot](https://css-irl.info/how-to-enable-experimental-features-03.png)
...
2.  Search for the feature. Searching for CSS here (at the time of writing) only yields one result (CSS fragment identifiers). All features have a dropdown from which you can select the options _enabled_, _disabled_ or _default_.
    ...
    ![Chrome screenshot](https://css-irl.info/how-to-enable-experimental-features-04.png)
