...
source: "https://csswizardry.com/2011/02/creating-a-pure-css-dropdown-menu/"
...
1.  [](#demo)[Demo](https://csswizardry.com/demos/css-dropdown/)
2.  [The concept](#the-concept)
    1.  [Featured case study: NHS](#)
3.  [The markup](#the-markup)
4.  [The CSS](#the-css)
    1.  [The nested lists](#the-nested-lists)
...
## [Demo](https://csswizardry.com/demos/css-dropdown/)
...
[View demo…](https://csswizardry.com/demos/css-dropdown/)
...
Hopefully my write-up makes sense. but if anything is unclear leave a comment and one of us in [the dev team](https://twitter.com/VenturelabDev) will try and set you right. Or, you could just copy/paste the code and hack it apart for yourselves.
