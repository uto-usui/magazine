...
source: "https://css-irl.info/masonry-in-css/"
...
![Masonry-style grid of rectangles of differing proportions](https://css-irl.info/masonry-in-css-01.webp)
...
See the Pen [Masonry grid (Firefox with flag enabled)](https://codepen.io/michellebarker/pen/RwMWYpb) by Michelle Barker ([@michellebarker](https://codepen.io/michellebarker)) on [CodePen](https://codepen.io/).
...
See the Pen [Masonry grid (Firefox with flag enabled)](https://codepen.io/michellebarker/pen/QWmjBXE) by Michelle Barker ([@michellebarker](https://codepen.io/michellebarker)) on [CodePen](https://codepen.io/).
