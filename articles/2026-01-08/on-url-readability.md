...
source: "https://lea.verou.me/2011/08/on-url-readability/"
...
Yesterday, I was watching some season 6 episodes of Futurama (btw, this is their best season ever!) and I noticed the URLs in the website I was in (let’s call it [foo.com](http://foo.com/)). They were like:

[http://foo.com/futurama/season/6/episode/9](http://foo.com/futurama/season/6/episode/9)
...
Regarding hierarchy and RESTful design, the first example isn’t exactly correct. If it was hierarchical, it should be [foo.com/futurama/season](http://foo.com/futurama/season)**s**/6/episode**s**/9. As it currently stands, it’s key-value pairs, masquerading as hierarchical. However, it still reads better.
...
http : [//foo.com/futurama-season-6-episode-9](https://foo.com/futurama-season-6-episode-9)  (suggested by Ben Alman)
