...
source: "https://lea.verou.me/2014/07/an-easy-notation-for-grayscale-colors/"
...
### [1\. gray(lightness \[, alpha\])](#1.-gray\(lightness-%5B%2C-alpha%5D\))
...
### [2\. white(lightness \[, alpha\])](#2.-white\(lightness-%5B%2C-alpha%5D\))
...
### [3\. black(lightness \[, alpha\])](#3.-black\(lightness-%5B%2C-alpha%5D\))
...
### [4\. rgb() with one argument and rgba() with two arguments](#4.-rgb\(\)-with-one-argument-and-rgba\(\)-with-two-arguments)
