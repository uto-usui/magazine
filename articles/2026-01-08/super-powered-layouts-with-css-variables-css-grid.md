...
source: "https://css-irl.info/super-powered-layouts/"
...
See the Pen [CSS Variables + CSS Grid experiment (in progress)](https://codepen.io/michellebarker/pen/xWPyWj/) by Michelle Barker ([@michellebarker](https://codepen.io/michellebarker)) on [CodePen](https://codepen.io/).
