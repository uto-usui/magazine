...
source: "https://lea.verou.me/2009/04/better-usability-in-5-minutes/"
...
### [1\. Make buttons and button-like links appear pressed](#1.-make-buttons-and-button-like-links-appear-pressed)
...
### [2\. Smooth transitions](#2.-smooth-transitions)
...
### [3\. Add dingbats to buttons that depict their functionality](#3.-add-dingbats-to-buttons-that-depict-their-functionality)
...
#### [Without dingbats:](#without-dingbats%3A)

Next Previous Done Favorite

#### [With dingbats:](#with-dingbats%3A)
...
You can find many such dingbats with their unicode hex codes in [http://www.copypastecharacter.com/](http://www.copypastecharacter.com/ "Linkification: http://www.copypastecharacter.com/") and [http://www.alanwood.net/unicode/dingbats.html](http://www.alanwood.net/unicode/dingbats.html).
...
### [5\. Highlight the current target](#5.-highlight-the-current-target)
...
### [That’s all folks](#that%E2%80%99s-all-folks)
