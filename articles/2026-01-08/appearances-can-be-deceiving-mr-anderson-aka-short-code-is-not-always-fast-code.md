...
source: "https://lea.verou.me/2009/02/appearances-can-be-deceiving-mr-anderson-aka-short-code-is-not-always-fast-code/"
...
### [So, which method is ideal for String/Number checks? (added afterwards)](#so%2C-which-method-is-ideal-for-string%2Fnumber-checks%3F-\(added-afterwards\))
