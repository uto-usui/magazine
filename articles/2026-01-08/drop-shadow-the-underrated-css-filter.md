...
source: "https://css-irl.info/drop-shadow-the-underrated-css-filter/"
...
![Pink chevron shape with blue drop-shadow](https://css-irl.info/drop-shadow-02.jpg)

The drop-shadow filter is applied on the parent element of the clipped shape.
...
![Two call-to-action components with box-shadow](https://css-irl.info/drop-shadow-03.jpg)

Box-shadow applied to component
...
![Two call-to-action components with box-shadow](https://css-irl.info/drop-shadow-04.jpg)

Box-shadow applied to columns

But by using `drop-shadow` on the whole component, we get the shadow exactly where we want it, without resorting to hacks:

![Two call-to-action components with drop-shadow](https://css-irl.info/drop-shadow-05.jpg)

Drop-shadow applied to component
