...
source: "https://css-irl.info/optimising-svgs-for-the-web/"
...
![Black and white CSS IRL logo as SVG](https://css-irl.info/optimising-svgs-for-the-web_01.png)
...
![](https://css-irl.info/optimising-svgs-for-the-web_02.jpg)

_Fig 02_SVG icon in the _SVGOMG_ interface
...
The first thing I do when optimising an SVG is remove any hidden layers, and expand groups where possible. This removes any `<g>` tags grouping paths in the SVG code. You might want to keep certain groups intact if you plan to style or animate them. You can expand a group in Illustrator using the shortcut Shift + CMD + G (_Fig 03_).

![](https://css-irl.info/optimising-svgs-for-the-web_03.jpg)

_Fig 03_ The layers panel in Illustrator, showing group with two objects
...
![Icons shown before stroke expanded and after](https://css-irl.info/optimising-svgs-for-the-web_04.png)

_Fig 04_ Icon shown before and after stroke expanded
...
![Search icon shown before and after paths merged](https://css-irl.info/optimising-svgs-for-the-web_05a.jpg)

_Fig 05_ Icon shown before and after paths merged
...
![Search icon shown before and after “Fit to artwork bounds” is selected](https://css-irl.info/optimising-svgs-for-the-web_06.jpg)

_Fig 06_ The icon on the left has a larger viewBox than is necessary. After selecting “Fit to artwork bounds”, the icon sits snugly within the viewBox, with no extra space (right).
