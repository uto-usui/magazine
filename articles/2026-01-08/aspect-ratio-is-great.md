...
source: "https://css-irl.info/aspect-ratio-is-great/"
...
See the Pen [Aspect-ratio](https://codepen.io/michellebarker/pen/oNoBaPE) by Michelle Barker ([@michellebarker](https://codepen.io/michellebarker)) on [CodePen](https://codepen.io/).
...
![Two blue boxes with short text, one purple box with longer text](https://css-irl.info/aspect-ratio-is-great-01.jpg)

[See the demo](https://codepen.io/michellebarker/pen/eYegQRG)
...
![Two blue boxes with short text, one purple box with longer text that overflows the parent](https://css-irl.info/aspect-ratio-is-great-02.jpg)

[See the demo](https://codepen.io/michellebarker/pen/WNXRYLp)
...
See the Pen [Aspect ratio image gallery](https://codepen.io/michellebarker/pen/RwjKEGa) by Michelle Barker ([@michellebarker](https://codepen.io/michellebarker)) on [CodePen](https://codepen.io/).

Or `object-fit: contain` for a logo grid:

See the Pen [Aspect ratio logo grid](https://codepen.io/michellebarker/pen/vYWgvZK) by Michelle Barker ([@michellebarker](https://codepen.io/michellebarker)) on [CodePen](https://codepen.io/).
...
![Two blue boxes with short text, one purple box with longer text](https://css-irl.info/aspect-ratio-is-great-03.jpg)
...
See the Pen [Aspect ratio](https://codepen.io/michellebarker/pen/YzEZzeM) by Michelle Barker ([@michellebarker](https://codepen.io/michellebarker)) on [CodePen](https://codepen.io/).
...
![Two call-to-actions, the second with longer text](https://css-irl.info/aspect-ratio-is-great-04.jpg)
...
![Image gallery](https://css-irl.info/aspect-ratio-is-great-05.jpg)

By setting `align-items: start` on the grid container, we can prevent this growing behaviour on the larger item’s siblings.

![Image gallery](https://css-irl.info/aspect-ratio-is-great-06.jpg)
