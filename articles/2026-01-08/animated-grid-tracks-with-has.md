...
source: "https://css-irl.info/animated-grid-tracks-with-has/"
publishedDate: "2022-04-05"
category: "css"
feedName: "CSS IRL"
---

![Grid of four segments with brightly coloured backgrounds and cupcake photo in the first section](https://css-irl.info/animated-grid-tracks-with-has-02.jpg)

Screenshot from a Codepen demo. Hovering on a grid item expands the grid tracks.

Somehow it’s already three months since I wrote about the CSS `:has()` pseudo-class [landing in Safari Technology preview](https://css-irl.info/has-has-landed-in-safari/). The latest Safari (proper) release has just shipped with support, and can be enabled with a flag in the next Chrome release.
...
![Menu bar with item hovered](https://css-irl.info/animated-grid-tracks-with-has-01.jpg)
...
See the Pen [CSS Grid: In-flight Entertainment Screen](https://codepen.io/oliviale/pen/LvKdRP) by Olivia Ng ([@oliviale](https://codepen.io/oliviale)) on [CodePen](https://codepen.io/).
...
See the Pen [grid / :has + animated grid tracks (Safari only)](https://codepen.io/michellebarker/pen/vYpdEgQ) by Michelle Barker ([@michellebarker](https://codepen.io/michellebarker)) on [CodePen](https://codepen.io/).
