...
source: "https://css-irl.info/writing-useful-alt-text/"
...
![Pink box with the text “Two blue boxes with short text, one purple box with longer text”](https://css-irl.info/writing-useful-alt-text-01.webp)

How an image’s alt text might be displayed to a user if the image hasn’t loaded
...
![Screenshot of tweet with the text “Another day working on the train where a CSS file fails to download, but THAT’S OK because ✨progressive enhancement✨”, accompanied a screenshot of the web page I was browsing at the time in its unstyled HTML form](https://css-irl.info/writing-useful-alt-text-02.webp)
