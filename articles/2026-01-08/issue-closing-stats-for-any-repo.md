...
source: "https://lea.verou.me/2019/12/issue-closing-stats-for-any-repo/"
...
![](https://lea.verou.me/2019/12/issue-closing-stats-for-any-repo/images/image.png)
...
## [Displaying a list of the last 100 closed issues and the time it took to close them](#displaying-a-list-of-the-last-100-closed-issues-and-the-time-it-took-to-close-them)
...
See the Pen [Step 1 - Issue Closing App Tutorial](https://codepen.io/leaverou/pen/qBEaoPL) by Lea Verou ([@leaverou](https://codepen.io/leaverou)) on [CodePen](https://codepen.io/).
...
See the Pen [Step 2 - Issue Closing App Tutorial](https://codepen.io/leaverou/pen/bGbBQwg) by Lea Verou ([@leaverou](https://codepen.io/leaverou)) on [CodePen](https://codepen.io/).

## [Displaying aggregate statistics](#displaying-aggregate-statistics)
...
See the Pen [Step 3 - Issue Closing App Tutorial](https://codepen.io/leaverou/pen/jONVQrw/) by Lea Verou ([@leaverou](https://codepen.io/leaverou)) on [CodePen](https://codepen.io/).

## [Making repo a variable](#making-repo-a-variable)
...
## [Avoid reload on every keystroke](#avoid-reload-on-every-keystroke)
...
## [Setting the repo via a URL parameter](#setting-the-repo-via-a-url-parameter)
...
See the Pen [Step 5 - Issue Closing App Tutorial](https://codepen.io/leaverou/pen/bGbBGXM/) by Lea Verou ([@leaverou](https://codepen.io/leaverou)) on [CodePen](https://codepen.io/).
...
## [Adding label autocomplete](#adding-label-autocomplete)
...
See the Pen [Issue Closing App - Tutorial Step 6](https://codepen.io/leaverou/pen/QWLGWXV/) by Lea Verou ([@leaverou](https://codepen.io/leaverou)) on [CodePen](https://codepen.io/).

## [Adding a visual summary graphic](#adding-a-visual-summary-graphic)
...
See the Pen [Issue Closing App - Tutorial Step 7](https://codepen.io/leaverou/pen/QWLGWzx/) by Lea Verou ([@leaverou](https://codepen.io/leaverou)) on [CodePen](https://codepen.io/).