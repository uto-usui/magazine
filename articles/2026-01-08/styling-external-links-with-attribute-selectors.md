...
![Two external links with appended icon. In the second link the icon wraps onto the next line](https://css-irl.info/styling-external-links-01.webp)
...
![Two external links with appended icon. The icon no longer wraps on its own](https://css-irl.info/styling-external-links-02.webp)
...
See the Pen [Untitled](https://codepen.io/michellebarker/pen/XWoGgrX) by Michelle Barker ([@michellebarker](https://codepen.io/michellebarker)) on [CodePen](https://codepen.io/).