...
source: "https://csswizardry.com/2019/05/self-host-your-static-assets/"
publishedDate: "2019-06-01"
category: "css"
feedName: "CSS Wizardry"
---

31 May, 2019 (last updated on 9 January, 2025)
...
1.  [What Am I Talking About?](#what-am-i-talking-about)
2.  [Risk: Slowdowns and Outages](#risk-slowdowns-and-outages)
    1.  [`code.jquery.com` Outage](#codejquerycom-outage)
3.  [Risk: Service Shutdowns](#risk-service-shutdowns)
4.  [Risk: Security Vulnerabilities](#risk-security-vulnerabilities)
    1.  [Mitigation: Subresource Integrity](#mitigation-subresource-integrity)
5.  [Penalty: Network Negotiation](#penalty-network-negotiation)
    1.  [Mitigation: `preconnect`](#mitigation-preconnect)
6.  [Penalty: Loss of Prioritisation](#penalty-loss-of-prioritisation)
7.  [Penalty: Caching](#penalty-caching)
8.  [Myth: Cross-Domain Caching](#myth-cross-domain-caching)
    1.  [Update: 2025-01-09](#update-2025-01-09)
9.  [Myth: Access to a CDN](#myth-access-to-a-cdn)
10.  [Self-Host Your Static Assets](#self-host-your-static-assets)
...
If you have any render-blocking CSS or synchronous JS hosted on third party domains, go and bring it onto your own infrastructure _right now_. Critical assets are far too valuable to leave on someone else’s servers.

### `code.jquery.com` Outage

> Yikes! It looks like code.jquery.⁠com is currently suffering an outage. This is going to have a huge impact across a massive portion of the web. Please please please SELF-HOST YOUR STATIC ASSETS: [https://t.co/YWb7ZLdPxc](https://t.co/YWb7ZLdPxc) [pic.twitter.com/2UjFNhrCST](https://t.co/2UjFNhrCST)
> 
> — Harry Roberts (@csswizardry) [27 April, 2023](https://twitter.com/csswizardry/status/1651599057608142849?ref_src=twsrc%5Etfw)
...
Chrome 86 (2020) and Firefox 85 (2021) also both enabled cache partitioning, meaning no major browser stands to gain any performance benefit from shared assets hosting. **Self-host your static assets.**
