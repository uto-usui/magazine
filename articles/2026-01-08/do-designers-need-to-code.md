...
source: "https://csswizardry.com/2011/09/do-designers-need-to-code/"
...
1.  [Is a web designer really a web designer if they can’t code?](#is-a-web-designer-really-a-web-designer-if-they-cant-code)
2.  [Designers should work with developers](#designers-should-work-with-developers)
    1.  [But the client was shown a PSD that needs to be honoured…](#but-the-client-was-shown-a-psd-that-needs-to-be-honoured)
3.  [HTML and CSS isn’t easy…](#html-and-css-isnt-easy)
4.  [These rules introduce restrictions](#these-rules-introduce-restrictions)
5.  [Real life examples](#real-life-examples)
6.  [What do they need to understand?](#what-do-they-need-to-understand)
7.  [But there is no right or wrong answer](#but-there-is-no-right-or-wrong-answer)
8.  [Massive disclaimer](#massive-disclaimer)
9.  [In short](#in-short)
