...
source: "https://una.im/gulp-local-psi/"
publishedDate: "2014-12-17"
category: "css"
feedName: "Una Kravets"
---

![](https://una.im/posts/lexus.jpg)
...
{% highlight JSON %} URL: [https://www.google.com/?gws\_rd=ssl](https://www.google.com/?gws_rd=ssl) Score: 92 Strategy: desktop

Number Resources | 13 Number Hosts | 5 Total Request | 2.62 kB Number Static Resources | 9 Html Response | 116.9 kB Image Response | 46.02 kB Javascript Response | 879.68 kB Other Response | 1.76 kB Number Js Resources | 5 | Avoid Landing Page Redirects | 7 Enable Gzip Compression | 0 Leverage Browser Caching | 0 Main Resource Server Response Time | 0 Minify Css | 0 Minify HTML | 0 Minify Java Script | 0.27 Minimize Render Blocking Resources | 0 Optimize Images | 0 Prioritize Visible Content | 0 {% endhighlight %}
...
![ngrok infographic](https://una.im/posts/ngrok-infographic.png)
...
That Forwarding URL is what we’ll use to get our page speed insights. Try it now. Type `psi <your forwarding url>` and you should see a response! Pretty cool right?
...
If you’re wondering what `cb` is, it stands for _callback_, and its what allows you to define the end to an asyncronous task. We’ll see this again in the psi tasks below in a second.
...
Thanks [AJ](https://github.com/silenceisgolden) for pointing out the API syntax update and [Chris](http://twitter.com/rupl) for updating the article!