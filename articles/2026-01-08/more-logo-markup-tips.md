...
source: "https://csswizardry.com/2011/08/more-logo-markup-tips/"
publishedDate: "2011-08-03"
category: "css"
...
1.  [There’s more…](#theres-more)

In my previous article we determined that [your logo is not a `<h1>`](https://csswizardry.com/2010/10/your-logo-is-an-image-not-a-h1/) and is in fact an image (`<img />`) in its own right. Now let’s cover some nice little tips and snippets for making the most of your markup and creating a nicer UX around it.
