...
2.  [The _key_ selector](#the-key-selector)
3.  [Overqualifying selectors](#overqualifying-selectors)
4.  [Is all this really necessary?](#is-all-this-really-necessary)
    1.  [But](#but)
    2.  [More on CSS selector efficiency](#more-on-css-selector-efficiency)

Efficient CSS is not a new topic, nor one that I really need to cover, but it’s something I’m really interested in and have been keeping an eye on more and more since working at [Sky](https://csswizardry.com/case-studies/bskyb/).
