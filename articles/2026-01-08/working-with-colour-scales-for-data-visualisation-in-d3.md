...
source: "https://css-irl.info/working-with-color-scales-for-data-visualisation-in-d3/"
publishedDate: "2023-02-14"
category: "css"
feedName: "CSS IRL"
---

![Temperature chart with threshold scale applied, showing distinct colour bands](https://css-irl.info/working-with-color-scales-03.jpg)
...
See the Pen [D3 domain/range](https://codepen.io/michellebarker/pen/PoEGXjM) by Michelle Barker ([@michellebarker](https://codepen.io/michellebarker)) on [CodePen](https://codepen.io/).
...
See the Pen [D3 color scale visualizer](https://codepen.io/michellebarker/pen/NWBZQRj) by Michelle Barker ([@michellebarker](https://codepen.io/michellebarker)) on [CodePen](https://codepen.io/).
...
![Screenshot showing the resulting colours on the colour scale](https://css-irl.info/working-with-color-scales-02.jpg)
...
![Colour swatches showing the (expected) colour values for 0 and 100, and the unexpected yellow colour for 200](https://css-irl.info/working-with-color-scales-01.svg)
...
![Temperature chart with linear colour scale. Higher temperature anomalies are depicted by pink colours, lower anomalies by blue](https://css-irl.info/working-with-color-scales-02c.jpg)
...
See the Pen [D3 colour scale linear (diverging)](https://codepen.io/michellebarker/pen/QWVWdjz) by Michelle Barker ([@michellebarker](https://codepen.io/michellebarker)) on [CodePen](https://codepen.io/).
...
See the Pen [D3 ordinal colour scale](https://codepen.io/michellebarker/pen/YzjMMNp) by Michelle Barker ([@michellebarker](https://codepen.io/michellebarker)) on [CodePen](https://codepen.io/).
...
![Temperature chart with threshold scale applied, showing distinct colour bands](https://css-irl.info/working-with-color-scales-02b.jpg)
...
See the Pen [D3 colour scale threshold (diverging)](https://codepen.io/michellebarker/pen/oNPNYmL) by Michelle Barker ([@michellebarker](https://codepen.io/michellebarker)) on [CodePen](https://codepen.io/).
