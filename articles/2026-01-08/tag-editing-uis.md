...
source: "https://lea.verou.me/2010/11/tag-editing-uis/"
publishedDate: "2010-11-14"
category: "css"
feedName: "Lea Verou"
---
...
### [Pattern #1: Input field to add new tags, delete button for existing ones](#pattern-%231%3A-input-field-to-add-new-tags%2C-delete-button-for-existing-ones)

Used by: Wordpress, flickr, foursquare![Screenshot of Wordpress' tagging UI](https://lea.verou.me/2010/11/tag-editing-uis/images/Screen-shot-2010-11-14-at-16.45.11-.png "Wordpress' tagging UI")
...
### [Pattern #2: One text field to edit, delete or add new tags](#pattern-%232%3A-one-text-field-to-edit%2C-delete-or-add-new-tags)

Used by: delicious, Google reader, stackoverflow, reddit[![Screenshot of delicious' tagging UI](https://lea.verou.me/2010/11/tag-editing-uis/images/Screen-shot-2010-11-14-at-16.47.04-.png "Delicious' tagging UI")](https://lea.verou.me/2010/11/tag-editing-uis/images/Screen-shot-2010-11-14-at-16.47.04-.png)
...
### [Pattern #3: Hybrid approach: Text field for all, existing tags seem to be inside and have a delete button](#pattern-%233%3A-hybrid-approach%3A-text-field-for-all%2C-existing-tags-seem-to-be-inside-and-have-a-delete-button)

Used by: [last.fm](http://last.fm/)![Screenshot of last.fm's tagging UI](https://lea.verou.me/2010/11/tag-editing-uis/images/Screen-shot-2010-11-14-at-16.54.45-.png "last.fm's tagging UI")
...
-   There’s no editing in [last.fm](http://last.fm/)’s implementation, but the pattern easily allows for that, for example by using contentEditable on the tag s

[last.fm](http://last.fm/) chooses to implement this by faking the tags being inside an input field: Technically they’re implemented just like in pattern #1 above, with the difference that they visually appear to be inside the same box and every time a user inserts a comma (which is the tag separator) the tag they just typed is removed from the text field and a new link with a delete button is created just before the text field, which is much smaller than it looks.

### [Which pattern is the best?](#which-pattern-is-the-best%3F)
...
### [Another pattern?](#another-pattern%3F)
