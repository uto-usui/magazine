...
source: "https://css-irl.info/solving-a-tricky-layout-problem/"
...
![A component with a large, centred heading, a block of text on the top right and a large image on the left](https://css-irl.info/solving-a-tricky-layout-problem_01.jpg)
...
![Simplified illustration of the component layout](https://css-irl.info/solving-a-tricky-layout-problem_02.png)
...
![Component with row tracks highlighted](https://css-irl.info/solving-a-tricky-layout-problem_03.png)
...
![Showing extra space created at the bottom of the grid](https://css-irl.info/solving-a-tricky-layout-problem_04.png)
...
![The same grid with the height of the top row only increased](https://css-irl.info/solving-a-tricky-layout-problem_07.png)

The idea solution: the top row track size increases, but the bottom does not
...
![Hidden row at the top of the grid](https://css-irl.info/solving-a-tricky-layout-problem_05.png)
...
![Hidden row expanding when text block is longer](https://css-irl.info/solving-a-tricky-layout-problem_06.png)

The top row of the grid expands as the text content grows longer
