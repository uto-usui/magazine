...
source: "https://lea.verou.me/2009/02/bulletproof-cross-browser-rgba-backgrounds/"
...
### [Browsers that currently support RGBA](#browsers-that-currently-support-rgba)
...
### [Problems with the filter method](#problems-with-the-filter-method)
...
### [A bulletproof solution](#a-bulletproof-solution)
...
Here it is: [rgba.php](https://lea.verou.me/2009/02/bulletproof-cross-browser-rgba-backgrounds/uploads/rgba.zip)
...
### [Why not data:// URIs?](#why-not-data%3A%2F%2F-uris%3F)
...
### [RGBA is not only for backgrounds!](#rgba-is-not-only-for-backgrounds!)
