...
source: "https://lea.verou.me/2012/02/exactly-how-much-css3-does-your-browser-support/"
...
[![](https://lea.verou.me/2012/02/exactly-how-much-css3-does-your-browser-support/images/Screen-shot-2012-02-02-at-14.20.15--300x187.png "Screen shot 2012-02-02 at 14.20.15")](https://lea.verou.me/2012/02/exactly-how-much-css3-does-your-browser-support/images/Screen-shot-2012-02-02-at-14.20.15-.png)This project started as an attempt to improve [dabblet](https://dabblet.com/) and to generate data for the book chapter I’m writing for Smashing Book #3. I wanted to create a very simple/basic testsuite for CSS3 stuff so that you could hover on a e.g. CSS3 property and you got a nice browser support popup. While I didn’t achieve that (turns out BrowserScope doesn’t do that kind of thing), I still think it’s interesting as a spin-off project, especially since the results will probably surprise you.
...
### [It doesn’t work on my browser, U SUCK!](#it-doesn%E2%80%99t-work-on-my-browser%2C-u-suck!)
...
### [Why did you build it?](#why-did-you-build-it%3F)
