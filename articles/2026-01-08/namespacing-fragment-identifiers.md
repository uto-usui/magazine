...
source: "https://csswizardry.com/2011/06/namespacing-fragment-identifiers/"
...
1.  [Fragment identifiers](#fragment-identifiers)
2.  [](#demo)[Demo](https://dl.dropbox.com/u/2629908/sandbox/namespacing/index.html)
3.  [Problems?](#problems)
4.  [A standard](#a-standard)
5.  [Addendum](#addendum)
...
So, whilst these are perfectly valid in HTML, they’re useless in CSS they _can_ be [styled with CSS](https://csswizardry.com/2011/06/namespacing-fragment-identifiers/#addendum:escaping). Kinda sucks, huh? But! If we know they’re okay in HTML and totally pointless in CSS, can we use that to our advantage?
...
## [Demo](https://dl.dropbox.com/u/2629908/sandbox/namespacing/index.html)

I’ve made [a demo page of this](https://dl.dropbox.com/u/2629908/sandbox/namespacing/index.html) to a) prove that it works and b) show you how it works in situ.
...
Ben ‘[Cowboy](https://twitter.com/#!/cowboy)’ Alman [points out](https://csswizardry.com/2011/06/namespacing-fragment-identifiers/#comment-61782) that [escaping the colon will allow you to style the ID via CSS, as will escaping the period](http://jsfiddle.net/csswizardry/ZYhhS/):
