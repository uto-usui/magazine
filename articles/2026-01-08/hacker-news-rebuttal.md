...
source: "https://csswizardry.com/2012/03/hacker-news-rebuttal/"
...
This means all our values—the bits that matter the most—are lined up to a) scan quickly and b) edit at once with columnal typing (in text editors which support it). This, to me, is a [no-brainer](https://www.google.co.uk/search?sourceid=chrome&ie=UTF-8&q=define%3Ano-brainer) and a very quick-win.
...
I would genuinely love to see an elegant solution to [this](http://jsfiddle.net/csswizardry/3sxZR/) that doesn’t use a class over an ID. ([There isn’t one.](https://csswizardry.com/2011/09/when-using-ids-can-be-a-pain-in-the-class/))
...
To me, another [no-brainer](https://www.google.co.uk/search?sourceid=chrome&ie=UTF-8&q=define%3Ano-brainer).
