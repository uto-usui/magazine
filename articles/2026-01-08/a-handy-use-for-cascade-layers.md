...
source: "https://css-irl.info/a-handy-use-for-cascade-layers/"
...
![Container queries demo of a grid of cards in Codepen showing the order in which layers are applied in the CSS panel](https://css-irl.info/a-handy-use-for-cascade-layers.jpg)

Here’s the full demo:

See the Pen [Container queries + cascade layers](https://codepen.io/michellebarker/pen/QWmPGqL) by Michelle Barker ([@michellebarker](https://codepen.io/michellebarker)) on [CodePen](https://codepen.io/).
