...
source: "https://www.sarasoueidan.com/blog/svg-vs-gif/"
...
2.  [Colors and Transparency](#colors-and-transparency)
3.  [Animation Techniques & Animation Performance](#animation-techniques-%26-animation-performance)
    1.  [Maintaining & Modifying Animations](#maintaining-%26-modifying-animations)
4.  [File Size, Page Load Time & Performance](#file-size%2C-page-load-time-%26-performance)
5.  [Browser Support](#browser-support)
6.  [Accessibility Concerns (#a11y)](#accessibility-concerns-\(%23a11y\))
    1.  [Content Accessibility](#content-accessibility)
7.  [Interactivity](#interactivity)
8.  [Responsive & Adaptive Animations](#responsive-%26-adaptive-animations)
...
![](https://www.sarasoueidan.com/assets/images/svg-vs-gif--animation-example.gif)
...
![](https://www.sarasoueidan.com/assets/images/svg-vs-gif--animation-example-zoomed-in.png)
...
![](https://www.sarasoueidan.com/assets/images/svg-vs-gif--circle-on-transparent-background.svg) ![](https://www.sarasoueidan.com/assets/images/svg-vs-gif--circle-on-transparent-background.gif)
...
![](https://www.sarasoueidan.com/assets/images/svg-vs-gif--artefact.png)
...
> 
> — [Chris Lilley](http://twitter.com/svgeesus/) ([Source](http://www.w3.org/Conferences/WWW4/Papers/53/gq-trans.html))
...
GIF images are capable of only binary transparency. This causes artefacts, known as the _halo effect_ to show up whenever the image or icon is used on a non-white background. The higher the background color contrast with the image, the more visible the halo effect, which makes the icons practically unusable.
...
![](https://www.sarasoueidan.com/assets/images/svg-vs-gif--rectangle-animation.gif)
...
![](https://www.sarasoueidan.com/assets/images/svg-vs-gif--photoshop-frames.png)
...
Thanks to my designer friend [Stephanie Walter](http://twitter.com/WalterStephanie) for the PS animation tips.
...
![](https://www.sarasoueidan.com/assets/images/svg-vs-gif--sprout-chart.svg)
...
GIF images cannot be stopped by the user without requiring extra images and extra HTTP requests. Even then, the control is not full.
