...
source: "https://csswizardry.com/2011/10/fully-fluid-responsive-css-carousel/"
...
1.  [](#demo)[Demo](https://dl.dropbox.com/u/2629908/sandbox/fluid-css-carousel/index.html)
2.  [The fluidity](#the-fluidity)
3.  [CSS powered](#css-powered)
4.  [Update](#update)
    1.  [Wait, CSS?!](#wait-css)

If you [follow me on Twitter](https://twitter.com/csswizardry) you’ll know I’ve been pretty enthused about this [fluid CSS carousel](https://dl.dropbox.com/u/2629908/sandbox/fluid-css-carousel/index.html) of mine. There are two aspects to it; the fluidity and the CSS functionality.

## [Demo](https://dl.dropbox.com/u/2629908/sandbox/fluid-css-carousel/index.html)

The demo features photos of me, taken on various mountains by [Suze](https://twitter.com/suzehaworth). Cheers to her for the content.
...
The numbers are so tricky to work with and if anyone can come up with a decent equation to describe it I would be so happy. I’ve got [Nick](https://twitter.com/makeusabrew) on the job, but I’ve not worked it out yet; I can’t quite grasp the relation between five panes and the numbers above in a way that I could do some quick maths to work out the animations for a four-pane carousel.
...
Massive thanks to Clay who’s worked out that the number of steps is 4n-3 and that the total time between start of one animation and the next is 100 / 2(n-1) (where n is the number of panes). See [his full comment](https://csswizardry.com/2011/10/fully-fluid-responsive-css-carousel/#comment-95396).
