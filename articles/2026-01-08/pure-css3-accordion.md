...
It’s all fairly self-explanatory; first we have the `.accordion` class for the `<ul>` where we define a width and overflow hidden ([to clear floats](https://csswizardry.com/floats/)) and some other bits and pieces.
