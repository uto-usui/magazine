...
source: "https://css-irl.info/accessible-toggles/"
...
See the Pen [Reduced-motion toggle](https://codepen.io/michellebarker/pen/JjyNXQZ) by Michelle Barker ([@michellebarker](https://codepen.io/michellebarker)) on [CodePen](https://codepen.io/).
...
See the Pen [Reduced-motion toggle (basic)](https://codepen.io/michellebarker/pen/rNzmLGv) by Michelle Barker ([@michellebarker](https://codepen.io/michellebarker)) on [CodePen](https://codepen.io/).
...
See the Pen [Toggle switch for motion (basic) with accessibility improvements](https://codepen.io/michellebarker/pen/oNeGYEz) by Michelle Barker ([@michellebarker](https://codepen.io/michellebarker)) on [CodePen](https://codepen.io/).
