...
source: "https://css-irl.info/irregular-shaped-links-with-subgrid/"
...
![A web page with two block links consisting of overlapping images and text](https://css-irl.info/irregular-shaped-links-with-subgrid-01b.jpg)
...
![Component layout with the numbered grid lines shown](https://css-irl.info/irregular-shaped-links-with-subgrid-04.jpg)
...
![Hover effect applied to both grid items](https://css-irl.info/irregular-shaped-links-with-subgrid-05.jpg)

Hovering on one item triggers the hover effect on both
...
![Illustrating the hover area of the link](https://css-irl.info/irregular-shaped-links-with-subgrid-02a.jpg)

When the user’s pointer is anywhere over the purple area, the link will be hovered

What we actually want is for our link to behave as if it’s shaped like this:

![Illustrating the desired hover area of the link](https://css-irl.info/irregular-shaped-links-with-subgrid-03a.jpg)

For the user, it would be better if only the purple area shown here activated the link’s hover effect
