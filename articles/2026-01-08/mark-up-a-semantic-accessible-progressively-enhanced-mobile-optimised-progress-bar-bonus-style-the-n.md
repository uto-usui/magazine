---
title: "Mark up a semantic, accessible, progressively enhanced, mobile optimised progress bar (bonus: style the numbers in an ordered list!)"
source: "https://csswizardry.com/2010/11/mark-up-a-semantic-accessible-progressively-enhanced-mobile-optimised-progress-bar-bonus-style-the-numbers-in-an-ordered-list/"
publishedDate: "2010-11-18"
category: "css"
...
1.  [Design and build](#design-and-build)
    1.  [Design](#design)
    2.  [Build](#build)
2.  [Styling](#styling)
3.  [Styling numbers in ordered lists](#styling-numbers-in-ordered-lists)
4.  [Progressively enhancing](#progressively-enhancing)
    1.  [Recap](#recap)
5.  [Mobile optimisation](#mobile-optimisation)
6.  [](#demo)[Demo](https://csswizardry.com/demos/progress-bar/)
7.  [Final words](#final-words)

How about that for an over-the-top title? But it’s true, that’s what we’re going to be doing. It’s been a while since my last post, unfortunately, so I thought I’d make up for it with this sizeable offering in which we will learn a lot of really great techniques in order to make something as simple as a progress bar. By which I mean a breadcrumb-esque meter of steps, such as you might find on a checkout process; we are making [this](https://csswizardry.com/demos/progress-bar/):

[![Screenshot of the final product.](https://csswizardry.com/wp-content/uploads/2010/11/progress.jpg)](https://csswizardry.com/demos/progress-bar/)
...
![Unstyled progress bar](https://csswizardry.com/wp-content/uploads/2010/11/progress-unstyled.jpg)
...
![Basic progress bar](https://csswizardry.com/wp-content/uploads/2010/11/progress-basic.jpg)
...
![Non-CSS3 progress bar](https://csswizardry.com/wp-content/uploads/2010/11/no-css3-progress.jpg)
...
For more information on mobile/iPhone optimised sites please see [my associated article](https://csswizardry.com/2010/01/iphone-css-tips-for-building-iphone-websites/).
...
Now, if you want to test this and don’t have a smartphone, or haven’t got this hosted in a live environment, simply resize your browser window right down until you see the change. I tend to use the Firefox Web Developer Toolbar addon to [resize the window to 480x800px](https://csswizardry.com/wp-content/uploads/2010/11/mobile-optimised-progress.jpg).

On the iPhone this now looks like:

![iPhone optimised progress bar](https://csswizardry.com/wp-content/uploads/2010/11/iphone-progress.jpg)

* * *

## [Demo](https://csswizardry.com/demos/progress-bar/)

For the full working demo head to [/demos/progress-bar/](https://csswizardry.com/demos/progress-bar/). For the complete CSS (with reset) please see [/demos/progress-bar/css/style.css](https://csswizardry.com/demos/progress-bar/css/style.css). Also, try using Firebug to change the `<body>`’s ID to `go-page`.
