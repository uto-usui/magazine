...
source: "https://addyosmani.com/blog/gemini-cli/"
...
-   [Tip 6: Read Google Docs, Sheets, and More.](#tip-6-read-google-docs-sheets-and-more)
-   [Tip 7: Reference Files and Images with `@` for Explicit Context](#tip-7-reference-files-and-images-with-at-for-explicit-context)
...
-   [Tip 29: Corgi Mode Easter Egg 🐕](#tip-29-corgi-mode-easter-egg)
...
Gemini CLI will recognize `/test:gen` and substitute the \`\` in your prompt template with the provided argument (in this case, the requirement). The AI will then proceed to generate a Jest unit test [accordingly](https://www.philschmid.de/gemini-cli-cheatsheet#:~:text=Example%3A%20%60). The `description` field is optional but is used when you run `/help` or `/tools` to list available commands.
