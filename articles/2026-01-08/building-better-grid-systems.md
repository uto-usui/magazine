...
source: "https://csswizardry.com/2011/08/building-better-grid-systems/"
...
2.  [The current solution(s)](#the-current-solutions)
    1.  [The other current solution](#the-other-current-solution)
3.  [The solution](#the-solution)
4.  [Roll your own…](#roll-your-own)
...
Another solution I’ve seen recently is used on [Twitter’s Bootstrap framework](https://twitter.github.com/bootstrap/) and a few other places. This solution is a little more elegant, but still not very robust.
...
I employ this technique on both [inuit.css](http://inuitcss.com/) and [Fluid Grids](https://csswizardry.com/fluid-grids/) and it’s proved perfect so far. Robust, portable and lean.