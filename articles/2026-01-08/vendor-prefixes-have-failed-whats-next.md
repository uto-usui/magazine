...
source: "https://lea.verou.me/2011/11/vendor-prefixes-have-failed-whats-next/"
...
### [1\. Unnecessary bloat](#1.-unnecessary-bloat)
...
### [2\. Spec changes still break existing content](#2.-spec-changes-still-break-existing-content)
...
### [3\. Web development has become a popularity contest](#3.-web-development-has-become-a-popularity-contest)
...
### [1\. Generic prefix (-x- or something else) and/or new @rule](#1.-generic-prefix-\(-x--or-something-else\)-and%2For-new-%40rule)
...
### [2\. Supporting both prefixed and unprefixed for WD features](#2.-supporting-both-prefixed-and-unprefixed-for-wd-features)
...
### [3\. Prefixes for versioning, not vendors](#3.-prefixes-for-versioning%2C-not-vendors)
...
### [We need more ideas](#we-need-more-ideas)
