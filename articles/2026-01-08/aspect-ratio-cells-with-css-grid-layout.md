...
source: "https://css-irl.info/aspect-ratio-cells/"
publishedDate: "2018-05-27"
category: "css"
feedName: "CSS IRL"
---

I found myself recently building a layout in CSS Grid that would have previously needed JavaScript in order to work. It’s a layout based on equal sized square grid cells, where grid items could span one or two cells on the row and/or column axis. In other words, the grid _cells_ needed to maintain an aspect ratio (1:1 in this case), but the actual grid _items_ did not necessarily, something like this:
...
See the Pen [Aspect ratio Grid boxes with Sass (with function)](https://codepen.io/michellebarker/pen/VxdXRY/) by Michelle Barker ([@michellebarker](https://codepen.io/michellebarker)) on [CodePen](https://codepen.io/).

This example actually compiles to _fewer_ lines of CSS than the equivalent example with CSS Variables.
