...
source: "https://csswizardry.com/2025/08/obs-js-context-aware-web-performance/"
...
1.  [Why It Must Run Early](#why-it-must-run-early)
2.  [What It Gives You](#what-it-gives-you)
3.  [CSS API](#css-api)
4.  [JS API](#js-api)
5.  [Statuses and Stances](#statuses-and-stances)
6.  [SPAs and Long-Lived Pages](#spas-and-long-lived-pages)
7.  [Analytics](#analytics)
8.  [Unsupported Browsers](#unsupported-browsers)
9.  [A Few Quick Wins](#a-few-quick-wins)

For the last several weeks, I’ve been working on a new JavaScript library called [Obs.js](https://github.com/csswizardry/Obs.js). If you want the broader case for why I think this kind of thing matters, I’ve written that up separately in [Meet Your Users Where They Are with Obs.js](https://csswizardry.com/2026/05/meet-your-users-where-they-are-with-obs-js/). This post is the more technical counterpart: what Obs.js gives you, how it works, and where I think it becomes useful.
...
Thankfully, Obs.js is under 1.5KB Gzipped and takes less than 5ms to run on a [low-end device](https://csswizardry.com/2025/08/low-and-mid-tier-mobile-for-the-real-world-2025/), so the inline cost is very small.
...
The full matrix is in the [README](https://github.com/csswizardry/Obs.js/blob/main/README.md), but the key idea is that Obs.js gives you a lightweight way to reason about transport, power, and hardware constraints.
...
I use [SpeedCurve](https://www.speedcurve.com/), so for me that might be as simple as:
...
Obs.js is running on its [demo page](https://csswizardry.com/Obs.js/demo/) right now, and the repo—including [`obs.js`](https://github.com/csswizardry/Obs.js/blob/main/obs.js) itself—is there if you want to inspect the code. It is one of the most quietly useful little things I’ve built in a long while.

Using Obs.js already? [Open a Pull Request](https://github.com/csswizardry/Obs.js/fork) to submit your site to the showcase.
