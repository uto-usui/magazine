...
source: "https://ics.media/entry/210129/?utm_source=atom&utm_medium=referral&utm_campaign=feed"
...
最初にインストールしている[Parcel](https://parceljs.org/)はバンドラーと呼ばれるツールで、今回はTypeScriptをJavaScriptに変換したり、ファイルの変更時にプレビューを自動更新したりするために利用します。今回はバンドラーについて深くは触れませんが、興味のある方は以前の記事[『Parcel入門 - TypeScriptの導入方法』](https://ics.media/entry/190325/)で解説していますので参照してみてください。
...
-   [最速のアニメーションライブラリはこれだ！ JSライブラリの性能をDOMとWebGPUで比較検証](https://ics.media/entry/14993/)
-   [フロントエンドから始めるアニメーション 最強のライブラリGSAPを手に入れよう](https://ics.media/entry/200805/)
