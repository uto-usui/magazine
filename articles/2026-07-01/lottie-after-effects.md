...
source: "https://ics.media/entry/230928/?utm_source=atom&utm_medium=referral&utm_campaign=feed"
...
-   After Effectsではいろんなアニメーションを作成できますが、Lottieで再現できるものに限りがあります。詳しくは[サポート表](https://lottiefiles.com/supported-features)の通りです。
...
プラグインは、[LottieFilesのページ](https://lottiefiles.com/plugins/after-effects)からでもインストール可能です。
...
そのほかの問題は[公式のトラブルシューティング](https://help.lottiefiles.com/troubleshooting-animation-render-stuck-)が参考になるかもしれません。
