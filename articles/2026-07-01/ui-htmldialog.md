...
source: "https://ics.media/entry/250904/?utm_source=atom&utm_medium=referral&utm_campaign=feed"
...
トースト、ポップオーバー、アコーディオンなども含めて、CSSの`linear()`関数でスプリングアニメーションを付けたUI例は、記事「[CSSのlinear()でUIが軽快になる! スプリングアニメーション活用術](https://ics.media/entry/260402/)」でまとめています。
