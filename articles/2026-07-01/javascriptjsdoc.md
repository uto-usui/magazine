...
source: "https://ics.media/entry/6789/?utm_source=atom&utm_medium=referral&utm_campaign=feed"
...
ちなみに[React](https://react.dev/)や[Angular](https://angular.io/)などのメジャーなJSライブラリにおいても、そのソースコードではJSDocコメントが使われています (例 : [Angular](https://github.com/angular/angular/blob/main/packages/core/src/render/api.ts)、[React](https://github.com/react/react))。APIが多岐に渡るJSライブラリを利用するとき、わざわざリファレンスをブラウザで開いたり解説書で調べることなく、コード上で関数の仕様を確認できます。
