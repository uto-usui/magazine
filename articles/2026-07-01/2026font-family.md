---
title: "2026年に最適なfont-familyの書き方"
source: "https://ics.media/entry/200317/?utm_source=atom&utm_medium=referral&utm_campaign=feed"
...
ウェブ制作を受託で対応している場合、納品後のソースコードを編集できないケースは少なくありません。納品後においても問題が起きないようにしておきたいところです。そう考えると、「無難」なフォント選定はビジネス観点でも無視できません。
...
-   キャッシュ機構を構築できたとしても、効果が生まれるのは2度目のアクセスから
    -   初回アクセスの速度は向上しない
...
2026年時点では「Noto Sans JP」がオススメです。2025年4月のWindowsの更新プログラムから「Noto Sans JP」が標準搭載されています。「Noto Sans JP」を使えば、WindowsとAndroidでの表示が統一されます。
...
もしくは、Windows 10 October 2018 Updateで搭載されたBIZ UDPゴシック（`BIZ UDPGothic`）も選択肢として挙げられます。
...
Windowsでは昔から「メイリオ」フォントが使われてきました。メイリオは丸みのある字形が独特であり、多くのウェブサイトに適合しづらい課題がありました。Noto Sans JPは字形に癖がなく、多くのサイトに適合します。Windowsに標準搭載されたことで、メイリオからNoto Sans JPにするべき時代がやってきたと言えます。

その他の選択肢として、游ゴシックはフォントのかすれ問題のため候補から外します。`ＭＳ Ｐゴシック`は[ダサい](https://news.mynavi.jp/techplus/article/20150611-mspg/)ので論外です。
...
-   2026年1月13日 Windowsの指定を「Meiryo」から「Noto Sans JP」へ変更