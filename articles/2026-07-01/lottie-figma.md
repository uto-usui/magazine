...
source: "https://ics.media/entry/230913/?utm_source=atom&utm_medium=referral&utm_campaign=feed"
...
「[Lottie](https://lottiefiles.com/jp/)ロッティー」はAirbnbのエンジニアが開発に関わった、ベクター画像をアニメーションさせることができる技術・ファイルフォーマットです。
...
中身はテキストファイルなので、アニメーション動画や画像と比較すると**容量が軽量である**ことが特長です。

#### `.lottie`拡張子のLottie

`.json`形式のほか、`.lottie`拡張子のLottieである「[dotLottie](https://lottiefiles.com/dotlottie)」も利用できます。以下のようなメリットがあります。
...
-   「[LottieFiles](https://www.figma.com/community/plugin/809860933081065308)」プラグイン
...
[LottieFilesコミュニティ](https://lottiefiles.com/featured-free-animations)にアップロードされている作例は、基本的には無料で編集やダウンロードして使用することが可能です。 ※ダウンロード数の部分に「Premium」と書いている場合は、[IconScout](https://iconscout.com/)というサービスから公開されている作品でIconScoutのサイトに飛びます。IconScoutのプランに応じて利用に制限があるLottieもあります。
...
作品をLottieFilesにアップロードすることで、非公開ファイルでもウェブ上での表示確認や、モバイルアプリでの表示確認を行うことができます。
