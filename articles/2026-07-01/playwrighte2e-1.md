...
source: "https://ics.media/entry/251226/?utm_source=atom&utm_medium=referral&utm_campaign=feed"
...
![UIテストランナー](https://ics.media/entry/251226/images/images/251226_playwright_ui_runner.png)
...
![UIテストランナーによるテスト結果](https://ics.media/entry/251226/images/images/251226_playwright_ui_runner_result.png)
...
![コードジェネレーターによる操作の記録](https://ics.media/entry/251226/images/images/251226_playwright_generator.png)
...
本記事では、Playwrightを使ったE2Eテストの基本的な使い方を紹介しました。[後編](https://ics.media/entry/260219/)では、失敗したテストの解析に役立つトレース機能と、GitHub Actionsを使用してCI環境でE2Eテストを実行する方法を紹介します。