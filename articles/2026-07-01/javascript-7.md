...
source: "https://ics.media/entry/18812/?utm_source=atom&utm_medium=referral&utm_campaign=feed"
...
パーリンノイズを使った作例としては、記事「[CSSとHTML Canvasで作るモーショングラフィック](https://ics.media/entry/10141/)」で紹介しています。今回はJavaScriptのみの話でしたが、CSSとJavaScriptを組み合わせることで表現の幅が広がります。ぜひ、皆さんも挑戦してみてください。
