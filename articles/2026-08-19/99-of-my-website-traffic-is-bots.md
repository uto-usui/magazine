...
source: "https://patronview.com/news/99-percent-of-my-website-traffic-is-bots/"
...
The blue square is the traffic I can see. The gray squares are what actually pounds my server. I use self-hosted [Plausible Community Edition](https://github.com/plausible/community-edition/) for analytics, and it only counts visitors who run JavaScript. Almost no bot does.
...
![A hand-drawn Chinese dragon coiled around a neoclassical museum building marked PatronView. The dragon's entire body is made of hundreds of small red robots linked nose to tail, some carrying tiny red flags. A single small human in a blue outfit stands on the steps below.](https://patronview.com/images/blog/bots/china-dragon.jpg)

I tried to imagine what all those Chinese bots looked like. With apologies for the cliche red dragon!!
...
01M2M3MApr 10Apr 15Apr 20Apr 22Apr 25Apr 30Apr 22: 3.62M requests from 361K unique IPs

Requests per day in April 2026. I implemented the China-wide block on April 23rd and immediately saw relief.

![Cloudflare security events chart totalling 1.18M managed challenges. The line sits flat at zero until about 15:00, then jumps to a jagged band between 14,000 and 25,000 events per interval and stays there overnight.](https://patronview.com/images/blog/bots/China-traffic.png)

Cloudflare security events during the flood: 1.18M managed challenges in about 10 hours.
...
![A hand-drawn robot walking away while towing a cart stacked with a tower of paper so tall it runs off the top of the frame, labelled 35,000 pages. On its other open palm it holds one tiny human in a blue outfit, labelled 1 visitor.](https://patronview.com/images/blog/bots/claude-ratio.jpg)

I didn't use the Claude logo so they can't sue me for copyright! But imagine this bot's name is Claude.
...
![Cloudflare AI crawler dashboard for one week in June. Claude-SearchBot: 420.68k requests, a dense line oscillating between roughly 1,500 and 3,500 per hour. Claude-User: 12, a flat line pinned to the bottom axis.](https://patronview.com/images/blog/bots/Claude-SearchBot0.jpeg)

The bandwidth tab was worse. That week I served 4.63 GB to the bot, and 175 KB to the humans it sent me:

![The same dashboard on the bandwidth tab. Claude-SearchBot: 4.63 GB, a line running between roughly 20 MB and 40 MB per hour all week. Claude-User: 175.56 kB, flat against the bottom axis.](https://patronview.com/images/blog/bots/Claude-SearchBot.jpeg)
...
Pages crawled per 1 human visitor referred (log scale). Lower is better.101001,00010,000100KGooglebot46:1Bingbot406:1Claude-SearchBot35,000:1Amzn-SearchBot∞

Crawl-to-referral ratios I measured. Google: 46 crawls per visitor sent. Amazon: infinity.
...
That same dashboard shows Bingbot at 158,610 requests for 680 visitors. My Bing referrals are actually growing, so I'm happy for them to keep scraping. And it shows Anthropic down to 47 requests since my block. ([Click here to see a screenshot](https://patronview.com/images/blog/bots/AI-Crawl-Control-crawlers.png) of the crawler dashboard.)
...
![A hand-drawn museum building with blue and gray robots swarming it from every direction, climbing the columns and sitting on the steps, with arrows showing more pouring in from both sides. One oversized human sits alone on the roof looking overwhelmed.](https://patronview.com/images/blog/bots/museum-swarm.jpg)

Me, as a cartoon, on top of a museum that's getting attacked by robots.
...
![A hand-drawn row of five ordinary front doors. On each doorstep stands a small robot holding up a cardboard cutout of the same smiling human face on a stick. The robot at the far end has lowered its mask, showing the robot underneath. A man in a blue outfit watches from the pavement.](https://patronview.com/images/blog/bots/residential-masks.jpg)

These residential botnets are wild. Worth reading up on if you've never run into one!
...
![Analytics table of visitors by country. United States 640 (31.9%), Germany 215, Vietnam 100, Russia 91, Italy 77, Canada 74, UK 70, then a long tail where roughly a dozen countries — Indonesia, Japan, Chile, Brazil, Hong Kong, Lithuania, Malaysia, South Africa — all sit within a few visitors of each other around 33 to 36.](https://patronview.com/images/blog/bots/November2025-post.jpeg)

The country breakdown from [my November 2025 tweet](https://x.com/nickgraynews/status/1994793007418155464). Look at the spread: Indonesia, Japan, Chile, Brazil, Hong Kong, almost evenly split.
...
025K50K75K100K125KJul 7Jul 14Jul 21Jul 28Aug 1Jul 31: 124K unique IPsbaseline ~18K/day

Unique IPs hitting my site per day, ramping through July. Nothing about the site changed in July.
...
![A hand-drawn brick wall with a crowd of robots stretching back into the distance, all pressed against it with their arms raised. A small sign on the bricks reads 403. A man in a blue outfit has already walked through a door in the wall and is strolling away on the other side.](https://patronview.com/images/blog/bots/403-wall.jpg)

I thought it would be funny to see all the robots like this, but now I almost feel bad for them. They're sorta cute.
...
Challenges issued (48 hours)Brazil10,370Singapore7,089India5,135France4,083Bangladesh4,058Argentina3,831Iraq3,526Spain3,428UK2,936Germany2,772…and the share that failedBrazil99.94%Singapore99.96%India99.14%France99.49%Bangladesh99.68%Argentina99.95%Iraq100.00%Spain99.97%UK99.22%Germany99.93%

Singapore: 7,089 challenged, 3 solved. I hope those three found what they needed.
...
![A hand-drawn arcade cabinet lettered whack-a-bot with a small orange Cloudflare cloud beside the name. Robot heads pop up out of holes all over the board. A man in a blue outfit, seen from behind, swings a mallet at one of them.](https://patronview.com/images/blog/bots/whack-a-bot.jpg)

I love this image. And Skee-Ball is actually my favorite arcade game, in case you were wondering.
...
If you're fighting this too, email me: [hello@nickgray.net](mailto:hello@nickgray.net). I'd love to compare notes.
