...
### Strict TypeScript API by default[​](#strict-typescript-api-by-default "Direct link to Strict TypeScript API by default")
...
![Hovering the TextInput symbol under the legacy types, showing no documentation](https://reactnative.dev/blog/assets/0.87-symbol-docs-before.png)

![Hovering the TextInput symbol under the Strict API, showing full type information and documentation](https://reactnative.dev/blog/assets/0.87-symbol-docs-after.png)
...
-   Opting out affects TypeScript analysis in your own project only — apps and libraries migrate independently ([more details](https://reactnative.dev/docs/strict-typescript-api#opting-out-since-087)).
...
-   [FAQs](https://reactnative.dev/docs/strict-typescript-api#faqs) — answers to common questions, including whether this affects runtime, library authors' migration timing, and why the manual types were replaced.
-   [Moving Towards a Stable JavaScript API](https://reactnative.dev/blog/2025/06/12/moving-towards-a-stable-javascript-api) — our original rationale for this migration, from the 0.80 preview announcement.
...
### Faster, leaner Metro[​](#faster-leaner-metro "Direct link to Faster, leaner Metro")
...
### Experimental Swift Package Manager support for iOS[​](#experimental-swift-package-manager-support-for-ios "Direct link to Experimental Swift Package Manager support for iOS")
...
### Android Gradle Plugin (AGP) v9[​](#android-gradle-plugin-agp-v9 "Direct link to Android Gradle Plugin (AGP) v9")
...
### Minimum toolchain requirements[​](#minimum-toolchain-requirements "Direct link to Minimum toolchain requirements")
...
### API removals[​](#api-removals "Direct link to API removals")
...
### Packages & tooling[​](#packages--tooling "Direct link to Packages & tooling")
...
## Upgrade to 0.87[​](#upgrade-to-087 "Direct link to Upgrade to 0.87")
