...
source: "https://kentcdodds.com/blog/migrating-to-workspaces-and-nx"
...
Then [yesterday](https://kentcdodds.com/blog/offloading-ffmpeg-with-cloudflare), I added two more deployable things:
...
That wasn't catastrophic. But it was annoying and I knew I really should just embrace the monorepo. The repo _already was_ a monorepo. The layout just hadn't caught up.
...
## [What the `services/*` constraint exposed](#what-the-services-constraint-exposed)
...
### [1\. Package import aliases stopped working](#1-package-import-aliases-stopped-working)
...
### [2\. Production went down because content moved](#2-production-went-down-because-content-moved)
...
### [3\. Docker stages have their own dependency graph](#3-docker-stages-have-their-own-dependency-graph)
...
## [CI got restructured around the actual workload](#ci-got-restructured-around-the-actual-workload)
