...
source: "https://swizec.com/blog/code-is-the-easy-part-or-how-we-refactored-half-the-business-to-fix-a-janky-script/"
...
## [](#some-context)[Some context](#some-context)
...
## [](#first-make-the-problem-simple-then-solve-the-simple-problem)[First make the problem simple, then solve the simple problem](#first-make-the-problem-simple-then-solve-the-simple-problem)
...
When you ask what's wrong, the answer looks a little like this:
  ...
  [![Panic Monster from wait but why](https://swizec.com/static/698ed422f663a07edba8f452b5e55c58/4ef49/Panic-Monster-from-wait-but-why-i92725.png)

Panic Monster from wait but why](https://waitbutwhy.com/2013/10/why-procrastinators-procrastinate.html)
...
### [](#its-your-data-model)[It's your data model](#its-your-data-model)
...
## [](#watch-people-work)[Watch people work](#watch-people-work)
...
## [](#its-a-roadmap-not-a-project)[It's a roadmap not a project](#its-a-roadmap-not-a-project)
...
You go in steps. Think skateboards and scooters, not wheels and chassis. **The software has to keep working the whole time**. No broken states.
  ...
  [![01mvppng 957a4h](https://swizec.com/static/a8836c1b8587fc10cdfaf88c2541fa36/8efc2/01mvppng-957a4h.png)](https://blog.crisp.se/2016/01/25/henrikkniberg/making-sense-of-mvp)
...
### [](#what-it-took-to-automate-invoicing)[What it took to automate invoicing](#what-it-took-to-automate-invoicing)
...
## [](#ship-along-the-way)[Ship along the way](#ship-along-the-way)
