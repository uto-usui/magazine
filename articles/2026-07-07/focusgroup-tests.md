...
_6 July 2026_. Open-UI’s `focusgroup` [_Quickstart_ (incorrectly) uses the APG `menu` navigation pattern](https://open-ui.org/components/scoped-focusgroup.explainer/#quickstart). In mid-2019 I responded to the APG pattern with a [link & disclosure navigation prototype](https://adrianroselli.com/2019/06/link-disclosure-widget-navigation.html#Pattern). Today [I forked it](https://codepen.io/aardrian/pen/myRpKpg?editors=1000) ([debug view](https://cdpn.io/aardrian/debug/myRpKpg)) and added `focusgroup="menubar"`, something I half expect authors to try.

See the Pen [2017 Link + Disclosure Nav with \`focusgroup\`](https://codepen.io/aardrian/pen/myRpKpg) by Adrian Roselli ([@aardrian](https://codepen.io/aardrian)) on [CodePen](https://codepen.io/).
...
`<button>`s in child `<li>`s role-up to become `menuitem`s.

[![Dev tools showing focusgroup="menubar" on the <ul> and the <li> reporting its role as listitem.](https://adrianroselli.com/wp-content/uploads/2026/07/focusgroup-nav-Chrome150_focusgroup.jpg)](https://adrianroselli.com/wp-content/uploads/2026/07/focusgroup-nav-Chrome150_focusgroup.jpg) [![Dev tools showing role="menubar" on the <ul> and the <li> reporting its role as none.](https://adrianroselli.com/wp-content/uploads/2026/07/focusgroup-nav-Chrome150_role.jpg)](https://adrianroselli.com/wp-content/uploads/2026/07/focusgroup-nav-Chrome150_role.jpg) [![Dev tools showing focusgroup="menubar" and role="menubar" on the <ul> and the <button> reporting its role as menuitem.](https://adrianroselli.com/wp-content/uploads/2026/07/focusgroup-nav-Chrome150_focusgroup-role.jpg)](https://adrianroselli.com/wp-content/uploads/2026/07/focusgroup-nav-Chrome150_focusgroup-role.jpg)
