...
source: "https://addyosmani.com/blog/human-judgment-doesnt-leave-the-software/"
publishedDate: "2026-08-21"
category: "performance"
feedName: "Addy Osmani"
---

**A software factory is a repeatable loop around software work. If you’re building a software factory, code good enough to ship still needs human taste and ownership. We’ll discuss this including whether you _need_ a factory just yet.**
...
![The difference between using a coding harness and operating a repeatable software factory.](https://addyosmani.com/assets/images/human-judgment/harness-vs-factory-dark.png)
...
![A triage label acts as the queue, the lock, and a parking spot for software-factory work.](https://addyosmani.com/assets/images/human-judgment/the-label-is-the-queue-dark.png)
...
![Human judgment moves upstream to intent and system shape, and downstream to evidence, risk, and ownership.](https://addyosmani.com/assets/images/human-judgment/where-judgment-goes-dark.png)
...
![Four ways a human participates in a software factory: shape, steer, hand off, and approve.](https://addyosmani.com/assets/images/human-judgment/four-ways-in-dark.png)
...
![Agent output grows faster than human understanding, creating comprehension debt.](https://addyosmani.com/assets/images/human-judgment/comprehension-debt-dark.png)
...
![A green test can be misleading when an agent changes the assertion instead of satisfying the intent.](https://addyosmani.com/assets/images/human-judgment/when-green-is-misleading-dark.png)
...
![A verification budget pushes fast deterministic checks early and reserves heavier checks for later gates.](https://addyosmani.com/assets/images/human-judgment/verification-budget-dark.png)
...
![Software-factory runs are classified as success, flawed, blocked, or manual; only success ships.](https://addyosmani.com/assets/images/human-judgment/when-a-run-doesnt-ship-dark.png)
