---
title: "Vol.498"
source: "https://frontendweekly.tokyo/posts/498/"
publishedDate: "2025-07-02"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 2nd July 2025

## [Why design goes wrong and how to set it right part 1](https://productpicnic.beehiiv.com/p/why-design-goes-wrong-and-how-to-set-it-right-part-1) [Jump to heading](#why-design-goes-wrong-and-how-to-set-it-right-part-1)

#### なぜデザインは失敗するのか、そしてどう正すか [Jump to heading](#なぜデザインは失敗するのか-そしてどう正すか)
...
## [How Rolldown Works: Module Loading Dependency Graphs and Optimization Explained | Atriiy](https://www.atriiy.dev/blog/rolldown-module-loader-and-dependency-graph) [Jump to heading](#how-rolldown-works-module-loading-dependency-graphs-and-optimization-explained-atriiy)

#### Rolldown の仕組み [Jump to heading](#rolldown-の仕組み)
...
## [Post-Chat UI - Allen Pike](https://allenpike.com/2025/post-chat-llm-ui) [Jump to heading](#post-chat-ui-allen-pike)

#### チャット後のUIへ — LLMが従来のアプリをどう壊し、どう再構築するか [Jump to heading](#チャット後のuiへ-llmが従来のアプリをどう壊し-どう再構築するか)
...
## [How to provide feedback on documents. | Irrational Exuberance](https://lethain.com/providing-feedback-on-writing/) [Jump to heading](#how-to-provide-feedback-on-documents-irrational-exuberance)
...
## [A fluid CSS methodology Willy Brauner](https://willybrauner.com/journal/a-fluid-css-methodology) [Jump to heading](#a-fluid-css-methodology-willy-brauner)
