---
title: "Vol.457"
source: "https://frontendweekly.tokyo/posts/457/"
publishedDate: "2024-06-19"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 19th June 2024

## [Promise over Purpose](https://rogermartin.medium.com/promise-over-purpose-7af65501f686) [Jump to heading](#promise-over-purpose)

#### 目的よりも約束 [Jump to heading](#目的よりも約束)
...
## [Composability in design systems](https://adactio.com/journal/21084) [Jump to heading](#composability-in-design-systems)

#### デザインシステムにおけるコンポーザビリティ [Jump to heading](#デザインシステムにおけるコンポーザビリティ)
...
## [Setting Up Your UX Mentorship Program For Success](https://indeed.design/article/setting-up-your-ux-mentorship-program-for-success/) [Jump to heading](#setting-up-your-ux-mentorship-program-for-success)

#### 効果的なUXメンターシッププログラムの構築 [Jump to heading](#効果的なuxメンターシッププログラムの構築)

UXメンターシッププログラムを成功させるための3つの重要な要素を紹介。1. 質の高いメンターペアの作成、2. 明確なメンターシップ目標の設定、3. プログラムの構造とサポートの提供。

## [Hardest Problem in Computer Science: Centering Things](https://tonsky.me/blog/centering) [Jump to heading](#hardest-problem-in-computer-science-centering-things)
...
## [4 Software Design Principles I Learned the Hard Way](https://read.engineerscodex.com/p/4-software-design-principles-i-learned?publication_id=1748074&r=18y4a0) [Jump to heading](#4-software-design-principles-i-learned-the-hard-way)
