---
title: "Vol.487"
source: "https://frontendweekly.tokyo/posts/487/"
publishedDate: "2025-03-12"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 12th March 2025

## [Will AI agents eat SaaS? - by Sandhya Hegde](https://sandhya.substack.com/p/will-ai-agents-eat-saas) [Jump to heading](#will-ai-agents-eat-saas-by-sandhya-hegde)

#### AIエージェントはSaaSを食い尽くすのか？ [Jump to heading](#aiエージェントはsaasを食い尽くすのか)

AIエージェントがSaaS業界に与える影響を探る。AIが自律的にタスクを実行し、意思決定を行う能力を持つようになると、従来のSaaSモデルはどのように変化するのかを考察する。

## [Developer philosophy @ Things Of Interest](https://qntm.org/devphilo) [Jump to heading](#developer-philosophy-things-of-interest)

#### 開発者の哲学 [Jump to heading](#開発者の哲学)
...
## [Oracle justified its JavaScript trademark with Node.js…now it wants that ignored](https://deno.com/blog/deno-v-oracle2) [Jump to heading](#oracle-justified-its-javascript-trademark-with-nodejsnow-it-wants-that-ignored)

#### OracleはNode.jsの商標問題 [Jump to heading](#oracleはnodejsの商標問題)
...
## [Standard Schema](https://standardschema.dev/) [Jump to heading](#standard-schema)
...
#### モダンCSSによるフルブリードレイアウト [Jump to heading](#モダンcssによるフルブリードレイアウト)
