---
title: "Vol.324"
source: "https://frontendweekly.tokyo/posts/324/"
publishedDate: "2021-07-14"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 14th July 2021

## [The problem is not the problem](https://kislayverma.com/organizations/the-problem-is-not-the-problem/) [Jump to heading](#the-problem-is-not-the-problem)

#### 問題は問題ではない [Jump to heading](#問題は問題ではない)
...
## [Asynchronous Design Critique: Giving Feedback](https://alistapart.com/article/async-design-critique-giving-feedback/) [Jump to heading](#asynchronous-design-critique-giving-feedback)

#### フィードバックをどのように活用するか [Jump to heading](#フィードバックをどのように活用するか)
...
## [It’s time to ban surveillance-based advertising | Vivaldi Browser](https://vivaldi.com/blog/its-time-to-ban-surveillance-based-advertising/) [Jump to heading](#its-time-to-ban-surveillance-based-advertising-vivaldi-browser)

#### 監視広告の禁止 [Jump to heading](#監視広告の禁止)
...
## [Benchmarking JavaScript Memory Usage](https://blog.webpagetest.org/posts/benchmarking-javascript-memory-usage/) [Jump to heading](#benchmarking-javascript-memory-usage)

JavaScriptのメモリ使用量を計測する方法とそれがパフォーマンスにどのような影響を与えるかについて

## [Rust from a JavaScript perspective – Contingent Musings](https://blogs.harvard.edu/kapolos/rust-from-a-javascript-perspective/) [Jump to heading](#rust-from-a-javascript-perspective-contingent-musings)
