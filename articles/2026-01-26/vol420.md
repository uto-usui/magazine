---
title: "Vol.420"
source: "https://frontendweekly.tokyo/posts/420/"
publishedDate: "2023-08-09"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 9th August 2023

## [Why engineers should focus on writing - Dmitry Kudryavtsev](https://www.yieldcode.blog/post/why-engineers-should-write/) [Jump to heading](#why-engineers-should-focus-on-writing-dmitry-kudryavtsev)

#### エンジニアがライティングを伸ばすべき理由 [Jump to heading](#エンジニアがライティングを伸ばすべき理由)
...
## [How to Do Great Work](http://paulgraham.com/greatwork.html) [Jump to heading](#how-to-do-great-work)

#### 素晴らしい仕事をする方法 [Jump to heading](#素晴らしい仕事をする方法)
...
## [Naming components](https://medium.com/@Mcondesa/naming-components-31c3180a50fd) [Jump to heading](#naming-components)

#### コンポーネントの命名の方法 [Jump to heading](#コンポーネントの命名の方法)
...
## [How to Prepare for Strategy](https://rogermartin.medium.com/how-to-prepare-for-strategy-4beaa4715c6e) [Jump to heading](#how-to-prepare-for-strategy)

戦略をどう立てればよいのか。一般的には、事前作業、プランニング、アウトプットのプロセスを踏むが、Roger氏は、事前作業は無い方望ましいと考えている。その意図を記事内で解説している。

## [A Deep Dive Into SVG Path Commands](https://www.nan.fyi/svg-paths) [Jump to heading](#a-deep-dive-into-svg-path-commands)
