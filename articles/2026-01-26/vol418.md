---
title: "Vol.418"
source: "https://frontendweekly.tokyo/posts/418/"
publishedDate: "2023-07-26"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 26th July 2023

## [Modern CSS in Real Life](https://chriscoyier.net/2023/06/06/modern-css-in-real-life/) [Jump to heading](#modern-css-in-real-life)

#### モダンなCSSをどのように活かすか [Jump to heading](#モダンなcssをどのように活かすか)

Chris Coyier氏のモダンなCSSについての最新のプレゼンテーションを記事にしている。論理プロパティ、CSSグリッド、コンテナクエリなど様々なモダンな機能に触れながら、それを現実的なサイトに実装する際のテクニックについて詳解していく

## [Packaging and selling a Node.js app](https://docs.emailengine.app/packaging-and-selling-a-node-js-app/) [Jump to heading](#packaging-and-selling-a-nodejs-app)

#### Node.jsアプリのパッケージ化と販売 [Jump to heading](#nodejsアプリのパッケージ化と販売)

Andris氏はEmailEngineというダウンロード可能なサーバーソフトウェアを販売している。この記事では、どのようにNode.jsのソフトウェアを販売しているか、その中身の仕組について詳しく紹介している。

## [CSS { In Real Life } | Reducing Complexity in Front End Development](https://css-irl.info/reducing-complexity-in-front-end-development/) [Jump to heading](#css-in-real-life-reducing-complexity-in-front-end-development)

#### フロントエンド開発の複雑さを軽減する [Jump to heading](#フロントエンド開発の複雑さを軽減する)
...
## [How to make hard decisions: even/over statements](https://larahogan.me/blog/even-over-statements/) [Jump to heading](#how-to-make-hard-decisions-evenover-statements)
...
## [Language Model Sketchbook or Why I Hate Chatbots](https://maggieappleton.com/lm-sketchbook) [Jump to heading](#language-model-sketchbook-or-why-i-hate-chatbots)
