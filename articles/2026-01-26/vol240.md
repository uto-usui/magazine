---
title: "Vol.240"
source: "https://frontendweekly.tokyo/posts/240/"
publishedDate: "2019-10-16"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 16th October 2019

## [Cascading Cache Invalidation by Philip Walton](https://philipwalton.com/articles/cascading-cache-invalidation/) [Jump to heading](#cascading-cache-invalidation-by-philip-walton)

#### Code Splittingにおけるキャッシュの最適化 [Jump to heading](#code-splittingにおけるキャッシュの最適化)
...
## [Building a Scrapbook Layout with CSS Grid by Michelle Barker](https://css-irl.info/building-a-scrapbook-layout-with-css-grid/) [Jump to heading](#building-a-scrapbook-layout-with-css-grid-by-michelle-barker)

#### スクラップブックのデザインをCSS Gridでスタイリングする [Jump to heading](#スクラップブックのデザインをcss-gridでスタイリングする)
...
## [Text Scanning Patterns: Eyetracking Evidence by Kara Pernice](https://www.nngroup.com/articles/text-scanning-patterns-eyetracking/) [Jump to heading](#text-scanning-patterns-eyetracking-evidence-by-kara-pernice)

#### アイトラッキングで明らかになったユーザー4つの走査パターン [Jump to heading](#アイトラッキングで明らかになったユーザー4つの走査パターン)
...
## [How to read a Web Page Test waterfall chart by Matt Hobbs](https://nooshu.github.io/blog/2019/10/02/how-to-read-a-wpt-waterfall-chart/): [Jump to heading](#how-to-read-a-web-page-test-waterfall-chart-by-matt-hobbs)
...
## [Introducing Sass Modules by Miriam Suzanne](https://css-tricks.com/introducing-sass-modules/) [Jump to heading](#introducing-sass-modules-by-miriam-suzanne)
