---
title: "Vol.264"
source: "https://frontendweekly.tokyo/posts/264/"
publishedDate: "2020-04-15"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 15th April 2020

## [Slow Code HATES him! Optimising a web app from 1 to 60fps](https://blog.scottlogic.com/2020/02/17/minesweeper-optimisation.html) [Jump to heading](#slow-code-hates-him-optimising-a-web-app-from-1-to-60fps)

#### 1fps の Web アプリを 60fps まで改善した話 [Jump to heading](#1fps-の-web-アプリを-60fps-まで改善した話)
...
## [Headings & Accessibility | TPG – The Accessibility Experts](https://developer.paciellogroup.com/blog/2020/03/headings-accessibility/) [Jump to heading](#headings-accessibility-tpg-the-accessibility-experts)

#### 見出しとアクセシビリティ [Jump to heading](#見出しとアクセシビリティ)
...
## [Adventures in CSS Semi-Transparency Land | CSS-Tricks](https://css-tricks.com/adventures-in-css-semi-transparency-land/) [Jump to heading](#adventures-in-css-semi-transparency-land-css-tricks)

#### CSS の半透明について [Jump to heading](#css-の半透明について)

CSS では半透明のオーバーレイを作成できるが、それを 2 枚重ねたとき、どのような見た目になるのか。その計算式と実際のサンプル実装を紹介しながら、違いを明らかにしていく

## [The History of the URL](https://blog.cloudflare.com/the-history-of-the-url/) [Jump to heading](#the-history-of-the-url)

URL や DNS、HTTP、Port など、Web の通信について、その歴史的経緯などをも踏まえて紹介していく。

## [Test Double | Our Blog | Necessary & Sufficient](https://blog.testdouble.com/posts/2020-02-25-necessary-and-sufficient/) [Jump to heading](#test-double-our-blog-necessary-sufficient)
