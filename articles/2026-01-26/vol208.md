---
title: "Vol.208"
source: "https://frontendweekly.tokyo/posts/208/"
publishedDate: "2019-02-21"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 21st February 2019

## [Code readability matters by by the Guardian’s internal Digital team](https://www.theguardian.com/info/2019/jan/29/code-readability-matters) [Jump to heading](#code-readability-matters-by-by-the-guardians-internal-digital-team)

#### コードの可読性に影響するポイント [Jump to heading](#コードの可読性に影響するポイント)
...
## [Rendering on the Web By Jason Miller and Addy Osmani](https://developers.google.com/web/updates/2019/02/rendering-on-the-web) [Jump to heading](#rendering-on-the-web-by-jason-miller-and-addy-osmani)

#### Webでのレンダリングに関して [Jump to heading](#webでのレンダリングに関して)
...
## [Paying tribute to the web with View Source by DHH](https://m.signalvnoise.com/paying-tribute-to-the-web-with-view-source/) [Jump to heading](#paying-tribute-to-the-web-with-view-source-by-dhh)

[https://m.signalvnoise.com/paying-tribute-to-the-web-with-view-source/](https://m.signalvnoise.com/paying-tribute-to-the-web-with-view-source/)

#### View SourceのあるWebに敬意を払う [Jump to heading](#view-sourceのあるwebに敬意を払う)
...
## [Designing for the web ought to mean making HTML and CSS by DHH](https://m.signalvnoise.com/designing-for-the-web-ought-to-mean-making-html-and-css/) [Jump to heading](#designing-for-the-web-ought-to-mean-making-html-and-css-by-dhh)
...
## [Understanding Service Workers and Caching Strategies](https://blog.bitsrc.io/understanding-service-workers-and-caching-strategies-a6c1e1cbde03) [Jump to heading](#understanding-service-workers-and-caching-strategies)
