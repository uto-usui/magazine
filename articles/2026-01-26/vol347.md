---
title: "Vol.347"
source: "https://frontendweekly.tokyo/posts/347/"
publishedDate: "2022-01-19"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 19th January 2022

## [Managers make organizations not products](https://tannerchristensen.com/blog/2021/12/8/managers-make-organizations-not-products) [Jump to heading](#managers-make-organizations-not-products)

#### マネージャーは組織を作る [Jump to heading](#マネージャーは組織を作る)
...
## [The Language Wall | Jorge Arango](https://jarango.com/2021/12/15/the-language-wall/) [Jump to heading](#the-language-wall-jorge-arango)

#### 言語の壁 [Jump to heading](#言語の壁)

組織の中で共通言語が作られていないことで問題が発生することを指摘し、その言語の問題を解決するためのC級の役割として、チーフオントロジーオフィサーの役割を立てることを提案している。

## [Introducing fuite: a tool for finding memory leaks in web apps](https://nolanlawson.com/2021/12/17/introducing-fuite-a-tool-for-finding-memory-leaks-in-web-apps/) [Jump to heading](#introducing-fuite-a-tool-for-finding-memory-leaks-in-web-apps)

#### メモリリークを見つけるfuiteの紹介 [Jump to heading](#メモリリークを見つけるfuiteの紹介)

Webアプリのメモリリークを見つけるためのツール fuite の紹介。npxで簡単に実行することができ、特にSPAアプリケーションで発生しやすいメモリリークの発見をサポートする。

## [Holiday Book Recommendations for Engineering Managers Software Engineers and Product Managers](https://blog.pragmaticengineer.com/holiday-tech-book-recommendations/) [Jump to heading](#holiday-book-recommendations-for-engineering-managers-software-engineers-and-product-managers)
...
## [Dynamic Color Manipulation with CSS Relative Colors](https://blog.jim-nielsen.com/2021/css-relative-colors/) [Jump to heading](#dynamic-color-manipulation-with-css-relative-colors)
