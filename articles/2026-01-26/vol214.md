---
title: "Vol.214"
source: "https://frontendweekly.tokyo/posts/214/"
publishedDate: "2019-04-03"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 3rd April 2019

## [I Used The Web For A Day On Internet Explorer 8 by Chris Ashton](https://www.smashingmagazine.com/2019/03/web-on-internet-explorer-ie8/) [Jump to heading](#i-used-the-web-for-a-day-on-internet-explorer-8-by-chris-ashton)

#### IE8で一日ネットサーフィンしてみた [Jump to heading](#ie8で一日ネットサーフィンしてみた)
...
## [Learning to Learn by Sarah Drasner](https://css-tricks.com/learning-to-learn/) [Jump to heading](#learning-to-learn-by-sarah-drasner)

#### 学ぶことを学ぶ [Jump to heading](#学ぶことを学ぶ)
...
## [Everything you need to know about Loading Animations by Lisa Dziuba](https://medium.com/flawless-app-stories/everything-you-need-to-know-about-loading-animations-10db7f9b61e) [Jump to heading](#everything-you-need-to-know-about-loading-animations-by-lisa-dziuba)

#### ローディングアニメーションに関して知っておくべきこと [Jump to heading](#ローディングアニメーションに関して知っておくべきこと)
...
## [Building Robust Layouts With Container Units by Russell](https://www.smashingmagazine.com/2019/03/robust-layouts-container-units-css/) [Jump to heading](#building-robust-layouts-with-container-units-by-russell)

CSS Variables を利用した、レイアウトテクニックについて。特に、コンテナユニットと呼ばれるレイアウトのアイディアを詳しく解説する。CSS Variablesを活用することで柔軟で堅牢なレイアウトを構成できる。

## [Getting Hooked on React Hooks by Ruben Martinez Jr](https://tech.okcupid.com/getting-hooked-on-react-hooks/) [Jump to heading](#getting-hooked-on-react-hooks-by-ruben-martinez-jr)
