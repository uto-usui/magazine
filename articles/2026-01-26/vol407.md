---
title: "Vol.407"
source: "https://frontendweekly.tokyo/posts/407/"
publishedDate: "2023-05-10"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 10th May 2023

## [Navigating the unpredictability of everything](https://longform.asmartbear.com/predict-the-future/) [Jump to heading](#navigating-the-unpredictability-of-everything)

#### 予測不可能を乗り越える [Jump to heading](#予測不可能を乗り越える)
...
## [Customers are not there to drive decisions about your product but to validate yours](https://uxdesign.cc/customers-are-not-there-to-drive-decisions-about-your-product-but-to-validate-yours-44cc0de8dae2) [Jump to heading](#customers-are-not-there-to-drive-decisions-about-your-product-but-to-validate-yours)

#### 適切にUXリサーチを行うためのヒント [Jump to heading](#適切にuxリサーチを行うためのヒント)
...
## [Laying Out a Print Book With CSS](https://iangmcdowell.com/blog/posts/laying-out-a-book-with-css/) [Jump to heading](#laying-out-a-print-book-with-css)

#### CSSを使用した印刷本のレイアウト [Jump to heading](#cssを使用した印刷本のレイアウト)

既存のソフトウェアを利用せずにCSSで印刷本のレイアウトを行った軌跡を紹介している。最終的にうまくいったが、他の人におすすめはしないという結論に至っている。

## [A Pragmatists Guide To Lean User Research](https://www.smashingmagazine.com/2023/03/pragmatists-guide-lean-user-research/) [Jump to heading](#a-pragmatists-guide-to-lean-user-research)
...
## [What are source maps?](https://web.dev/source-maps/) [Jump to heading](#what-are-source-maps)
