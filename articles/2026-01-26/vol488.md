---
title: "Vol.488"
source: "https://frontendweekly.tokyo/posts/488/"
publishedDate: "2025-03-19"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 19th March 2025

## [The Mistakes Of CSS | CSS-Tricks](https://css-tricks.com/the-mistakes-of-css/) [Jump to heading](#the-mistakes-of-css-css-tricks)

#### CSSの誤り [Jump to heading](#cssの誤り)
...
## [The 70% problem: Hard truths about AI-assisted coding](https://addyo.substack.com/p/the-70-problem-hard-truths-about) [Jump to heading](#the-70-problem-hard-truths-about-ai-assisted-coding)

#### AI支援によるコーディングの70%問題 [Jump to heading](#ai支援によるコーディングの70問題)
...
## [Which rich text editor framework should you choose in 2025? | Liveblocks Blog](https://liveblocks.io/blog/which-rich-text-editor-framework-should-you-choose-in-2025) [Jump to heading](#which-rich-text-editor-framework-should-you-choose-in-2025-liveblocks-blog)

#### 2025年に選ぶべきリッチテキストエディターフレームワークは？ [Jump to heading](#2025年に選ぶべきリッチテキストエディターフレームワークは)
...
## [Emerging Patterns in Building GenAI Products](https://martinfowler.com/articles/gen-ai-patterns/) [Jump to heading](#emerging-patterns-in-building-genai-products)

ジェネレーティブAIを活用した製品を概念実証から本番システムへ移行する際に直面する共通のパターンと課題を探る。

## [AI Needs Architects Thats Why Im Pivoting | Jorge Arango](https://jarango.com/2025/02/18/ai-needs-architects-thats-why-im-pivoting/) [Jump to heading](#ai-needs-architects-thats-why-im-pivoting-jorge-arango)
