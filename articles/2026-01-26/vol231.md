---
title: "Vol.231"
source: "https://frontendweekly.tokyo/posts/231/"
publishedDate: "2019-08-14"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 14th August 2019

## [I Used The Web For A Day On A 50 MB Budget by Chris Ashton](https://www.smashingmagazine.com/2019/07/web-on-50mb-budget/) [Jump to heading](#i-used-the-web-for-a-day-on-a-50-mb-budget-by-chris-ashton)

#### 50MBだけで1日ネットサーフィンしてみた [Jump to heading](#50mbだけで1日ネットサーフィンしてみた)
...
## [Tips for Portable Patterns by Tyler Sticka](https://cloudfour.com/thinks/tips-for-portable-patterns/) [Jump to heading](#tips-for-portable-patterns-by-tyler-sticka)

#### ポータブルパターンを実現するためのテクニック [Jump to heading](#ポータブルパターンを実現するためのテクニック)
...
## [Desire Paths and Real World UX by Austin Knight](https://austinknight.com/writing/desire-paths-and-real-world-ux) [Jump to heading](#desire-paths-and-real-world-ux-by-austin-knight)

#### 本当に必要だった道と現実的なUX [Jump to heading](#本当に必要だった道と現実的なux)
...
## [Keeping things fresh with stale-while-revalidate by Jeff Posnick](https://web.dev/stale-while-revalidate/) [Jump to heading](#keeping-things-fresh-with-stale-while-revalidate-by-jeff-posnick)
...
## [Making Things Better: Redefining the Technical Possibilities of CSS by Rachel Andrew](https://noti.st/rachelandrew/ClxWtN/making-things-better-redefining-the-technical-possibilities-of-css#soNczRo) [Jump to heading](#making-things-better-redefining-the-technical-possibilities-of-css-by-rachel-andrew)
