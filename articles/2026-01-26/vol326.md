---
title: "Vol.326"
source: "https://frontendweekly.tokyo/posts/326/"
publishedDate: "2021-08-04"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 4th August 2021

## [How design systems can enhance creativity in cross-functional teams](https://uxdesign.cc/how-design-systems-can-enhance-creativity-in-cross-functional-teams-b109b5a1130f) [Jump to heading](#how-design-systems-can-enhance-creativity-in-cross-functional-teams)

#### デザインシステムが協業に対してどのように有効に働くか [Jump to heading](#デザインシステムが協業に対してどのように有効に働くか)
...
#### コードコメントのベストプラクティス [Jump to heading](#コードコメントのベストプラクティス)
...
## [The Key to Understanding Why Things Happen – Jorge Arango](https://jarango.com/2021/05/07/the-key-to-understanding-why-things-happen/) [Jump to heading](#the-key-to-understanding-why-things-happen-jorge-arango)

#### 物事が起こる理由を理解する方法 [Jump to heading](#物事が起こる理由を理解する方法)
...
## [npm audit: Broken by Design](https://overreacted.io/npm-audit-broken-by-design/) [Jump to heading](#npm-audit-broken-by-design)

npm auditが壊れた挙動をすることについての指摘をする。npm auditがどのように機能するか解説しつつ、それがなぜ壊れているのかを詳細に説明していく。

## [`export default thing` is different to `export { thing as default }`](https://jakearchibald.com/2021/export-default-thing-vs-thing-as-default/) [Jump to heading](#export-default-thing-is-different-to-export-thing-as-default)
