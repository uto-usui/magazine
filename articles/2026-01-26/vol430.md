---
title: "Vol.430"
source: "https://frontendweekly.tokyo/posts/430/"
publishedDate: "2023-10-25"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 25th October 2023

## [How Custom Property Values are Computed | Modern CSS Solutions](https://moderncss.dev/how-custom-property-values-are-computed/) [Jump to heading](#how-custom-property-values-are-computed-modern-css-solutions)

#### カスタムプロパティ詳解 [Jump to heading](#カスタムプロパティ詳解)
...
## [Writing Component Specs](https://eisenbergeffect.medium.com/writing-component-specs-111f154d6f46) [Jump to heading](#writing-component-specs)

#### コンポーネント仕様の書き方 [Jump to heading](#コンポーネント仕様の書き方)
...
## [On APIs and their responses - Dmitry Kudryavtsev](https://www.yieldcode.blog/post/on-apis-and-responses/) [Jump to heading](#on-apis-and-their-responses-dmitry-kudryavtsev)

#### APIとそのレスポンス [Jump to heading](#apiとそのレスポンス)

基本的な5つのHTTPメソッドについて解説する。また、一般的には、POST、PUT、PATCHのレスポンスには作成、更新されたリソースを返すことがよくあるが、そうすべきではない理由を解説する。

## [The Design System Ecosystem](https://bradfrost.com/blog/post/the-design-system-ecosystem/) [Jump to heading](#the-design-system-ecosystem)
...
## [Successful iteration requires going beyond agile](https://uxdesign.cc/successful-iteration-requires-going-beyond-agile-81ef0bc80798) [Jump to heading](#successful-iteration-requires-going-beyond-agile)
