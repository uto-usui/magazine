---
title: "Vol.397"
source: "https://frontendweekly.tokyo/posts/397/"
publishedDate: "2023-02-22"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 22nd February 2023

## [Technical Decision-Making and Alignment in a Remote Culture | Stitch Fix Technology Multithreaded](https://multithreaded.stitchfix.com/blog/2020/12/07/remote-decision-making/) [Jump to heading](#technical-decision-making-and-alignment-in-a-remote-culture-stitch-fix-technology-multithreaded)

#### リモート文化における技術的な意思決定のコツ [Jump to heading](#リモート文化における技術的な意思決定のコツ)
...
## [Scalable CSS](https://chriscoyier.net/2023/01/17/scalable-css/) [Jump to heading](#scalable-css)

#### スケーラブルなCSSとは [Jump to heading](#スケーラブルなcssとは)
...
## [You Will Never Be A Full Stack Developer](https://seldo.com/posts/you-will-never-be-a-full-stack-developer/) [Jump to heading](#you-will-never-be-a-full-stack-developer)

#### フルスタックエンジニアになれるのか [Jump to heading](#フルスタックエンジニアになれるのか)
...
## [Deploying CSS Logical Properties On Web Apps](https://www.smashingmagazine.com/2022/12/deploying-css-logical-properties-on-web-apps/) [Jump to heading](#deploying-css-logical-properties-on-web-apps)

RTL言語に対応するための論理プロパティについての紹介。RTL言語に対応するには、物理的な指示を論理的な指示に変換する必要がある。既存のプロパティと論理プロパティとの対応表を用いて紹介していく。

## [Copying Designs Doesnt Work And Heres Why](https://www.smashingmagazine.com/2023/01/copying-designs-doesnt-work/) [Jump to heading](#copying-designs-doesnt-work-and-heres-why)
