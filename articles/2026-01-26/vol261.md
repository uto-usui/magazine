---
title: "Vol.261"
source: "https://frontendweekly.tokyo/posts/261/"
publishedDate: "2020-03-25"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 25th March 2020

## [Stop using isLoading booleans](https://kentcdodds.com//blog/stop-using-isloading-booleans) [Jump to heading](#stop-using-isloading-booleans)

#### isLoadingを使うのを止めよう [Jump to heading](#isloadingを使うのを止めよう)
...
## [Keep digging - Signal v. Noise](https://m.signalvnoise.com/keep-digging/) [Jump to heading](#keep-digging-signal-v-noise)

#### カスタマインタビューにおける効果的なアプローチ方法 [Jump to heading](#カスタマインタビューにおける効果的なアプローチ方法)
...
## [Responsive Grid Magazine Layout in Just 20 Lines of CSS | CSS-Tricks](https://css-tricks.com/responsive-grid-magazine-layout-in-just-20-lines-of-css/) [Jump to heading](#responsive-grid-magazine-layout-in-just-20-lines-of-css-css-tricks)

#### わずか20行のCSSでレスポンシブなマガジンレイアウトを作る [Jump to heading](#わずか20行のcssでレスポンシブなマガジンレイアウトを作る)
...
## [Best practices for REST API design - Stack Overflow Blog](https://stackoverflow.blog/2020/03/02/best-practices-for-rest-api-design/) [Jump to heading](#best-practices-for-rest-api-design-stack-overflow-blog)
...
## [Stop using Material Design text fields! - Matsuko Friedland](https://www.matsuko.ca/blog/stop-using-material-design-text-fields/) [Jump to heading](#stop-using-material-design-text-fields-matsuko-friedland)
