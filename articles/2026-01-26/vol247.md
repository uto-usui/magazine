---
title: "Vol.247"
source: "https://frontendweekly.tokyo/posts/247/"
publishedDate: "2019-12-11"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 11th December 2019

## [Auditing For Accessibility Problems With Firefox Developer Tools by Marco](https://marcozehe.de/2019/11/29/auditing-for-accessibility-problems-with-firefox-developer-tools/) [Jump to heading](#auditing-for-accessibility-problems-with-firefox-developer-tools-by-marco)

#### Firefox開発者ツールによるアクセシビリティの問題の調査 [Jump to heading](#firefox開発者ツールによるアクセシビリティの問題の調査)
...
## [Inversion of Control by Kent C. Dodds](https://kentcdodds.com/blog/inversion-of-control) [Jump to heading](#inversion-of-control-by-kent-c-dodds)

#### 制御の反転 [Jump to heading](#制御の反転)
...
## [Build your own React by Rodrigo Pombo](https://pomb.us/build-your-own-react/) [Jump to heading](#build-your-own-react-by-rodrigo-pombo)

#### 自分のReactを実装する [Jump to heading](#自分のreactを実装する)

Reactをスクラッチで書き直す。この記事ではReactをそのアーキテクチャに沿って、JavaScriptで実装する。実際のコードをインタラクティブに表示させてくれるので変更箇所などが非常にわかりやすい。

## [Boomerang Performance Update by Nic Jansma](https://calendar.perfplanet.com/2019/boomerang-performance-update/) [Jump to heading](#boomerang-performance-update-by-nic-jansma)

アカマイが提供するオープンソースライブラリのひとつ、Boomerangについての紹介と、過去2年間に渡って行ってきた改善の取り組みを紹介していく。

## [a design system governance process by Brad Frost](https://bradfrost.com/blog/post/a-design-system-governance-process/) [Jump to heading](#a-design-system-governance-process-by-brad-frost)
