---
title: "Vol.309"
source: "https://frontendweekly.tokyo/posts/309/"
publishedDate: "2021-03-24"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 24th March 2021

## [\[Part 1\] The problems with MVPs in legacy replacement](https://www.thoughtworks.com/insights/blog/part-1-problems-mvps-legacy-replacement) [Jump to heading](#part-1-the-problems-with-mvps-in-legacy-replacement)

#### レガシー置換におけるMVPの問題点 [Jump to heading](#レガシー置換におけるmvpの問題点)
...
## [CSS Generators](https://www.smashingmagazine.com/2021/03/css-generators/) [Jump to heading](#css-generators)

#### 便利なCSSジェネレータの紹介 [Jump to heading](#便利なcssジェネレータの紹介)
...
## [Getting Deep into Shadows](https://css-tricks.com/getting-deep-into-shadows/) [Jump to heading](#getting-deep-into-shadows)

#### シャドウについて深く学ぶ [Jump to heading](#シャドウについて深く学ぶ)
...
## [We Are Not ‘System Designers’ (and Other Random Thoughts On the Scales of Design)](https://uxplanet.org/there-s-no-such-thing-as-system-designers-and-other-random-thoughts-on-the-scales-of-design-63d1dfb2885c) [Jump to heading](#we-are-not-system-designers-and-other-random-thoughts-on-the-scales-of-design)
...
## [Why Does a Design Look Good?](https://www.nngroup.com/articles/why-does-design-look-good/) [Jump to heading](#why-does-a-design-look-good)
