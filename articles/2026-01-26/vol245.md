---
title: "Vol.245"
source: "https://frontendweekly.tokyo/posts/245/"
publishedDate: "2019-11-27"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 27th November 2019

## [How to send good pull requests on GitHub by Eli Bendersky](https://eli.thegreenplace.net/2019/how-to-send-good-pull-requests-on-github/) [Jump to heading](#how-to-send-good-pull-requests-on-github-by-eli-bendersky)

#### 良いPRの作り方 [Jump to heading](#良いprの作り方)
...
#### instagram.comのパフォーマンス改善 [Jump to heading](#instagramcomのパフォーマンス改善)
...
## [Handling null and undefined in JavaScript by Eric Elliott](https://medium.com/javascript-scene/handling-null-and-undefined-in-javascript-1500c65d51ae) [Jump to heading](#handling-null-and-undefined-in-javascript-by-eric-elliott)

#### nullとundefinedをハンドリングする [Jump to heading](#nullとundefinedをハンドリングする)
...
## [8 critical skills of effective design leaders by Amy Schroeder](https://www.abstract.com/blog/design-leadership-skills/) [Jump to heading](#8-critical-skills-of-effective-design-leaders-by-amy-schroeder)
...
## [Intent to Explain: Demystifying the Blink Shipping Process by Chromium Blog](https://blog.chromium.org/2019/11/intent-to-explain-demystifying-blink.html) [Jump to heading](#intent-to-explain-demystifying-the-blink-shipping-process-by-chromium-blog)
