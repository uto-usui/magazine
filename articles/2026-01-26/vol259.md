---
title: "Vol.259"
source: "https://frontendweekly.tokyo/posts/259/"
publishedDate: "2020-03-11"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 11th March 2020

## [Understanding Web Accessibility Color Contrast Guidelines and Ratios | CSS-Tricks](https://css-tricks.com/understanding-web-accessibility-color-contrast-guidelines-and-ratios/) [Jump to heading](#understanding-web-accessibility-color-contrast-guidelines-and-ratios-css-tricks)

#### アクセシビリティを考慮したカラーコントラストのガイドライン [Jump to heading](#アクセシビリティを考慮したカラーコントラストのガイドライン)
...
## [Toward Responsive Elements](https://bkardell.com/blog/TowardResponsive.html) [Jump to heading](#toward-responsive-elements)

#### レスポンシブ要素に向けて [Jump to heading](#レスポンシブ要素に向けて)

この記事ではコンテナクエリの問題について考察し、その問題をどのように解決するかどうかについてどのような議論が行われているかを紹介する

## [Requirements volatility is the core problem of software engineering - Stack Overflow Blog](https://stackoverflow.blog/2020/02/20/requirements-volatility-is-the-core-problem-of-software-engineering/) [Jump to heading](#requirements-volatility-is-the-core-problem-of-software-engineering-stack-overflow-blog)

#### ソフトウェア開発における要求ボラティリティの問題 [Jump to heading](#ソフトウェア開発における要求ボラティリティの問題)
...
## [Let’s Define CSS 4 · Issue #4770 · w3c/csswg-drafts](https://github.com/w3c/csswg-drafts/issues/4770) [Jump to heading](#lets-define-css-4-issue-4770-w3ccsswg-drafts)
...
## [A Guide to Console Commands | CSS-Tricks](https://css-tricks.com/a-guide-to-console-commands/) [Jump to heading](#a-guide-to-console-commands-css-tricks)
