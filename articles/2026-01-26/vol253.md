---
title: "Vol.253"
source: "https://frontendweekly.tokyo/posts/253/"
publishedDate: "2020-01-29"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 29th January 2020

## [An Engineering Team where Everyone is a Leader](https://blog.pragmaticengineer.com/a-team-where-everyone-is-a-leader/) [Jump to heading](#an-engineering-team-where-everyone-is-a-leader)

#### 誰もがリーダーであるエンジニアリングチーム [Jump to heading](#誰もがリーダーであるエンジニアリングチーム)
...
## [Effective Mental Models for Code and Systems - Cindy Sridharan - Medium](https://medium.com/@copyconstruct/effective-mental-models-for-code-and-systems-7c55918f1b3e) [Jump to heading](#effective-mental-models-for-code-and-systems-cindy-sridharan-medium)

#### コードとシステムにおける効果的なメンタルモデルを構築する方法 [Jump to heading](#コードとシステムにおける効果的なメンタルモデルを構築する方法)
...
## [Guide to Internal Communication, the Basecamp Way](https://basecamp.com/guides/how-we-communicate) [Jump to heading](#guide-to-internal-communication-the-basecamp-way)

#### Basecampにおける内部コミュニケーションガイド [Jump to heading](#basecampにおける内部コミュニケーションガイド)
...
## [Defining ‘Toast’ Messages](https://adrianroselli.com/2020/01/defining-toast-messages.html) [Jump to heading](#defining-toast-messages)

ユーザーインターフェースにおけるToastは画面に表示されるメッセージのことを指す。この記事ではそのUIの標準的な仕様、機能をまとめながら、特にアクセシビリティの観点から考察を行う。

## [Debunking the Myth: Accessibility and React | Deque](https://www.deque.com/blog/debunking-the-myth-accessibility-and-react/) [Jump to heading](#debunking-the-myth-accessibility-and-react-deque)
