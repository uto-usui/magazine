---
title: "Vol.216"
source: "https://frontendweekly.tokyo/posts/216/"
publishedDate: "2019-04-17"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 17th April 2019

## [Simple & Boring by Chris Coyier](https://css-tricks.com/simple-boring/) [Jump to heading](#simple-boring-by-chris-coyier)

#### 単純さと退屈さ [Jump to heading](#単純さと退屈さ)

Chris氏がWeb開発における、単純さと退屈さ、について言及する。昨今のWeb開発における、複雑さと、Webが本来持つ単純さについて。退屈、という言葉は一見ネガティブに感じるが、退屈な技術、退屈なコード、退屈な開発者は悪なのか。

## [The Value of Inconvenient Design by Jesse Weaver](https://medium.com/s/user-friendly/the-power-of-inconvenience-f0ae1773dd77) [Jump to heading](#the-value-of-inconvenient-design-by-jesse-weaver)

#### 不便なデザインの価値 [Jump to heading](#不便なデザインの価値)
...
## [Writing Resilient Components by Dan Abramov](https://overreacted.io/writing-resilient-components/) [Jump to heading](#writing-resilient-components-by-dan-abramov)

#### 柔軟で壊れないコンポーネントを書く [Jump to heading](#柔軟で壊れないコンポーネントを書く)
...
## [GraphQL in Depth: What, Why, and How by Ryan Glover](https://ponyfoo.com/articles/graphql-in-depth-what-why-and-how) [Jump to heading](#graphql-in-depth-what-why-and-how-by-ryan-glover)

GraphQLを非常にわかりやすく解説してくれる。基本的な要素の解説、RESTの問題点とGraphQLがそれをどのように解決するか、実際のコードを交えたサンプルの紹介、使い所などを詳しく紹介していく。

## [10 Lessons Learned Conducting Code Reviews by Jacque Schrag](https://dev.to/jnschrag/10-lessons-learned-conducting-code-reviews-5di6) [Jump to heading](#10-lessons-learned-conducting-code-reviews-by-jacque-schrag)
