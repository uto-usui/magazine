---
title: "Vol.209"
source: "https://frontendweekly.tokyo/posts/209/"
publishedDate: "2019-02-27"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 27th February 2019

## [Rule-based UX Evaluations – undervalued methods by Jan Dittrich](https://fordes.de/posts/ruleBasedUXEvaluation.html) [Jump to heading](#rule-based-ux-evaluations-undervalued-methods-by-jan-dittrich)

#### ルールに基づいたUXの評価 - 低コストな方法 [Jump to heading](#ルールに基づいたuxの評価-低コストな方法)
...
## [Navigation Should Be Boring by Allen Pike](https://allenpike.com/2019/navigation-should-be-boring) [Jump to heading](#navigation-should-be-boring-by-allen-pike)

#### ナビゲーションは退屈であるべき [Jump to heading](#ナビゲーションは退屈であるべき)
...
## [don’t get clever with login forms by Brad Frost](http://bradfrost.com/blog/post/dont-get-clever-with-login-forms/) [Jump to heading](#dont-get-clever-with-login-forms-by-brad-frost)

#### 複雑なログインフォームにするな [Jump to heading](#複雑なログインフォームにするな)
...
## [HTML Snapshot Testing with Node by Jordan Nelson](https://spin.atomicobject.com/2019/02/13/html-snapshot-testing-with-node/) [Jump to heading](#html-snapshot-testing-with-node-by-jordan-nelson)
...
## [How To Architect A Complex Web Table by Slava](https://www.smashingmagazine.com/2019/02/complex-web-tables/) [Jump to heading](#how-to-architect-a-complex-web-table-by-slava)
