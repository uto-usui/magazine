---
title: "Vol.277"
source: "https://frontendweekly.tokyo/posts/277/"
publishedDate: "2020-07-22"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 22nd July 2020

## [You’ve only added two lines - why did that take two days! ~ Matt Lacey: Creating Better Apps](https://www.mrlacey.com/2020/07/youve-only-added-two-lines-why-did-that.html) [Jump to heading](#youve-only-added-two-lines-why-did-that-take-two-days-~-matt-lacey-creating-better-apps)

#### たった 2 行のコードを追加するのに時間がかかる理由 [Jump to heading](#たった-2-行のコードを追加するのに時間がかかる理由)
...
## [Accessible to some - Manuel Matuzović](https://www.matuzo.at/blog/accessible-to-some/) [Jump to heading](#accessible-to-some-manuel-matuzović)

#### 機械的なアクセシビリティ判定と実際のアクセシビリティ [Jump to heading](#機械的なアクセシビリティ判定と実際のアクセシビリティ)
...
## [A Reason to Exist: The Product Thesis | Toptal](https://www.toptal.com/product-managers/product-strategy-consultant/product-thesis) [Jump to heading](#a-reason-to-exist-the-product-thesis-toptal)

#### プロダクトの存在価値を明確にする [Jump to heading](#プロダクトの存在価値を明確にする)
...
## [Everything You Have to Know About Core Web Vitals - Calibre](https://calibreapp.com/blog/core-web-vitals) [Jump to heading](#everything-you-have-to-know-about-core-web-vitals-calibre)
...
## [Inclusively Hiding & Styling Checkboxes and Radio Buttons — Sara Soueidan – Freelance-Front-End UI/UX Developer](https://www.sarasoueidan.com/blog/inclusively-hiding-and-styling-checkboxes-and-radio-buttons/) [Jump to heading](#inclusively-hiding-styling-checkboxes-and-radio-buttons-sara-soueidan-freelance-front-end-uiux-developer)
