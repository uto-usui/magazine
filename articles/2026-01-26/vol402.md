---
title: "Vol.402"
source: "https://frontendweekly.tokyo/posts/402/"
publishedDate: "2023-03-29"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 29th March 2023

## [Jade Rubick - Your process should be open source](https://www.rubick.com/engineering-handbook/) [Jump to heading](#jade-rubick-your-process-should-be-open-source)

#### プロセスのオープンソース化の利点 [Jump to heading](#プロセスのオープンソース化の利点)
...
## [Technical Decision-Making trivago tech blog](https://tech.trivago.com/post/2023-02-22-technical-decision-making/) [Jump to heading](#technical-decision-making-trivago-tech-blog)

#### 技術的な意思決定のベストプラクティス [Jump to heading](#技術的な意思決定のベストプラクティス)

技術的な意思決定をするためのベストプラクティスについて紹介する

1.  デザインドキュメントの作成
2.  変更の影響を受けるすべての人がドキュメントを確認する
3.  提案を検討し、決定を下すためのワーキンググループを形成する
4.  決定会議
5.  決定結果の文書化

## [Stop saying technical debt](https://stackoverflow.blog/2023/02/27/stop-saying-technical-debt/) [Jump to heading](#stop-saying-technical-debt)

#### 「技術的負債」と言うのをやめる [Jump to heading](#技術的負債と言うのをやめる)
...
## [10x your feedback game: Choose kindness over niceness](https://abdulapopoola.com/2023/02/06/10x-your-feedback-game-choose-kindness-over-niceness/) [Jump to heading](#10x-your-feedback-game-choose-kindness-over-niceness)
...
## [Organizational boundary problems: too many cooks or not enough kitchens?](https://medium.com/@ElizAyer/organizational-boundary-problems-too-many-cooks-or-not-enough-kitchens-2ddedc6de26a) [Jump to heading](#organizational-boundary-problems-too-many-cooks-or-not-enough-kitchens)
