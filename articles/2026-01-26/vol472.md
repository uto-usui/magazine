---
title: "Vol.472"
source: "https://frontendweekly.tokyo/posts/472/"
publishedDate: "2024-10-16"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 16th October 2024

## [How to build a strategy](https://www.cultivatedmanagement.com/how-to-build-a-strategy/) [Jump to heading](#how-to-build-a-strategy)

#### 戦略の構築方法 [Jump to heading](#戦略の構築方法)
...
## [When to write strategy and how much?](https://lethain.com/when-write-down-engineering-strategy/) [Jump to heading](#when-to-write-strategy-and-how-much)

#### エンジニアリング戦略を書くタイミングと量 [Jump to heading](#エンジニアリング戦略を書くタイミングと量)
...
## [What price?](https://adactio.com/journal/21405) [Jump to heading](#what-price)

#### ウェブ技術の価格設定 [Jump to heading](#ウェブ技術の価格設定)
...
## [Web features explorer](https://web-platform-dx.github.io/web-features-explorer/release-notes/) [Jump to heading](#web-features-explorer)

ウェブプラットフォームの機能を探索するためのインタラクティブなリソース。最新のウェブ技術やAPIについての情報を提供し、開発者がブラウザの互換性や実装状況を確認するのに役立つ。

## [How To Create An NPM Package](https://www.totaltypescript.com/how-to-create-an-npm-package) [Jump to heading](#how-to-create-an-npm-package)
