---
title: "Vol.438"
source: "https://frontendweekly.tokyo/posts/438/"
publishedDate: "2023-12-20"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 20th December 2023

## [HTML Web Components](https://blog.jim-nielsen.com/2023/html-web-components/) [Jump to heading](#html-web-components)

#### HTMLウェブコンポーネント [Jump to heading](#htmlウェブコンポーネント)
...
## [16 things you believe about software](https://blog.testdouble.com/posts/2023-10-10-16-things-you-believe-about-software/) [Jump to heading](#16-things-you-believe-about-software)

#### ソフトウェアに関する16の信念 [Jump to heading](#ソフトウェアに関する16の信念)
...
## [You’re Gonna Need A Bigger Browser](https://berjon.com/bigger-browser/) [Jump to heading](#youre-gonna-need-a-bigger-browser)

#### ブラウザ再考 [Jump to heading](#ブラウザ再考)

ブラウザを単なるクライアント以上のものとして再考し、ユーザー体験とよりよくするためにはどのようにすればよいかを考察する。ブラウザのアーキテクチャやUI、およびビジネスモデルを見直すことで、プロダクトを差別化する十分な余地がある。

## [Reality Check #2: Building out a fancy 404 page](https://set.studio/reality-check-2-building-out-a-fancy-404-page/) [Jump to heading](#reality-check-2-building-out-a-fancy-404-page)
...
## [Headless Component: a pattern for composing React UIs](https://martinfowler.com/articles/headless-component.html) [Jump to heading](#headless-component-a-pattern-for-composing-react-uis)
