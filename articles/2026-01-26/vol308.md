---
title: "Vol.308"
source: "https://frontendweekly.tokyo/posts/308/"
publishedDate: "2021-03-17"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 17th March 2021

## [Prefetching Heuristics](https://blog.mgechev.com/2021/02/07/prefetching-strategies-heuristics-faster-web-apps/) [Jump to heading](#prefetching-heuristics)

#### プリフェッチング戦略 [Jump to heading](#プリフェッチング戦略)
...
## [Design engineer](https://adactio.com/journal/17838) [Jump to heading](#design-engineer)

#### デザインエンジニア [Jump to heading](#デザインエンジニア)
...
## [10 Software Engineering Laws Everybody Loves to Ignore](https://www.netmeister.org/blog/software-engineering-laws.html) [Jump to heading](#10-software-engineering-laws-everybody-loves-to-ignore)

#### 10のソフトウェアエンジニアリングの法則 [Jump to heading](#10のソフトウェアエンジニアリングの法則)
...
## [Systems design explains the world: volume 1 - apenwarr](https://apenwarr.ca/log/20201227) [Jump to heading](#systems-design-explains-the-world-volume-1-apenwarr)

「システムデザイン」は、分野を超えて有効な普遍的なアーキテクチャパターンを見つけようとする研究分野のことである。この記事ではシステムデザインの考え方について解説する。

## [Building better products with a design token pipeline](https://uxdesign.cc/building-better-products-with-the-design-token-pipeline-faa86aa068e8) [Jump to heading](#building-better-products-with-a-design-token-pipeline)
