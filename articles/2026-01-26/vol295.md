---
title: "Vol.295"
source: "https://frontendweekly.tokyo/posts/295/"
publishedDate: "2020-12-02"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 2nd December 2020

## [Site-Speed Topography – CSS Wizardry – Web Performance Optimisation](https://csswizardry.com/2020/11/site-speed-topography/) [Jump to heading](#site-speed-topography-css-wizardry-web-performance-optimisation)

#### Web サイトパフォーマンスを WebPageTest を使って改善する [Jump to heading](#web-サイトパフォーマンスを-webpagetest-を使って改善する)
...
## [Web Platform Design Principles](https://www.w3.org/TR/design-principles/) [Jump to heading](#web-platform-design-principles)

#### Web プラットフォームにおける設計の原則 [Jump to heading](#web-プラットフォームにおける設計の原則)
...
## [The Raven Technique: One Step Closer to Container Queries | CSS-Tricks](https://css-tricks.com/the-raven-technique-one-step-closer-to-container-queries/) [Jump to heading](#the-raven-technique-one-step-closer-to-container-queries-css-tricks)

#### CSS 関数を駆使したコンテナクエリライクな実装 [Jump to heading](#css-関数を駆使したコンテナクエリライクな実装)

CSS の`min`、`max`、`clamp`などの関数や CSS 変数を組み合わせることで、コンテナクエリのような動作を実現するための実装アイディアを紹介する。

## [JavaScript’s Memory Management Explained](https://felixgerschau.com/javascript-memory-management/) [Jump to heading](#javascripts-memory-management-explained)
...
## [Effective Skeleton Screens - Web Performance Consulting | TimKadlec.com](https://timkadlec.com/remembers/2020-11-02-skeleton-screens/) [Jump to heading](#effective-skeleton-screens-web-performance-consulting-timkadleccom)
