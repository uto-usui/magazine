---
title: "Vol.355"
source: "https://frontendweekly.tokyo/posts/355/"
publishedDate: "2022-03-30"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 30th March 2022

## [The 15 minute fix vs the 30 day fix](https://daverupert.com/2022/03/15-minute-fix-vs-30-day-fix/) [Jump to heading](#the-15-minute-fix-vs-the-30-day-fix)

#### 15分の修正と30日の修正 [Jump to heading](#15分の修正と30日の修正)
...
## [The Science of Color & Design](https://material.io/blog/science-of-color-design) [Jump to heading](#the-science-of-color-design)

#### 色とデザインの科学 [Jump to heading](#色とデザインの科学)

Materialデザインは色の科学を利用して、これまでになく簡単でかつ表現力豊かなデザインを実現した。この記事では、それがどのように設計されて実装されていったのかを詳しく解説する。

## [How to Read the ECMAScript Specification](https://timothygu.me/es-howto/) [Jump to heading](#how-to-read-the-ecmascript-specification)

#### ECMAScript仕様の読み方 [Jump to heading](#ecmascript仕様の読み方)
...
## [Things the CSS Spec Folks Got Right](https://blog.jim-nielsen.com/2022/things-the-css-spec-folks-got-right/) [Jump to heading](#things-the-css-spec-folks-got-right)

CSSの仕様についてもコラム。`font-weight`の仕様が優れている点、CSSインポートはJavaScriptのインポートよりも早期に実装されていた点、font-familyなどについて言及している。

## [A Complete Guide to CSS Cascade Layers](https://css-tricks.com/css-cascade-layers/) [Jump to heading](#a-complete-guide-to-css-cascade-layers)
