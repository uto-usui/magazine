---
title: "Vol.203"
source: "https://frontendweekly.tokyo/posts/203/"
publishedDate: "2019-01-16"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 16th January 2019

## [Stop Learning Frameworks by Eduards Sizovs](https://sizovs.net/2018/12/17/stop-learning-frameworks/) [Jump to heading](#stop-learning-frameworks-by-eduards-sizovs)

#### フレームワークを学習するのは止めにしよう [Jump to heading](#フレームワークを学習するのは止めにしよう)
...
## [Leveling up: why developers need to be able to identify technologies with staying power (and how to do it) by Mathias Biilmann](https://medium.com/netlify/leveling-up-why-developers-need-to-be-able-to-identify-technologies-with-staying-power-and-how-to-9aa74878fc08) [Jump to heading](#leveling-up-why-developers-need-to-be-able-to-identify-technologies-with-staying-power-and-how-to-do-it-by-mathias-biilmann)

#### なぜ開発者はその技術が安定しているかどうかを見分けられる必要があるのか(そして、どのようにそれをするのか) [Jump to heading](#なぜ開発者はその技術が安定しているかどうかを見分けられる必要があるのかそして-どのようにそれをするのか)
...
## [The practical value of semantic HTML by Bruce](https://www.brucelawson.co.uk/2018/the-practical-value-of-semantic-html/) [Jump to heading](#the-practical-value-of-semantic-html-by-bruce)

#### セマンティックHTMLの実用価値とは [Jump to heading](#セマンティックhtmlの実用価値とは)
...
## [Researching a Property in the CSS Specifications by Rachel Andrew](https://24ways.org/2018/researching-a-property-in-the-css-specifications/) [Jump to heading](#researching-a-property-in-the-css-specifications-by-rachel-andrew)

よくCSSの仕様を解説記事を投稿するRachel氏が、そもそも読者がCSSの仕様を自分で読めるようになるためのTipsを紹介してくれる。そもそも、どこにあるのか、またどういった観点で読めばよいのか、最新版の追い方など、丁寧に解説する。

## [Accurately measuring layout on the web by Nolan Lawson](https://nolanlawson.com/2018/09/25/accurately-measuring-layout-on-the-web/) [Jump to heading](#accurately-measuring-layout-on-the-web-by-nolan-lawson)
