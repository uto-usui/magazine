---
title: "Vol.441"
source: "https://frontendweekly.tokyo/posts/441/"
publishedDate: "2024-01-31"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 31st January 2024

## [HTML Web Components Are Having a Moment](https://cloudfour.com/thinks/html-web-components-are-having-a-moment/) [Jump to heading](#html-web-components-are-having-a-moment)

#### 注目されるHTML Web Components [Jump to heading](#注目されるhtml-web-components)
...
## [The Cost of Not Shaping](https://www.feltpresence.com/the-cost-of-not-shaping/) [Jump to heading](#the-cost-of-not-shaping)

#### シェイピングしないことのコスト [Jump to heading](#シェイピングしないことのコスト)
...
## [NPS the good parts](https://apenwarr.ca/log/20231204) [Jump to heading](#nps-the-good-parts)

#### NPSの利点 [Jump to heading](#npsの利点)
...
## [How to Run Surveys at Every Stage of the Design Cycle](https://www.nngroup.com/articles/surveys-design-cycle/) [Jump to heading](#how-to-run-surveys-at-every-stage-of-the-design-cycle)

デザインサイクルの各段階でどのようなリサーチを行えばよいか解説する。「発見」、「探求」、「テスト」、「リッスン」の4つの段階があり、リサーチはリッスンフェーズに最も一般的に使用されるが、他のフェーズでも効果的に使用できるこ。

## [Get more out of design reviews](https://grillopress.github.io/2023/11/26/get-more-out-of-design-reviews.html) [Jump to heading](#get-more-out-of-design-reviews)
