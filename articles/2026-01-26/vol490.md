---
title: "Vol.490"
source: "https://frontendweekly.tokyo/posts/490/"
publishedDate: "2025-04-09"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 9th April 2025

## [You’re Not Creating Enough Prototypes - Blog - zeroheight](https://zeroheight.com/blog/prototypes-with-design-systems/) [Jump to heading](#youre-not-creating-enough-prototypes-blog-zeroheight)

#### 十分なプロトタイプを作成しているか？ [Jump to heading](#十分なプロトタイプを作成しているか)
...
## [Truth Lies and Progress Bars Cloud Four](https://cloudfour.com/thinks/truth-lies-and-progress-bars/) [Jump to heading](#truth-lies-and-progress-bars-cloud-four)

#### プログレスバーの嘘 [Jump to heading](#プログレスバーの嘘)
...
## [Why Is Everyone Obsessed With Chat Interfaces? | Zeh Fernandes](https://zehfernandes.com/posts/why-is-everyone-obsessed-with-chat-interfaces) [Jump to heading](#why-is-everyone-obsessed-with-chat-interfaces-zeh-fernandes)

#### なぜ人々はチャットインターフェースに夢中なのか？ [Jump to heading](#なぜ人々はチャットインターフェースに夢中なのか)

チャットインターフェースは強力なツールであるものの、すべての状況に適しているわけではなく、ユーザーのニーズやタスクの特性に応じて最適なインターフェースを選択することが重要であると結論付けている。

## [Product Strategy Should be Messy Ant Murphy](https://www.antmurphy.me/newsletter/product-strategy-should-be-messy) [Jump to heading](#product-strategy-should-be-messy-ant-murphy)

プロダクト戦略の策定は混沌としたプロセスであり、その過程での試行錯誤や多様な視点の統合が、最終的に効果的な戦略を生み出す鍵であると結論付けている。

## [XOR](https://www.chiark.greenend.org.uk/~sgtatham/quasiblog/xor/) [Jump to heading](#xor)
