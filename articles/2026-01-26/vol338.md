---
title: "Vol.338"
source: "https://frontendweekly.tokyo/posts/338/"
publishedDate: "2021-11-03"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 3rd November 2021

## [The Art of Deception Lighthouse Score Editionzachleat.com](https://www.zachleat.com/web/lighthouse-deception/) [Jump to heading](#the-art-of-deception-lighthouse-score-editionzachleatcom)

#### Lighthouseのスコアの正確性 [Jump to heading](#lighthouseのスコアの正確性)
...
## [Software developers have stopped caring about reliability](https://drewdevault.com/2021/10/17/Reliability.html) [Jump to heading](#software-developers-have-stopped-caring-about-reliability)

#### 信頼性を軽視するようになってしまったソフトウェアエンジニア [Jump to heading](#信頼性を軽視するようになってしまったソフトウェアエンジニア)
...
## [CSS { In Real Life } | Evaluating Clever CSS Solutions](https://css-irl.info/evaluating-clever-css-solutions/) [Jump to heading](#css-in-real-life-evaluating-clever-css-solutions)

#### 賢いCSSソリューションは必要か [Jump to heading](#賢いcssソリューションは必要か)
...
## [When a JavaScript WeakMap() Actually Came in Handy](https://macarthur.me/posts/when-a-weakmap-came-in-handy) [Jump to heading](#when-a-javascript-weakmap-actually-came-in-handy)

JavaScriptでスライドショーを実装していた際に発生した問題について深堀りし、WeakMapオブジェクトを使用することで改善した例を紹介している。

## [Practical frontend philosophy](https://jaredgorski.org/writing/15-practical-frontend-philosophy/) [Jump to heading](#practical-frontend-philosophy)
