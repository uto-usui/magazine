---
title: "Vol.432"
source: "https://frontendweekly.tokyo/posts/432/"
publishedDate: "2023-11-08"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 8th November 2023

## [The complexity of telling stories in UX](https://uxdesign.cc/the-complexity-of-telling-stories-in-ux-f773ffe834d8) [Jump to heading](#the-complexity-of-telling-stories-in-ux)

#### UXでストーリーを伝えることの複雑さ [Jump to heading](#uxでストーリーを伝えることの複雑さ)
...
## [From Template to Atoms.](https://bradfrost.com/blog/link/from-template-to-atoms/) [Jump to heading](#from-template-to-atoms)

#### アトミックデザインの誤解 [Jump to heading](#アトミックデザインの誤解)
...
## [Misconceptions can kill accessibility momentum Eric Eggert](https://yatil.net/blog/misconceptions-can-kill-accessibility-momentum) [Jump to heading](#misconceptions-can-kill-accessibility-momentum-eric-eggert)

#### ウェブアクセシビリティにおける誤解と誤用 [Jump to heading](#ウェブアクセシビリティにおける誤解と誤用)
...
## [Temporal API is Awesome Taro](https://taro.codes/posts/2023-08-23-temporal-api/) [Jump to heading](#temporal-api-is-awesome-taro)

JavaScriptの `Date` に置き換わる `Temporal` APIについて解説する。

## [Table of Contents: The Ultimate Design Guide](https://www.nngroup.com/articles/table-of-contents/) [Jump to heading](#table-of-contents-the-ultimate-design-guide)
