---
title: "Vol.276"
source: "https://frontendweekly.tokyo/posts/276/"
publishedDate: "2020-07-15"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 15th July 2020

## [Written communication is remote work super power - Snir David Blog](https://snir.dev/blog/remote-async-communication/) [Jump to heading](#written-communication-is-remote-work-super-power-snir-david-blog)

#### 文字でのコミュニケーションの力 [Jump to heading](#文字でのコミュニケーションの力)
...
## [Building a Design System? Start with a map - Prototypr | Prototyping](https://prototypr.io/post/building-a-design-system-start-with-a-map/) [Jump to heading](#building-a-design-system-start-with-a-map-prototypr-prototyping)

#### デザインシステムは地図から始めよう [Jump to heading](#デザインシステムは地図から始めよう)
...
## [Is WebP really better than JPEG? - siipo.la](https://siipo.la/blog/is-webp-really-better-than-jpeg) [Jump to heading](#is-webp-really-better-than-jpeg-siipola)

#### WebP は本当に JPEG よりも優れているのか [Jump to heading](#webp-は本当に-jpeg-よりも優れているのか)
...
## [Optimizing keyboard navigation using tabindex and ARIA — Sara Soueidan – Freelance-Front-End UI/UX Developer](https://www.sarasoueidan.com/blog/keyboard-friendlier-article-listings/) [Jump to heading](#optimizing-keyboard-navigation-using-tabindex-and-aria-sara-soueidan-freelance-front-end-uiux-developer)
...
## [Service Worker Lifecycle Explained](https://felixgerschau.com/service-worker-lifecycle-update/) [Jump to heading](#service-worker-lifecycle-explained)
