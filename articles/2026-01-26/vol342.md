---
title: "Vol.342"
source: "https://frontendweekly.tokyo/posts/342/"
publishedDate: "2021-12-01"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 1st December 2021

## [19\. Two kinds of usability](https://world.hey.com/rjs/19-two-kinds-of-usability-b9bc04d5) [Jump to heading](#19-two-kinds-of-usability)

#### 2種類のユーザビリティ [Jump to heading](#2種類のユーザビリティ)
...
## [Towards an animation smoothness metric](https://web.dev/smoothness/) [Jump to heading](#towards-an-animation-smoothness-metric)

#### アニメーションの滑らかさを示す指標 [Jump to heading](#アニメーションの滑らかさを示す指標)
...
## [Inertia](https://adactio.com/journal/18604) [Jump to heading](#inertia)

#### Svelteの優れた思想とそれを実現するAstro [Jump to heading](#svelteの優れた思想とそれを実現するastro)
...
## [The Guideline Gap](https://medium.com/tap-to-dismiss/the-guideline-gap-d7549d28f1ec) [Jump to heading](#the-guideline-gap)

ガイドライン、デザイナー、エンジニアのギャップをどのように埋めていくか。

## [Beyond 10](https://matthewstrom.com/writing/beyond-10x/) [Jump to heading](#beyond-10)
