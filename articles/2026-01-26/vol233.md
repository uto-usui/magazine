---
title: "Vol.233"
source: "https://frontendweekly.tokyo/posts/233/"
publishedDate: "2019-08-28"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 28th August 2019

## [Branching Out from the Great Divide by Chris Coyier](https://css-tricks.com/branching-out-from-the-great-divide/) [Jump to heading](#branching-out-from-the-great-divide-by-chris-coyier)

#### フロントエンドデベロッパの大きな境界とさらなる枝分かれ [Jump to heading](#フロントエンドデベロッパの大きな境界とさらなる枝分かれ)
...
## [4 Rules for Intuitive UX by Erik D. Kennedy](https://learnui.design/blog/4-rules-intuitive-ux.html) [Jump to heading](#4-rules-for-intuitive-ux-by-erik-d-kennedy)

#### 直感的なUXのための4つのルール [Jump to heading](#直感的なuxのための4つのルール)
...
## [Write tests. Not too many. Mostly integration. by Kent C. Dodds](https://kentcdodds.com/blog/write-tests) [Jump to heading](#write-tests-not-too-many-mostly-integration-by-kent-c-dodds)

#### テストを書く。多すぎず。そしてインテグレーションテスト [Jump to heading](#テストを書く-多すぎず-そしてインテグレーションテスト)
...
## [Using Native JavaScript Modules in Production Today by Philip Walton](https://philipwalton.com/articles/using-native-javascript-modules-in-production-today/) [Jump to heading](#using-native-javascript-modules-in-production-today-by-philip-walton)
...
## [Design tools are holding us back by Tom Johnson](https://uxdesign.cc/design-tools-are-holding-us-back-1aca266b333e) [Jump to heading](#design-tools-are-holding-us-back-by-tom-johnson)
