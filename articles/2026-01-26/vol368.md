---
title: "Vol.368"
source: "https://frontendweekly.tokyo/posts/368/"
publishedDate: "2022-07-06"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 6th July 2022

## [Mobile-First CSS: Is It Time for a Rethink?](https://alistapart.com/article/mobile-first-css-is-it-time-for-a-rethink/) [Jump to heading](#mobile-first-css-is-it-time-for-a-rethink)

#### モバイルファーストCSSを考え直す時？ [Jump to heading](#モバイルファーストcssを考え直す時)

モバイルファーストCSSは優れた設計アイディアではあるが、デメリットもある。この記事では、このアプローチの問題点を指摘しながら、ベターな設計のアイディアを考察していく。

## [The collapse of complex software](https://nolanlawson.com/2022/06/09/the-collapse-of-complex-software/) [Jump to heading](#the-collapse-of-complex-software)

#### 複雑なソフトウェアの崩壊 [Jump to heading](#複雑なソフトウェアの崩壊)
...
## [Re-evaluating technology](https://adactio.com/journal/19125) [Jump to heading](#re-evaluating-technology)

#### テクノロジーを再評価する時 [Jump to heading](#テクノロジーを再評価する時)
...
## [SQLite’s web renaissance](https://changelog.com/posts/sqlite-web-renaissance) [Jump to heading](#sqlites-web-renaissance)
