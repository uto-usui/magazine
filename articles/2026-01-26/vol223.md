---
title: "Vol.223"
source: "https://frontendweekly.tokyo/posts/223/"
publishedDate: "2019-06-19"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 19th June 2019

## [Virtual DOM is pure overhead by Rich Harris](https://svelte.dev/blog/virtual-dom-is-pure-overhead) [Jump to heading](#virtual-dom-is-pure-overhead-by-rich-harris)

#### 仮想DOMは純粋なオーバーヘッドになる [Jump to heading](#仮想domは純粋なオーバーヘッドになる)
...
## [Building the most inaccessible site possible with a perfect Lighthouse score by Manuel Matuzovic](https://www.matuzo.at/blog/building-the-most-inaccessible-site-possible-with-a-perfect-lighthouse-score/) [Jump to heading](#building-the-most-inaccessible-site-possible-with-a-perfect-lighthouse-score-by-manuel-matuzovic)

#### Lighthouseで100点をとりながら、最もアクセシブルでないサイトを作る [Jump to heading](#lighthouseで100点をとりながら-最もアクセシブルでないサイトを作る)
...
## [The difference between keyboard and screen reader navigation by Léonie](https://tink.uk/the-difference-between-keyboard-and-screen-reader-navigation/) [Jump to heading](#the-difference-between-keyboard-and-screen-reader-navigation-by-léonie)

#### キーボードユーザーとスクリーンリーダーユーザーのナビゲーションの違い [Jump to heading](#キーボードユーザーとスクリーンリーダーユーザーのナビゲーションの違い)
...
## [Unpacking hoisting by Axel Rauschmayer](http://2ality.com/2019/05/unpacking-hoisting.html) [Jump to heading](#unpacking-hoisting-by-axel-rauschmayer)
...
## [Enabling Modern JavaScript on npm by Jason Miller](https://jasonformat.com/enabling-modern-js-on-npm/) [Jump to heading](#enabling-modern-javascript-on-npm-by-jason-miller)
