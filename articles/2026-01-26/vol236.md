---
title: "Vol.236"
source: "https://frontendweekly.tokyo/posts/236/"
publishedDate: "2019-09-18"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 18th September 2019

## [Better Search Results by Bradley Taunt](https://bradleytaunt.com/better-search-results/) [Jump to heading](#better-search-results-by-bradley-taunt)

#### より良い検索結果を求めて [Jump to heading](#より良い検索結果を求めて)
...
## [Faster Image Loading With Embedded Image Previews by Christoph Erdmann](https://www.smashingmagazine.com/2019/08/faster-image-loading-embedded-previews/) [Jump to heading](#faster-image-loading-with-embedded-image-previews-by-christoph-erdmann)

#### 埋め込み画像プレビューを用いた画像読み込みの高速化について [Jump to heading](#埋め込み画像プレビューを用いた画像読み込みの高速化について)
...
## [Designing for Action: Best Practices for Effective Buttons by Billy Carlson](https://balsamiq.com/learn/resources/articles/best-practices-button-design/) [Jump to heading](#designing-for-action-best-practices-for-effective-buttons-by-billy-carlson)

#### アクションをデザインする: 効果的なボタンデザインに関するベストプラクティス [Jump to heading](#アクションをデザインする-効果的なボタンデザインに関するベストプラクティス)
...
## [How to do a code review by Google](https://google.github.io/eng-practices/review/reviewer/) [Jump to heading](#how-to-do-a-code-review-by-google)
