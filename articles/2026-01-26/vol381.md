---
title: "Vol.381"
source: "https://frontendweekly.tokyo/posts/381/"
publishedDate: "2022-10-12"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 12th October 2022

## [Against Superficial Simplicity](https://jarango.com/2022/09/15/against-superficial-simplicity/) [Jump to heading](#against-superficial-simplicity)

#### シンプルだけがベストなデザインではない [Jump to heading](#シンプルだけがベストなデザインではない)
...
## [One Formula To Rule Them All: The ROI Of A Design System](https://www.smashingmagazine.com/2022/09/formula-roi-design-system/) [Jump to heading](#one-formula-to-rule-them-all-the-roi-of-a-design-system)

#### デザインシステムのROI [Jump to heading](#デザインシステムのroi)
...
## [Prototyping to learn](https://daverupert.com/2022/09/prototyping-to-learn/) [Jump to heading](#prototyping-to-learn)

#### 学ぶためのプロトタイピング [Jump to heading](#学ぶためのプロトタイピング)

プロトタイピングの有用性について。プロトタイピングの種類、役割、対象とすべき範囲、など様々な観点からそれぞれの利点をまとめて紹介していく。

## [Making Sense Of WAI-ARIA: A Comprehensive Guide](https://www.smashingmagazine.com/2022/09/wai-aria-guide/) [Jump to heading](#making-sense-of-wai-aria-a-comprehensive-guide)

この記事では、Kate氏が、ARIAをいつ使用すればよいのか、そしてARIAを適切に使用する方法について説明する。

## [Meetings are Toxic (Season 2)](https://www.rework.fm/meetings-are-toxic-season-2/) [Jump to heading](#meetings-are-toxic-season-2)
