---
title: "Vol.289"
source: "https://frontendweekly.tokyo/posts/289/"
publishedDate: "2020-10-21"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 21st October 2020

## [Developer priorities throughout their career – Lea Verou](https://lea.verou.me/2020/09/developer-priorities-throughout-their-career/) [Jump to heading](#developer-priorities-throughout-their-career-lea-verou)

#### 開発者キャリアにおける優先事項の推移 [Jump to heading](#開発者キャリアにおける優先事項の推移)
...
## [Understanding Resource Priorities](https://noti.st/andydavies/Tw5Q3B) [Jump to heading](#understanding-resource-priorities)

#### ブラウザがどのようにリソースの優先順位をつけるのか [Jump to heading](#ブラウザがどのようにリソースの優先順位をつけるのか)
...
## [Publish events, not logs | Kislay Verma](https://kislayverma.com/programming/publish-events-not-logs/) [Jump to heading](#publish-events-not-logs-kislay-verma)

#### ログではなくイベント [Jump to heading](#ログではなくイベント)
...
## [Finding The Root Cause of a CSS Bug](https://ishadeed.com/article/finding-the-root-cause/) [Jump to heading](#finding-the-root-cause-of-a-css-bug)

この記事では、いくつかの一般的な CSS の問題と、それを間違った方法で修正する際に発生しうる問題を明らかにしながら、CSS のバグを根本から修正する方法を紹介する。

## [Do the next right thing - daverupert.com](https://daverupert.com/2020/09/do-the-next-right-thing/) [Jump to heading](#do-the-next-right-thing-daverupertcom)
