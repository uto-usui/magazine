---
title: "Vol.256"
source: "https://frontendweekly.tokyo/posts/256/"
publishedDate: "2020-02-19"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 19th February 2020

## [Design systems roundup](https://adactio.com/journal/16400) [Jump to heading](#design-systems-roundup)

#### デザインシステム総括 [Jump to heading](#デザインシステム総括)
...
## [Old CSS, new CSS](https://eev.ee/blog/2020/02/01/old-css-new-css/) [Jump to heading](#old-css-new-css)

#### CSSの変遷 [Jump to heading](#cssの変遷)
...
## [Unlearning toxic behaviors in a code review culture](https://medium.com/@sandya.sankarram/unlearning-toxic-behaviors-in-a-code-review-culture-b7c295452a3c) [Jump to heading](#unlearning-toxic-behaviors-in-a-code-review-culture)

#### コードレビュー文化における悪い行動 [Jump to heading](#コードレビュー文化における悪い行動)
...
## [Deep dive CSS: font metrics, line-height and vertical-align - Vincent De Oliveira](https://iamvdo.me/en/blog/css-font-metrics-line-height-and-vertical-align) [Jump to heading](#deep-dive-css-font-metrics-line-height-and-vertical-align-vincent-de-oliveira)
...
## [Innovation Can’t Keep the Web Fast | CSS-Tricks](https://css-tricks.com/innovation-cant-keep-the-web-fast/) [Jump to heading](#innovation-cant-keep-the-web-fast-css-tricks)
