---
title: "Vol.238"
source: "https://frontendweekly.tokyo/posts/238/"
publishedDate: "2019-10-01"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 1st October 2019

## [How Web Content Can Affect Power Usage by @awfulben](https://webkit.org/blog/8970/how-web-content-can-affect-power-usage/) [Jump to heading](#how-web-content-can-affect-power-usage-by-awfulben)

#### Webサイトがバッテリーに与える影響とその対策 [Jump to heading](#webサイトがバッテリーに与える影響とその対策)
...
## [Everything I Know About Style Guides, Design Systems, and Component Libraries by Lee Robinson](https://leerob.io/blog/style-guides-component-libraries-design-systems/) [Jump to heading](#everything-i-know-about-style-guides-design-systems-and-component-libraries-by-lee-robinson)

#### スタイルガイド・デザインシステム・コンポーネントライブラリ [Jump to heading](#スタイルガイドデザインシステムコンポーネントライブラリ)
...
## [Design System Backlogging by Sandy Lam](https://medium.com/dallas-design-sprints/design-system-backlogging-b1e92afd34db) [Jump to heading](#design-system-backlogging-by-sandy-lam)

#### デザインシステムにおけるバックログの作り方 [Jump to heading](#デザインシステムにおけるバックログの作り方)
...
## [Process for growing Seedling into an internal product by Jaclyn Kerschner](https://medium.com/in-the-weeds/process-for-growing-seedling-845f6d010290) [Jump to heading](#process-for-growing-seedling-into-an-internal-product-by-jaclyn-kerschner)
...
## [How to Present an Easy-to-Follow Tech Demo by Angie Siu](https://open.nytimes.com/how-to-present-an-easy-to-follow-tech-demo-d0ffce96c3b4) [Jump to heading](#how-to-present-an-easy-to-follow-tech-demo-by-angie-siu)
