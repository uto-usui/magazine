---
title: "Vol.426"
source: "https://frontendweekly.tokyo/posts/426/"
publishedDate: "2023-09-27"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 27th September 2023

## [The value of a prototype is in the insight it imparts not the code.](https://addyosmani.com/blog/prototypes/) [Jump to heading](#the-value-of-a-prototype-is-in-the-insight-it-imparts-not-the-code)

#### プロトタイプの価値はコードではなく得られる洞察にある [Jump to heading](#プロトタイプの価値はコードではなく得られる洞察にある)
...
## [Understanding React Server Components](https://vercel.com/blog/understanding-react-server-components) [Jump to heading](#understanding-react-server-components)

#### React Server Componentsについて [Jump to heading](#react-server-componentsについて)
...
## [Your Computer Should Say What You Tell It To Say](https://www.eff.org/deeplinks/2023/08/your-computer-should-say-what-you-tell-it-say-1) [Jump to heading](#your-computer-should-say-what-you-tell-it-to-say)

#### WEIとは [Jump to heading](#weiとは)
...
## [How to Make AI UX Your Moat - by Anshul Ramachandran](https://www.latent.space/p/ai-ux-moat) [Jump to heading](#how-to-make-ai-ux-your-moat-by-anshul-ramachandran)

ChatGPTは、そのLLMが成功したのではなく、そのUXが成功した。それではチャットがLLMの最終形態なのか。そうではない。この記事ではAI UXをどのように改善すればよいのかについて。考察する。

## [Shaping isn’t writing](https://www.feltpresence.com/shaping-isnt-writing/) [Jump to heading](#shaping-isnt-writing)
