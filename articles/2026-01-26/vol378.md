---
title: "Vol.378"
source: "https://frontendweekly.tokyo/posts/378/"
publishedDate: "2022-09-21"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 21st September 2022

## [Webhooks.fyi](https://webhooks.fyi/) [Jump to heading](#webhooksfyi)

#### Webhookのベストプラクティス [Jump to heading](#webhookのベストプラクティス)
...
## [8 mental model design heuristics](https://uxdesign.cc/8-mental-model-design-heuristics-85d2e3133128) [Jump to heading](#8-mental-model-design-heuristics)

#### メンタルモデルをサポートする8つのヒューリスティック [Jump to heading](#メンタルモデルをサポートする8つのヒューリスティック)
...
## [Time isnt the only way to plan and estimate](https://theoverlap.substack.com/p/time) [Jump to heading](#time-isnt-the-only-way-to-plan-and-estimate)

#### 時間以外の見積もり方法 [Jump to heading](#時間以外の見積もり方法)
...
## [Truthish. ethanmarcotte.com](https://ethanmarcotte.com/wrote/truthish/) [Jump to heading](#truthish-ethanmarcottecom)
...
## [What Makes A Great Toggle Button? (Case Study Part 2) Smashing Magazine](https://www.smashingmagazine.com/2022/08/toggle-button-case-study-part-2/) [Jump to heading](#what-makes-a-great-toggle-button-case-study-part-2-smashing-magazine)
