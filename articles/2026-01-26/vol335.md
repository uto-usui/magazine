---
title: "Vol.335"
source: "https://frontendweekly.tokyo/posts/335/"
publishedDate: "2021-10-13"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 13th October 2021

## [Typography for Data](https://medium.com/tap-to-dismiss/typography-for-data-c760e73367e0) [Jump to heading](#typography-for-data)

#### データ可視化のためのタイポグラフィ [Jump to heading](#データ可視化のためのタイポグラフィ)
...
## [Design systems: the BNARL model](https://uxdesign.cc/the-bnarl-model-5f72b3c7e46c) [Jump to heading](#design-systems-the-bnarl-model)

#### デザインシステムを改善するBNARLモデル [Jump to heading](#デザインシステムを改善するbnarlモデル)
...
## [Quicker UX Research Synthesis](https://uxtools.co/blog/quicker-ux-research-synthesis/) [Jump to heading](#quicker-ux-research-synthesis)

#### UXリサーチの結果を統合する方法 [Jump to heading](#uxリサーチの結果を統合する方法)

複数の様々なリサーチ結果をどのように統合し、有効活用していけばよいか。この記事ではリサーチ結果を効率よく統合する方法を紹介している。

## [Optimizing JSON IndexedDB or postMessage](https://webreflection.medium.com/optimizing-json-indexeddb-or-postmessage-698112860899) [Jump to heading](#optimizing-json-indexeddb-or-postmessage)

同じようなデータを格納するJSONのデータだったとしても、最適化をすることでパフォーマンスとメモリ消費を大幅に改善できる例を紹介する。

## [Less Absolute Positioning With Modern CSS - Ahmad Shadeed](https://ishadeed.com/article/less-absolute-positioning-modern-css/) [Jump to heading](#less-absolute-positioning-with-modern-css-ahmad-shadeed)
