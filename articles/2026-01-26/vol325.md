---
title: "Vol.325"
source: "https://frontendweekly.tokyo/posts/325/"
publishedDate: "2021-07-21"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 21st July 2021

## [6 Ways to Reduce Cognitive Demand When Designing UX](https://uxplanet.org/6-ways-to-reduce-cognitive-demand-when-designing-ux-5571bad05b2f) [Jump to heading](#6-ways-to-reduce-cognitive-demand-when-designing-ux)

#### 決断疲労を減らす6つの方法 [Jump to heading](#決断疲労を減らす6つの方法)
...
## [Designing an omni-search](https://uxdesign.cc/designing-an-omni-search-29c6cb6ec3f7) [Jump to heading](#designing-an-omni-search)

#### オムニサーチをデザインする [Jump to heading](#オムニサーチをデザインする)

複数のエンティティや複数のフィールドを一箇所の入力エリアで検索することができるオムニサーチのUIについてのデザインを解説する。SpotifyやMediumの実装を例を挙げながら、どのような点に考慮してデザインすべきかを紹介していく。

## [The Siren Song of the ‘User’ Model](https://chelseatroy.com/2021/06/28/the-siren-song-of-the-user-model/) [Jump to heading](#the-siren-song-of-the-user-model)

#### ユーザーモデルの問題点 [Jump to heading](#ユーザーモデルの問題点)
...
## [Asynchronous Design Critique: Getting Feedback – A List Apart](https://alistapart.com/article/asynchronous-design-critique-giving-feedback-part2/) [Jump to heading](#asynchronous-design-critique-getting-feedback-a-list-apart)
...
## [Design systems don’t kill creativity. But that wasn’t the question.](https://stuffandnonsense.co.uk/blog/design-systems-dont-kill-creativity-but-that-wasnt-the-question) [Jump to heading](#design-systems-dont-kill-creativity-but-that-wasnt-the-question)
