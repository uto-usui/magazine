---
title: "Vol.356"
source: "https://frontendweekly.tokyo/posts/356/"
publishedDate: "2022-04-06"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 6th April 2022

## [When or If](https://meyerweb.com/eric/thoughts/2022/03/14/if-or-when/) [Jump to heading](#when-or-if)

#### WhenかIfか [Jump to heading](#whenかifか)
...
## [When should there be a declarative version of a JavaScript API?](https://adactio.com/journal/18903) [Jump to heading](#when-should-there-be-a-declarative-version-of-a-javascript-api)

#### 宣言的なJavaScript API [Jump to heading](#宣言的なjavascript-api)

`button type="share"`や`button type="fullscreen"`といったHTMLで実装できる宣言的なJavaScript APIの有用性について説く。

## [Why Compilers Dont Autocorrect Obvious Parse Errors](https://chelseatroy.com/2022/03/11/why-compilers-dont-autocorrect-obvious-parse-errors/) [Jump to heading](#why-compilers-dont-autocorrect-obvious-parse-errors)

#### なぜコンパイラは自動でエラーを修正しないのか [Jump to heading](#なぜコンパイラは自動でエラーを修正しないのか)
...
## [Translating User Research Into Design](https://uxtools.co/blog/translating-user-research-to-design/) [Jump to heading](#translating-user-research-into-design)
...
## [An incoherent rant about design systems](https://www.robinrendle.com/notes/an-incoherent-rant-about-design-systems/) [Jump to heading](#an-incoherent-rant-about-design-systems)
