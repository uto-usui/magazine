---
title: "Vol.249"
source: "https://frontendweekly.tokyo/posts/249/"
publishedDate: "2019-12-25"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 25th December 2019

## [Accessibility Tips for Web Developers by Addy Osmani](https://dev.to/addyosmani/accessibility-tips-for-web-developers-4cn0) [Jump to heading](#accessibility-tips-for-web-developers-by-addy-osmani)

#### Webディベロッパーのためのアクセリビリティ基礎 [Jump to heading](#webディベロッパーのためのアクセリビリティ基礎)
...
## [No, Absolutely Not by Robin Rendle](https://css-tricks.com/no-absolutely-not/) [Jump to heading](#no-absolutely-not-by-robin-rendle)

#### 優秀なフロントエンドエンジニアに求められるものとは [Jump to heading](#優秀なフロントエンドエンジニアに求められるものとは)
...
## [Don’t Serve Burnt Pizza (And Other Lessons in Building Minimum Lovable Products) by Jiaona Zhang](https://firstround.com/review/dont-serve-burnt-pizza-and-other-lessons-in-building-minimum-lovable-products/) [Jump to heading](#dont-serve-burnt-pizza-and-other-lessons-in-building-minimum-lovable-products-by-jiaona-zhang)

#### 焦げたピザを提供しないで(そして、愛されるプロダクトデザインの開発のために) [Jump to heading](#焦げたピザを提供しないでそして-愛されるプロダクトデザインの開発のために)
...
## [It All Starts with a Humble `<textarea>` by Andy Bell](https://24ways.org/2019/it-all-starts-with-a-humble-textarea/) [Jump to heading](#it-all-starts-with-a-humble-textarea-by-andy-bell)
...
## [CSS: When to Use Logical Properties by Jens Oliver Meiert](https://meiert.com/en/blog/logical-properties/) [Jump to heading](#css-when-to-use-logical-properties-by-jens-oliver-meiert)
