---
title: "Vol.230"
source: "https://frontendweekly.tokyo/posts/230/"
publishedDate: "2019-08-07"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 7th August 2019

## [Pseudo Code by Chris Coyier](https://css-tricks.com/pseudo-code/) [Jump to heading](#pseudo-code-by-chris-coyier)

[https://css-tricks.com/pseudo-code/](https://css-tricks.com/pseudo-code/)

#### 擬似コードは素晴らしい [Jump to heading](#擬似コードは素晴らしい)
...
#### FT.comチームはたった7時間でどのようにドキュメントを95%改善したのか [Jump to heading](#ftcomチームはたった7時間でどのようにドキュメントを95改善したのか)
...
## [9 UX Requirements for Designing a User-Friendly Homepage Carousel (If You Need One) by Jamie Appleseed](https://www.baymard.com/blog/homepage-carousel) [Jump to heading](#9-ux-requirements-for-designing-a-user-friendly-homepage-carousel-if-you-need-one-by-jamie-appleseed)

#### ユーザーフレンドリーなカルーセルをデザインするための9つの条件 [Jump to heading](#ユーザーフレンドリーなカルーセルをデザインするための9つの条件)
...
## [Accessible CSS Generated Content by Eric Eggert](https://yatil.net/blog/accessible-css-generated-content) [Jump to heading](#accessible-css-generated-content-by-eric-eggert)
...
## [The Growing Demand For UX Managers by Jared M. Spool](https://medium.com/@jmspool/the-growing-demand-for-ux-managers-60b304a0a72c) [Jump to heading](#the-growing-demand-for-ux-managers-by-jared-m-spool)
