---
title: "Vol.317"
source: "https://frontendweekly.tokyo/posts/317/"
publishedDate: "2021-05-26"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 26th May 2021

## [“Support Systems for Learning,” an essay by Dan Mall](https://danmall.com/essays/support-systems-for-learning/) [Jump to heading](#support-systems-for-learning-an-essay-by-dan-mall)

#### 学習支援システム [Jump to heading](#学習支援システム)
...
## [The Almost-Complete Guide to Cumulative Layout Shift](https://jessbpeck.com/posts/completecls/) [Jump to heading](#the-almost-complete-guide-to-cumulative-layout-shift)

#### 累積レイアウトシフトについてのガイド [Jump to heading](#累積レイアウトシフトについてのガイド)

コアウェブバイタルでは、その要素の一つとしてCLS(累積レイアウトシフト)を挙げている。この記事ではCLSについて包括的に紹介し、それが何か、どのように計測できるのか、そしてその対応策を解説していく。

## [Understanding Design Systems — Designing Component APIs](https://javascript.plainenglish.io/design-systems-designing-component-apis-25dcf81d26f5) [Jump to heading](#understanding-design-systems-designing-component-apis)

#### コンポーネントAPI設計 [Jump to heading](#コンポーネントapi設計)
...
2.  どういったバリエーションが提供されているかを考慮する
3.  どのスタイルがカスタマイズ可能かどうかを考慮する
4.  コンポーネントは将来どのように進化するか考慮する
5.  どこにコンテンツが挿入可能か考慮する

## [The Humble `img` Element And Core Web Vitals](https://www.smashingmagazine.com/2021/04/humble-img-element-core-web-vitals/) [Jump to heading](#the-humble-img-element-and-core-web-vitals)
...
## [The State of CSS Cross-Browser Development - Ahmad Shadeed](https://ishadeed.com/article/cross-browser-development/) [Jump to heading](#the-state-of-css-cross-browser-development-ahmad-shadeed)
