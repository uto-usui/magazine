---
title: "Vol.265"
source: "https://frontendweekly.tokyo/posts/265/"
publishedDate: "2020-04-22"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 22nd April 2020

## [Maintaining Performance - daverupert.com](https://daverupert.com/2020/03/maintaining-performance/) [Jump to heading](#maintaining-performance-daverupertcom)

#### パフォーマンスをメンテナンスする [Jump to heading](#パフォーマンスをメンテナンスする)
...
## [How to build a bad design system | CSS-Tricks](https://css-tricks.com/how-to-build-a-bad-design-system/) [Jump to heading](#how-to-build-a-bad-design-system-css-tricks)

#### 悪いデザインシステムの作り方 [Jump to heading](#悪いデザインシステムの作り方)
...
## [Adactio: Journal — Apple’s attack on service workers](https://adactio.com/journal/16619) [Jump to heading](#adactio-journal-apples-attack-on-service-workers)

#### Apple と Safari と service worker [Jump to heading](#apple-と-safari-と-service-worker)

Safari のサービスワーカーの仕様についての調査し、サービスワーカーの登録に関する仕様について解説しながら、Web 開発者の視点で Apple の対応について論じる。

## [Responsive Images the Simple Way - Cloud Four](https://cloudfour.com/thinks/responsive-images-the-simple-way/) [Jump to heading](#responsive-images-the-simple-way-cloud-four)

レスポンシブな画像を実装するために、img タグで使用できる、`srcset属性`と`sizes属性`についての紹介。この 2 つを組み合わせることで、画面サイズに応じた画像の幅、画像の候補から最適サイズのものを使用する仕組みを実装できる。

## [A creative person’s guide to negotiating – The Creative Independent](https://thecreativeindependent.com/guides/a-creative-persons-guide-to-negotiating/) [Jump to heading](#a-creative-persons-guide-to-negotiating-the-creative-independent)
