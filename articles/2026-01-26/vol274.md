---
title: "Vol.274"
source: "https://frontendweekly.tokyo/posts/274/"
publishedDate: "2020-07-01"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 1st July 2020

## [Introducing the Web Platform Contribution Guide - featured-home, featured-reliability-standards-and-testing, tutorial, web standards - Bocoup](https://bocoup.com/blog/introducing-the-web-platform-contribution-guide) [Jump to heading](#introducing-the-web-platform-contribution-guide-featured-home-featured-reliability-standards-and-testing-tutorial-web-standards-bocoup)

#### Web プラットフォームへの貢献ガイド [Jump to heading](#web-プラットフォームへの貢献ガイド)
...
## [Don’t just sit there - james helms - Medium](https://medium.com/@jamesh_str/dont-just-sit-there-b25f7dcdb5af) [Jump to heading](#dont-just-sit-there-james-helms-medium)

#### デザイナーがキャリアアップするための方法 [Jump to heading](#デザイナーがキャリアアップするための方法)
...
## [3 practical tips to make your waterfall product team a little more agile | Matt Andrews](https://mattandre.ws/2020/05/waterfall-to-agile/) [Jump to heading](#3-practical-tips-to-make-your-waterfall-product-team-a-little-more-agile-matt-andrews)

#### プロダクトを改善する 3 つのシンプルな方法 [Jump to heading](#プロダクトを改善する-3-つのシンプルな方法)
...
## [Product Judgment: How some people can repeatedly create product success | Inside Intercom](https://www.intercom.com/blog/product-judgment/) [Jump to heading](#product-judgment-how-some-people-can-repeatedly-create-product-success-inside-intercom)

素晴らしいプロダクトを生み出すに必要な Product Judgement について。それには、顧客との対話を多く持つことが重要であると話す。

## [Grid for layout, Flexbox for components](https://ishadeed.com/article/grid-layout-flexbox-components/) [Jump to heading](#grid-for-layout-flexbox-for-components)
