---
title: "Vol.331"
source: "https://frontendweekly.tokyo/posts/331/"
publishedDate: "2021-09-15"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 15th September 2021

## [How To Build Resilient JavaScript UIs](https://www.smashingmagazine.com/2021/08/build-resilient-javascript-ui/) [Jump to heading](#how-to-build-resilient-javascript-uis)

#### 柔軟なUIを実装する方法 [Jump to heading](#柔軟なuiを実装する方法)
...
## [How We Design Our APIs at Slack](https://slack.engineering/how-we-design-our-apis-at-slack/) [Jump to heading](#how-we-design-our-apis-at-slack)

#### SlackではAPIをどのようにデザインしているのか [Jump to heading](#slackではapiをどのようにデザインしているのか)
...
## [Discovery vs. Documentation | Silicon Valley Product Group](https://svpg.com/discovery-vs-documentation/) [Jump to heading](#discovery-vs-documentation-silicon-valley-product-group)

#### 仕様書とプロトタイピング [Jump to heading](#仕様書とプロトタイピング)
...
## [The local minima of suckiness](https://veekaybee.github.io/2021/08/05/local-minima-of-suckiness/) [Jump to heading](#the-local-minima-of-suckiness)
...
## [A guide to designing accessible WCAG-compliant focus indicators](https://www.sarasoueidan.com/blog/focus-indicators/) [Jump to heading](#a-guide-to-designing-accessible-wcag-compliant-focus-indicators)
