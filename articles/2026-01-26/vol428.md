---
title: "Vol.428"
source: "https://frontendweekly.tokyo/posts/428/"
publishedDate: "2023-10-11"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 11th October 2023

## [Nine Essential Information Architecture Practices](https://jarango.com/2023/09/04/nine-essential-information-architecture-practices/) [Jump to heading](#nine-essential-information-architecture-practices)

#### 情報アーキテクチャにおける9つのプラクティス [Jump to heading](#情報アーキテクチャにおける9つのプラクティス)
...
## [Leaning into Business as In-House Designers](https://www.imkylelambert.com/articles/leaning-into-business-as-in-house-designers) [Jump to heading](#leaning-into-business-as-in-house-designers)

#### インハウスデザイナーとして学ぶべきリソース [Jump to heading](#インハウスデザイナーとして学ぶべきリソース)
...
## [The value of good design](https://www.teresamira.com/writing/the-value-of-good-design) [Jump to heading](#the-value-of-good-design)

#### 良いデザインの価値 [Jump to heading](#良いデザインの価値)

デザインへの投資は、長期的な影響を伴う戦略的措置である。解決すべき適切な問題を定義する、一貫したエクスペリエンスを提供する、value propositionを高めるなど。良いデザインは良いビジネスを意味する。

## [If you want to address tech debt quantify it first](https://stackoverflow.blog/2023/08/24/if-you-want-to-address-tech-debt-quantify-it-first/) [Jump to heading](#if-you-want-to-address-tech-debt-quantify-it-first)
...
## [The cost of convenience](https://surma.dev/things/cost-of-convenience/) [Jump to heading](#the-cost-of-convenience)
