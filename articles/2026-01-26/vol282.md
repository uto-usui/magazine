---
title: "Vol.282"
source: "https://frontendweekly.tokyo/posts/282/"
publishedDate: "2020-09-02"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 2nd September 2020

#### Facebook のアクセシビリティを改善した方法 [Jump to heading](#facebook-のアクセシビリティを改善した方法)

[facebook.com](http://facebook.com/) がどのように Web サイトのアクセシビリティを改善したかを紹介する。Facebook2004 年に公開されて以降様々な実装を重ねてきたため、大規模で複雑なサイトになっており、リグレッション無しで広範囲の修正を施すことが難しくなってしまっていたが、React を利用してアクセシビリティの改善や新しいツールの導入ができるようになっていったという。
...
## [The Guide to Design](https://start.uxdesign.cc/) [Jump to heading](#the-guide-to-design)

#### プロダクトデザインビギナーズガイド [Jump to heading](#プロダクトデザインビギナーズガイド)
...
## [Design Principles to Support Better Decision Making](https://www.nngroup.com/articles/design-principles/) [Jump to heading](#design-principles-to-support-better-decision-making)

#### 意思決定をサポートするためのデザイン原則 [Jump to heading](#意思決定をサポートするためのデザイン原則)
...
## [content-visibility: the new CSS property that boosts your rendering performance](https://web.dev/content-visibility/) [Jump to heading](#content-visibility-the-new-css-property-that-boosts-your-rendering-performance)
