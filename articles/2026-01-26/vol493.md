---
title: "Vol.493"
source: "https://frontendweekly.tokyo/posts/493/"
publishedDate: "2025-05-14"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 14th May 2025

## [Exploring Generative AI](https://martinfowler.com/articles/exploring-gen-ai.html) [Jump to heading](#exploring-generative-ai)

#### 生成AIの探求 [Jump to heading](#生成aiの探求)
...
## [All pretty models are wrong but some ugly models are useful](https://longform.asmartbear.com/models/) [Jump to heading](#all-pretty-models-are-wrong-but-some-ugly-models-are-useful)

#### 役に立つのは不格好なモデル [Jump to heading](#役に立つのは不格好なモデル)

ビジネスや戦略におけるモデル（枠組み）についての洞察を提供している。ビジネスの現場では、完璧なモデルを追い求めるよりも、現実に即した柔軟なアプローチが求められる。

## [Introducing command and commandfor | Blog | Chrome for Developers](https://developer.chrome.com/blog/command-and-commandfor) [Jump to heading](#introducing-command-and-commandfor-blog-chrome-for-developers)

#### commandとcommandfor [Jump to heading](#commandとcommandfor)
...
## [7 SaaS Website UX Fixes – Baymard Institute](https://baymard.com/blog/saas-website-ux-best-practices) [Jump to heading](#7-saas-website-ux-fixes-baymard-institute)

SaaSウェブサイトのUX改善に関するベストプラクティスをまとめた記事。ユーザーのニーズに応えるためのウェブサイトの設計と実装についての詳細なガイド。

## [Learn Zod So You Can Trust Your Data and Your Types – DiDoesDigital](https://didoesdigital.com/blog/zod-overview/) [Jump to heading](#learn-zod-so-you-can-trust-your-data-and-your-types-didoesdigital)
