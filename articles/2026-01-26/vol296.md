---
title: "Vol.296"
source: "https://frontendweekly.tokyo/posts/296/"
publishedDate: "2020-12-08"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 8th December 2020

## [Technical debt as a lack of understanding - daverupert.com](https://daverupert.com/2020/11/technical-debt-as-a-lack-of-understanding/) [Jump to heading](#technical-debt-as-a-lack-of-understanding-daverupertcom)

#### 技術的負債の本質 [Jump to heading](#技術的負債の本質)
...
## [The Core Web Vitals hype train](https://sylormiller.com/posts/2020/core-web-vitals/) [Jump to heading](#the-core-web-vitals-hype-train)

#### Core Web Vitals との向き合い方 [Jump to heading](#core-web-vitals-との向き合い方)
...
## [The Challenge of Identifying UX Success Metrics | by Jared M. Spool | Medium](https://medium.com/@jmspool/the-challenge-of-identifying-ux-success-metrics-c065cb9657b3) [Jump to heading](#the-challenge-of-identifying-ux-success-metrics-by-jared-m-spool-medium)

#### UX 改善において重要な指標を特定するということ [Jump to heading](#ux-改善において重要な指標を特定するということ)
...
## [A Complete Guide to CSS Gradients | CSS-Tricks](https://css-tricks.com/a-complete-guide-to-css-gradients/) [Jump to heading](#a-complete-guide-to-css-gradients-css-tricks)
...
## [Why some IA is better than none](https://ux.shopify.com/why-some-ia-is-better-than-none-d046b9d6731b) [Jump to heading](#why-some-ia-is-better-than-none)
