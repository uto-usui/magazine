---
title: "Vol.412"
source: "https://frontendweekly.tokyo/posts/412/"
publishedDate: "2023-06-14"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 14th June 2023

## [Hand-thrown frontends](https://robbowen.digital/wrote-about/hand-thrown-frontends/) [Jump to heading](#hand-thrown-frontends)

#### フロントエンド開発は粘土を扱うようなものである [Jump to heading](#フロントエンド開発は粘土を扱うようなものである)
...
## [The ongoing defence of frontend as a full-time job](https://christianheilmann.com/2023/05/09/the-ongoing-defence-of-frontend-as-a-full-time-job/) [Jump to heading](#the-ongoing-defence-of-frontend-as-a-full-time-job)

#### プロフェッショナルとしてのフロントエンド開発者 [Jump to heading](#プロフェッショナルとしてのフロントエンド開発者)
...
## [The UX Cookbook](https://theuxcookbook.com/) [Jump to heading](#the-ux-cookbook)

#### UXクックブック [Jump to heading](#uxクックブック)

ユーザーリサーチ、デザイン、ユーザビリティテストなど、UX に関する様々なトピックに対してどのように考え、アプローチをどのようにすればよいかをまとめたサイト。

## [Sometimes the job is an assembly line](https://daverupert.com/2023/05/assembly-line/) [Jump to heading](#sometimes-the-job-is-an-assembly-line)
...
## [The problem with disabled buttons and what to do instead](https://adamsilver.io/blog/the-problem-with-disabled-buttons-and-what-to-do-instead/) [Jump to heading](#the-problem-with-disabled-buttons-and-what-to-do-instead)
