---
title: "Vol.201"
source: "https://frontendweekly.tokyo/posts/201/"
...
## [What makes someone a good front-end developer? by Chris Ferdinandi](https://gomakethings.com/what-makes-someone-a-good-front-end-developer/) [Jump to heading](#what-makes-someone-a-good-front-end-developer-by-chris-ferdinandi)

#### 優秀なフロントエンドデベロッパーに必要な要素とは？ [Jump to heading](#優秀なフロントエンドデベロッパーに必要な要素とは)
...
## [Maybe Our Documentation “Best Practices” Aren’t Really Best Practices by Kayce Basques](https://kayce.basqu.es/blog/best-practices) [Jump to heading](#maybe-our-documentation-best-practices-arent-really-best-practices-by-kayce-basques)

#### あなたのドキュメントに関するベストプラクティスはベストではないかもしれない [Jump to heading](#あなたのドキュメントに関するベストプラクティスはベストではないかもしれない)
...
## [Risking a Homogeneous Web by Tim Kadlec](https://timkadlec.com/remembers/2018-12-04-risking-a-homogenous-web/) [Jump to heading](#risking-a-homogeneous-web-by-tim-kadlec)

#### 同質的なWebの危険性 [Jump to heading](#同質的なwebの危険性)
...
## [Prototypes and production by Jeremy Keith](https://adactio.com/journal/14562) [Jump to heading](#prototypes-and-production-by-jeremy-keith)
...
## [Performance-Driven Development by Artem Denysov](https://calendar.perfplanet.com/2018/performance-driven-development/) [Jump to heading](#performance-driven-development-by-artem-denysov)
