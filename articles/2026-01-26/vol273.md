---
title: "Vol.273"
source: "https://frontendweekly.tokyo/posts/273/"
publishedDate: "2020-06-24"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 24th June 2020

## [Over-complicated? Over-simplified? The UX Efficient Frontier](https://uxdesign.cc/over-complicated-over-simplified-the-ux-efficient-frontier-561d7773bc6b) [Jump to heading](#over-complicated-over-simplified-the-ux-efficient-frontier)

#### UX における効率的フロンティア [Jump to heading](#ux-における効率的フロンティア)
...
## [Good coders borrow, great coders steal - Stack Overflow Blog](https://stackoverflow.blog/2020/05/20/good-coders-borrow-great-coders-steal/) [Jump to heading](#good-coders-borrow-great-coders-steal-stack-overflow-blog)

#### コードをコピーするということ [Jump to heading](#コードをコピーするということ)
...
## [CUBE CSS - Piccalilli](https://piccalil.li/blog/cube-css/) [Jump to heading](#cube-css-piccalilli)

#### Cube CSS [Jump to heading](#cube-css)
...
## [Convince managers to address Tech Debt with Enclosure Diagrams](https://understandlegacycode.com/blog/convince-management-to-address-tech-debt-with-enclosure-diagrams) [Jump to heading](#convince-managers-to-address-tech-debt-with-enclosure-diagrams)

マネージャーに技術的負債を対処することの重要性を説くために、ツリーマップ図を使用することでコードベースを可視化するのが良い方法であると、解説する。この記事では、コードベースから簡単にそういった図を作成する方法を紹介する。

## [What every developer should know about TCP | Roberto Vitillo’s Blog](https://robertovitillo.com/what-every-developer-should-know-about-tcp/) [Jump to heading](#what-every-developer-should-know-about-tcp-roberto-vitillos-blog)
