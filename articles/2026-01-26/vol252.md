---
title: "Vol.252"
source: "https://frontendweekly.tokyo/posts/252/"
publishedDate: "2020-01-22"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 22nd January 2020

## [Helping Browsers Optimize With The CSS Contain Property by Smashing Magazine](https://www.smashingmagazine.com/2019/12/browsers-containment-css-contain-property/) [Jump to heading](#helping-browsers-optimize-with-the-css-contain-property-by-smashing-magazine)

#### CSSの `contain` プロパティを用いて、ブラウザの最適化を手助けする [Jump to heading](#cssの-contain-プロパティを用いて-ブラウザの最適化を手助けする)
...
## [Goodbye, Clean Code](https://overreacted.io/goodbye-clean-code/) [Jump to heading](#goodbye-clean-code)

#### クリーンなコードが全てではない [Jump to heading](#クリーンなコードが全てではない)
...
## [A short history of body copy sizes on the Web](https://fvsch.com/body-copy-sizes/) [Jump to heading](#a-short-history-of-body-copy-sizes-on-the-web)

#### Webにおけるフォントサイズの変遷 [Jump to heading](#webにおけるフォントサイズの変遷)
...
## [Why You Should Choose HTML5 `<article>` Over `<section>` by Smashing Magazine](https://www.smashingmagazine.com/2020/01/html5-article-section/) [Jump to heading](#why-you-should-choose-html5-article-over-section-by-smashing-magazine)

`article` タグと `section` タグは視覚的には大きな違いが無いが、Assistive Technologyを使用して閲覧した際には、挙動の違いがある点を取り挙げる。

## [My Priority of Methods for Labeling a Control](https://adrianroselli.com/2020/01/my-priority-of-methods-for-labeling-a-control.html) [Jump to heading](#my-priority-of-methods-for-labeling-a-control)
...
## [Flexible Captioned Slanted Images by 24 ways](https://24ways.org/2019/flexible-captioned-slanted-images/) [Jump to heading](#flexible-captioned-slanted-images-by-24-ways)
...
## [Motion Paths - Past, Present and Future by Codrops](https://tympanus.net/codrops/2019/12/03/motion-paths-past-present-and-future/) [Jump to heading](#motion-paths-past-present-and-future-by-codrops)
