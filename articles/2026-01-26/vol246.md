---
title: "Vol.246"
source: "https://frontendweekly.tokyo/posts/246/"
publishedDate: "2019-12-04"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 4th December 2019

## [No, disabling a button is not app logic. by David K.](https://dev.to/davidkpiano/no-disabling-a-button-is-not-app-logic-598i) [Jump to heading](#no-disabling-a-button-is-not-app-logic-by-david-k)

#### ボタンを無効化するのはアプリのロジックではない [Jump to heading](#ボタンを無効化するのはアプリのロジックではない)
...
## [Chrome Developer Summit 2019: performance announcements you have to know by Karolina Szczur](https://calibreapp.com/blog/performance-at-chrome-dev-summit) [Jump to heading](#chrome-developer-summit-2019-performance-announcements-you-have-to-know-by-karolina-szczur)

#### Chrome Developer Summit 2019: あなたが知るべきパフォーマンスに関するアップデート [Jump to heading](#chrome-developer-summit-2019-あなたが知るべきパフォーマンスに関するアップデート)
...
## [Delivering the “right” 80/20 by Rob Bayley](https://medium.com/product-to-product/delivering-the-right-80-20-64c96ea95a3d) [Jump to heading](#delivering-the-right-8020-by-rob-bayley)

[https://medium.com/product-to-product/delivering-the-right-80-20-64c96ea95a3d](https://medium.com/product-to-product/delivering-the-right-80-20-64c96ea95a3d)

#### 正しいパレートの法則 [Jump to heading](#正しいパレートの法則)
...
## [A Business Case for Dropping Internet Explorer by Ollie Williams](https://css-tricks.com/a-business-case-for-dropping-internet-explorer/) [Jump to heading](#a-business-case-for-dropping-internet-explorer-by-ollie-williams)

web開発におけるIEの対応は頭のいたくなる問題であるが、Ollie氏はビジネス的な観点を判断に取り入れて、ロジカルにIEのサポートを外す理由を解説していく。

## Slide/Video [Jump to heading](#slidevideo)

## [Refactoring (the way we talk about) CSS by Rachel Andrew](https://noti.st/rachelandrew/wuKH4y/refactoring-the-way-we-talk-about-css) [Jump to heading](#refactoring-the-way-we-talk-about-css-by-rachel-andrew)
