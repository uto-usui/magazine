---
title: "Vol.417"
source: "https://frontendweekly.tokyo/posts/417/"
publishedDate: "2023-07-19"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 19th July 2023

## [Modern CSS For Dynamic Component-Based Architecture | Modern CSS Solutions](https://moderncss.dev/modern-css-for-dynamic-component-based-architecture/) [Jump to heading](#modern-css-for-dynamic-component-based-architecture-modern-css-solutions)

#### 最新のCSSを利用したCSSアーキテクチャの考え方 [Jump to heading](#最新のcssを利用したcssアーキテクチャの考え方)
...
## [Gestalt Principles of Design Closure - Christopher Butler](https://www.chrbutler.com/gestalt-principles-of-design-closure) [Jump to heading](#gestalt-principles-of-design-closure-christopher-butler)

#### ゲシュタルトの設計原則 [Jump to heading](#ゲシュタルトの設計原則)
...
## [The hardest part of building software is not coding it’s requirements](https://stackoverflow.blog/2023/06/26/the-hardest-part-of-building-software-is-not-coding-its-requirements/) [Jump to heading](#the-hardest-part-of-building-software-is-not-coding-its-requirements)

#### 要件定義とAIによるコーディング [Jump to heading](#要件定義とaiによるコーディング)
...
## [Estimation Isnt for Everyone](https://open.nytimes.com/estimation-isnt-for-everyone-a72484f88b27) [Jump to heading](#estimation-isnt-for-everyone)
...
## [ESLint guide: how to use it with confidence Z1 Blog](https://z1.digital/blog/eslint-guide-how-to-use-it-with-confidence) [Jump to heading](#eslint-guide-how-to-use-it-with-confidence-z1-blog)
