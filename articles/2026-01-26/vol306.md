---
title: "Vol.306"
source: "https://frontendweekly.tokyo/posts/306/"
publishedDate: "2021-03-03"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 3rd March 2021

## [Design system components, recipes, and snowflakes | Brad Frost](https://bradfrost.com/blog/post/design-system-components-recipes-and-snowflakes/) [Jump to heading](#design-system-components-recipes-and-snowflakes-brad-frost)

#### システムコンポーネント、レシピ、雪片の単位で設計をする [Jump to heading](#システムコンポーネント-レシピ-雪片の単位で設計をする)
...
## [9 Takeaways for Product Managers from A Philosophy of Software Design | Viget](https://www.viget.com/articles/how-to-reduce-complexity-on-digital-product-projects/) [Jump to heading](#9-takeaways-for-product-managers-from-a-philosophy-of-software-design-viget)

#### ソフトウェア設計の哲学から学ぶプロダクトマネージャーのための9つのポイント [Jump to heading](#ソフトウェア設計の哲学から学ぶプロダクトマネージャーのための9つのポイント)
...
## [A comprehensive list of UX design methods & deliverables](https://uxdesign.cc/a-comprehensive-list-of-ux-design-methods-deliverables-2021-2feb3e70e168) [Jump to heading](#a-comprehensive-list-of-ux-design-methods-deliverables)

#### UXデザインの方法と成果物のリスト [Jump to heading](#uxデザインの方法と成果物のリスト)
...
## [ARCHITECTURE.md](https://matklad.github.io//2021/02/06/ARCHITECTURE.md.html) [Jump to heading](#architecturemd)
...
## [Creative Good: Why I’m losing faith in UX](https://creativegood.com/blog/21/losing-faith-in-ux.html) [Jump to heading](#creative-good-why-im-losing-faith-in-ux)
