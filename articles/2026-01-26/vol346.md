---
title: "Vol.346"
source: "https://frontendweekly.tokyo/posts/346/"
publishedDate: "2021-12-29"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 29th December 2021

## [Embrace the Platform](https://css-tricks.com/embrace-the-platform/) [Jump to heading](#embrace-the-platform)

#### プラットフォームを活かす [Jump to heading](#プラットフォームを活かす)
...
#### Webフィード実装のベストプラクティス [Jump to heading](#webフィード実装のベストプラクティス)
...
## [Three Foundational IA Concepts](https://jarango.com/2021/11/30/three-foundational-ia-concepts/) [Jump to heading](#three-foundational-ia-concepts)

#### 3つの基本的なIA概念 [Jump to heading](#3つの基本的なia概念)
...
## [mess with dns](https://messwithdns.net/) [Jump to heading](#mess-with-dns)

DNSレコードの設定を試すことができるWebアプリ。DNSの基本の設定方法から、実際によくある設定方法、変わった設定方法を行ったときにどのような挙動になるか、などをチュートリアル形式で学ぶ事ができる。

## [SVGcode: a PWA to convert raster images to SVG vector graphics](https://web.dev/svgcode/) [Jump to heading](#svgcode-a-pwa-to-convert-raster-images-to-svg-vector-graphics)
