---
title: "Vol.220"
source: "https://frontendweekly.tokyo/posts/220/"
publishedDate: "2019-05-29"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 29th May 2019

## [How Frontend Developers Can Help To Bridge The Gap Between Designers And Developers by Stefan Kaltenegger](https://www.smashingmagazine.com/2019/05/frontend-developers-designers/) [Jump to heading](#how-frontend-developers-can-help-to-bridge-the-gap-between-designers-and-developers-by-stefan-kaltenegger)

#### どのようにフロントエンドデベロッパがデザイナとデベロッパのギャップを埋めるのを手助けできるのか [Jump to heading](#どのようにフロントエンドデベロッパがデザイナとデベロッパのギャップを埋めるのを手助けできるのか)
...
## [Hybrid Lazy Loading: A Progressive Migration To Native Lazy Loading by Andrea](https://www.smashingmagazine.com/2019/05/hybrid-lazy-loading-progressive-migration-native/) [Jump to heading](#hybrid-lazy-loading-a-progressive-migration-to-native-lazy-loading-by-andrea)

#### ハイブリッド遅延読み込み: ネィティブの遅延読み込みへの段階的な移行 [Jump to heading](#ハイブリッド遅延読み込み-ネィティブの遅延読み込みへの段階的な移行)
...
## [Modes in User Interfaces: When They Help and When They Hurt Users by Page Laubheimer](https://www.nngroup.com/articles/modes/) [Jump to heading](#modes-in-user-interfaces-when-they-help-and-when-they-hurt-users-by-page-laubheimer)

#### “モード”というUI: どういった場面でそれが使いやすく、そして不便なものになってしまうのか [Jump to heading](#モードというui-どういった場面でそれが使いやすく-そして不便なものになってしまうのか)
...
## [How to know what to test by Kent C. Dodds](https://kentcdodds.com/blog/how-to-know-what-to-test) [Jump to heading](#how-to-know-what-to-test-by-kent-c-dodds)
...
## Video [Jump to heading](#video)

## [How to Create an SVG Pie Chart—Code Along with Kasey (Video) by Kasey Bonifacio](https://seesparkbox.com/foundry/how_to_code_an_SVG_pie_chart) [Jump to heading](#how-to-create-an-svg-pie-chartcode-along-with-kasey-video-by-kasey-bonifacio)
