---
title: "Vol.269"
source: "https://frontendweekly.tokyo/posts/269/"
publishedDate: "2020-05-27"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 27th May 2020

## [Inside a dev’s mind - How do you plan a UI feature?](https://jkettmann.com/how-do-you-plan-a-ui-feature/) [Jump to heading](#inside-a-devs-mind-how-do-you-plan-a-ui-feature)

#### どのように UI を設計するか [Jump to heading](#どのように-ui-を設計するか)
...
## [“The title ‘Front-End Developer’ is obsolete.”](https://css-tricks.com/the-title-front-end-developer-is-obsolete/) [Jump to heading](#the-title-front-end-developer-is-obsolete)

#### フロントエンドディベロッパーという肩書は時代遅れ [Jump to heading](#フロントエンドディベロッパーという肩書は時代遅れ)
...
## [You don’t need to stop shipping features to fix technical debt](https://medium.com/@ryan0x44/technical-debt-f5158cc9ca07) [Jump to heading](#you-dont-need-to-stop-shipping-features-to-fix-technical-debt)

#### 技術的負債のために機能実装を止める必要はない [Jump to heading](#技術的負債のために機能実装を止める必要はない)

あなたがソフトウェアエンジニアであるならば、技術的負債の返済と機能実装を天秤にかけたことが何度もあるだろう。この記事ではこの技術的負債について再度明確に定義し、それとどのように向き合っていくべきかについてのアイディアを紹介する。

## [How does TypeScript work? The bird’s eye view](https://2ality.com/2020/04/typescript-workflows.html) [Jump to heading](#how-does-typescript-work-the-birds-eye-view)

TypeScript を使ったプロジェクトはどのように始めれば良いのか。ファイル構造から実際に配置されるファイルを一つ一つ丁寧に紹介する

## [A case study of complex table design](https://jlongster.com/case-study-complex-table-design) [Jump to heading](#a-case-study-of-complex-table-design)
