---
title: "Vol.482"
source: "https://frontendweekly.tokyo/posts/482/"
publishedDate: "2025-01-29"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 29th January 2025

## [If Not React, Then What?](https://infrequently.org/2024/11/if-not-react-then-what/) [Jump to heading](#if-not-react-then-what)

#### Reactの代替として何を選ぶべきか？ [Jump to heading](#reactの代替として何を選ぶべきか)

この記事では、Reactの代替となるフロントエンドフレームワークやライブラリの選択肢について検討している。Reactのパフォーマンスや複雑さに関する課題を指摘し、他のツールの利点や適用シナリオを分析している。

## [New CSS that can actually be used in 2024](https://thomasorus.com/new-css-that-can-actually-be-used-in-2024.html) [Jump to heading](#new-css-that-can-actually-be-used-in-2024)

#### 2024年に利用された新しいCSS機能 [Jump to heading](#2024年に利用された新しいcss機能)

この記事では、2024年に実際に使用可能になっている新しいCSS機能を紹介している。これらの新機能を活用することで、開発者はより効率的で洗練されたデザインを実現できる。

## [Product management is broken. Engineers can fix it](https://newsletter.posthog.com/p/product-management-is-broken-engineers) [Jump to heading](#product-management-is-broken-engineers-can-fix-it)

#### プロダクトマネジメントの問題点とエンジニアによる解決策 [Jump to heading](#プロダクトマネジメントの問題点とエンジニアによる解決策)

この記事では、現代のプロダクトマネジメントの課題を指摘し、エンジニアがどのようにその問題を解決できるかを論じている。エンジニア主導のアプローチが、プロダクト開発の効率と品質を向上させる可能性を探っている。

## [Overflow Clip](https://ishadeed.com/article/overflow-clip/) [Jump to heading](#overflow-clip)

#### Overflow Clipの活用方法 [Jump to heading](#overflow-clipの活用方法)

この記事では、CSSの`overflow: clip`プロパティの使用方法とその利点について解説している。このプロパティを適切に活用することで、不要なスクロールバーを表示せずに要素の内容をクリップできる。

## [When Is a Skip Link Needed?](https://www.tpgi.com/when-is-a-skip-link-needed/) [Jump to heading](#when-is-a-skip-link-needed)

#### Skipリンクが必要な場合とは？ [Jump to heading](#skipリンクが必要な場合とは)
