---
title: "Vol.293"
source: "https://frontendweekly.tokyo/posts/293/"
publishedDate: "2020-11-18"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 18th November 2020

## [Spatial Memory: Why It Matters for UX Design](https://www.nngroup.com/articles/spatial-memory/) [Jump to heading](#spatial-memory-why-it-matters-for-ux-design)

#### 空間メモリがなぜ UX デザインにとって重要なのか [Jump to heading](#空間メモリがなぜ-ux-デザインにとって重要なのか)
...
## [Emancipating Information Architecture](https://semanticstudios.com/emancipating-information-architecture/) [Jump to heading](#emancipating-information-architecture)

#### 情報アーキテクチャの解放 [Jump to heading](#情報アーキテクチャの解放)
...
## [How to Think Like a Front-End Developer | CSS-Tricks](https://css-tricks.com/how-to-think-like-a-front-end-developer/) [Jump to heading](#how-to-think-like-a-front-end-developer-css-tricks)

#### フロントエンド開発者のように考える方法 [Jump to heading](#フロントエンド開発者のように考える方法)

Chris 氏はフロントエンド開発者について多くのの記事を執筆・紹介してきた。この記事ではそれらをまとめ、リンク集とし公開している。

## [The most useful accessibility testing tools and techniques — Artem Sapegin’s Blog](https://blog.sapegin.me/all/accessibility-testing/) [Jump to heading](#the-most-useful-accessibility-testing-tools-and-techniques-artem-sapegins-blog)
...
## [State-Switch Controls: The Infamous Case of the “Mute” Button](https://www.nngroup.com/articles/state-switch-buttons/) [Jump to heading](#state-switch-controls-the-infamous-case-of-the-mute-button)
