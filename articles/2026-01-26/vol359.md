---
title: "Vol.359"
source: "https://frontendweekly.tokyo/posts/359/"
publishedDate: "2022-04-27"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 27th April 2022

## [Make Beautifully Resilient Apps With Progressive Enhancement](https://austingil.com/resilient-applications-progressive-enhancement/) [Jump to heading](#make-beautifully-resilient-apps-with-progressive-enhancement)

#### プログレッシブエンハンスメントを適用したフォームの実装 [Jump to heading](#プログレッシブエンハンスメントを適用したフォームの実装)
...
## [Optimising Largest Contentful Paint](https://csswizardry.com/2022/03/optimising-largest-contentful-paint/) [Jump to heading](#optimising-largest-contentful-paint)

#### LCPを最適化する [Jump to heading](#lcpを最適化する)

Core Web Vitalsの一つである`LCP`をどのように最適化していけばよいかを解説する。この投稿では、いくつかのポイントを紹介した後に、興味深いトリックと最適化について解説する。また、いくつかの落とし穴とバグを紹介している。

## [Master your questioning skills](http://muratbuffalo.blogspot.com/2018/12/master-your-questioning-skills.html) [Jump to heading](#master-your-questioning-skills)

#### 質問のスキル身につけるためには [Jump to heading](#質問のスキル身につけるためには)

Murat氏がブログに設けている MAD questionについての考察。この問いかけがどのようにワークしたのか、それから学んだこととは何か、紹介していく。

## [Tao of Node - Design Architecture & Best Practices](https://alexkondov.com/tao-of-node/) [Jump to heading](#tao-of-node-design-architecture-best-practices)

Node.jsに関するデザイン、アーキテクチャのベストプラクティスを紹介する。

## [Refactor Organisation](https://medium.com/bbc-design-engineering/refactor-organisation-80e4e171d922) [Jump to heading](#refactor-organisation)
