---
title: "Vol.372"
source: "https://frontendweekly.tokyo/posts/372/"
publishedDate: "2022-08-03"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 3rd August 2022

## [21\. Prototyping to learn](https://world.hey.com/rjs/21-prototyping-to-learn-726e2d3e) [Jump to heading](#21-prototyping-to-learn)

#### プロトタイピングの威力 [Jump to heading](#プロトタイピングの威力)
...
## [The Demo Demo Loop](https://daverupert.com/2022/06/demo-to-demo-loop/) [Jump to heading](#the-demo-demo-loop)

#### デモが生み出すもの [Jump to heading](#デモが生み出すもの)
...
## [Governance is a design systems friend](https://zeroheight.com/blog/governance-is-a-design-systems-friend/) [Jump to heading](#governance-is-a-design-systems-friend)

#### デザインシステムにおけるガバナンス [Jump to heading](#デザインシステムにおけるガバナンス)
...
## [Building tabs in Web Components](https://darn.es/building-tabs-in-web-components/) [Jump to heading](#building-tabs-in-web-components)

タブのWeb Componentsを作成する。セマンティクス、アクセシビリティを考慮する。また、スクロールが可能であることを示すシャドウを動的に適用するテクニックを紹介している。

## [The Unlocked Possibilities of the :has() Selector](https://blog.jim-nielsen.com/2022/unlocked-possibilities-of-has-selector/) [Jump to heading](#the-unlocked-possibilities-of-the-has-selector)
