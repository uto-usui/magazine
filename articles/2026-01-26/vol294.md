---
title: "Vol.294"
source: "https://frontendweekly.tokyo/posts/294/"
publishedDate: "2020-11-25"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 25th November 2020

## [Thinking Contextually – Jorge Arango](https://jarango.com/2020/11/11/thinking-contextually/) [Jump to heading](#thinking-contextually-jorge-arango)

#### コンテキストについて考慮する [Jump to heading](#コンテキストについて考慮する)
...
## [Copying is the way design works || Matthew Ström: designer & developer](https://matthewstrom.com/writing/copying/) [Jump to heading](#copying-is-the-way-design-works-matthew-ström-designer-developer)

#### デザインとコピーの関係 [Jump to heading](#デザインとコピーの関係)
...
## [Design good practices | Home](https://goodpractices.design/) [Jump to heading](#design-good-practices-home)

#### デザインにおけるグッドプラクティス [Jump to heading](#デザインにおけるグッドプラクティス)

このサイトでは、命名規則やコンポーネント設計、ドキュメント編成におけるガイドラインを分かりやすく明快に紹介している。

## [Designing better data tables for enterprise UX](https://uxdesign.cc/data-table-for-enterprise-ux-cb48fb9fdf1e) [Jump to heading](#designing-better-data-tables-for-enterprise-ux)

エンタープライズ向けのシステムでよく使われるデータテーブルのデザインについて、その様々なバリエーションを紹介し、デザインのベストプラクティスを紹介していく。

## [Improve your debugging strategies](https://www.functionize.com/blog/improve-your-debugging-strategies/) [Jump to heading](#improve-your-debugging-strategies)
