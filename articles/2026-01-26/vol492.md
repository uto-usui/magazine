---
title: "Vol.492"
source: "https://frontendweekly.tokyo/posts/492/"
publishedDate: "2025-04-30"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 30th April 2025

## [Cool native HTML elements you should already be using Harrison Broadbent](https://harrisonbroadbent.com/blog/cool-native-html-elements/) [Jump to heading](#cool-native-html-elements-you-should-already-be-using-harrison-broadbent)

#### ネイティブHTML要素の活用 [Jump to heading](#ネイティブhtml要素の活用)
...
## [how organizations should learn to fail - by Tim Casasola](https://theoverlap.substack.com/p/how-organizations-should-learn-to) [Jump to heading](#how-organizations-should-learn-to-fail-by-tim-casasola)

#### 組織が失敗から学ぶ方法 [Jump to heading](#組織が失敗から学ぶ方法)
...
## [The Product Engineer Rands in Repose](https://randsinrepose.com/archives/the-product-engineer/) [Jump to heading](#the-product-engineer-rands-in-repose)

#### プロダクトエンジニアとは何者か [Jump to heading](#プロダクトエンジニアとは何者か)
...
## [CSS Relative Colors](https://ishadeed.com/article/css-relative-colors/) [Jump to heading](#css-relative-colors)

CSSの新機能「相対カラー（Relative Colors）」について解説。相対カラーを使用することで、既存の色を基にして、明度や彩度、透明度などを動的に調整した新しい色を生成できる。

## [Its Time to Accept that Marketing and Strategy are One Discipline | by Roger Martin | Medium](https://rogermartin.medium.com/its-time-to-accept-that-marketing-and-strategy-are-one-discipline-17f0140521c9) [Jump to heading](#its-time-to-accept-that-marketing-and-strategy-are-one-discipline-by-roger-martin-medium)
