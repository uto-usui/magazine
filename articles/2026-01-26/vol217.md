---
title: "Vol.217"
source: "https://frontendweekly.tokyo/posts/217/"
publishedDate: "2019-04-24"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 24th April 2019

## [Split by Jeremy](https://adactio.com/journal/15050) [Jump to heading](#split-by-jeremy)

#### Webフロントエンドの2つの側面 [Jump to heading](#webフロントエンドの2つの側面)
...
## [A Website is a Car and Not a Book by Robin Rendle](https://css-tricks.com/a-website-is-a-car-and-not-a-book/) [Jump to heading](#a-website-is-a-car-and-not-a-book-by-robin-rendle)

#### Webサイトは”車”であり、”本”ではない [Jump to heading](#webサイトは車であり-本ではない)
...
## [How We Used WebAssembly To Speed Up Our Web App By 20X (Case Study) by Robert](https://www.smashingmagazine.com/2019/04/webassembly-speed-web-app/) [Jump to heading](#how-we-used-webassembly-to-speed-up-our-web-app-by-20x-case-study-by-robert)

#### WebAssemblyを使用して、Webアプリを20倍高速にした [Jump to heading](#webassemblyを使用して-webアプリを20倍高速にした)
...
## [Opinion: We Built A Broken Internet. Now We Need To Burn It To The Ground. by Mike Monteiro](https://www.buzzfeednews.com/article/mikemonteiro/we-built-a-broken-internet-now-we-need-to-burn-it) [Jump to heading](#opinion-we-built-a-broken-internet-now-we-need-to-burn-it-to-the-ground-by-mike-monteiro)
...
## [Revisiting the rendering tier by Alex Sanders](https://www.theguardian.com/info/2019/apr/04/revisiting-the-rendering-tier) [Jump to heading](#revisiting-the-rendering-tier-by-alex-sanders)
