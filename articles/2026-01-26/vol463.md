---
title: "Vol.463"
source: "https://frontendweekly.tokyo/posts/463/"
publishedDate: "2024-07-31"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 31st July 2024

## [How to create software quality.](https://lethain.com/quality/) [Jump to heading](#how-to-create-software-quality)

#### ソフトウェア品質の向上方法 [Jump to heading](#ソフトウェア品質の向上方法)
...
## [Common Fate: Gestalt Principle for User Interface Design](https://bootcamp.uxdesign.cc/common-fate-gestalt-principle-for-user-interface-design-4a123b9aa319) [Jump to heading](#common-fate-gestalt-principle-for-user-interface-design)

#### UIデザインのための共通運命のゲシュタルト原理 [Jump to heading](#uiデザインのための共通運命のゲシュタルト原理)
...
## [Why Passkey Implementation is 100x Harder Than You Think Misconceptions Pitfalls and Unknown Unknowns](https://www.corbado.com/blog/passkey-implementation-pitfalls-misconceptions-unknowns) [Jump to heading](#why-passkey-implementation-is-100x-harder-than-you-think-misconceptions-pitfalls-and-unknown-unknowns)

#### パスキー実装の課題と誤解 [Jump to heading](#パスキー実装の課題と誤解)
...
## [Hands-On Guide to Property-Based Testing in JavaScript](https://www.webdevlog.com/p/properety-based-testing-in-javascript/) [Jump to heading](#hands-on-guide-to-property-based-testing-in-javascript)
...
## [Queueing An interactive study of queueing strategies Encore Blog](https://encore.dev/blog/queueing) [Jump to heading](#queueing-an-interactive-study-of-queueing-strategies-encore-blog)
