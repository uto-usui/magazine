---
title: "Vol.343"
source: "https://frontendweekly.tokyo/posts/343/"
publishedDate: "2021-12-08"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 8th December 2021

## [Be usable not consistent not uniform](https://uxdesign.cc/be-usable-not-consistent-not-uniform-9ac72374cf93) [Jump to heading](#be-usable-not-consistent-not-uniform)

#### 一貫性や均一性よりも使いやすさ [Jump to heading](#一貫性や均一性よりも使いやすさ)
...
## [Design Systems are for user interfaces](https://bradfrost.com/blog/post/design-systems-are-for-user-interfaces/) [Jump to heading](#design-systems-are-for-user-interfaces)

#### ユーザーインターフェースのためのデザインシステム [Jump to heading](#ユーザーインターフェースのためのデザインシステム)
...
## [Design Ops in scalable design organizations](https://www.mynameisjehad.com/design-ops-in-scalable-design-organizations/) [Jump to heading](#design-ops-in-scalable-design-organizations)

#### スケーラブルなデザインチームDesign Ops [Jump to heading](#スケーラブルなデザインチームdesign-ops)
...
## [Language is Infrastructure](https://understandinggroup.com/ia-theory/language-is-infrastructure) [Jump to heading](#language-is-infrastructure)

どういった言語を使うかはインフラとなるほど重要な要素である。ユーザーストーリーや要件を決めるとき、使用する言語が将来の結果を形作ることになる。

## [Your CSS is an interface](https://ericwbailey.design/writing/your-css-is-an-interface/) [Jump to heading](#your-css-is-an-interface)
