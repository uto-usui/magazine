---
title: "Vol.413"
source: "https://frontendweekly.tokyo/posts/413/"
publishedDate: "2023-06-21"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 21st June 2023

## [Technology Decision Making (and Boring Technology)](https://code.likeagirl.io/technology-decision-making-and-boring-technology-e6cbe612450f) [Jump to heading](#technology-decision-making-and-boring-technology)

#### 技術的意思決定と退屈なテクノロジー [Jump to heading](#技術的意思決定と退屈なテクノロジー)
...
## [Meetings are the work](https://medium.com/@ElizAyer/meetings-are-the-work-9e429dde6aa3) [Jump to heading](#meetings-are-the-work)

#### MTGは悪か [Jump to heading](#mtgは悪か)
...
## [Graph Slider](https://rauno.me/craft/graph-slider) [Jump to heading](#graph-slider)

#### SVGを利用したグラフのスライダー [Jump to heading](#svgを利用したグラフのスライダー)

SVGとCSSの `offsetPath` プロパティを利用して、グラフのスライダーを実装する方法を解説する。また、インジケーターの位置を固定するなどの細かいチューニング方法にいても紹介する。

## [Semantics and the popover attribute: what to use when?](https://hidde.blog/popover-semantics/) [Jump to heading](#semantics-and-the-popover-attribute-what-to-use-when)

`popover`属性についての解説。また、それに関連して `menu` と `dialog`、`listbox` などの要素、roleなどについても触れる。

## [Regular expressions in JavaScript - Honeybadger Developer Blog](https://www.honeybadger.io/blog/javascript-regular-expressions/) [Jump to heading](#regular-expressions-in-javascript-honeybadger-developer-blog)
