---
title: "Vol.316"
source: "https://frontendweekly.tokyo/posts/316/"
publishedDate: "2021-05-19"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 19th May 2021

## [To Get Real Answers, Ask The Right Questions](https://blog.testdouble.com/posts/2021-04-19-ask-the-right-questions/) [Jump to heading](#to-get-real-answers-ask-the-right-questions)

#### 本当の回答を得るためには正しい質問が必要 [Jump to heading](#本当の回答を得るためには正しい質問が必要)
...
## [To add is expected, to subtract is design](https://uxdesign.cc/to-add-is-expected-to-subtract-is-design-e84025fe201) [Jump to heading](#to-add-is-expected-to-subtract-is-design)

#### 引き算のデザイン [Jump to heading](#引き算のデザイン)
...
## [Waking up from the dream of UX, Peter Merholz](https://www.petermerholz.com/blog/waking-up-from-the-dream-of-ux/) [Jump to heading](#waking-up-from-the-dream-of-ux-peter-merholz)

#### UXの夢から覚める [Jump to heading](#uxの夢から覚める)
...
## [Web Performance Recipes With Puppeteer](https://addyosmani.com/blog/puppeteer-recipes/) [Jump to heading](#web-performance-recipes-with-puppeteer)

Puppeteerを使用してウェブサイトパフォーマンスを測定するための方法をまとめる。

## [How To Make Tree Shakeable Libraries](https://blog.theodo.com/2021/04/library-tree-shaking/) [Jump to heading](#how-to-make-tree-shakeable-libraries)
