---
title: "Vol.257"
source: "https://frontendweekly.tokyo/posts/257/"
publishedDate: "2020-02-26"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 26th February 2020

## [Hydration](https://adactio.com/journal/16404) [Jump to heading](#hydration)

#### プログレッシブエンハンスメントとそれにまつわる技術について [Jump to heading](#プログレッシブエンハンスメントとそれにまつわる技術について)
...
## [Honesty is the best policy - Andy Bell](https://hankchizljaw.com/wrote/honesty-is-the-best-policy/) [Jump to heading](#honesty-is-the-best-policy-andy-bell)

#### Gatsbyのパフォーマンスに対する見解について [Jump to heading](#gatsbyのパフォーマンスに対する見解について)
...
## [Design System Subtasks, by Step](https://www.eightshapes.com/articles/design-system-subtasks-by-step.html) [Jump to heading](#design-system-subtasks-by-step)

#### デザインシステムのサブタスク [Jump to heading](#デザインシステムのサブタスク)
...
## [High Output Management for (Non-managing) Tech Leads](https://www.g9labs.com/2020/01/04/high-output-management-for-non-managing-tech-leads/) [Jump to heading](#high-output-management-for-non-managing-tech-leads)
...
## [Freezing User-Agent Strings | CSS-Tricks](https://css-tricks.com/freezing-user-agent-strings/) [Jump to heading](#freezing-user-agent-strings-css-tricks)

[https://groups.google.com/a/chromium.org/forum/#!msg/blink-dev/-2JIRNMWJ7s/yHe4tQNLCgAJ](https://frontendweekly.tokyo/posts/257/Chrome%E3%81%8CUser-Agent%E3%81%A8%E5%87%8D%E7%B5%90)するというニュースがある。Chris氏はこの内容に関して、開発者目線からどういった影響があるか、どのように対応をするべきかなどについて考察を公開する
