---
title: "Vol.254"
source: "https://frontendweekly.tokyo/posts/254/"
publishedDate: "2020-02-05"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 5th February 2020

## [Unity](https://adactio.com/journal/16331) [Jump to heading](#unity)

#### EdgeのBlink採用とWebの健全さ [Jump to heading](#edgeのblink採用とwebの健全さ)
...
## [justinamiller/SoftwareArchitect](https://github.com/justinamiller/SoftwareArchitect/blob/master/README.md) [Jump to heading](#justinamillersoftwarearchitect)

#### ソフトウェアアーキテクトという職業 [Jump to heading](#ソフトウェアアーキテクトという職業)
...
## [Technical documentation for everyone](https://hugogiraudel.com/2020/01/23/technical-documentation-for-everyone/) [Jump to heading](#technical-documentation-for-everyone)

#### 技術ドキュメントのベストプラクティス [Jump to heading](#技術ドキュメントのベストプラクティス)
...
## [Web standards, dictionaries, and design systems](https://adactio.com/journal/16342) [Jump to heading](#web-standards-dictionaries-and-design-systems)
...
## [Getting Started with Front End Testing — JavaScript January](https://www.javascriptjanuary.com/blog/getting-started-with-front-end-testing) [Jump to heading](#getting-started-with-front-end-testing-javascript-january)
