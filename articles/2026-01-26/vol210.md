---
title: "Vol.210"
source: "https://frontendweekly.tokyo/posts/210/"
publishedDate: "2019-03-06"
category: "frontend"
feedName: "Frontend Weekly Tokyo"
---

Kota Furusawa 6th March 2019

## [Design Systems Architecture Diagrams by Nathan Curtis](https://medium.com/eightshapes-llc/design-systems-architecture-diagrams-3fc13ec979e3) [Jump to heading](#design-systems-architecture-diagrams-by-nathan-curtis)

#### デザインシステムアーキテクチャダイアグラム [Jump to heading](#デザインシステムアーキテクチャダイアグラム)
...
## [Bandwidth or Latency: When to Optimise for Which by Harry Roberts](https://csswizardry.com/2019/01/bandwidth-or-latency-when-to-optimise-which/) [Jump to heading](#bandwidth-or-latency-when-to-optimise-for-which-by-harry-roberts)

#### 帯域幅と応答速度: いつどちらを最適化するか [Jump to heading](#帯域幅と応答速度-いつどちらを最適化するか)
...
## [Diving Deeper in JavaScripts Objects by Arfat Salman](https://blog.bitsrc.io/diving-deeper-in-javascripts-objects-318b1e13dc12) [Jump to heading](#diving-deeper-in-javascripts-objects-by-arfat-salman)

#### JavaScriptオブジェクトを深く理解する [Jump to heading](#javascriptオブジェクトを深く理解する)
...
## [Exploring a back/forward cache for Chrome by Addy Osmani](https://addyosmani.com/blog/back-forward-cache/) [Jump to heading](#exploring-a-backforward-cache-for-chrome-by-addy-osmani)
...
## [Paint the Picture, Not the Frame: How Browsers Provide Everything Users Need by Eric Bailey](https://alistapart.com/article/paint-the-picture-not-the-frame) [Jump to heading](#paint-the-picture-not-the-frame-how-browsers-provide-everything-users-need-by-eric-bailey)
