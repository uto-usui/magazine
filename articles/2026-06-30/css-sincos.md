...
source: "https://ics.media/entry/230126/?utm_source=atom&utm_medium=referral&utm_campaign=feed"
...
-   [WebGPU・WebGL開発に役立つ三角関数の数式・概念まとめ （Three.js編）](https://ics.media/entry/10657/)
-   [CreateJS で三角関数を活用しよう](https://ics.media/tutorial-createjs/math_basic/)

フローティングアクションボタンの配置に三角関数を活用したUI例は、記事「[CSSのlinear()でUIが軽快になる! スプリングアニメーション活用術](https://ics.media/entry/260402/)」でも確認できます。