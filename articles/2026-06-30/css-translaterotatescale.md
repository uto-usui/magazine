...
source: "https://ics.media/entry/230309/?utm_source=atom&utm_medium=referral&utm_campaign=feed"
...
独立した各プロパティについて簡単に説明します。独立したプロパティはChrome・Edge 104（2022年）、Safari 14.1（2021年）、Safari for iOS 14.8（2021年）、Firefox 72（2020年）以降のブラウザで利用できます。
