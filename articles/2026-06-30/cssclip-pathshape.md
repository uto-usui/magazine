...
source: "https://ics.media/entry/250703/?utm_source=atom&utm_medium=referral&utm_campaign=feed"
...
`shape()`関数はChrome・Edge 135（2025年4月）、Safari 18.4（2025年3月）、FirefoxではNightlyビルドでのみ利用可能です。

参照：[“shape()” | Can I use…](https://caniuse.com/?search=shape\(\))
