...
source: "https://ics.media/entry/18730/?utm_source=atom&utm_medium=referral&utm_campaign=feed"
...
ICS MEDIAではこの他にもアニメーションについて、記事「[あえてズレを！ ウェブのアニメーションを「いい感じ」に魅せる手法](https://ics.media/entry/14346/)」や「[CSSだけで表現！ コピペで使えるマイクロインタラクション作りました](https://ics.media/entry/15130/)」にまとめているのでご参考ください。

`linear()`関数を使ったスプリングアニメーションの実践例は、記事「[CSSのlinear()でUIが軽快になる! スプリングアニメーション活用術](https://ics.media/entry/260402/)」で紹介しています。UIでの使いどころを見たい方は、あわせてご覧ください。
...
※この記事が公開されたのは**7年前**ですが、**9か月前の2025年9月**に内容をメンテナンスしています。