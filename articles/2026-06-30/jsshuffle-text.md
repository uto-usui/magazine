...
source: "https://ics.media/entry/15498/?utm_source=atom&utm_medium=referral&utm_campaign=feed"
...
-   [デモを別ウインドウで開く](https://ics-ikeda.github.io/shuffle-text/examples/plain/)
-   [ソースコードを確認する](https://github.com/ics-ikeda/shuffle-text/blob/main/examples/plain/index.html)

スクランブルする文字列に「░▒▓█」「⠁⠃⠇⡇⣇⣧⣿」などを指定すると、モザイク風の演出にもなります（[Anime.jsの作例](https://codepen.io/juliangarnier/pen/vEyYdXN)にインスパイアを受けました）。

-   [デモを別ウインドウで開く](https://ics-ikeda.github.io/shuffle-text/examples/block/)
-   [ソースコードを確認する](https://github.com/ics-ikeda/shuffle-text/blob/main/examples/block/index.html)
...
[![](https://ics.media/entry/15498/images/170518_showcase_clockmaker.jpg)](https://labs.clockmaker.jp/)
