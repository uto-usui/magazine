...
source: "https://ics.media/entry/240902/?utm_source=atom&utm_medium=referral&utm_campaign=feed"
...
```
const container = container.querySelectorAll(".container");
...
汎用的なJavaScriptライブラリとして以下があります。

-   Anime.jsの[Layout機能](https://animejs.com/documentation/layout/)
-   GSAPの[『FLIPプラグイン』](https://gsap.com/docs/v3/Plugins/Flip/)

▼Anime.jsのLayout機能を使ったデモ

-   [サンプルを別ウインドウで開く](https://ics-creative.github.io/260123_flip_layout/animejs.html)
-   [ソースコードを確認する](https://github.com/ics-creative/260123_flip_layout/tree/main/animejs.html)

▼GSAPのFLIPプラグインを使ったデモ
...
また、JSライブラリには以下のような機能があります。

-   React向けのFLIPアニメーションライブラリ
    -   [react-flip-toolkit](https://github.com/aholachek/react-flip-toolkit)
-   Vue.jsやSvelteはFLIPアニメーションの仕組みが標準で組み込まれています。
...
View Transitions APIはFLIPではないですが、ウェブの新しい仕組みとして類似のことができます。
...
※この記事が公開されたのは**1年前**ですが、**5か月前の1月**に内容をメンテナンスしています。