...
source: "https://www.smashingmagazine.com/2026/03/human-strategy-ai-accelerated-workflow/"
...
-   10 min read
-   [Workflow](https://www.smashingmagazine.com/category/workflow), [AI](https://www.smashingmagazine.com/category/ai), [UX](https://www.smashingmagazine.com/category/ux)
...
When generative AI tools first entered my workflow, my reaction wasn’t excitement — it was **unease**, with a little bit of **curiosity**. Watching an interface appear in seconds, complete with sensible spacing, readable typography, and halfway-decent copy, triggered a very real fear: _If a machine can do this, where does that leave me?_

That fear is now widespread. Designers at every level ask the same question, often quietly, _“Will an AI agent replace me by next week/month/year?”_ While the difference between next week and next year seems a lot, it depends on where you are in your career and the speed at which your employer chooses to engage with AI tools. I have been lucky in several roles to be working with organisations that haven’t allowed the use of AI tools due to data security concerns. If you’re interested in any of these conversations, you can view the discussions happening on platforms like [Reddit](https://www.reddit.com/r/UXDesign/comments/1oqs2k8/in_reality_how_bad_is_the_ai_replacement/).
...
Still, UX design has _never_ truly been about just creating a user interface.
...
Let’s be clear, AI _is_ better than humans at certain aspects of design work. Fighting that reality only keeps us stuck in fear.
...
[McKinsey estimates](https://www.mckinsey.com/capabilities/tech-and-ai/our-insights/the-economic-potential-of-generative-ai-the-next-productivity-frontier) that generative AI can reduce the time spent on creative and design-related tasks by up to **70%**, particularly during ideation and exploration phases.

[![McKinseys report on generative AI.](https://res.cloudinary.com/indysigner/image/fetch/f_auto,q_80/w_400/https://files.smashing.media/articles/human-strategy-ai-accelerated-workflow/1-mckinseys-report-generative-ai.png)](https://www.mckinsey.com/capabilities/tech-and-ai/our-insights/the-economic-potential-of-generative-ai-the-next-productivity-frontier#/)

McKinseys report on generative AI. (Image source: [McKinsey](https://www.mckinsey.com/capabilities/tech-and-ai/our-insights/the-economic-potential-of-generative-ai-the-next-productivity-frontier#/)) ([Large preview](https://files.smashing.media/articles/human-strategy-ai-accelerated-workflow/1-mckinseys-report-generative-ai.png))

AI can also help with the research side of UX, for example, exploring the habits of a certain demographic, and [**creating personas**](https://persona.qcri.org/blog/what-is-an-ai-generated-persona/). While this can reduce research time required, the designer is still required to guardrail this by providing accurate prompts and [**reviewing generated responses**](https://uxpsychology.substack.com/p/the-problem-with-ai-generated-personas). I have personally found that using AI to assist with the initial research for design projects is incredibly useful, specifically when there is limited time and access to users.
...
Behavioural analytics platforms increasingly rely on AI to surface insights that designers might otherwise miss. [Contentsquare](https://contentsquare.com/guides/behavior-analytics/), an AI-powered analytics platform, talks about the impacts and benefits of utilising behavioural analytics data. I’ve always said that quantitative data tells us the “what”, and qualitative data tells us the “why”. This is the human component of research where we get to connect with the users to understand the reason driving the behaviour.

[![An example of a session replay tool display](https://res.cloudinary.com/indysigner/image/fetch/f_auto,q_80/w_400/https://files.smashing.media/articles/human-strategy-ai-accelerated-workflow/2-session-replay-tool-display.png)](https://files.smashing.media/articles/human-strategy-ai-accelerated-workflow/2-session-replay-tool-display.png)

An example of a session replay tool display. (Image Source: [Contentsquare](https://contentsquare.com/guides/behavior-analytics/)) ([Large preview](https://files.smashing.media/articles/human-strategy-ai-accelerated-workflow/2-session-replay-tool-display.png))
...
AI can describe frustration. It can summarise user feedback. It can mimic empathetic language. But it has never _felt_ the quiet rage of a broken form, the anxiety of submitting sensitive data, or the shame of not understanding an interface that assumes too much.
...
As the [Nielsen Norman Group](https://www.nngroup.com/articles/definition-user-experience/) reminds us, good UX design is not about interfaces. It’s about **communication** and **understanding**.
...
[The Center for Humane Technology](https://www.humanetech.com/the-cht-perspective) has documented how algorithmic optimisation can unintentionally undermine wellbeing.

Ethical UX design requires designers who can say, _“We could do this, but we shouldn’t.”_

[![Ethical design pyramide](https://res.cloudinary.com/indysigner/image/fetch/f_auto,q_80/w_400/https://files.smashing.media/articles/human-strategy-ai-accelerated-workflow/3-ethical-design-choices.png)](https://files.smashing.media/articles/human-strategy-ai-accelerated-workflow/3-ethical-design-choices.png)

Ethical design choices require human review. (Image source: [Medium](https://uxdesign.cc/considerations-and-responsibilities-for-ethical-designers-829450fcb972)) ([Large preview](https://files.smashing.media/articles/human-strategy-ai-accelerated-workflow/3-ethical-design-choices.png))
...
[![Four design screens complete with user flow mapping](https://res.cloudinary.com/indysigner/image/fetch/f_auto,q_80/w_400/https://files.smashing.media/articles/human-strategy-ai-accelerated-workflow/4-design-screens.png)](https://files.smashing.media/articles/human-strategy-ai-accelerated-workflow/4-design-screens.png)

Four design screens created by Uizard Autodesigner, complete with user flow mapping. (Image source: [Uizard.io](https://uizard.io/blog/5-ai-generated-ui-designs/#5-ai-generated-ui-design-examples)) ([Large preview](https://files.smashing.media/articles/human-strategy-ai-accelerated-workflow/4-design-screens.png))
...
-   _Who is this actually for?_
-   _What problem are we solving, and for whom?_
-   _What happens when this fails?_
-   _Who might this unintentionally exclude or disadvantage?_
...
> [AI accelerates production, but it does not remove the designer’s responsibility. In fact, it increases it. When options are cheap and plentiful, discernment becomes a scarce skill.](https://twitter.com/share?text=%0aAI%20accelerates%20production,%20but%20it%20does%20not%20remove%20the%20designer%e2%80%99s%20responsibility.%20In%20fact,%20it%20increases%20it.%20When%20options%20are%20cheap%20and%20plentiful,%20discernment%20becomes%20a%20scarce%20skill.%0a&url=https://smashingmagazine.com%2f2026%2f03%2fhuman-strategy-ai-accelerated-workflow%2f)
> 
> “
...
-   Explore [**Figma’s AI features**](https://www.figma.com/ai/).
