---
title: "次世代 CSS 仕様が与えるコンポーネント時代の Web への影響"
source: "https://blog.jxck.io/entries/2023-01-07/new-css-capabilities-for-component.html"
...
-   CSS Cascading and Inheritance Level 6
    -   [https://drafts.csswg.org/css-cascade-6/#scoped-styles](https://drafts.csswg.org/css-cascade-6/#scoped-styles)
-   @scope - Chrome Platform Status
    -   [https://chromestatus.com/feature/5100672734199808](https://chromestatus.com/feature/5100672734199808)
...
-   Chrome: Intent to Prototype: @scope
    -   [https://groups.google.com/a/chromium.org/g/blink-dev/c/O2xZZT\_xCZM](https://groups.google.com/a/chromium.org/g/blink-dev/c/O2xZZT_xCZM)
-   Firefox: @scope · Issue #625 · mozilla/standards-positions
    -   [https://github.com/mozilla/standards-positions/issues/625](https://github.com/mozilla/standards-positions/issues/625)
-   Safari: CSS Cascading and Inheritance Level 6 (@scope) · Issue #13 · WebKit/standards-positions
    -   [https://github.com/WebKit/standards-positions/issues/13](https://github.com/WebKit/standards-positions/issues/13)
-   CSS Scoping Solutions Brainstorming - Google Document
    -   [https://docs.google.com/document/d/1hhjmuQE6BTTnAyKP3spDr8sU6lpXArh8LDfihZh78hw/edit](https://docs.google.com/document/d/1hhjmuQE6BTTnAyKP3spDr8sU6lpXArh8LDfihZh78hw/edit)
...
-   CSS Cascading and Inheritance Level 5
    -   [https://w3c.github.io/csswg-drafts/css-cascade-5/#layering](https://w3c.github.io/csswg-drafts/css-cascade-5/#layering)
-   CSS cascade layers - Chrome Platform Status
    -   [https://chromestatus.com/feature/5663362835808256](https://chromestatus.com/feature/5663362835808256)
...
-   CSS Nesting - Chrome Platform Status
    -   [https://chromestatus.com/feature/5800613594529792](https://chromestatus.com/feature/5800613594529792)
...
-   CSS Selectors 4 Pseudo-Classes :is(), :where() - Chrome Platform Status
    -   [https://chromestatus.com/feature/5445716612743168](https://chromestatus.com/feature/5445716612743168)
-   `:is()` Design Doc - Google Document
    -   [https://docs.google.com/document/d/1ZUNf4eXIABKYtOb2IWdzkHqMSC9GWgX5740McqQ5ur0/edit](https://docs.google.com/document/d/1ZUNf4eXIABKYtOb2IWdzkHqMSC9GWgX5740McqQ5ur0/edit)

## [コンポーネントにおけるカスケード](#コンポーネントにおけるカスケード)
...
-   Why we don't have a parent selector - Snook.ca
    -   [https://snook.ca/archives/html\_and\_css/css-parent-selectors](https://snook.ca/archives/html_and_css/css-parent-selectors)
...
-   Can I :has()
    -   [https://bkardell.com/blog/canihas.html](https://bkardell.com/blog/canihas.html)
...
-   `:has()` pseudo class - Chrome Platform Status
    -   [https://chromestatus.com/feature/5794378545102848](https://chromestatus.com/feature/5794378545102848)
-   Why we don't have a parent selector - Snook.ca
    -   [https://snook.ca/archives/html\_and\_css/css-parent-selectors](https://snook.ca/archives/html_and_css/css-parent-selectors)
-   Can I `:has()`
    -   [https://bkardell.com/blog/canihas.html](https://bkardell.com/blog/canihas.html)
...
-   Creating Animated, Clickable Cards With the `:has()` Relational Pseudo Class | CSS-Tricks - CSS-Tricks
    -   [https://css-tricks.com/creating-animated-clickable-cards-with-the-has-relational-pseudo-class/](https://css-tricks.com/creating-animated-clickable-cards-with-the-has-relational-pseudo-class/)
...
-   Container Queries - Chrome Platform Status
    -   [https://chromestatus.com/feature/6525308435955712](https://chromestatus.com/feature/6525308435955712)
...
-   CSS Containment Module Level 3
    -   [https://drafts.csswg.org/css-contain-3/#style-container](https://drafts.csswg.org/css-contain-3/#style-container)
-   Intent to Ship: Style Container Queries for CSS Custom Properties
    -   [https://groups.google.com/a/chromium.org/g/blink-dev/c/ACL23q\_nbK0/m/PaNJ81\_qDAAJ](https://groups.google.com/a/chromium.org/g/blink-dev/c/ACL23q_nbK0/m/PaNJ81_qDAAJ)
-   Container Style Query Explainer
    -   [https://css.oddbird.net/rwd/style/explainer/](https://css.oddbird.net/rwd/style/explainer/)
-   \[css-contain-3\] Move style queries of standard properties to level 4 · Issue #7185 · w3c/csswg-drafts
    -   [https://github.com/w3c/csswg-drafts/issues/7185](https://github.com/w3c/csswg-drafts/issues/7185)
