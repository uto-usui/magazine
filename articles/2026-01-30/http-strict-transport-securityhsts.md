...
source: "https://blog.jxck.io/entries/2016-04-11/strict-transport-security.html"
...
## [Strict-Transport-Security ヘッダ](#strict-transport-security-ヘッダ)
...
この性質は [HPKP](https://blog.jxck.io/entries/2016-04-09/public-key-pinning.html) 同様 _TOFU_ (Trust of First Use) と呼ばれる。
...
結果として、本ドメインでは _`includeSubDomains` の指定はせず_、ドメインごとに個別に指定することとした。

また、Chrome の Preload 登録の条件には、`includeSubDomains` の適用が含まれている。

したがって同様の理由から、止むを得ず _preload 登録は見送る_ こととした。
