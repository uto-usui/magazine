...
source: "https://jakearchibald.com/2024/garbage-collection-and-closures/"
...
## [JavaScript engines are reasonably smart](#javascript-engines-are-reasonably-smart)
...
### [An IIFE is enough to trigger the leak](#an-iife-is-enough-to-trigger-the-leak)
...
### [It's a cross-browser issue](#its-a-cross-browser-issue)
...
### [I'm not the first to write about this](#im-not-the-first-to-write-about-this)
...
### [And no, this is not due to `eval()`](#and-no-this-is-not-due-to-eval)
