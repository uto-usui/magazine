---
title: "Cookie Theft 対策と Device Bound Session Credentials"
source: "https://blog.jxck.io/entries/2025-01-16/device-bound-session-credentials.html"
...
## [Cookie Theft によるインシデント](#cookie-theft-によるインシデント)
...
-   北朝鮮を背景とするサイバー攻撃グループ TraderTraitor による暗号資産関連事業者を標的としたサイバー攻撃について - 令和 6 年 12 月 24 日 警察庁
    -   [https://www.npa.go.jp/bureau/cyber/pdf/020241224\_pa.pdf](https://www.npa.go.jp/bureau/cyber/pdf/020241224_pa.pdf)
...
-   add application bound encryption primitives for chrome \[40227925\] - Chromium
    -   [https://issues.chromium.org/issues/40227925](https://issues.chromium.org/issues/40227925)
...
### [Cookie Theft 対策](#cookie-theft-対策)
...
-   Catching Compromised Cookies - Engineering at Slack
    -   [https://slack.engineering/catching-compromised-cookies/](https://slack.engineering/catching-compromised-cookies/)

## [Cookie をどう守るか](#cookie-をどう守るか)
...
-   session-lock - Home
    -   [https://session-lock.keyri.com/](https://session-lock.keyri.com/)
...
-   RFC 8473 - Token Binding over HTTP
    -   [https://datatracker.ietf.org/doc/html/rfc8473](https://datatracker.ietf.org/doc/html/rfc8473)
...
### [Demonstrating Proof-of-Possession in the Browser Application (BPoP)](#demonstrating-proof-of-possession-in-the-browser-application-bpop)
...
-   MSEdgeExplainers/BindingContext/explainer.md at main · MicrosoftEdge/MSEdgeExplainers
    -   [https://github.com/MicrosoftEdge/MSEdgeExplainers/blob/main/BindingContext/explainer.md](https://github.com/MicrosoftEdge/MSEdgeExplainers/blob/main/BindingContext/explainer.md)
...
-   DBSC (Device Bound Session Credentials) · Issue #106 · WICG/proposals
    -   [https://github.com/WICG/proposals/issues/106#issuecomment-1624111068](https://github.com/WICG/proposals/issues/106#issuecomment-1624111068)
-   Device Bound Session Credentials · Issue #912 · mozilla/standards-positions
    -   [https://github.com/mozilla/standards-positions/issues/912#issuecomment-2420716960](https://github.com/mozilla/standards-positions/issues/912#issuecomment-2420716960)
...
-   WICG/dbsc
    -   [https://github.com/WICG/dbsc](https://github.com/WICG/dbsc)
...
そこで、セッションの維持自体は従来通り Cookie を用いて行う。しかし、Cookie を短命にしておき、それが切れる前に公開鍵による認証を行うことで、Cookie を再発行するのだ。
  ...
  ![DBSC の Flow](https://blog.jxck.io/entries/2025-01-16/flow.png?250517_153220)
...
-   Testing early versions of DBSC · w3c/webappsec-dbsc Wiki
    -   [https://github.com/w3c/webappsec-dbsc/wiki/Testing-early-versions-of-DBSC](https://github.com/w3c/webappsec-dbsc/wiki/Testing-early-versions-of-DBSC)
...
-   DBSC prototype
    -   [https://dbsc-prototype-server.glitch.me/](https://dbsc-prototype-server.glitch.me/)
...
-   Appropriate Prefix for Server initiated header field (`Secure-` ?)
    -   [https://github.com/w3c/webappsec-dbsc/issues/186](https://github.com/w3c/webappsec-dbsc/issues/186)

### [Sec-Session-Registration](#sec-session-registration)
...
### [Sec-Session-Response](#sec-session-response)
...
### [Device Bound Session Credentials for Enterprise](#device-bound-session-credentials-for-enterprise)

この仕組みを拡張し、Enterprise 領域で発生する様々な要求をカバーできる可能性にも言及されている。

-   Device Bound Session Credentials for Enterprise - explainer
    -   [https://github.com/drubery/dbsc/blob/main/DBSCE/Overview.md](https://github.com/drubery/dbsc/blob/main/DBSCE/Overview.md)
...
-   [https://labs.jxck.io/device-bound-session-credentials/index.html](https://labs.jxck.io/device-bound-session-credentials/index.html)

ソースコードは以下なので、こちらを参考にしてほしい。

-   [https://github.com/Jxck/jxck.io/blob/main/labs.jxck.io/device-bound-session-credentials/session.cgi](https://github.com/Jxck/jxck.io/blob/main/labs.jxck.io/device-bound-session-credentials/session.cgi)
...
-   Mozilla Standard Position
    -   Device Bound Session Credentials · Issue #912 · mozilla/standards-positions
        -   [https://github.com/mozilla/standards-positions/issues/912](https://github.com/mozilla/standards-positions/issues/912)
-   Webkit Position
    -   Device Bound Session Credentials · Issue #281 · WebKit/standards-positions
        -   [https://github.com/WebKit/standards-positions/issues/281](https://github.com/WebKit/standards-positions/issues/281)
...
-   Intents
    -   Intent to Prototype: Device Bound Session Credentials (DBSC)
        -   [https://groups.google.com/a/chromium.org/g/blink-dev/c/xvZJPpXNS8Y/m/Z1gU6U-UAAAJ](https://groups.google.com/a/chromium.org/g/blink-dev/c/xvZJPpXNS8Y/m/Z1gU6U-UAAAJ)
-   Chrome Platform Status
    -   Device Bound Session Credentials - Chrome Platform Status
        -   [https://chromestatus.com/feature/5140168270413824](https://chromestatus.com/feature/5140168270413824)
...
-   Blog
    ...
    -   Origin trial: Device Bound Session Credentials in Chrome
        -   [https://developer.chrome.com/blog/dbsc-origin-trial](https://developer.chrome.com/blog/dbsc-origin-trial)
-   Presentation
-   Issues
    -   DBSC (Device Bound Session Credentials) · Issue #106 · WICG/proposals
        -   [https://github.com/WICG/proposals/issues/106](https://github.com/WICG/proposals/issues/106)
    -   Create DBSC in network service \[41495201\] - Chromium
        -   [https://issues.chromium.org/issues/41495201](https://issues.chromium.org/issues/41495201)
-   Other
    -   MSEdgeExplainers/BindingContext/explainer.md at main · MicrosoftEdge/MSEdgeExplainers
        -   [https://github.com/MicrosoftEdge/MSEdgeExplainers/blob/main/BindingContext/explainer.md](https://github.com/MicrosoftEdge/MSEdgeExplainers/blob/main/BindingContext/explainer.md)
    -   DBSC public drive - Google ドライブ
        -   [https://drive.google.com/drive/folders/1xL5GnXS6XtBlf96UROkW4gAbvsInB-Fd](https://drive.google.com/drive/folders/1xL5GnXS6XtBlf96UROkW4gAbvsInB-Fd)
    -   DBSC prototype
        -   [https://dbsc-prototype-server.glitch.me/](https://dbsc-prototype-server.glitch.me/)
        -   [https://glitch.com/edit/#!/dbsc-prototype-server](https://glitch.com/edit/#!/dbsc-prototype-server)