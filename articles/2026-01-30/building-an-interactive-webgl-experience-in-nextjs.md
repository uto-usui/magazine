...
source: "https://vercel.com/blog/building-an-interactive-webgl-experience-in-next-js"
...
1.  [Put together a prototype](#1.-put-together-a-prototype)
    
2.  [Enhance the visuals](#2.-enhance-the-visuals)
    
3.  [Optimize performance](#3.-optimize-performance)
    

## [Link to heading](#the-big-idea)The big idea
...
![10 permutations of an image generated by DALL-E. The original image also came from DALL-E.](https://vercel.com/vc-ap-vercel-marketing/_next/image?url=https%3A%2F%2Fassets.vercel.com%2Fimage%2Fupload%2Fcontentful%2Fimage%2Fe5382hct74si%2F3vHIH3olq35Jzlc4OfXeUB%2Faa82fd57710d38651629b0bfbfe9a32b%2FDall-E.png&w=1920&q=75)![10 permutations of an image generated by DALL-E. The original image also came from DALL-E.](https://vercel.com/vc-ap-vercel-marketing/_next/image?url=https%3A%2F%2Fassets.vercel.com%2Fimage%2Fupload%2Fcontentful%2Fimage%2Fe5382hct74si%2F3vHIH3olq35Jzlc4OfXeUB%2Faa82fd57710d38651629b0bfbfe9a32b%2FDall-E.png&w=1920&q=75)

10 permutations of an image generated by DALL-E. The original image also came from DALL-E.
...
![A mood board depicting many of the concepts that led to the creation of the Next.js Conf registration page. Prisms, beams of light, and rainbows create vivid, eye-catching visual elements.¹](https://vercel.com/vc-ap-vercel-marketing/_next/image?url=https%3A%2F%2Fassets.vercel.com%2Fimage%2Fupload%2Fcontentful%2Fimage%2Fe5382hct74si%2F1Rw1xOYvWXI9LKJGJCljqp%2F421114bc3193b46a67b8382ebbef4c33%2FMood-Board.png&w=1920&q=75)![A mood board depicting many of the concepts that led to the creation of the Next.js Conf registration page. Prisms, beams of light, and rainbows create vivid, eye-catching visual elements.¹](https://vercel.com/vc-ap-vercel-marketing/_next/image?url=https%3A%2F%2Fassets.vercel.com%2Fimage%2Fupload%2Fcontentful%2Fimage%2Fe5382hct74si%2F1Rw1xOYvWXI9LKJGJCljqp%2F421114bc3193b46a67b8382ebbef4c33%2FMood-Board.png&w=1920&q=75)
...
## [Link to heading](#1.-put-together-a-prototype)1\. Put together a prototype
...
### [Link to heading](#getting-familiar-with-react-three-fiber)Getting familiar with `react-three-fiber`
...
### [Link to heading](#proving-the-concept)Proving the concept
...
### [Link to heading](#creating-a-rainbow)Creating a rainbow
...
## [Link to heading](#2.-enhance-the-visuals)2\. Enhance the visuals
...
-   [Bloom](#bloom): Give bright areas a glowing effect
    
-   [Color Lookup Table](#color-lookup-table): Achieve a desired color range
    
-   [Screen Space Reflections](#screen-space-reflections): Create reflections of existing graphical data
    

### [Link to heading](#bloom)Bloom
...
### [Link to heading](#color-lookup-tables)Color Lookup Tables
...
### [Link to heading](#screen-space-reflections)Screen Space Reflections
...
![A screenshot of the Next.js 2022 registration page. The prism is illuminated by the white, glowing blocks that redirect the light source because they are placed quite close to it.](https://vercel.com/vc-ap-vercel-marketing/_next/image?url=https%3A%2F%2Fassets.vercel.com%2Fimage%2Fupload%2Fcontentful%2Fimage%2Fe5382hct74si%2F73688psEynP7W7sLtDtQSY%2Feae811449c6d81a768362df68386356d%2FCleanShot_2022-10-06_at_12.29.57_2x.png&w=1920&q=75)![A screenshot of the Next.js 2022 registration page. The prism is illuminated by the white, glowing blocks that redirect the light source because they are placed quite close to it.](https://vercel.com/vc-ap-vercel-marketing/_next/image?url=https%3A%2F%2Fassets.vercel.com%2Fimage%2Fupload%2Fcontentful%2Fimage%2Fe5382hct74si%2F73688psEynP7W7sLtDtQSY%2Feae811449c6d81a768362df68386356d%2FCleanShot_2022-10-06_at_12.29.57_2x.png&w=1920&q=75)
...
### [Link to heading](#all-together-now)All together now
...
## [Link to heading](#3.-optimize-performance)3\. Optimize performance
...
### [Link to heading](#building-a-new-performance-monitor)Building a new performance monitor
...
```
import { PerformanceMonitor, usePerformanceMonitor } from '@react-three/drei'import { EffectComposer } from '@react-three/postprocessing'// The postprocessing effects that will be used for your render.function Effects() {  // A switch that turns effects on and off.  const [hasEffects, setHasEffects] = useState(true)  // A callback destructuring for the onChange parameter.  // `factor` is the current quality scale between 0 and 1.  usePerformanceMonitor({ onChange: ({ factor }) => {    // If effects are currently enabled and     // the factor is higher than average...    if (hasEffects && factor > 0.5) {      // ...decrease quality.      effect.qualityScale = round(0.5 + 0.5 * factor, 1)    }     // Handle other conditions    // when PerformanceMonitor says    // to decline or incline  }})  return (    <EffectComposer>      { /** Your effects */ }    </EffectComposer>  )}function App() {  // Starting out with the highest resolution,   // reduce the resolution if the framerate is too low.  const [dpr, setDpr] = useState(2)  return (    <Canvas dpr={dpr}>      <PerformanceMonitor         onDecline={() => setDpr(1.5)}        onIncline={() => setDpr(2)}      >        <Scene />        <Effects />      </PerformanceMonitor />    </Canvas>  )}
```

## [Link to heading](#see-it-live)See it live
