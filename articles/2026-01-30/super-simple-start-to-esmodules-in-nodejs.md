...
source: "https://kentcdodds.com/blog/super-simple-start-to-es-modules-in-node-js"
publishedDate: "2021-04-04"
category: "frontend"
feedName: "Kent C. Dodds"
---

On April 30th 2021, Node v10 will officially reach it's "end of life" (learn more on the [Node Releases](https://nodejs.org/en/about/releases/) page). This is exciting because it means that every supported version of the Node.js JavaScript runtime will support Node's official EcmaScript Modules! There are mixed feelings on this change (some would have preferred we stick with CommonJS in the Node ecosystem), but whatever your opinion on the matter the fact is that ESModules are here and they are the future. So let's learn how to use them in a Node.js environment.

Note: You might be interested in my companion post [Super Simple Start to ESModules in the Browser](https://kentcdodds.com/blog/super-simple-start-to-es-modules-in-the-browser)
...
There's plenty more to talk about here but this should get you started. You may be interested in reading [the official initial announcement of ESM support](https://nodejs.medium.com/announcing-core-node-js-support-for-ecmascript-modules-c5d6dc29b663). Good luck!