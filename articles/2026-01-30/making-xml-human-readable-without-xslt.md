...
source: "https://jakearchibald.com/2025/making-xml-human-readable-without-xslt/"
...
## [XSLT and browser support](#xslt-and-browser-support)
...
If you [visit that document](https://jakearchibald.com/demos/xml-transformation/via-xslt/index.xml), you'll (for now, at least), see a grid of books, with formatting and images, and that's all down to:
...
Which is what I've done with [my RSS feed](https://jakearchibald.com/posts.rss).

For anything more complex, you need to do some kind of transformation of the source data.

## [Wait, do you really want to do this client-side?](#wait-do-you-really-want-to-do-this-client-side)
...
## [Transforming XML client-side without XSLT](#transforming-xml-client-side-without-xslt)
...
[Here's a demo](https://jakearchibald.com/demos/xml-transformation/via-js/index.xml) that produces the same result as the XSLT demo, but this time using JS. Here's how it works…
...
### [Ensure you're creating _HTML_ elements](#ensure-youre-creating-_html_-elements)
...
Here's [the full working demo](https://jakearchibald.com/demos/xml-transformation/via-js/index.xml), and [the source](https://github.com/jakearchibald/jakearchibald.com/tree/main/root-static/demos/xml-transformation/via-js). And that's it! Wow you made it to the end. Huh. I didn't think anyone would.