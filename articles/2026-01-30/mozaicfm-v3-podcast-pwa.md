---
title: "mozaic.fm v3 リリースと Podcast の PWA 化"
source: "https://blog.jxck.io/entries/2020-05-06/mozaic-v3-release.html"
...
## [Podcast over Web](#podcast-over-web)
...
### [Periodic Background Sync(PBS)](#periodic-background-syncpbs)
...
### [before install prompt](#before-install-prompt)
...
### [Pure WebComponents](#pure-webcomponents)
...
### [Scroll To Text Fragment Search](#scroll-to-text-fragment-search)
