---
title: "How the at-home workout sensation, Hydrow, cut authoring times from weeks to minutes"
source: "https://vercel.com/blog/hydrow"
...
## [Link to heading](#the-problem:-limited-content-agility)The problem: Limited content agility
...
### [Link to heading](#team-members-needed-their-independence)Team members needed their independence
...
### [Link to heading](#the-company-needed-to-keep-its-customers)The company needed to keep its customers

In ecommerce, ​improving the speed of implementation by refactoring a tech stack can be double edged sword. Hydrow aspired to swiftness, but having worked diligently to achieve their ecommerce standing, they also recognized the stakes. Any system overhaul couldn't jeopardize what they'd built.
...
### [Link to heading](#hydrow-wanted-to-move-quickly-and-in-sync)Hydrow wanted to move quickly and in sync
...
## [Link to heading](#the-solution:-moving-to-a-headless-architecture)The solution: moving to a headless architecture
...
> 
> ![](https://assets.vercel.com/image/upload/contentful/image/e5382hct74si/6uYL9XmXJ1YYI5O1ppprK3/929b4ca8326a05455059f38a09c44195/image.png)
> 
> **Robin Rogowski,** Senior Lead Software Engineer

### [Link to heading](#contentful-as-the-headless-cms)**Contentful as the headless CMS**
...
### [Link to heading](#vercel's-managed-infrastructure)Vercel's managed infrastructure
...
### [Link to heading](#next.js-and-isr-for-better-dynamic-content)Next.js and ISR for better dynamic content
...
> 
> ![](https://assets.vercel.com/image/upload/contentful/image/e5382hct74si/2i1ayQYyMYYyB4HTvJmGIY/8c11a38683512ec04ca61da194fd8348/image.png)
> 
...
### [Link to heading](#preview-environments-for-authors'-workflows)Preview Environments for authors' workflows
...
### [Link to heading](#edge-middleware-for-a-personalized-experience-)**Edge Middleware for a personalized experience**
...
## [Link to heading](#the-wins:-a-complete-transformation--)The wins: A complete transformation
...
## [Link to heading](#the-future-is-bright)The future is bright
