...
source: "https://kentcdodds.com/blog/test-isolation-with-react"
...
![a rendered version of the component](https://res.cloudinary.com/kentcdodds-com/image/upload/f_auto,q_auto,w_1600/v1625033400/kentcdodds.com/content/blog/test-isolation-with-react/0.gif)

### [Our first test suite](#our-first-test-suite)
...
First of all, as of [@testing-library/react@9.0.0](https://github.com/testing-library/react-testing-library/releases/tag/v9.0.0) this style of testing won't even work properly, but let's imagine that it would.
...
![broken tests](https://res.cloudinary.com/kentcdodds-com/image/upload/f_auto,q_auto,dpr_2.0,w_1600/v1625033400/kentcdodds.com/content/blog/test-isolation-with-react/1.png)
...
So I'm actually still not super happy with the tests we have above. I'm not a huge fan of `beforeEach` and sharing variables between tests. [I feel like they lead to tests that are harder to understand](https://kentcdodds.com/blog/avoid-nesting-when-youre-testing). Let's try again:
...
### [Even better better](#even-better-better)
...
![broken tests](https://res.cloudinary.com/kentcdodds-com/image/upload/f_auto,q_auto,dpr_2.0,w_1600/v1625033400/kentcdodds.com/content/blog/test-isolation-with-react/2.png)
...
I hope this is helpful to you! You can find the code for this example [here](https://github.com/kentcdodds/react-test-isolation). Try to keep your tests isolated from one another and focus on use cases rather than functionality and you'll have a much better time testing! Good luck!