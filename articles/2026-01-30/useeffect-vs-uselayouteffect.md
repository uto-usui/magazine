...
source: "https://kentcdodds.com/blog/useeffect-vs-uselayouteffect"
publishedDate: "2020-12-02"
category: "frontend"
feedName: "Kent C. Dodds"
---

Both of these can be used to do basically the same thing, but they have slightly different use cases. So here are some rules for you to consider when deciding which [React Hook](https://reactjs.org/hooks) to use.
...
## [One special case](#one-special-case)
