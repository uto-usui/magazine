...
There are situations where default values are useful, but most of the time they're not necessary or useful.
...
If you're using TypeScript, not providing a default value can be really annoying for people who are using `React.useContext`, but I'll show you how to avoid that problem altogether below. Keep reading!

## [The Custom Provider Component](#the-custom-provider-component)

Ok, let's continue. For this context module to be useful _at all_ we need to use the Provider and expose a component that provides a value. Our component will be used like this:
...
## [The Custom Consumer Hook](#the-custom-consumer-hook)
...
## [What about dispatch `type` typos?](#what-about-dispatch-type-typos)
...
![dispatch type getting autocompleted](https://res.cloudinary.com/kentcdodds-com/image/upload/f_auto,q_auto,dpr_2.0,w_1600/v1625032892/kentcdodds.com/content/blog/how-to-use-react-context-effectively/auto-complete.png)

![type error on a misspelled dispatch type](https://res.cloudinary.com/kentcdodds-com/image/upload/f_auto,q_auto,dpr_2.0,w_1600/v1625032891/kentcdodds.com/content/blog/how-to-use-react-context-effectively/type-error.png)
...
## [What about async actions?](#what-about-async-actions)
...
What I suggest is you make a helper function within your context module which accepts `dispatch` along with any other data you need, and make that helper be responsible for dealing with all of that. Here's an example from [my Advanced React Patterns workshop](https://epicreact.dev/patterns):
...
I'm really happy with this pattern and if you'd like me to teach this at your company [let me know](https://kentcdodds.com/contact) (or [add yourself to the waitlist](https://epicreact.dev/patterns) for the next time I host the workshop)!
