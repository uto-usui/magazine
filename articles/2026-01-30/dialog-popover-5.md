---
title: "Dialog と Popover #5"
source: "https://blog.jxck.io/entries/2024-10-02/popover.html"
...
-   Release Notes for Safari Technology Preview 166
    -   [https://webkit.org/blog/13964/release-notes-for-safari-technology-preview-166/](https://webkit.org/blog/13964/release-notes-for-safari-technology-preview-166/)
-   News from WWDC23: WebKit Features in Safari 17 beta
    -   [https://webkit.org/blog/14205/news-from-wwdc23-webkit-features-in-safari-17-beta/](https://webkit.org/blog/14205/news-from-wwdc23-webkit-features-in-safari-17-beta/)
...
-   Popover API lands in Baseline
    -   [https://web.dev/blog/popover-api](https://web.dev/blog/popover-api)

今回は、この `popover` の議論と、仕様が完成していくまでをまとめる。

## [Popover 属性の完成](#popover-属性の完成)
...
-   popover attribute may not be web compatible · Issue #9042 · whatwg/html
    -   [https://github.com/whatwg/html/issues/9042](https://github.com/whatwg/html/issues/9042)
...
-   Some sites are reporting compat issues with popover \[40270593\] - Chromium
    -   [https://issues.chromium.org/issues/40270593](https://issues.chromium.org/issues/40270593)
...
-   Baseline Newly Available
    -   [https://web.dev/series/baseline-newly-available](https://web.dev/series/baseline-newly-available)

## [Dialog と Popover の違い](#dialog-と-popover-の違い)
...
## [`<dialog>` を `popover` する](#dialog-を-popover-する)
...
-   Add light dismiss functionality to `<dialog>` · Issue #9373 · whatwg/html
    -   [https://github.com/whatwg/html/issues/9373](https://github.com/whatwg/html/issues/9373)
...
-   Support disabling CloseWatcher integration in `<dialog>` · Issue #10592 · whatwg/html
    -   [https://github.com/whatwg/html/issues/10592](https://github.com/whatwg/html/issues/10592)
...
-   `dialogmodaltarget` attribute · Issue #834 · mozilla/standards-positions
    -   [https://github.com/mozilla/standards-positions/issues/834](https://github.com/mozilla/standards-positions/issues/834)

しかし、このように追加していくとキリがないため、よりジェネリックな方向に進めるために提案されたのが Invoker だ。

-   Intent to Prototype: Invokers
    -   [https://groups.google.com/a/chromium.org/g/blink-dev/c/tDanwUCp2cg](https://groups.google.com/a/chromium.org/g/blink-dev/c/tDanwUCp2cg)

最初は属性名も Invoker だったが、今は `command` という属性名になっている。

-   \[invokers\] bikeshed the attribute names. · Issue #998 · openui/open-ui
    -   [https://github.com/openui/open-ui/issues/998](https://github.com/openui/open-ui/issues/998)
...
![Top Layer の真ん中に表示された Popover](https://blog.jxck.io/entries/2024-10-02/top-layer.drawio.svg?241002_223502)

そこで、Anchor という概念を導入し、「開いた `<button>` を Anchor として、開かれた側はその Anchor の右上に表示する」といった指定ができるようにした。これが Anchor Positioning だ。

![button を anchor としその右下に Popover を表示](https://blog.jxck.io/entries/2024-10-02/top-layer-anchor.drawio.svg?241002_223502)
...
![button を anchor として右下に popover を表示する](https://blog.jxck.io/entries/2024-10-02/anchor.drawio.svg?241002_223502)
...
## [Position Area Grid](#position-area-grid)
...
![Anchor を中心に 9 個に分割したグリッド](https://blog.jxck.io/entries/2024-10-02/position-area-grid.drawio.svg?241003_012609)
...
## [Anchor Position の fallback](#anchor-position-の-fallback)

先の例で、`<div popover>` を表示するための余白が `<button>` の右下に無かった場合、Popover がはみ出して表示されることになる。

![anchor で右下に表示した popover がはみ出す](https://blog.jxck.io/entries/2024-10-02/anchor-over.drawio.svg?241002_223502)
...
![左でははみ出す popover を anchor の右にフォールバック表示](https://blog.jxck.io/entries/2024-10-02/anchor-fallback.drawio.svg?241002_223502)
...
### [CSS Anchor Name](#css-anchor-name)
...
## [Invoker Relationship](#invoker-relationship)
...
## [HTML Anchor Attributes の今後](#html-anchor-attributes-の今後)
...
例えば、GitHub のリンクをマウスオーバーした場合、Issue なら概要、User ならプロフィールが Popover されるだろう。プロフィールの場合は、アイコンが Anchor になる。
  ...
  ![GitHub のアカウントをマウスオーバーすると開くプロフィールのポップオーバー](https://blog.jxck.io/entries/2024-10-02/github-profile-popover.png?241002_223502)
...
-   Popover Labs | labs.jxck.io
    -   [https://labs.jxck.io/popover/](https://labs.jxck.io/popover/)

## [Links](#links)

-   Popover API (Explainer) | Open UI
    -   [https://open-ui.org/components/popover.research.explainer/](https://open-ui.org/components/popover.research.explainer/)
-   Popover=hint (Explainer) | Open UI
    -   [https://open-ui.org/components/popover-hint.research.explainer/](https://open-ui.org/components/popover-hint.research.explainer/)
-   Invoker Commands (Explainer) | Open UI
    -   [https://open-ui.org/components/invokers.explainer/](https://open-ui.org/components/invokers.explainer/)
...
-   Semantics and the popover attribute: which role to use when? | hidde.blog
    -   [https://hidde.blog/popover-semantics/](https://hidde.blog/popover-semantics/)
...
-   On popover accessibility: what the browser does and doesn't do | hidde.blog
    -   [https://hidde.blog/popover-accessibility/](https://hidde.blog/popover-accessibility/)