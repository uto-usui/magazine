...
source: "https://jakearchibald.com/2024/video-with-transparency/"
...
A Shopify UI video with transparency (click to pause)
...
## [Native support for transparency in web-compatible video formats](#native-support-for-transparency-in-web-compatible-video-formats)
...
#### [It doesn't work in Safari](#it-doesnt-work-in-safari)
...
#### [The performance is prohibitively bad](#the-performance-is-prohibitively-bad)
...
#### [Streaming is poor](#streaming-is-poor)
...
#### [Animated image formats are a hack](#animated-image-formats-are-a-hack)
...
#### [Encoding animated AVIF](#encoding-animated-avif)
...
### [VP9 + HEVC somewhat works](#vp9--hevc-somewhat-works)
...
A reasonable solution that doesn't need JavaScript
...
Top half: colour data. Bottom half: alpha data.
...
### [Wrapping it up in a web component](#wrapping-it-up-in-a-web-component)
...
### [Encoding the video](#encoding-the-video)
...
## [Aside: limited range](#aside-limited-range)
