---
title: "Cookie の性質を利用した攻撃と Same Site Cookie の効果"
source: "https://blog.jxck.io/entries/2018-10-26/same-site-cookie.html"
...
## [Cookie の挙動を利用した攻撃](#cookie-の挙動を利用した攻撃)
...
## [SameSite Cookie の導入](#samesite-cookie-の導入)

実際に Same Site Cookie の導入する方法は、大きく 2 つある。

### [既存の Cookie に対する Lax の付与](#既存の-cookie-に対する-lax-の付与)
...
### [Read/Write Cookie の分離運用](#readwrite-cookie-の分離運用)
...
-   [https://labs.mozaic.fm/same-site-cookie/](https://labs.mozaic.fm/same-site-cookie/)