...
But I’ve also come to see it not as a flaw of Hooks but as a mismatch between the [React programming model](https://overreacted.io/react-as-a-ui-runtime/) and `setInterval`. Hooks, being closer to the React programming model than classes, make that mismatch more prominent.
...
## [Why `useInterval()` Is a Better API](#why-useinterval-is-a-better-api)
...
![Counter with an input that adjusts the interval delay](https://overreacted.io/making-setinterval-declarative-with-react-hooks/counter_delay.gif)
...
## [Refs to the Rescue!](#refs-to-the-rescue)
...
## [Bonus: Pausing the Interval](#bonus-pausing-the-interval)
...
![Counter that automatically speeds up](https://overreacted.io/making-setinterval-declarative-with-react-hooks/counter_inception.gif)
