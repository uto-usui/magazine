...
source: "https://blog.jxck.io/entries/2016-04-24/service-worker-tutorial.html"
publishedDate: "2016-04-24"
...
-   DEMO: [https://labs.jxck.io/service-worker/registration/](https://labs.jxck.io/service-worker/registration/)
...
-   DEMO: [https://labs.jxck.io/service-worker/background-sync/](https://labs.jxck.io/service-worker/background-sync/)

## [push](#push)

push に必要な情報とその取り方、投げ方。

_デモで作った API KEY は当たり前ですが無効にしてあります、全く同じ値を入れても動きません_

### [1\. Google Developer Console](#1.-google-developer-console)
...
使用したモジュール: [https://github.com/web-push-libs/web-push](https://github.com/web-push-libs/web-push)
...
![service worker のライフサイクル (installing -> waiting -> active -> redundunt) の遷移図](https://blog.jxck.io/entries/2016-04-24/service-worker-lifecycle.svg?180105_115707 "service worker lifecycle")