---
title: "CSS Rhythmic Sizing で Vertical Rhythm"
source: "https://blog.jxck.io/entries/2017-10-09/css-rhythmic-sizing.html"
...
## [CSS Rhythmic Sizing](#css-rhythmic-sizing)
...
## [Readability of Rhythm](#readability-of-rhythm)
...
-   [https://labs.jxck.io/rhythmic-sizing/basic.html](https://labs.jxck.io/rhythmic-sizing/basic.html)
...
例えば以下のようなページがあったとする。
  ...
  ![Vertical Rhythm を適用しないシングルカラムでは、各行の高さ/余白のリズムが安定しない](https://blog.jxck.io/entries/2017-10-09/single-no-rhythm.png?200901_002432 "single column with no vertical rhythm")
...
`<p>` のマージンは同じく(相殺含め) `24px` に揃っているので、表示は以下のようにグリッドに揃う。
  ...
  ![Vertical Rhythm を適用したシングルカラムでは、各行の高さ/余白が揃いリズムが安定する](https://blog.jxck.io/entries/2017-10-09/single-with-rhythm.png?200901_002432 "single column with vertical rhythm")
...
結果は以下である。
  ...
  ![Vertical Rhythm を適用したマルチカラムレイアウトでは、隣同士での高さも揃いリズムが安定する](https://blog.jxck.io/entries/2017-10-09/multi-with-rhythm.png?200901_002432 "multi column with vertical rhythm")
