---
title: "Apple によるブラウザエンジン規制の緩和"
source: "https://blog.jxck.io/entries/2024-01-28/apple-sideloading.html"
...
-   モバイル・エコシステムに関する競争評価 最終報告
    -   [https://www.kantei.go.jp/jp/singi/digitalmarket/kyosokaigi/dai7/siryou2s.pdf](https://www.kantei.go.jp/jp/singi/digitalmarket/kyosokaigi/dai7/siryou2s.pdf)
...
## [EU でのブラウザエンジン緩和](#eu-でのブラウザエンジン緩和)

今回の一連の発表の中で、ブラウザに関するものは以下だ。

-   Using alternative browser engines in the European Union - Support - Apple Developer
    -   [https://developer.apple.com/support/alternative-browser-engines/#web-browser-engine-entitlement](https://developer.apple.com/support/alternative-browser-engines/#web-browser-engine-entitlement)

この内容について、詳細を見ていく。

## [Browser Engine Entitlement](#browser-engine-entitlement)
...
今回は _Web Browser Engine Entitlement_ の方に絞る。

## [Web Browser Engine Entitlement](#web-browser-engine-entitlement)
...
### [Program Security Requirements](#program-security-requirements)
...
### [Program privacy requirements](#program-privacy-requirements)
...
### [Secure SDLC (Software Development Lifecycle)](#secure-sdlc-software-development-lifecycle)
