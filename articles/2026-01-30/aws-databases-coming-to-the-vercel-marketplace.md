---
title: "AWS Databases coming to the Vercel Marketplace"
source: "https://vercel.com/blog/aws-databases-coming-to-the-vercel-marketplace"
...
## [Link to heading](#expanding-the-vercel-and-aws-partnership)Expanding the Vercel and AWS partnership
...
> 
> ![](https://assets.vercel.com/image/upload/contentful/image/e5382hct74si/65AK0QZjm0y7uetJcNoF59/6c7ec0f0830e3952c9482e6583d1e37f/2025.jpg)
> 
> **Tom Occhino,** Chief Product Officer

## [Link to heading](#a-faster-path-from-idea-to-production)A faster path from idea to production
...
### [Link to heading](#v0-support-on-day-one)v0 support on day one
...
## [Link to heading](#built-for-self-driving-infrastructure)Built for self-driving infrastructure
...
AWS databases are coming to the [Vercel Marketplace](https://vercel.com/marketplace/aws) on December 15th. Once live:

1.  Navigate to the [**Vercel Marketplace**](https://vercel.com/marketplace/category/database) **→ AWS**
    
2.  Choose **Aurora PostgreSQL, Amazon DynamoDB,** or **Aurora DSQL**
    
3.  Select your region and plan (including a free starter plan with $100 in credits for new AWS customers)
    
4.  Connect it to your project. Vercel automatically handles credentials and configuration
    

If you’re using [v0](https://v0.app/), simply describe your app. v0 will generate your frontend, backend, and AWS database automatically.