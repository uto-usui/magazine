...
source: "https://overreacted.io/beyond-booleans/"
...
![Hover in TypeScript playground: question2 is a boolean](https://overreacted.io/beyond-booleans/1.png)
...
### [Propositions as Values](#propositions-as-values)
...
![Hover in Lean playground showing question2 is of type Prop](https://overreacted.io/beyond-booleans/2.png)
...
**In Lean, you must _convince_ the computer it’s true—by presenting a proof.** Turns out, not only is `2 + 2 = 4` a value, it is _also_ a type. A proof is a value _of_ that type.
...
![Screenshot of linked playground](https://overreacted.io/beyond-booleans/3.png)
...
2 = 22 + 2 = 4Not (2 + 2 = 5)by rflby rflby decideProp
...
2 = 22 + 2 = 42 + 2 = 5Not (2 + 2 = 5)by rflby rflby decideProp
...
2 + 2 = 4by rfltwo\_add\_two\_eq\_fourby decideProp
...
### [Typed Truthfulness](#typed-truthfulness)
...
2 = 22 + 2 = 42 + 2 = 5Not (2 + 2 = 5)by rflby rflby decidetwo\_add\_two\_eq\_fourby decideby decideProp
...
![Screenshot of linked playground.](https://overreacted.io/beyond-booleans/9.png)
...
### [Composing Proofs](#composing-proofs)
...
![Screenshot of linked playground.](https://overreacted.io/beyond-booleans/10.png)
...
![Lean suggests exact sq_nonneg (Real.sin a)](https://overreacted.io/beyond-booleans/11.png)
...
![Lean suggests exact sin_sq_le_one a](https://overreacted.io/beyond-booleans/12.png)
...
![Screenshot of the linked playground](https://overreacted.io/beyond-booleans/13.png)
...
![Screenshot of Lean source code defining a = b](https://overreacted.io/beyond-booleans/14.png)
...
2 = 2Eq 2 2Eq Nat.zero.succ.succ Nat.zero.succ.succEq (2+2) 4Eq Nat.zero.succ.succ.succ.succ Nat.zero.succ.succ.succ.succEq Nat.zero.succ.succ.succ.succ Nat.zero.succ.succ.succ.succ.succEq (2+2) 52 + 2 = 42 + 2 = 5by rflEq.refl 2Eq.refl Nat.zero.succ.succEq.refl Nat.zero.succ.succ.succ.succEq.refl 4by rflProp
