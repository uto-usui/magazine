---
title: "Markdown の Table 記法を CSS で実現する"
source: "https://blog.jxck.io/entries/2022-03-06/markdown-style-table-css.html"
...
などと考えている間に飽きて、適当に border を dash にしただけのお粗末な実装で誤魔化していた。
  ...
  ![border を dash にしただけの実装](https://blog.jxck.io/entries/2022-03-06/table-before.png?230731_162900)

## [Call for Implementation](#call-for-implementation)
...
-   araya: [https://codepen.io/arayaryoma/pen/XWzgVwx](https://codepen.io/arayaryoma/pen/XWzgVwx)
-   yoshiko: [http://jsfiddle.net/j4fm9scg/](http://jsfiddle.net/j4fm9scg/)
...
これで見た目が以下のようになる。
  ...
  ![Markdown Like の実装](https://blog.jxck.io/entries/2022-03-06/table-after.png?230731_162900)

スタイル自体はこれで完成だ。

## [Generated Content Model](#generated-content-model)
...
せっかくなので、論文のようにキャプションの前に "表 1:" のようなプレフィックスを CSS Counter を用いて付与し、以下のように表示するようにした。
  ...
  ![figcaption を付与した table](https://blog.jxck.io/entries/2022-03-06/figcaption.png?230731_162900)
...
-   [https://labs.jxck.io/table](https://labs.jxck.io/table)
...
-   Spec
    -   CSS Generated Content Module Level 3
        -   [https://drafts.csswg.org/css-content/#content-property](https://drafts.csswg.org/css-content/#content-property)
...
-   Other
    -   content - CSS | MDN
        -   [https://developer.mozilla.org/ja/docs/Web/CSS/content](https://developer.mozilla.org/ja/docs/Web/CSS/content)
    -   @supports - CSS | MDN
        -   [https://developer.mozilla.org/ja/docs/Web/CSS/@supports](https://developer.mozilla.org/ja/docs/Web/CSS/@supports)