...
source: "https://kentcdodds.com/blog/super-simple-start-to-react"
...
When you're learning something new (or you want to solidify your foundational understanding of something you're already familiar with), one of the most valuable things you can do is remove _everything_ until all you're left with is the _one_ thing you're trying to learn.
...
![Ball of Rubber bands](https://res.cloudinary.com/kentcdodds-com/image/upload/f_auto,q_auto,dpr_2.0,w_1600/v1625033396/kentcdodds.com/content/blog/super-simple-start-to-react/rubber-bands-ball.jpg)
...
The next little bit will basically be a simple version of what you can watch for free in my [Beginner's Guide to React](https://kcd.im/beginner-react) course on egghead. For this next part, you can **[watch "Create a User Interface with Vanilla JavaScript and DOM" on egghead.io](https://egghead.io/lessons/react-create-a-user-interface-with-vanilla-javascript-and-dom?af=5236ad)**
...
## [Let's add React](#lets-add-react)

For this next part, you can **[watch "Create a User Interface with React's createElement API" on egghead.io](https://egghead.io/lessons/react-create-a-user-interface-with-react-s-createelement-api?af=5236ad)**
...
Learn more about this from my blog post [What is JSX?](https://kentcdodds.com/blog/what-is-jsx)
...
For this next part, you can **[watch "Create a User Interface with React's JSX syntax" on egghead.io](https://egghead.io/lessons/react-create-a-user-interface-with-react-s-jsx-syntax?af=5236ad)**

Nobody writes React like we have above though. We're all using [JSX](https://kentcdodds.com/blog/what-is-jsx)! But the browser doesn't know what JSX is! So while we like writing our code using this special syntax, we need to provide the browser with something it understands. The browser understands `React.createElement`. So what if we write our code using JSX, and then we have some tool that converts JSX to `React.createElement`? That's precisely what the [Babel](https://babeljs.io/) compiler does for us.
...
![Rubber bands separated](https://res.cloudinary.com/kentcdodds-com/image/upload/f_auto,q_auto,dpr_2.0,w_1600/v1625033397/kentcdodds.com/content/blog/super-simple-start-to-react/rubber-bands.jpg)

If you want to continue your learning journey, don't miss [The Beginner's Guide to React](https://kcd.im/beginner-react). Good luck!