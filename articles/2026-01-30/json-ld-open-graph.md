...
source: "https://blog.jxck.io/entries/2016-02-26/jsonld-opengraph.html"
...
### [JSON-LD と LD-JSON](#json-ld-と-ld-json)
...
しかし、JSON-LD の HTML 内の記述は script type が _application/ld+json_ なのが微妙に引っかかる。
