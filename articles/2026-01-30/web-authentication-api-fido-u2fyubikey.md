---
title: "Web Authentication API で FIDO U2F(YubiKey) 認証"
source: "https://blog.jxck.io/entries/2018-05-15/webauthentication-api.html"
...
-   [https://labs.jxck.io/webauthentication/fido-u2f/](https://labs.jxck.io/webauthentication/fido-u2f/)
...
-   [https://github.com/Jxck/jxck.io/tree/master/labs.jxck.io/webauthentication/fido-u2f](https://github.com/Jxck/jxck.io/tree/master/labs.jxck.io/webauthentication/fido-u2f)

YubiKey Login の動作イメージは以下。

## [WebAuthentication API](#webauthentication-api)
...
### [1\. サービスに対して challenge (乱数)の発行を要求する](#1.-サービスに対して-challenge-乱数の発行を要求する)
...
### [2\. この challenge を元に `navigator.credentials.create()` を呼ぶ](#2.-この-challenge-を元に-navigator.credentials.create-を呼ぶ)
...
### [3\. サービスは中身を確認し、ユーザに紐付けて保存する。](#3.-サービスは中身を確認しユーザに紐付けて保存する)
...
-   [https://w3c.github.io/webauthn/#fido-u2f-attestation](https://w3c.github.io/webauthn/#fido-u2f-attestation)
...
### [1\. サービスに対して challenge (乱数)の発行を要求する](#1.-サービスに対して-challenge-乱数の発行を要求する_1)
...
### [2\. この challenge を元に `navigator.credentials.get()` を呼ぶ](#2.-この-challenge-を元に-navigator.credentials.get-を呼ぶ)
...
### [3\. サービスは中身を確認し、ユーザを認証する](#3.-サービスは中身を確認しユーザを認証する)
