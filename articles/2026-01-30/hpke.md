---
title: "HPKE とは何か"
source: "https://blog.jxck.io/entries/2022-08-25/hpke.html"
...
-   RFC 9180: Hybrid Public Key Encryption
    -   [https://www.rfc-editor.org/rfc/rfc9180.html](https://www.rfc-editor.org/rfc/rfc9180.html)
...
## [Hybrid Crypto System の概要](#hybrid-crypto-system-の概要)
...
PSK Mode では、shared\_secret の交換のあと、コンテキストの生成時に PSK を引数に追加する。
...
KEM で交換した shared\_secret を元に、Extract/Expand によって実際の共有鍵を生成する。
...
> 
> — [https://www.rfc-editor.org/rfc/rfc9180.html#section-5.2-13](https://www.rfc-editor.org/rfc/rfc9180.html#section-5.2-13)
...
> 
> — [https://www.rfc-editor.org/rfc/rfc9180.html#section-9.8](https://www.rfc-editor.org/rfc/rfc9180.html#section-9.8)
...
> 
> — [https://www.rfc-editor.org/rfc/rfc9180.html#section-9.1.1-1](https://www.rfc-editor.org/rfc/rfc9180.html#section-9.1.1-1)

## [Use Case](#use-case)

すでに、HPKE を用いることを想定して策定が進んでいるプロトコルがいくつかある。ここでは、代表的なものを紹介する。

### [ECH (Encrypted Client Hello)](#ech-encrypted-client-hello)
...
-   TLS Encrypted Client Hello
    -   [https://www.ietf.org/archive/id/draft-ietf-tls-esni-14.html](https://www.ietf.org/archive/id/draft-ietf-tls-esni-14.html)
...
-   The Messaging Layer Security (MLS) Protocol
    -   [https://www.ietf.org/archive/id/draft-ietf-mls-protocol-16.html](https://www.ietf.org/archive/id/draft-ietf-mls-protocol-16.html)

### [OHTTP (Oblivious HTTP)](#ohttp-oblivious-http)
...
-   Private Relay と IP Blindness による Fingerprint 対策 | blog.jxck.io
    -   [https://blog.jxck.io/entries/2021-09-22/private-relay-for-ip-blindness.html](https://blog.jxck.io/entries/2021-09-22/private-relay-for-ip-blindness.html)

ここで、Client と Proxy がメッセージを追加で暗号化するために HPKE を用いることが想定されている。

-   Oblivious HTTP
    -   [https://www.ietf.org/archive/id/draft-thomson-http-oblivious-02.html](https://www.ietf.org/archive/id/draft-thomson-http-oblivious-02.html)
...
-   Blog
    -   HPKE: Standardizing public-key encryption (finally!)
        -   [https://blog.cloudflare.com/hybrid-public-key-encryption/](https://blog.cloudflare.com/hybrid-public-key-encryption/)
    ...
    -   Hybrid Public Key Encryption: My Involvement in Development and Analysis of a Cryptographic Standard - Benjamin Lipp
        -   [https://www.benjaminlipp.de/p/hpke-cryptographic-standard/](https://www.benjaminlipp.de/p/hpke-cryptographic-standard/)
    -   TL;DR - Hybrid Public Key Encryption
        -   [https://www.franziskuskiefer.de/p/tldr-hybrid-public-key-encryption/](https://www.franziskuskiefer.de/p/tldr-hybrid-public-key-encryption/)
-   Presentation
-   Issues
-   Other