...
source: "https://kentcdodds.com/blog/understanding-reacts-key-prop"
publishedDate: "2019-11-01"
category: "frontend"
feedName: "Kent C. Dodds"
---

**[Watch "Use the key prop when Rendering a List with React" on egghead.io](https://egghead.io/lessons/react-use-the-key-prop-when-rendering-a-list-with-react-3a0661b6?af=5236ad)** (part of [The Beginner's Guide to ReactJS](https://kcd.im/beginner-react)).
...
I want to share a little trick with you, not because I use this a lot (though this is exactly what I do on [my contact page](https://kentcdodds.com/contact)), but because understanding this principle will help you understand React a bit better. It has to do with React component "instances" and how React treats the `key` prop.
...
Side note: If you'd like to know why this is necessary and what can happen if you ignore it or simply put the `index` as the key, watch ["Use the key prop when Rendering a List with React"](https://egghead.io/lessons/react-use-the-key-prop-when-rendering-a-list-with-react?af=5236ad)
...
For more on this, read [One simple trick to optimize React re-renders](https://kentcdodds.com/blog/optimize-react-re-renders)
...
NOTE: effect cleanup actually happens _after_ the new component has been mounted, but before the next effect callback is run.
...
I hope that was interesting/enlightening. If you want to play around with any of this code, [I have a codesandbox for it here](https://codesandbox.io/s/concerning-react-keys-onb2g). Have fun!