---
title: "Passkey への道 #2: 2FA/TOTP"
source: "https://blog.jxck.io/entries/2025-07-09/load-to-passkey-2.html"
...
平成の中~後期頃、銀行は顧客に以下のような乱数表を配り始めた。
  ...
  ![楽天銀行のセキュリティカード](https://blog.jxck.io/entries/2025-07-09/security-card.png?250707_145919)

-   セキュリティカード認証
    -   [https://www.rakuten-bank.co.jp/security/howto/enhanced/securitycard/](https://www.rakuten-bank.co.jp/security/howto/enhanced/securitycard/)
...
銀行が乱数表の次に顧客に配ったのは、以下のようなデバイスだ。
  ...
  ![きらぼし銀行のハードウェアトークン](https://blog.jxck.io/entries/2025-07-09/hardware-token.png?250707_150706)

-   ワンタイムパスワード | きらぼし銀行
    -   [https://www.kiraboshibank.co.jp/hojin/kouritsuka/biz-net/security/otp.html](https://www.kiraboshibank.co.jp/hojin/kouritsuka/biz-net/security/otp.html)
...
しかし、サービスごとにログイン用アプリが増えていくのは、ユーザにとってもサービスにとっても負荷だ。そこで、一般的なサービスでは、標準化されているこの仕組みを実装して QR コードを表示し、ユーザが好きな対応アプリで登録する方式が広まった。黎明期は Google Authenticator や Authy などがあり、しばらくするとパスワードマネージャも TOTP に対応するようになっていった。
  ...
  ![Google Authenticator](https://blog.jxck.io/entries/2025-07-09/google-authenticator.png?250707_151451)
