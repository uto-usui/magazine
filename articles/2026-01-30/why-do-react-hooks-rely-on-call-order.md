...
![Negative HN comment](https://overreacted.io/why-do-hooks-rely-on-call-order/hooks-hn1.png)

They’re like a music record that grows on you only after a few good listens:

![Positive HN comment from the same person four days later](https://overreacted.io/why-do-hooks-rely-on-call-order/hooks-hn2.png)
...
### [Flaw #2: Name Clashes](#flaw-2-name-clashes)
...
### [Flaw #3: Can’t Call the Same Hook Twice](#flaw-3-cant-call-the-same-hook-twice)
...
### [Flaw #4: The Diamond Problem](#flaw-4-the-diamond-problem)
...
### [Flaw #5: Copy Paste Breaks Things](#flaw-5-copy-paste-breaks-things)
...
### [Flaw #6: We Still Need a Linter](#flaw-6-we-still-need-a-linter)
...
### [Flaw #7: Can’t Pass Values Between Hooks](#flaw-7-cant-pass-values-between-hooks)
...
### [Flaw #8: Too Much Ceremony](#flaw-8-too-much-ceremony)
...
The same applies to Hooks. Still, as [Sebastian’s answer](https://github.com/reactjs/rfcs/pull/68#issuecomment-439314884) mentions, it is _technically possible_ to “redirect” Hooks exported from `react` to a different implementation. ([One of my previous posts](https://overreacted.io/how-does-setstate-know-what-to-do/) mentions how.)
