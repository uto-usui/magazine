...
source: "https://kentcdodds.com/blog/make-your-own-dev-tools"
publishedDate: "2020-02-01"
category: "frontend"
feedName: "Kent C. Dodds"
---

**[Watch "Create App DevTools to enhance development productivity" on egghead.io](https://egghead.io/lessons/javascript-create-app-devtools-to-enhance-development-productivity?pl=kent-s-blog-posts-as-screencasts-eefa540c&af=5236ad)**
...
So instead, I had this idea to have some code that's actually _in_ the app instead. Both in the repo, and actually running in the app, like the rest of the code in the app. Here's what it looked like (screen-grabbed from a demo video I made when I left the company):

![Alianza Admin Portal with DevTools visible](https://res.cloudinary.com/kentcdodds-com/image/upload/f_auto,q_auto,dpr_2.0,w_1600/v1625033119/kentcdodds.com/content/blog/make-your-own-dev-tools/alianza.png)

That was an AngularJS app and I did a few fancy things to make that work. I've put together [a relatively small demo React app](https://app-dev-tools.netlify.com/) ([repo](https://github.com/kentcdodds/app-dev-tools)) to show you an example of how this could work. In this app we're using the DevTools to control a [feature toggle](https://en.wikipedia.org/wiki/Feature_toggle), but remember that App DevTools enable you to do just about anything.
...
2.  The code for the DevTools do NOT end up in our production bundle. They're chunked separately from the rest of the app. Whenever we're doing something to improve the developer experience productivity, we want to limit (or eliminate) the impact on the user experience (because [users care about how you write code](https://kentcdodds.com/blog/why-users-care-about-how-you-write-code)).
...
You can check out [the `src/dev-tools/dev-tools.js` file in the repo](https://github.com/kentcdodds/app-dev-tools/blob/master/src/dev-tools/dev-tools.js) for an idea of what you can put in there.

## [Local DevTools](#local-devtools)
...
## [Warning! Production !== local](#warning-production--local)
...
Also, please please please make sure you don't ship anything that won't work without the DevTools enabled! That can be surprisingly easy to do when you spend all of your time developing the app with the DevTools enabled. To avoid this, make sure that you have a good suite of tests that run with the DevTools _disabled_.
...
[Play around with the app](https://app-dev-tools.netlify.com/) [and repo](https://github.com/kentcdodds/app-dev-tools).