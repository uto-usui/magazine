---
title: "Intel NUC で自宅 Ubuntu 開発環境構築と SSH Port Forwarding によるアクセス"
source: "https://blog.jxck.io/entries/2019-11-03/nuc-dev-server-port-forwarding.html"
...
authorized\_keys の最初には、SSH で接続してくる IP の制限が指定できる。
...
## [Laptop の config](#laptop-の-config)
