---
title: "Foreign Fetch による Micro Service Workers"
source: "https://blog.jxck.io/entries/2016-12-12/foreign-fetch.html"
...
## [1st Party と 3rd Party](#1st-party-と-3rd-party)
...
## [1st Party Service Worker の限界](#1st-party-service-worker-の限界)
...
## [3rd Party Service Worker](#3rd-party-service-worker)
...
## [foreign-fetch の仕組み](#foreign-fetch-の仕組み)
...
## [3rd Party Service Worker の登録](#3rd-party-service-worker-の登録)
...
## [foreign-fetch によるサービス間連携](#foreign-fetch-によるサービス間連携)
...
## [Micro Service Workers](#micro-service-workers)
