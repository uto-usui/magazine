---
title: "1Password AC #3: Master Password の作り方"
source: "https://blog.jxck.io/entries/2025-11-06/create-master-password.html"
...
-   1Password の Master Password は使い回すべき理由 | blog.jxck.io
    -   [https://blog.jxck.io/entries/2025-11-05/reuse-master-password.html](https://blog.jxck.io/entries/2025-11-05/reuse-master-password.html)
...
> 
> — [https://www.1password.community/discussions/lounge/community-password-62-character-maximum-limit/150913](https://www.1password.community/discussions/lounge/community-password-62-character-maximum-limit/150913)
...
> 
> — [https://pages.nist.gov/800-63-4/sp800-63b.html#password-authenticators](https://pages.nist.gov/800-63-4/sp800-63b.html#password-authenticators)
...
## [Master Password は変えない](#master-password-は変えない)
...
## [Policy による強制](#policy-による強制)

1Password の Business では、組織に参加するアカウントの Master Password にポリシーを設定し、強制することができる。

  ![Business アカウントのパスワードポリシー](https://blog.jxck.io/entries/2025-11-06/password-policy.png?251106_115515)
...
## [長いパスワードの作り方](#長いパスワードの作り方)

仮に 20 文字以上の Master Password を新しく作る場合、どのように作るのが良いだろうか?

20 文字あれば、小文字アルファベットだけでも `26^20` 通りあり `2x10^30` で _二百穣_ という単位になる。もはや、記号や数字といった文字種など気にする必要はなく、むしろ絶対に忘れないこと、入力がストレスにならないことを重視して作るべきとなる。
...
## [Master Password は誰にも見えない](#master-password-は誰にも見えない)
