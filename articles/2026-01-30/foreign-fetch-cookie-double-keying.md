---
title: "Foreign Fetch が削除されそうな理由と Cookie の double keying"
source: "https://blog.jxck.io/entries/2017-09-19/remove-foreign-fetch.html"
...
## [Foreign Fetch Origin Trial results](#foreign-fetch-origin-trial-results)
...
## [double keying cookie](#double-keying-cookie)

### [3rd party cookie tracking](#3rd-party-cookie-tracking)
...
Cookie は、ブラウザ内で「_どこから付与されたか_」をキーとして保存されている。
...
## [ITP (Intelligent Tracking Prevention)](#itp-intelligent-tracking-prevention)
...
## [double keying と foreign fetch](#double-keying-と-foreign-fetch)
...
## [3rd Party SW のユースケース](#3rd-party-sw-のユースケース)
