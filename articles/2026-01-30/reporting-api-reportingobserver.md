---
title: "ブラウザで何が起こっているのかを知る Reporting API と ReportingObserver"
source: "https://blog.jxck.io/entries/2020-01-18/reporting.html"
...
## [Reporting API の経緯](#reporting-api-の経緯)
...
-   include\_subdomains(optional): サブドメインまで伝搬させる。
-   max\_age(required): グループの有効期間。0 にするとブラウザからグループが消える。
...
### [report-to directive](#report-to-directive)
...
### [Reporting Request](#reporting-request)
...
執筆時の Chrome や Fetch の Spec からは、Preflight は無いように見えるが、_これから Reporting Endpoint を作る場合は Preflight を前提にすべき_ と言える。

## [Reporting Observer](#reporting-observer)

ReportingObserver は JS で report を取得する API だ。

-   [https://w3c.github.io/reporting/#observers](https://w3c.github.io/reporting/#observers)
...
-   [https://github.com/WICG/interventions](https://github.com/WICG/interventions)
...
### [Feature Policy Violation](#feature-policy-violation)
