...
source: "https://overreacted.io/preparing-for-tech-talk-part-3-content/"
...
-   **Preparing for a Tech Talk, Part 3: Content (_this post_)**
-   To be continued
...
### [Top-Down Pass: The Outline](#top-down-pass-the-outline)

After I know [what the talk is about](https://overreacted.io/preparing-for-tech-talk-part-2-what-why-and-how/), **I write a rough outline. It is a bullet point list of every thought I want to include.** It doesn’t need to be polished or clear to anyone other than me. I’m just throwing things at the wall to see what sticks.
...
Many initial thoughts in the outline might not make the final cut. In fact, writing an outline is a great way to separate the ideas that contribute to the [“what” and “why”](https://overreacted.io/preparing-for-tech-talk-part-2-what-why-and-how/) of the talk from the “filler” that should be removed.
...
### [Bottom-Up Pass: The High-Energy Section](#bottom-up-pass-the-high-energy-section)
...
**Previous in this series: [Preparing for a Tech Talk, Part 2: What, Why, and How](https://overreacted.io/preparing-for-tech-talk-part-2-what-why-and-how/)**.