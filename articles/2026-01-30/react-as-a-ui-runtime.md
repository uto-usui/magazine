...
source: "https://overreacted.io/react-as-a-ui-runtime/"
...
![React homepage screenshot: "A JavaScript library for building user interfaces"](https://overreacted.io/react-as-a-ui-runtime/react.png)

I’ve written about the challenges of creating [user interfaces](https://overreacted.io/the-elements-of-ui-engineering/) before. But this post talks about React in a different way — more as a [programming runtime](https://en.wikipedia.org/wiki/Runtime_system).
...
_(Note: I omitted [some properties](https://overreacted.io/why-do-react-elements-have-typeof-property/) that aren’t important to this explanation.)_
...
This lets React decide when and _whether_ to call it. If our `Page` component ignores its `children` prop and renders `<h1>Please log in</h1>` instead, React won’t even attempt to call the `Comments` function. What’s the point?
...
## [Static Use Order](#static-use-order)
