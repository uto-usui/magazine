---
title: "Dialog と Popover #4"
source: "https://blog.jxck.io/entries/2024-09-30/toast-popup.html"
...
![Toast UI](https://blog.jxck.io/entries/2024-09-30/1.toast.drawio.svg?240930_162302)
...
-   std-toast/study-group at master - jackbsteinberg/std-toast
    -   [https://github.com/jackbsteinberg/std-toast/tree/master/study-group](https://github.com/jackbsteinberg/std-toast/tree/master/study-group)
...
-   Intent to Implement: Toast UI element
    -   [https://groups.google.com/a/chromium.org/g/blink-dev/c/Gl7FIKM5IFw/m/tA70X9ZIBQAJ](https://groups.google.com/a/chromium.org/g/blink-dev/c/Gl7FIKM5IFw/m/tA70X9ZIBQAJ)
...
-   Intent to Prototype: HTMLPopupElement - `<popup>`
    -   [https://groups.google.com/a/chromium.org/g/blink-dev/c/9y-Thg9UCxY](https://groups.google.com/a/chromium.org/g/blink-dev/c/9y-Thg9UCxY)

Explainer は以下。

-   MSEdgeExplainers/Popup/explainer.md at main - MicrosoftEdge/MSEdgeExplainers
    -   [https://github.com/MicrosoftEdge/MSEdgeExplainers/blob/main/Popup/explainer.md](https://github.com/MicrosoftEdge/MSEdgeExplainers/blob/main/Popup/explainer.md)
...
## [ModalCloseWatcher](#modalclosewatcher)

`<popup>` の Intents とほぼ同時に、もう一つの Intents が出る。

-   Intent to Prototype: ModalCloseWatcher
    -   [https://groups.google.com/a/chromium.org/g/blink-dev/c/NA5NC16OmsU](https://groups.google.com/a/chromium.org/g/blink-dev/c/NA5NC16OmsU)

で、Explainer はというと

-   history\_api/history\_and\_modals.md at master - slightlyoff/history\_api
    -   [https://github.com/slightlyoff/history\_api/blob/master/history\_and\_modals.md](https://github.com/slightlyoff/history_api/blob/master/history_and_modals.md)
...
-   Domenic Denicola on Twitter / X
    -   [https://x.com/Domenic/status/1339675541083971586](https://x.com/Domenic/status/1339675541083971586)
...
-   close-watcher/README.md at main - WICG/close-watcher
    -   [https://github.com/WICG/close-watcher/blob/main/README.md](https://github.com/WICG/close-watcher/blob/main/README.md)
...
-   New Approach for Popup - Issue #455 - openui/open-ui (github.com)
    -   [https://github.com/openui/open-ui/issues/455#issuecomment-1050172067](https://github.com/openui/open-ui/issues/455#issuecomment-1050172067)
...
-   HTMLPopupElement · Issue #680 · w3ctag/design-reviews
    -   [https://github.com/w3ctag/design-reviews/issues/680#issuecomment-943472331](https://github.com/w3ctag/design-reviews/issues/680#issuecomment-943472331)
...
-   Popup API Alternatives | Open UI
    -   [https://open-ui.org/components/popup.proposal.alternatives/#alternative-dedicated-popup-element](https://open-ui.org/components/popup.proposal.alternatives/#alternative-dedicated-popup-element)

以上のように `<popup>` 要素から popup 属性に変更した、新しいプロポーサルができた。

-   mfreed7/popup: Alternative popup proposal
    -   [https://github.com/mfreed7/popup](https://github.com/mfreed7/popup)
...
-   Intent to Experiment: The Pop-Up API
    -   [https://groups.google.com/a/chromium.org/g/blink-dev/c/Sp5UI7RaaGg](https://groups.google.com/a/chromium.org/g/blink-dev/c/Sp5UI7RaaGg)
-   Pop-ups: They're making a resurgence!  |  Blog  |  Chrome for Developers
    -   [https://developer.chrome.com/blog/pop-ups-theyre-making-a-resurgence](https://developer.chrome.com/blog/pop-ups-theyre-making-a-resurgence)
...
-   Open UI TPAC Update 2022.pptx - Microsoft PowerPoint Online
    -   [https://onedrive.live.com/view.aspx?resid=5ACBE28A578FB511!3079257&ithint=file%2cpptx&authkey=!AH8NhgDiDmD1j-M](https://onedrive.live.com/view.aspx?resid=5ACBE28A578FB511!3079257&ithint=file%2cpptx&authkey=!AH8NhgDiDmD1j-M)
...
-   TPAC 2022 - CSS Anchoring
    -   [https://jhey-presents.netlify.app/tpac-2022/](https://jhey-presents.netlify.app/tpac-2022/)
...
-   New feature proposal: Popover API · Issue #7785 · whatwg/html
    -   [https://github.com/whatwg/html/issues/7785#issuecomment-1284656230](https://github.com/whatwg/html/issues/7785#issuecomment-1284656230)

ここで、再度名前を変更する議論が再開された。

-   \[popup\] Should we rename popup due to potential developer confusion? · Issue #627 · openui/open-ui
    -   [https://github.com/openui/open-ui/issues/627](https://github.com/openui/open-ui/issues/627)
