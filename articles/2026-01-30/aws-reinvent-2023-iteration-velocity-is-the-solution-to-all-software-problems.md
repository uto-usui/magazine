---
title: "AWS re:Invent 2023: Iteration velocity is the solution to all software problems"
source: "https://vercel.com/blog/aws-reinvent-2023-iteration-velocity"
...
## [Link to heading](#the-shift-to-the-frontend—the-final-frontier-of-differentiation)The shift to the frontend—the final frontier of differentiation
...
## [Link to heading](#composable-architecture-for-better-speed,-ux,-and-ai-adoption)Composable architecture for better speed, UX, and AI adoption
...
## [Link to heading](#iterate-faster-and-make-better-decisions-with-the-frontend-cloud)Iterate faster _and_ make better decisions with the Frontend Cloud
...
### [Link to heading](#develop-your-application)**Develop** your application

-   [**Turborepo and Turbopack**](https://vercel.com/solutions/turborepo)**:** Use intelligent, team-shared caching to dramatically improve build performance during development and deployment
    
-   [**React Server Components**](https://vercel.com/blog/understanding-react-server-components)**:** Make it easier to iterate on data integration
    

### [Link to heading](#preview-your-site-after-you-build-it)**Preview** your site after you build it

-   [**Preview deployments**](https://vercel.com/docs/deployments/preview-deployments)**:** Get an automatic direct, immutable deployment with every commit push, that you can share with stakeholders
    
-   [**Comments**](https://vercel.com/docs/workflow-collaboration/comments)**:** Figma-like live feedback on your Preview deployments, actionable through Slack, Linear and Jira integrations
    
-   [**Fast builds**](https://vercel.com/docs/deployments/builds)**:** Fast builds with each step of the Preview process, to maintain team velocity
    

### [Link to heading](#ship-your-site-into-production)**Ship** your site into production

-   [**Continuous Deployment:**](https://vercel.com/docs/deployments/overview) Deploy quickly in production, automatically via your favorite Git provider
    
-   [**Edge Config**](https://vercel.com/docs/storage/edge-config)**:** Globally push configuration of your app to global edge, so you can run A/B tests and other experimentation as close as possible to your users
    
-   [**Instant Rollback**](https://vercel.com/docs/deployments/instant-rollback)**:** We all make mistakes, so instantly rollback to any previous version of your app in a second or less
...
## [Link to heading](#generative-ui-helps-you-take-that-first-step)Generative UI helps you take that first step
...
## [Link to heading](#configure-less.-create-more.)**Configure less. Create more.**
