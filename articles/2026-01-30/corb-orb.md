---
title: "CORB から ORB へ"
source: "https://blog.jxck.io/entries/2022-10-25/corb-to-orb.html"
...
## [Allow List と Block List](#allow-list-と-block-list)
...
> 
> — [https://mozilla.github.io/standards-positions/#corb](https://mozilla.github.io/standards-positions/#corb)
...
-   annevk/orb: Opaque Response Blocking (CORB++)
    -   [https://github.com/annevk/orb](https://github.com/annevk/orb)

CORB と ORB の違いについては、以下に詳細がある。

-   Cross-Origin Read Blocking / Opaque Resource Blocking (CORB/ORB)
    -   [https://chromium.googlesource.com/chromium/src/+/HEAD/services/network/public/cpp/corb/README.md](https://chromium.googlesource.com/chromium/src/+/HEAD/services/network/public/cpp/corb/README.md)
...
-   Define opaque-response blocking by annevk · Pull Request #1442 · whatwg/fetch
    -   [https://github.com/whatwg/fetch/pull/1442/files](https://github.com/whatwg/fetch/pull/1442/files)
-   Remove CORB by annevk · Pull Request #1441 · whatwg/fetch
    -   [https://github.com/whatwg/fetch/pull/1441/files](https://github.com/whatwg/fetch/pull/1441/files)
...
-   Intent to Ship: Opaque Response Blocking (ORB, aka CORB++) v0.1
    -   [https://groups.google.com/a/chromium.org/g/blink-dev/c/ScjhKz3Z6U4/m/I6KIhSnyBAAJ](https://groups.google.com/a/chromium.org/g/blink-dev/c/ScjhKz3Z6U4/m/I6KIhSnyBAAJ)
...
-   [https://labs.jxck.io/site-isolation/cross-origin-read-blocking/index.html](https://labs.jxck.io/site-isolation/cross-origin-read-blocking/index.html)
...
-   Mozilla Standard Position
    -   [https://mozilla.github.io/standards-positions/#corb](https://mozilla.github.io/standards-positions/#corb)
-   Webkit Position
    -   [https://github.com/WebKit/standards-positions/issues/64](https://github.com/WebKit/standards-positions/issues/64)
    -   執筆時点で回答なし
-   TAG Design Review
    -   [https://github.com/w3ctag/design-reviews/issues/618](https://github.com/w3ctag/design-reviews/issues/618)
-   Intents
    -   Intent to Ship: Opaque Response Blocking (ORB, aka CORB++) v0.1
        -   [https://groups.google.com/a/chromium.org/g/blink-dev/c/ScjhKz3Z6U4/m/I6KIhSnyBAAJ](https://groups.google.com/a/chromium.org/g/blink-dev/c/ScjhKz3Z6U4/m/I6KIhSnyBAAJ)
-   Chrome Platform Status
    -   [https://chromestatus.com/feature/4933785622675456](https://chromestatus.com/feature/4933785622675456)
-   WPT (Web Platform Test)
    -   [https://github.com/web-platform-tests/wpt/tree/master/fetch/corb](https://github.com/web-platform-tests/wpt/tree/master/fetch/corb)
-   DEMO
-   Blog
-   Presentation
-   Issues
