---
title: "1Password AC #4: Secret Key の運用とアカウントリカバリ"
source: "https://blog.jxck.io/entries/2025-11-07/secret-key.html"
...
アカウントを作成した際、1Password からは Emergency Kit という PDF が発行される。これは実質的に Secret Key が記載されたファイルだ。
  ...
  ![Emergency Kit](https://blog.jxck.io/entries/2025-11-07/emergency-kit.png?251106_204732)
...
ログイン URL やメールアドレスも、普段から使っていれば忘れないだろうと考えると、Emergency Kit 自体にこだわる必要はなく、_Secret Key の値をいかに管理するか_ が重要となる。

この保管方法は、_個人アカウントかビジネスアカウントかで異なる_ のだ。

## [個人アカウントでの Secret Key 管理](#個人アカウントでの-secret-key-管理)
...
-   "Less Password" 時代のアカウント防災訓練 | blog.jxck.io
    -   [https://blog.jxck.io/entries/2025-01-27/account-recovery.html](https://blog.jxck.io/entries/2025-01-27/account-recovery.html)

なお、Secret Key の値は更新することが可能だ。物理的に保管を考える場合は、逆に Secret Key を更新しないように気をつける必要もある。

しかし、ビジネスアカウントを持っていると、ここも少し楽になるため、話は変わる。

## [ビジネスアカウントでの Secret Key 管理](#ビジネスアカウントでの-secret-key-管理)
...
したがって、メンバーは Secret Key を保管せず、リカバリが必要なときだけ管理者に依頼するという運用を取るのが、最も安全性が高いと言えるだろう。したがって、Emergency Kit のように雑に管理されるとリスクになるものは、最初から発行しないように設定することができる。
  ...
  ![Emergency Kit は発行しない](https://blog.jxck.io/entries/2025-11-07/no-emergency-kit.png?251106_204910)
...
## [ビジネスアカウントの管理者の Secret Key 管理](#ビジネスアカウントの管理者の-secret-key-管理)
...
## [ビジネスアカウントへの個人アカウントのバックアップ](#ビジネスアカウントへの個人アカウントのバックアップ)
