...
source: "https://blog.jxck.io/entries/2018-07-24/clear-site-data.html"
...
-   [https://w3c.github.io/webappsec-clear-site-data/#http-headerdef-clear-site-data](https://w3c.github.io/webappsec-clear-site-data/#http-headerdef-clear-site-data)
...
挙動は `location.reload()` を実行するのと同等だが _開いている他のタブも全てリロード_ される。
...
-   [https://labs.jxck.io/clear-site-data/](https://labs.jxck.io/clear-site-data/)

## [Link](#link)

-   [https://github.com/mozilla/standards-positions/issues/90](https://github.com/mozilla/standards-positions/issues/90)
-   [https://bugzilla.mozilla.org/show\_bug.cgi?id=1268889](https://bugzilla.mozilla.org/show_bug.cgi?id=1268889)
