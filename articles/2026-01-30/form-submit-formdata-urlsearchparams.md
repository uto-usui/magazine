---
title: "Form で submit されたデータの収集と FormData & URLSearchParams"
source: "https://blog.jxck.io/entries/2018-01-13/formdata-urlsearchparams.html"
...
(ただし Form に `<select>` などが入る場合は修正が必要 [https://labs.jxck.io/form/input-type/](https://labs.jxck.io/form/input-type/))
...
-   [https://labs.jxck.io/form/form-data/](https://labs.jxck.io/form/form-data/)
