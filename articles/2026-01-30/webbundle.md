---
title: "Webbundle によるサブリソース取得の最適化"
source: "https://blog.jxck.io/entries/2020-07-26/bundle-subresources.html"
publishedDate: "2020-07-26"
category: "web-standards"
feedName: "blog.jxck.io"
---

## [Subresource Bundling](#subresource-bundling)
...
### [link rel bundle](#link-rel-bundle)
...
-   DEMO: [https://labs.jxck.io/webpackaging/subresource-webbundle/bundle.html](https://labs.jxck.io/webpackaging/subresource-webbundle/bundle.html)

  ![Bundle Subresource のデモを Chrome Devtools で表示](https://blog.jxck.io/entries/2020-07-26/bundle-subresources.png?201205_194234 "bundle-subresources demo")
...
### [Web Component Bundle](#web-component-bundle)
...
-   DEMO: [https://labs.jxck.io/webpackaging/subresource-webbundle/webcomponents.html](https://labs.jxck.io/webpackaging/subresource-webbundle/webcomponents.html)
...
### [Nested Bundling](#nested-bundling)
...
-   DEMO: [https://labs.jxck.io/webpackaging/subresource-webbundle/nested-bundle/](https://labs.jxck.io/webpackaging/subresource-webbundle/nested-bundle/)

## [考察](#考察)

### [bundle のネイティブ化への期待の背景](#bundle-のネイティブ化への期待の背景)
...
-   [https://github.com/WICG/webpackage/blob/master/explainers/subresource-loading.md#approximate-membership-query-datastructure](https://github.com/WICG/webpackage/blob/master/explainers/subresource-loading.md#approximate-membership-query-datastructure)
