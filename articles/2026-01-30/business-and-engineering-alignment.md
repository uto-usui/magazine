...
source: "https://kentcdodds.com/blog/business-and-engineering-alignment"
...
Luckily, every framework migration I've participated in was ultimately a success. They each had their own level of challenge and impact on development productivity (and [ultimately the user](https://kentcdodds.com/blog/why-users-care-about-how-you-write-code)), but ultimately, the migration was a success.
...
## [The mission of the company](#the-mission-of-the-company)
...
## [Ok, so the mission is important, so what?](#ok-so-the-mission-is-important-so-what)
...
## [What if my company is not functional or I don't care about the mission?](#what-if-my-company-is-not-functional-or-i-dont-care-about-the-mission)
...
## [What if my goals are misaligned with what's good for the mission?](#what-if-my-goals-are-misaligned-with-whats-good-for-the-mission)
