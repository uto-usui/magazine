---
title: "Agents at work, a partnership with Salesforce and Slack"
source: "https://vercel.com/blog/agents-at-work-a-partnership-with-salesforce-and-slack"
publishedDate: "2025-10-15"
category: "frontend"
feedName: "Vercel"
author: "Zack Ciesinski"
---
...
> Vercel sets the bar for developer experience and agent infrastructure; Slack sets the bar for collaboration at work. This is a natural partnership as we work with more customers who want to deploy agents on Slack.
> 
> ![](https://assets.vercel.com/image/upload/contentful/image/e5382hct74si/2b2aPDEKes5GyS5najuymc/8e48964b63c1d80288a704ad4fee0126/Rob_Seaman_LinkedIn_Image.jpeg)
> 
> **Rob Seaman,** Chief Product Officer

### [Link to heading](#the-new-surface-for-software)The new surface for software
...
### [Link to heading](#the-agent-runtime-for-the-enterprise)The agent runtime for the enterprise
...
### [Link to heading](#from-prototype-to-production:-the-v0-slack-agent)From prototype to production: the v0 Slack Agent
...
](https://vercel.com/go/dreamforce-2025-waitlist)

### [Link to heading](#frontend-extensibility)Frontend extensibility
...
> The future of enterprise software is event-driven and conversational. Together with Salesforce, we’re building the runtime for that future, where agents run on Vercel AI Cloud, interface through Slack, and connect directly to business logic in Salesforce.
> 
