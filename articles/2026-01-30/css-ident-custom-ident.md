---
title: "CSS の ident() による動的な custom-ident の生成"
source: "https://blog.jxck.io/entries/2025-06-14/ident.html"
...
## [Anchor Name の動的生成](#anchor-name-の動的生成)
...
-   \[css-values\] Implement ident() \[384930424\]
    -   [https://issues.chromium.org/issues/384930424/resources](https://issues.chromium.org/issues/384930424/resources)
    -   `anchor-name`
    -   `timeline-name`
    -   `container-name`
    -   `@position-try`
...
-   \[css-values\] String concatentation · Issue #542 · w3c/csswg-drafts
    -   [https://github.com/w3c/csswg-drafts/issues/542](https://github.com/w3c/csswg-drafts/issues/542)
...
-   [https://labs.jxck.io/css/ident.html](https://labs.jxck.io/css/ident.html)

## [Resources](#resources)

-   Spec
    -   CSS Values and Units Module Level 5
        -   [https://drafts.csswg.org/css-values-5/#ident](https://drafts.csswg.org/css-values-5/#ident)
-   Explainer
-   Requirements Doc
...
-   Intents
    -   Intent to Prototype: The ident() function
        -   [https://groups.google.com/a/chromium.org/g/blink-dev/c/pAqsAGZIIjw](https://groups.google.com/a/chromium.org/g/blink-dev/c/pAqsAGZIIjw)
-   Chrome Platform Status
    -   The ident() function - Chrome Platform Status
        -   [https://chromestatus.com/feature/6230159413477376](https://chromestatus.com/feature/6230159413477376)
...
-   Issues
    -   \[css-values\] A way to dynamically construct custom-ident and dashed-ident values · Issue #9141 · w3c/csswg-drafts
        -   [https://github.com/w3c/csswg-drafts/issues/9141](https://github.com/w3c/csswg-drafts/issues/9141)
    -   \[css-values\] String concatentation · Issue #542 · w3c/csswg-drafts
        -   [https://github.com/w3c/csswg-drafts/issues/542](https://github.com/w3c/csswg-drafts/issues/542)
    -   \[ident\] Implement ident() function fundamentals (6551725) · Gerrit Code Review
        -   [https://chromium-review.googlesource.com/c/chromium/src/+/6551725](https://chromium-review.googlesource.com/c/chromium/src/+/6551725)
-   Other