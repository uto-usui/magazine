...
source: "https://overreacted.io/functional-html/"
...
According to [our specification so far](#server-tags), _serializing_ the HTML above would produce:
...
### [Async Server Tags](#async-server-tags)
...
-   [Client References](#client-references) that let the server refer to the client (a [first-class `<script>`](https://overreacted.io/what-does-use-client-do/#use-client)).
-   [Server References](#server-references) that let the client refer to the server (a [first-class `fetch`](https://overreacted.io/what-does-use-client-do/#use-server)).
...
### [Full-Stack Tags](#full-stack-tags)
