---
title: "Referrer-Policy によるリファラ制御"
source: "https://blog.jxck.io/entries/2018-10-08/referrer-policy.html"
...
## [Referer or Referrer](#referer-or-referrer)

本来の英語としては _RefeRRer_ が正しいが、HTTP Header ではスペルミスした _RefeRer_ が互換性を保つためそのまま使われている。

しかし、新しく定義された Referrer-Policy は、正しいスペルが採用されている。

## [Referer ヘッダ](#referer-ヘッダ)
...
## [Referer による情報漏洩](#referer-による情報漏洩)
...
例として、架空の _Example_ 社が _Orange_ という新プロジェクトを開始した場合を考える。
...
## [Referrer-Policy](#referrer-policy_1)
...
これは Origin ヘッダが付与する情報と同等であり、_Origin ヘッダが送信される状況では Referer を禁止しても同等の情報が送信されている_ ことは認識しておきたい。
...
### [no-referrer-when-downgrade (default)](#no-referrer-when-downgrade-default)
...
## [Referrer-Policy の適用方法](#referrer-policy-の適用方法)
...
仕様: [https://html.spec.whatwg.org/multipage/urls-and-fetching.html#referrer-policy-attribute](https://html.spec.whatwg.org/multipage/urls-and-fetching.html#referrer-policy-attribute)

### [`<a>`, `<area>` の `rel=noreferrer`](#a-area-の-relnoreferrer)
...
### [referrerpolicy 属性](#referrerpolicy-属性)
...
仕様: [https://w3c.github.io/webappsec-referrer-policy/#referrer-policy-delivery-referrer-attribute](https://w3c.github.io/webappsec-referrer-policy/#referrer-policy-delivery-referrer-attribute)

### [`<meta>` の referrer 属性](#meta-の-referrer-属性)
...
仕様: [https://html.spec.whatwg.org/multipage/semantics.html#meta-referrer](https://html.spec.whatwg.org/multipage/semantics.html#meta-referrer)
...
仕様: [https://w3c.github.io/webappsec-referrer-policy/#referrer-policy-header-dfn](https://w3c.github.io/webappsec-referrer-policy/#referrer-policy-header-dfn)

## [DEMO](#demo)

動作するデモを以下に用意した。

-   [https://labs.jxck.io/referrer-policy/](https://labs.jxck.io/referrer-policy/)
