...
**Disclaimer: Just like [most](https://overreacted.io/why-do-react-elements-have-typeof-property/) [other](https://overreacted.io/how-does-react-tell-a-class-from-a-function/) [posts](https://overreacted.io/why-do-we-write-super-props/) on this blog, you don’t actually _need_ to know any of that to be productive with React. This post is for those who like to see what’s behind the curtain. Completely optional!**
