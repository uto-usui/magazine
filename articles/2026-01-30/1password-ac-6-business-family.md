---
title: "1Password AC #6: Business アカウント特典の無料 Family アカウント"
source: "https://blog.jxck.io/entries/2025-11-09/family-paln.html"
...
## [Family Plan 特典](#family-plan-特典)

1Password は、個人のプランでも $3/月の有料プランしかない。

-   最高のパスワードマネージャーの料金プラン | 1Password
    -   [https://1password.com/jp/pricing/password-manager](https://1password.com/jp/pricing/password-manager)
...
しかし、もし 1 つでも 1Password Business を運用している組織に参加し、ビジネスアカウントを発行された場合、以下のようなバナーが表示される。
  ...
  ![無料ファミリーアカウントを申し込む](https://blog.jxck.io/entries/2025-11-09/free-family-account.png?251107_020003)

書かれている通り、無料で Family アカウントが作成できるのだ。

## [無料 Family アカウントを作る](#無料-family-アカウントを作る)
...
しかも、新しくアカウントを作ることも、既存のアカウントを移行することもできる。
  ...
  ![新しくアカウントを作るか、既存のアカウントを追加する](https://blog.jxck.io/entries/2025-11-09/create-family-account.png?251107_020306)
