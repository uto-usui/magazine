---
title: "3rd Party Cookie 調査のための Web 広告導入"
source: "https://blog.jxck.io/entries/2020-01-31/ads-for-blog.html"
...
## [Google AdSense 導入](#google-adsense-導入)
...
背景や文字色も変更できるため、本サイトに合わせて変更しているが、本サイトが対応している _Dark Mode には対応できない_ ようだ。

### [AMP 対応](#amp-対応)

AMP 対応は `<amp-ad>` を用いることになる。

-   [https://amp.dev/ja/documentation/components/amp-ad/](https://amp.dev/ja/documentation/components/amp-ad/)

これも貼るだけなので特に問題はなかった。

### [ads.txt 対応](#ads.txt-対応)
...
### [Privacy Policy 対応](#privacy-policy-対応)
