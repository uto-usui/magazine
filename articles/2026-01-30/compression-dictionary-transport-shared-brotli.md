---
title: "Compression Dictionary Transport (Shared Brotli) によるコンテンツ圧縮の最適化"
source: "https://blog.jxck.io/entries/2023-07-29/compression-dictionary-transport.html"
...
-   Intent to Experiment: Compression dictionary transport with Shared Brotli
    -   [https://groups.google.com/a/chromium.org/g/blink-dev/c/NgH-BeYO72E](https://groups.google.com/a/chromium.org/g/blink-dev/c/NgH-BeYO72E)

この提案の仕様および本サイトへの適用について解説する。

## [brotli の Dictionary](#brotli-の-dictionary)
...
-   RFC 7932 - Brotli Compressed Data Format
    -   [https://datatracker.ietf.org/doc/html/rfc7932#appendix-A](https://datatracker.ietf.org/doc/html/rfc7932#appendix-A)
...
-   Shared\_Dictionary\_Compression\_over\_HTTP.pdf
    -   [https://lists.w3.org/Archives/Public/ietf-http-wg/2008JulSep/att-0441/Shared\_Dictionary\_Compression\_over\_HTTP.pdf](https://lists.w3.org/Archives/Public/ietf-http-wg/2008JulSep/att-0441/Shared_Dictionary_Compression_over_HTTP.pdf)
...
-   brotli/research/dictionary\_generator.cc at master · google/brotli
    -   [https://github.com/google/brotli/blob/master/research/dictionary\_generator.cc](https://github.com/google/brotli/blob/master/research/dictionary_generator.cc)
...
この状態で本ブログのインデックスページにアクセスすると、以下のようにメインコンテンツの後に辞書が取得されていることがわかる。
  ...
  ![dictionary が取得されている devtools timeline のスクショ](https://blog.jxck.io/entries/2023-07-29/dictionary.png?230731_162900)

次に、記事に遷移すると、コンテントネゴシエーションの結果 sbr が返されていることがわかる。

  ![Content-Encoding sbr が取得されている devtools timeline のスクショ](https://blog.jxck.io/entries/2023-07-29/compression.png?230731_162900)

[前回の記事](https://blog.jxck.io/entries/2023-06-18/cookie-store-api.html) の圧縮結果を比較すると、以下のようになっている。
...
-   Spec
    -   Compression Dictionary Transport
        -   [https://www.ietf.org/archive/id/draft-meenan-httpbis-compression-dictionary-04.html](https://www.ietf.org/archive/id/draft-meenan-httpbis-compression-dictionary-04.html)
-   Explainer
...
-   Mozilla Standard Position
    -   Request for Mozilla Position on Compression dictionary transport · Issue #771 · mozilla/standards-positions
        -   [https://github.com/mozilla/standards-positions/issues/771](https://github.com/mozilla/standards-positions/issues/771)
-   Webkit Position
    -   Compression Dictionary Transport · Issue #160 · WebKit/standards-positions
        -   [https://github.com/WebKit/standards-positions/issues/160](https://github.com/WebKit/standards-positions/issues/160)
-   TAG Design Review
...
-   DEMO
    -   horo-t/compression-dictionary-transport-shop-demo
        -   [https://github.com/horo-t/compression-dictionary-transport-shop-demo](https://github.com/horo-t/compression-dictionary-transport-shop-demo)
    -   horo-t/compression-dictionary-transport-threejs-demo
        -   [https://github.com/horo-t/compression-dictionary-transport-threejs-demo](https://github.com/horo-t/compression-dictionary-transport-threejs-demo)
-   Blog
    -   All the way up to 11: Serve Brotli from origin and Introducing Compression Rules
        -   [https://blog.cloudflare.com/this-is-brotli-from-origin/#the-future-of-web-compression](https://blog.cloudflare.com/this-is-brotli-from-origin/#the-future-of-web-compression)
-   Presentation
-   Issues
-   Other