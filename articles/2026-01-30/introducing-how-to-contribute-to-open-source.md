...
source: "https://kentcdodds.com/blog/introducing-how-to-contribute-to-open-source"
publishedDate: "2016-02-01"
category: "frontend"
feedName: "Kent C. Dodds"
---

tl;dr — [makeapullrequest.com](http://makeapullrequest.com/) and [kcd.im/pull-request](http://kcd.im/pull-request)
...
#### [What this means for project maintainers](#what-this-means-for-project-maintainers)

This means that instead of just saying: "_I'll get to it when I can_" or "_I probably don't have time to do that, but feel free to make a pull request._" You can now say: "_Feel free to [makeapullrequest.com](http://makeapullrequest.com/)!_"
