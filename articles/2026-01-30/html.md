...
source: "https://blog.jxck.io/entries/2016-01-28/html-compression.html"
...
この変換時に以前から思っていた _HTML の最適化_ を実施することにした。
...
### [attribute value の quote](#attribute-value-の-quote)
...
また Chrome の devtools で二つのファイルをレンダリングし、Timeline から _Parse HTML_ の時間を確認した。
...
しかし、これは逆に、_省略がパースを著しく遅くする、といった影響はない_ と言えるだろう。
