...
source: "https://kentcdodds.com/blog/open-source-stamina"
publishedDate: "2015-10-04"
category: "frontend"
feedName: "Kent C. Dodds"
---

This is likely the reason that [TJ Holowaychuk](https://x.com/tjholowaychuk) gave his Node.js projects to other maintainers (read [Farewell Node.js](https://medium.com/@tjholowaychuk/farewell-node-js-4ba9e7f3e52b#.pj5yx57zb)). This is also probably why [Vojta Jína](https://x.com/vojtajina) handed [Karma](http://karma-runner.github.io/) off to [Mark Trostler](https://x.com/zzoass) and [Friedel Ziegelmayer](https://x.com/dignifiedquire).
...
The exception to this is when you're paid to do it. I work for [Alianza](http://www.alianza.com/), but I get my phone service from Verizon. I never use the product personally, but I work on the project because I have a wife and three kids to support and I care about the mission.
...
I contribute and maintain [angular-formly](https://github.com/formly-js/angular-formly) because I use it regularly at work (a lot). If one day I stopped working with forms and/or Angular, it's likely that I would be searching around for someone else to take over the project for me. Hopefully this does not shock anyone.

## [Conclusion](#conclusion)

People who hand off projects to others aren't doing it because they don't care about it anymore or anything. For example [TJ Holowaychuk](https://x.com/tjholowaychuk) still guides people on some of his old Node.js projects. It's just difficult to be actively involved because of the reasons I've mentioned above.
...
Thanks to [TJ Holowaychuk](https://x.com/tjholowaychuk), [Friedel Ziegelmayer](https://x.com/dignifiedquire), and [Mark Trostler](https://x.com/zzoass) for reviewing this post.