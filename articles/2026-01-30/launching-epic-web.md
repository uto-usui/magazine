...
source: "https://kentcdodds.com/blog/launching-epic-web"
publishedDate: "2023-12-03"
category: "frontend"
feedName: "Kent C. Dodds"
---

This blog post is for those of you who have asked me what it was like to launch [EpicWeb.dev](https://www.epicweb.dev/). Epic Web is a platform for learning everything you need to know to build full stack web applications the way I do based on my decade of experience building web apps of all kinds, sizes, and scales. It's terrific, you should check it out.

I've wanted to do this for a long time. You may recall from the end of [2010s Decade in Review](https://kentcdodds.com/blog/2010s-decade-in-review), someone once tweeted at me:

> [@kentcdodds](https://x.com/kentcdodds) I'm expecting you to announce your online Kent C. Dodds engineering bootcamp.

[1](https://x.com/erinfoox/status/1212815681680363521) [](https://x.com/intent/retweet?tweet_id=1212815681680363521)[13](https://x.com/intent/like?tweet_id=1212815681680363521)[](https://x.com/erinfoox/status/1212815681680363521)

To which I replied:

When [I left Remix in 2022](https://kentcdodds.com/blog/a-review-of-my-time-at-remix), I did it [in pursuit of this dream](https://kentcdodds.com/blog/i-m-building-epicweb-dev).

So by the time 2023 started, I had my eyes set on launching [Epic Web](https://www.epicweb.dev/). My wife and I had decided to try for another child and I was committed to launch Epic Web before the baby came.

A big part of getting Epic Web launched was live streaming the process of building the ultimate app we'd be building as part of the workshops. That was [Rocket Rental](https://github.com/epicweb-dev/rocket-rental). You'll find an outrageous number of hours of live stream footage on [my YouTube channel](https://kcd.im/YouTube) of the process of building that application as well as [the workshop app](https://github.com/epicweb-dev/kcdshop) which is the application used to facilitate the learning experience for Epic Web.
...
I did manage to publish [a free tutorial](https://www.epicweb.dev/tutorials/deploy-web-applications) about deploying multi-region applications and distributed SQLite databases all over the world. With that in addition to some articles, it felt great to get some content on the EpicWeb.dev domain and demonstrate I was a serious operation.
...
Ultimately, [Matt Pocock](https://x.com/mattpocockuk) replied with a brilliant summary of my problem:

[![Matt Pocock avatar](https://pbs.twimg.com/profile_images/1666460461884211204/SmBm505D_bigger.jpg)

Matt Pocock @mattpocockuk

](https://x.com/mattpocockuk)

> [@kentcdodds](https://x.com/kentcdodds) I'm starting to see a course as 'solution to a team's problem'. I.e. 'We need to do better testing' -> Testing JavaScript 'We need to learn React' -> Epic React 'We need to learn Remix' -> Epic Remix What's the rationale for a team choosing Epic Web Dev?

[5](https://x.com/mattpocockuk/status/1654127513822699520) [](https://x.com/intent/retweet?tweet_id=1654127513822699520)[15](https://x.com/intent/like?tweet_id=1654127513822699520)[](https://x.com/mattpocockuk/status/1654127513822699520)
...
> [@kentcdodds](https://x.com/kentcdodds) [@tammergard](https://x.com/tammergard) ☝️ If you branded it the 'Kent Stack' and leaned in to it being \_your\_ method for building web apps, I could see people really going for that. 'We want to use the Kent Stack' 'We want to learn how to build PESPA's'

[1](https://x.com/mattpocockuk/status/1654129724241727488) [](https://x.com/intent/retweet?tweet_id=1654129724241727488)[4](https://x.com/intent/like?tweet_id=1654129724241727488)[](https://x.com/mattpocockuk/status/1654129724241727488)
...
So I stripped down Rocket Rental to a much simpler note taking application and introduced that to the world as [The Epic Stack](https://www.epicweb.dev/epic-stack) in my [Remix Conf Keynote](https://www.youtube.com/watch?v=yMK5SVRASxM&list=PLV5CVI1eNcJgNqzNwcs4UKrlJdhfDjshf) the following week. (Yes, it was stressful to do this while also running a conference, but [Zero Slope Events](https://zeroslopeevents.com/) makes running a conference much less difficult 😅).
...
![Building train track while riding the front](https://res.cloudinary.com/kentcdodds-com/image/upload/f_auto,q_auto,dpr_2.0,w_1600/kentcdodds.com/content/blog/launching-epic-web/building-train)
...
-   [Full Stack Foundations](https://github.com/epicweb-dev/full-stack-foundations/compare/fbed62dd50c6204135f2c08d9d73fc241865ee2e...b3cf9a01fa58ba24f7dc7cf77dfefe15ff71f43d) (84 commits on 19 days)
-   [Web Forms](https://github.com/epicweb-dev/web-forms/compare/3ca9eea053149049b9d6f31bfcc118a19cce6776...f0370e988b42e669f10b5cc2b714d72cc7c6bf3a) (38 commits on 12 days)
-   [Data Modeling](https://github.com/epicweb-dev/data-modeling/compare/f66a515f7428bbc16410bdb4faef3a5001ebbb3b...5f444600736b9955cc753b2db9c17bd4c4902a34) (37 commits on 8 days)
-   [Web Auth](https://github.com/epicweb-dev/web-auth/compare/9a5a669161fa353808dcd7e58add01289c6adea5...f3bd28ccfae6892671fdf44ec48e5b333d559a1c) (66 commits on 9 days)
-   [Full Stack Testing](https://github.com/epicweb-dev/full-stack-testing/compare/2d4fb64a093ff743c7207e60ed5b843bb293514c...b6024a15f759355c9948d9c399f5fb8da3f3b285) (71 commits on 8 days)

Oh, and during that time I was also still working on [the workshop app](https://github.com/epicweb-dev/kcdshop/compare/b3c29a4b1c67178f2bad8638950da2154989f274...38ef0ecfbe6899a8ceaa3ed325ac4c1a20de6081) (105 commits on 30 days).

I only feel comfortable sharing this now because the responses from the workshop attendees was phenomenal. I think some of them suspected I was just barely keeping ahead of our progress, but they were all very happy with the experience. Several of them appear on [my testimonials page](https://kentcdodds.com/testimonials).

## [Recording the workshops](#recording-the-workshops)
...
> I finished recording the Data Modeling videos today! 64 videos all about properly modeling your data and optimizing your database for a full stack application 🔥 Next up: Web Auth 🔒

[11](https://x.com/kentcdodds/status/1696962038780788903) [](https://x.com/intent/retweet?tweet_id=1696962038780788903)[298](https://x.com/intent/like?tweet_id=1696962038780788903)[](https://x.com/kentcdodds/status/1696962038780788903)
...
> jk, I stayed up later and got 10 more done. Another 30 video day! If I want to finish all the videos tomorrow, I'll need to beat my record and hit ~55 🤯 Let's gooooooooooo!

[1](https://x.com/kentcdodds/status/1702184727183274271) [](https://x.com/intent/retweet?tweet_id=1702184727183274271)[14](https://x.com/intent/like?tweet_id=1702184727183274271)[](https://x.com/kentcdodds/status/1702184727183274271)
...
> Despite discovering an issue in my Web Auth workshop and having to re-record 4 videos, I managed to also record 16 more videos today! Today I finished the two factor authentication implementation exercises. Up next is third party auth (OAuth/SSO/etc applies here).

[4](https://x.com/kentcdodds/status/1700282756796961189) [](https://x.com/intent/retweet?tweet_id=1700282756796961189)[27](https://x.com/intent/like?tweet_id=1700282756796961189)[](https://x.com/kentcdodds/status/1700282756796961189)
...
> I managed to get 29 videos done before the kids got home... I'm so close I can taste it. Apologies if this means you hear little kid squeals in the background of these last few videos 😅 (jk, my wife said she's taking them to the library ❤️)

[2](https://x.com/kentcdodds/status/1702425181934023124) [](https://x.com/intent/retweet?tweet_id=1702425181934023124)[9](https://x.com/intent/like?tweet_id=1702425181934023124)[](https://x.com/kentcdodds/status/1702425181934023124)
...
> That thing where the Chrome Devtools network tab hasn't had a UI update in years and then they update it right after you finish 452 videos to instantly date your videos 🤦‍♂️ What. The. Heck. 😆😂😭

[](https://x.com/kentcdodds/status/1703819483746623856)

[19](https://x.com/kentcdodds/status/1703819483746623856) [](https://x.com/intent/retweet?tweet_id=1703819483746623856)[436](https://x.com/intent/like?tweet_id=1703819483746623856)[](https://x.com/kentcdodds/status/1703819483746623856)

Thanks a lot Chrome team 😂 🤷‍♂️ 🙃

## [Prepping for Launch](#prepping-for-launch)

[The team](https://www.epicweb.dev/credits) was hard at work getting the videos and the site ready for publication. I also needed to finish up writing some of the instructions for some of the workshops and I had some improvements to make to the workshop app as well.
...
> Only have to write instructions for 5 more exercises. Each one requires about as much written content as you would expect from a full-length tutorial on the topic (almost then length of a chapter in a Harry Potter book). nbd. This is 5 of 55 exercises in the whole series 😆

[](https://x.com/kentcdodds/status/1704533808786399238)

[3](https://x.com/kentcdodds/status/1704533808786399238) [](https://x.com/intent/retweet?tweet_id=1704533808786399238)[19](https://x.com/intent/like?tweet_id=1704533808786399238)[](https://x.com/kentcdodds/status/1704533808786399238)
...
We decided we wanted to launch on my birthday, October 18th. But we also wanted to start giving people early access. Folks who bought both Epic React and TestingJavaScript Pro were invited to jump on Epic Web at a 40% discount a week before the official launch. The next day it was opened to folks who bought either before. Feedback was very positive, so we were ready for launch day.

## [The Launch](#the-launch)

We wanted to make the first 24 hours **huge.** So we decided to offer a 40% discount + free access to both Epic React and TestingJavaScript.com to anyone who bought Epic Web in the first 24 hours. This is a ridiculous value.
...
I'm super excited about the future of Epic Web. With Epic React and Testing JavaScript, I created the material, published, and it was done (with small, necessary updates here and there). Epic Web is bigger and certainly not done. I have so much that I still want to teach. Here's some stuff on my list:
...
So that's what I did! So I reached out to [Simon Vrachliotis](https://x.com/simonswiss) and he agreed to contribute to the Epic Web world! He's already started producing free material for Epic Web which you can find on [his instructor page](https://www.epicweb.dev/authors/simon-vrachliotis).
