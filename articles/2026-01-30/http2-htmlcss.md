...
source: "https://blog.jxck.io/entries/2016-02-15/loading-css-over-http2.html"
...
## [HTTP/1.1 時代の CSS](#http1.1-時代の-css)
...
`<link rel=stylesheet>` があるとロードされるまで、直ちにレンダリングを止める。このため、`<link>` より _上_ の要素も、レンダリング途中で止まる場合がよくある。
...
## [Firefox での FOUC 対策](#firefox-での-fouc-対策)
