---
title: "ABNF Parser の実装"
source: "https://blog.jxck.io/entries/2021-10-21/abnf-parser.html"
...
しかし、ABNF に忠実な実装ができると、それは逆に _ABNF が意味的に正しいか_ を検証する手段にもなる。
...
-   Jxck/structured-field-values
    -   [https://github.com/Jxck/structured-field-values/blob/master/bnf/bnf.js](https://github.com/Jxck/structured-field-values/blob/master/bnf/bnf.js)
...
## [IETF と WHATWG での違い](#ietf-と-whatwg-での違い)
