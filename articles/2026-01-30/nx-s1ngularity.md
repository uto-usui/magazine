---
title: "Nx の攻撃から学べること #s1ngularity"
...
-   feat(repo): add GitHub Actions workflow to validate PR titles by AgentEnder · Pull Request #32458 · nrwl/nx
    -   [https://github.com/nrwl/nx/pull/32458](https://github.com/nrwl/nx/pull/32458)
...
[https://github.com/nrwl/nx/pull/32496](https://github.com/nrwl/nx/pull/32496)

しかし、任意の Shell が実行できるということは、例えば以下のようにすれば、何でもできる。

  ![PR のタイトルでスクリプトを取得し実行する例](https://blog.jxck.io/entries/2025-09-03/shell-injection-pr.png?250903_161837)
...
ところが、この PR にはおなじみの "🤖 Generated with Claude Code" が付与されていた。
  ...
  ![](https://blog.jxck.io/entries/2025-09-03/PR-by-CC.png?250903_161837)
...
-   GitHub Actions のセキュリティ強化 - GitHub Enterprise Cloud Docs
    -   [https://docs.github.com/ja/enterprise-cloud@latest/enterprise-onboarding/github-actions-for-your-enterprise/security-hardening-for-github-actions#example-of-a-script-injection-attack](https://docs.github.com/ja/enterprise-cloud@latest/enterprise-onboarding/github-actions-for-your-enterprise/security-hardening-for-github-actions#example-of-a-script-injection-attack)
...
## [GITHUB\_TOKEN の窃取](#github_token-の窃取)
...
> For workflows that are triggered by the pull\_request\_target event,
> 
> the GITHUB\_TOKEN is granted read/write repository permission
> 
> unless the permissions key is specified and the workflow
> 
> can access secrets, even when it is triggered from a fork.
> 
> — [https://docs.github.com/ja/actions/reference/workflows-and-actions/events-that-trigger-workflows#pull\_request\_target](https://docs.github.com/ja/actions/reference/workflows-and-actions/events-that-trigger-workflows#pull_request_target)
...
-   [https://github.com/nrwl/nx/blob/400e3003d72acd75522468d58fdc160e76e13a68/.github/workflows/publish.yml](https://github.com/nrwl/nx/blob/400e3003d72acd75522468d58fdc160e76e13a68/.github/workflows/publish.yml)
...
-   \[skip ci\] Update publish-resolve-data.js · nrwl/nx@3905475
    -   [https://github.com/nrwl/nx/commit/3905475cfd0e0ea670e20c6a9eaeb768169dc33d](https://github.com/nrwl/nx/commit/3905475cfd0e0ea670e20c6a9eaeb768169dc33d)
...
-   Compromised Package versions as of v20.9.0 and v21.5.0 · Issue #32522 · nrwl/nx
    -   [https://github.com/nrwl/nx/issues/32522#issuecomment-3231702053](https://github.com/nrwl/nx/issues/32522#issuecomment-3231702053)
...
-   [https://play.clickhouse.com/play?user=play#](https://play.clickhouse.com/play?user=play#)
  ...
  ![攻撃されたリポジトリのリスト](https://blog.jxck.io/entries/2025-09-03/attacked-repo.png?250903_161837)
...
-   [https://x.com/adnanthekhan/status/1961152614055207039](https://x.com/adnanthekhan/status/1961152614055207039)
...
-   npm trusted publishing with OIDC is generally available - GitHub Changelog
    -   [https://github.blog/changelog/2025-07-31-npm-trusted-publishing-with-oidc-is-generally-available/](https://github.blog/changelog/2025-07-31-npm-trusted-publishing-with-oidc-is-generally-available/)
-   Trusted publishing for npm packages | npm Docs
    -   [https://docs.npmjs.com/trusted-publishers#supported-cicd-providers](https://docs.npmjs.com/trusted-publishers#supported-cicd-providers)
...
-   About code scanning with CodeQL - GitHub Docs
    -   [https://docs.github.com/en/code-security/code-scanning/introduction-to-code-scanning/about-code-scanning-with-codeql](https://docs.github.com/en/code-security/code-scanning/introduction-to-code-scanning/about-code-scanning-with-codeql)
...
-   [https://x.com/adnanthekhan/status/1958723681913385382](https://x.com/adnanthekhan/status/1958723681913385382)
...
> What a PR [https://t.co/zdMt9Ilq4r](https://t.co/zdMt9Ilq4r) by @NxDevTools
> 
...
> 
> — [https://x.com/adnanthekhan/status/1958722939534417989](https://x.com/adnanthekhan/status/1958722939534417989)
...
-   chore(repo): add SECURITY.md and disable PR release by jaysoo · Pull Request #32536 · nrwl/nx
    -   [https://github.com/nrwl/nx/pull/32536](https://github.com/nrwl/nx/pull/32536)
...
8.  pull\_request\_target to pull\_request - 権限昇格を防ぐ
