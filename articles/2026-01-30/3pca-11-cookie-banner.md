---
title: "3PCA 11 日目: Cookie Banner"
source: "https://blog.jxck.io/entries/2023-12-11/3pca-banner.html"
...
-   同意に関するガイドライン 05/2020 - 個人情報保護委員会 - (ppc.go.jp)
    -   [https://www.ppc.go.jp/files/pdf/doui\_guideline\_v1.1\_koushin.pdf](https://www.ppc.go.jp/files/pdf/doui_guideline_v1.1_koushin.pdf)
...
バナーはサイト下部に Window 幅のパターンで実装されている。
  ...
  ![欧州委員会の Cookie Banner](https://blog.jxck.io/entries/2023-12-11/europa.eu.png?240212_235833)
...
-   Cookies policy (europa.eu)
    -   [https://commission.europa.eu/cookies-policy\_en](https://commission.europa.eu/cookies-policy_en)

このページでは「Cookie とは何か」から始まって、「なぜ、どのように使っているのか」といったことも全て説明している。これが「十分な説明」の実装にあたる。

特に注目したいのは以下のテーブルだ。

  ![Cookie の名前や用途のテーブル](https://blog.jxck.io/entries/2023-12-11/europa.eu.cookie-table.png?240212_235833)
...
-   Website of the Federal Government | Bundesregierung
    -   [https://www.bundesregierung.de/breg-en](https://www.bundesregierung.de/breg-en)

こちらは、サイトの上部に Window 幅 Sticky のパターンで実装されている。

  ![ドイツ連邦政府の Cookie Banner](https://blog.jxck.io/entries/2023-12-11/bundesregierung.de.png?240212_235833)
...
"Confirm selection" をクリックするとバナーが消え、選択結果が JS で Cookie に保存される。
  ...
  ![選択結果が反映されたことを保存する Cookie](https://blog.jxck.io/entries/2023-12-11/bundesregierung.de.cookie.png?240212_235833)
...
-   Data Privacy Policy (bundesregierung.de)
    -   [https://www.bundesregierung.de/breg-en/service/data-privacy-information/data-privacy-policy-1534306#\[anker\]](https://www.bundesregierung.de/breg-en/service/data-privacy-information/data-privacy-policy-1534306#[anker])

GDPR に準拠していることや、使用している Cookie の値も記載されている。

  ![使用している Cookie の値の説明](https://blog.jxck.io/entries/2023-12-11/bundesregierung.de.explanation.png?240212_235833)
...
こちらもページトップの実装だ。
  ...
  ![イギリス政府サイトの Cookie Banner](https://blog.jxck.io/entries/2023-12-11/gov.uk.png?240212_235833)

注目すべきは "View Cookies" のページだ。

-   Cookies on GOV.UK
    -   [https://www.gov.uk/help/cookies](https://www.gov.uk/help/cookies)

このページは、さらに詳細な Cookie の説明を別ページにし、その上で以下のような設定 UI を持っている。

  ![イギリス政府の Cookie についての説明のページ](https://blog.jxck.io/entries/2023-12-11/gov.uk.explanation.png?240212_235833)
...
-   News, sport and opinion from the Guardian's global edition | The Guardian
  ...
  ![Guardian の Cookie Banner](https://blog.jxck.io/entries/2023-12-11/guardian.png?240212_235833)
...
Manage or reject を選ぶと、以下のポップアップが出てくる。
  ...
  ![Guardian の Cookie Settings](https://blog.jxck.io/entries/2023-12-11/guardian.settings.png?240212_235833)
...
ここはポップアップ実装だ。
  ...
  ![Financial Times の Cookie Banner](https://blog.jxck.io/entries/2023-12-11/financial-times.png?240212_235833)

"Manage cookies" の UI は、個別選択の実装をせず "Allow" / "Block" のみの、シンプルで分かりやすい実装だ。

  ![Financial Times の Manage Cookies](https://blog.jxck.io/entries/2023-12-11/financial-times-manage-cookies.png?240212_235833)
...
-   Privacy policy | Help Centre
    -   [https://help.ft.com/legal-privacy/privacy-policy/](https://help.ft.com/legal-privacy/privacy-policy/)
...
このサイト自体はバナーが出ないが、サービスは 3rd Party として機能を提供するものであるため、サイトの下部に "Do Not Sell or Share My Info" リンクがある。
  ...
  ![Disqus のフッター](https://blog.jxck.io/entries/2023-12-11/disqus-footer.png?240212_235833)

この先にオプトアウトの UI が設置されている。

  ![Disqus のオプトアウト](https://blog.jxck.io/entries/2023-12-11/disqus-optout.png?240212_235833)
...
-   デジタル庁
  ...
  ![デジタル庁のトップページ](https://blog.jxck.io/entries/2023-12-11/digital.go.jp.png?240212_235833)

特に Cookie バナーはない。

プライバシーポリシーを確認する。

  ![クッキーの利用に関する説明](https://blog.jxck.io/entries/2023-12-11/digital.go.jp.cookies.png?240212_235833)
...
なお、User Insight を提供しているユーザローカルのページがリンクされている。
  ...
  ![リンクされているユーザローカルのページ](https://blog.jxck.io/entries/2023-12-11/userlocal.jp.policy.png?240212_235833)
...
Cookie バナーが表示される。
  ...
  ![日経電子版のバナー](https://blog.jxck.io/entries/2023-12-11/nikkei-banner.png?240212_235833)

これは、「外部送信規律」の「通知」にあたる UI だろう。特に Accept/Reject ではなく、利用している事実のみを述べ、ポリシーへの導線のみを伝えている。

-   日本経済新聞社 - クッキーなどで取得する情報の取り扱いについて
    -   [https://www.nikkei.com/lounge/privacy/cookie/policy.html](https://www.nikkei.com/lounge/privacy/cookie/policy.html)

今回世界中の様々なサイトを調べたが、この日経の Cookie ポリシーのページは、日本語であることを差し置いても、群を抜いて分かりやすく書かれている。

  ![日経電子版の Cookie ポリシー](https://blog.jxck.io/entries/2023-12-11/nikkei-policy.png?240212_235833)
...
-   日本経済新聞社 - ご利用履歴情報の外部送信一覧
    -   [https://www.nikkei.com/lounge/privacy/cookie/optout.html](https://www.nikkei.com/lounge/privacy/cookie/optout.html)