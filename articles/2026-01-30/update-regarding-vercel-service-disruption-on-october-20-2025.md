---
title: "Update regarding Vercel service disruption on October 20, 2025"
source: "https://vercel.com/blog/update-regarding-vercel-service-disruption-on-october-20-2025"
...
## [Link to heading](#service-disruption-overview)Service disruption overview
...
### [Link to heading](#initial-loss-of-the-us-east-1-region)Initial loss of the `us-east-1` region
...
### [Link to heading](#secondary-disruption-of-vercel’s-control-plane)Secondary disruption of Vercel’s control plane
...
For additional details and service-specific information, [see the full timeline](#incident-timeline).

## [Link to heading](#the-disruption-from-the-perspective-of-a-request)The disruption from the perspective of a request
...
## [Link to heading](#incident-timeline)Incident timeline
...
## [Link to heading](#future-improvements)Future improvements
