---
title: "Houdini Paint API"
source: "https://blog.jxck.io/entries/2017-10-31/houdini-paint-api.html"
...
### [Style Property Map](#style-property-map)
...
## [動作イメージ](#動作イメージ)
  ...
  ![Houdini Paint API で色と間隔を変更可能な二重線を引くデモ](https://blog.jxck.io/entries/2017-10-31/border-double-custom.png?200901_002432 "border-double-custom implemented by css paint api")

## [DEMO](#demo)

動作するデモを以下に用意した。

-   [https://labs.jxck.io/houdini/paint/border-double-custom/](https://labs.jxck.io/houdini/paint/border-double-custom/)
