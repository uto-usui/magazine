---
title: "SQL でファイル検索するコマンド selects を書いた話"
source: "https://blog.jxck.io/entries/2016-08-05/sql-for-file-search.html"
...
### [/dev 以下で pipe か socket か symlink だけを ctime, atime の順で](#dev-以下で-pipe-か-socket-か-symlink-だけを-ctime-atime-の順で)
...
だから Ruby を知ってて SQL が書ける人には、_Ruby で書いた SQL っぽいメソッドチェインに見える_ というメリットがある(と思う)。
