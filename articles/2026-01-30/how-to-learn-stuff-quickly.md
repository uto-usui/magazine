...
## [Link to this heading](#mixing-guided-and-unguided-learning-1)Mixing guided and unguided learning
...
### [Link to this heading](#making-intentional-mistakes-2)Making intentional mistakes
...
### [Link to this heading](#extending-tutorials-3)Extending tutorials

Let's suppose we're learning React by building a tic-tac-toe game, following the [official tutorial(opens in new tab)](https://react.dev/learn/tutorial-tic-tac-toe).
...
It also has a nice side-benefit: if you add significant extensions to a tutorial project, you can take credit for it in your portfolio! I cover this strategy in depth in my book, [Building an Effective Dev Portfolio(opens in new tab)](https://www.joshwcomeau.com/effective-portfolio/).
...
I've seen this strategy described as "one on, one off". Follow a guided resource like a tutorial, and then spend an equal amount of time creating a similar (but unguided) project. If the tutorial shows you how to build an Instagram clone, try building a Bluesky clone on your own!

## [Link to this heading](#mindset-cultivation-5)Mindset cultivation
...
There is a self-fulfilling prophecy aspect to this: whichever interpretation you choose will be correct. If you think that your level of bowling skill is fixed, it will be. If you believe that you can improve, you will!This isn't to say that everyone starts from the same place; I do believe that natural ability exists! But all of us have the potential to improve tremendously.
...
Learn more about [cultivating a growth mindset(opens in new tab)](https://www.youtube.com/watch?v=-71zdXCMU6A).

## [Link to this heading](#goals-and-motivation-6)Goals and motivation
...
(If you're interested in this project, you can [view it live(opens in new tab)](https://beatmapper.app/), [check out the code(opens in new tab)](https://github.com/joshwcomeau/beatmapper) on Github, or [watch a conference talk(opens in new tab)](https://www.youtube.com/watch?v=9u0VapB-AbE) about its development!)
...
## [Link to this heading](#remembering-things-7)Remembering things
...
It sounds complicated, but there are tools that can keep track of this for you. Personally, I use a leitner box, a physical box that holds a few hundred index cards. Every day, I'll review a small handful of cards.Full disclosure: I'll occasionally forget to do this, sometimes for weeks in a row 😅 but even with that negligence, it still helps a lot!

If you're interested in learning more about spaced repetition, I _strongly_ encourage you to check out this explorable explanation by Nicky Case: [“How to Remember Anything Forever-ish”(opens in new tab)](https://ncase.me/remember/).

## [Link to this heading](#building-a-daily-habit-8)Building a daily habit
...
## [Link to this heading](#learning-in-public-9)Learning in public

I'm a big fan of Swyx's [Learn in Public(opens in new tab)](https://www.swyx.io/learn-in-public/) philosophy.
...
One word of caution: don't fall into the trap of spending weeks setting up the perfect blog from scratch! Start by publishing on a platform like [Dev(opens in new tab)](https://dev.to/), or even on LinkedIn! I published dozens of blog posts on Medium before I built my blog. If you discover that you really enjoy learning in public, you can always migrate to a fancy custom blog later. 😄

## [Link to this heading](#a-network-of-skills-10)A network of skills

Recently, I started teaching myself how to create 3D illustrations using [Blender(opens in new tab)](https://www.blender.org/).
...
My goal is to change your relationship with CSS. So many JS developers find it frustrating and counterintuitive. If you want to level up your CSS skills, you can [learn more about the course(opens in new tab)](https://css-for-js.dev/).
