...
source: "https://kentcdodds.com/blog/how-to-implement-usestate-with-usereducer"
...
## [The `useState` API](#the-usestate-api)
...
## [The `useReducer` API](#the-usereducer-api)
...
## [The `useReducer`\-based `useState` implementation](#the-usereducer-based-usestate-implementation)
