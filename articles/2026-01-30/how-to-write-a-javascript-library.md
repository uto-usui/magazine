...
source: "https://kentcdodds.com/blog/how-to-write-a-javascript-library"
publishedDate: "2015-09-02"
category: "frontend"
feedName: "Kent C. Dodds"
---

There's a lot of steps to creating and maintaining an open source library. It's like becoming a parent. Open source libraries _can be_ quite demanding, impatient, and time consuming.
...
Not all libraries need all of this, but many would benefit from having this. If you're curious, check out the (free) lesson series on egghead.io: [How to Write a JavaScript Library](https://egghead.io/courses/how-to-write-an-open-source-javascript-library?af=5236ad). Start writing more open source JavaScript today! 👍

If you have any recommendations or questions, catch me on [Twitter](https://x.com/kentcdodds).