...
source: "https://blog.jxck.io/entries/2016-02-08/h2o-http2-deploy.html"
...
実は _.jxck.io_ に対するワイルドカード証明書を買っている。
...
これは、せっかくなので _TLS1.2_ 以下を切ったり、_暗号スイート_ を強めに制限したりしているため、古い Android への対応できてないからである。

積極的に切って行くスタイル。

## [静的ファイルへのマッピング](#静的ファイルへのマッピング)
