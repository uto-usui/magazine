---
title: "OWASP に Cookie Theft 対策 Cheat Sheet を執筆した"
source: "https://blog.jxck.io/entries/2025-03-03/owasp-cheat-sheet.html"
...
-   Cookie Theft 対策と Device Bound Session Credentials | blog.jxck.io
    -   [https://blog.jxck.io/entries/2025-01-16/device-bound-session-credentials.html](https://blog.jxck.io/entries/2025-01-16/device-bound-session-credentials.html)

しかし、その標準化と普及にはまだまだ時間がかかるため、現状でも「Cookie が盗まれた場合に、迅速にその事実を検出する」という対策が必須となる。

これが Cookie Theft Mitigation と呼ばれる(筆者が呼んでいる?)対策だ。

## [Cookie Theft Mitigation](#cookie-theft-mitigation)
...
-   Cookie Theft Mitigation - OWASP Cheat Sheet Series
    -   [https://cheatsheetseries.owasp.org/cheatsheets/Cookie\_Theft\_Mitigation\_Cheat\_Sheet.html](https://cheatsheetseries.owasp.org/cheatsheets/Cookie_Theft_Mitigation_Cheat_Sheet.html)
