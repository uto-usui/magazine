...
**[Watch "When to useState instead of useReducer" on egghead.io](https://egghead.io/lessons/react-when-to-usestate-instead-of-usereducer?pl=kent-s-blog-posts-as-screencasts-eefa540c&af=5236ad)**

**[Watch "When to useReducer instead of useState" on egghead.io](https://egghead.io/lessons/egghead-when-to-usereducer-instead-of-usestate?pl=kent-s-blog-posts-as-screencasts-eefa540c&af=5236ad)**
...
### [Custom `useDarkMode` hook](#custom-usedarkmode-hook)
...
#### [`useState` implementation](#usestate-implementation)
...
#### [`useReducer` implementation:](#usereducer-implementation)
...
### [Custom `useUndo` hook](#custom-useundo-hook)

There's a great [`useUndo` hook on GitHub](https://github.com/xxhomey19/use-undo). I took inspiration from that for this example. Thank you [Homer Chen](https://x.com/xxhomey19)!

(For these, almost everything is interacting with state, so... no highlights...)

#### [`useState` implementation](#usestate-implementation-1)
...
That said, if we were to call `reset` in an async function (like after making an HTTP request), then that _would_ result in three re-renders. However, in the future with concurrent mode those will be batched as well. So my main concern isn't the re-renders.
...
#### [`useReducer` implementation](#usereducer-implementation-1)
