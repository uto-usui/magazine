---
title: "\"Less Password\" 時代のアカウント防災訓練"
source: "https://blog.jxck.io/entries/2025-01-27/account-recovery.html"
...
現代のアカウントの管理は、"_Password Less_" を目指す過渡期で、中途半端に複雑だ。Password は無くなっているというより、集約された "_Less Password_" 状態であり、残る「最後の Password」を起点にどう全体を復元するかが、災害時リカバリの課題となる。これに失敗して全てが詰むと、仮に無事避難できたとしても、相当な喪失を味わうだろう。
...
![依存が複雑なリカバリの連鎖](https://blog.jxck.io/entries/2025-01-27/recovery-chain.drawio.svg?250127_155159)
...
![チェーンをシンプルにし復旧コストを下げたチェーン](https://blog.jxck.io/entries/2025-01-27/simplified-chain.drawio.svg?250127_155348)
...
セキュリティと可用性はトレードオフだが、多くの一般ユーザにとっては「_攻撃されるリスク_」よりも「_ミスって詰む_」リスクのほうがよっぽど高いと個人的には思っている。
...
![Password と Authenticator の二要素認証](https://blog.jxck.io/entries/2025-01-27/2-factor-auth.drawio.svg?250127_154118)
...
![1Password での一要素二段階認証](https://blog.jxck.io/entries/2025-01-27/1-factor-2-step-auth.drawio.svg?250127_154118)
...
3.  Password
  ...
  ![1Password のサインイン画面。前述の 3 つが必要](https://blog.jxck.io/entries/2025-01-27/1password-signin.png?250127_154118)
...
![現在のリカバリチェーン](https://blog.jxck.io/entries/2025-01-27/current-recovery-chain.drawio.svg?250130_135129)
