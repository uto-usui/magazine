...
source: "https://jakearchibald.com/2025/fetch-streams-not-for-progress/"
...
### [But they're not ideal for measuring download progress](#but-theyre-not-ideal-for-measuring-download-progress)
...
### [But they're bad for measuring upload progress](#but-theyre-bad-for-measuring-upload-progress)
...
### [Using streams to measure upload progress could cause problems in future](#using-streams-to-measure-upload-progress-could-cause-problems-in-future)
...
## [How to measure upload progress](#how-to-measure-upload-progress)
