---
title: "Background Fetch API が消えそうだった話"
source: "https://blog.jxck.io/entries/2025-12-08/deprecating-background-fetch.html"
...
-   mozaic.fm v3 リリースと Podcast の PWA 化 | blog.jxck.io
    -   [https://blog.jxck.io/entries/2020-05-06/mozaic-v3-release.html](https://blog.jxck.io/entries/2020-05-06/mozaic-v3-release.html)
-   Podcast over PWA
    -   [https://speakerdeck.com/jxck/podcast-over-pwa](https://speakerdeck.com/jxck/podcast-over-pwa)
...
## [Deprecate Background Fetch](#deprecate-background-fetch)
...
-   Chrome Platform Status
    -   [https://cr-status.appspot.com/metrics/feature/timeline/popularity/2550](https://cr-status.appspot.com/metrics/feature/timeline/popularity/2550)

  ![Chrome Status の Background Fetch API Usage](https://blog.jxck.io/entries/2025-12-08/background-fetch-usage.png?251208_230839)
...
## [Intent to Deprecate](#intent-to-deprecate)

TPAC が終わってすぐ、その Intent は公開された。

-   Intent to Ship: deprecate BackgroundFetch
    -   [https://groups.google.com/a/chromium.org/g/blink-dev/c/CpXXaJh5Rq8/](https://groups.google.com/a/chromium.org/g/blink-dev/c/CpXXaJh5Rq8/)
