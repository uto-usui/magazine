...
## [An (Artificially) Slow Component](#an-artificially-slow-component)
...
## [Solution 1: Move State Down](#solution-1-move-state-down)
...
## [Solution 2: Lift Content Up](#solution-2-lift-content-up)
...
## [What’s the moral?](#whats-the-moral)
...
## [Didn’t I read about this before?](#didnt-i-read-about-this-before)
