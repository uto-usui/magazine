...
## [Link to heading](#setting-up-the-eval)Setting up the eval
...
2.  **Bash agent**: Using [`just-bash`](https://github.com/vercel-labs/bash-tool) to navigate and query JSON files on the filesystem
...
## [Link to heading](#initial-results)Initial results
...
## [Link to heading](#debugging-the-results)Debugging the results
...
## [Link to heading](#the-hybrid-approach)The hybrid approach
...
## [Link to heading](#key-learnings)Key learnings
...
## [Link to heading](#what-this-means-for-agent-design)What this means for agent design
...
## [Link to heading](#run-your-own-benchmarks)Run your own benchmarks
...
_This post was written by_ [_Ankur Goyal_](https://x.com/ankrgyl) _and the team at_ [_Braintrust_](https://www.braintrust.dev/)_, who build evaluation infrastructure for AI applications. The eval harness is open source and integrates with_ [`_just-bash_`](https://github.com/vercel-labs/bash-tool) _from Vercel._