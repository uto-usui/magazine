---
title: "閲覧履歴があってもリンクの色が変わらないケースについて"
source: "https://blog.jxck.io/entries/2025-04-16/link-visited-history.html"
...
![リンク先が閲覧済みの場合色が変わる](https://blog.jxck.io/entries/2025-04-16/link-visited.drawio.svg?250416_175407)
...
![Google 検索から直接ページにアクセスする](https://blog.jxck.io/entries/2025-04-16/google-search.drawio.svg?250417_235247)

その後また Wikipedia の「ハイパーリンク」ページに戻ったら、当然閲覧済みの「ハイパーテキスト」のリンクは色が変わると想定されるだろう。

ところが、今後この場合は、色が変わらなくなる。

![閲覧済みなのにリンクの色が変わらない](https://blog.jxck.io/entries/2025-04-16/link-visited-but-unchanged.drawio.svg?250417_235247)
...
-   A proposal to partition :visited link history by top-level site and frame origin.
    -   [https://github.com/explainers-by-googlers/Partitioning-visited-links-history?tab=readme-ov-file#motivation](https://github.com/explainers-by-googlers/Partitioning-visited-links-history?tab=readme-ov-file#motivation)
-   Browsing History Sniffing 最前線 - あなたのブラウザ履歴を狙う攻撃たち - やっていく気持ち
    -   [https://diary.shift-js.info/browsing-history-sniffing/](https://diary.shift-js.info/browsing-history-sniffing/)
...
エンジニア向けに今回の変更を解説するならば、「_閲覧履歴が複合キーで管理されるようになる_」ということになる(Partitioning)。
...
そこで、今後は「_どのサイトの_」「_どの URL か_」という、複合キーに変更したのだ。
...
そこで、実際には「_どのサイトの_」「_どの `<iframe>` に埋め込まれた_」「_どの URL か_」という 3 つのキーで管理されている。(Triple Keying)
...
-   A proposal to partition :visited link history by top-level site and frame origin.
    -   [https://github.com/explainers-by-googlers/Partitioning-visited-links-history](https://github.com/explainers-by-googlers/Partitioning-visited-links-history)
...
-   Intent to Experiment: Partitioning :visited links history Phase 1
    -   [https://groups.google.com/a/chromium.org/g/blink-dev/c/U5AX0OXaxM8](https://groups.google.com/a/chromium.org/g/blink-dev/c/U5AX0OXaxM8)
-   Intent to Experiment: Partitioning :visited links history Phase 2
    -   [https://groups.google.com/a/chromium.org/g/blink-dev/c/qbHl0W-75zA](https://groups.google.com/a/chromium.org/g/blink-dev/c/qbHl0W-75zA)

それがトライアルを終え、今回 Ship されることとなったのだ。

-   Intent to Ship: Partitioning :visited links history
    -   [https://groups.google.com/a/chromium.org/g/blink-dev/c/8dZqt8JuLdc](https://groups.google.com/a/chromium.org/g/blink-dev/c/8dZqt8JuLdc)

Chrome チームからのエントリも出ている。

-   Making :visited more private
    -   [https://developer.chrome.com/blog/visited-links](https://developer.chrome.com/blog/visited-links)
...
-   Partitioned :visited links history · Issue #1040 · mozilla/standards-positions
    -   [https://github.com/mozilla/standards-positions/issues/1040](https://github.com/mozilla/standards-positions/issues/1040)
-   Partitioning :visited links history · Issue #363 · WebKit/standards-positions
    -   [https://github.com/WebKit/standards-positions/issues/363](https://github.com/WebKit/standards-positions/issues/363)
...
-   webappsec/meetings/2023/2023-06-21-minutes.md at main · w3c/webappsec
    -   [https://github.com/w3c/webappsec/blob/main/meetings/2023/2023-06-21-minutes.md](https://github.com/w3c/webappsec/blob/main/meetings/2023/2023-06-21-minutes.md)
...
-   Revisiting why hyperlinks are blue
    -   [https://blog.mozilla.org/en/internet-culture/why-are-hyperlinks-blue-revisited/](https://blog.mozilla.org/en/internet-culture/why-are-hyperlinks-blue-revisited/)
...
-   Spec
    -   Selectors Level 4
        -   [https://drafts.csswg.org/selectors-4/#visited-privacy](https://drafts.csswg.org/selectors-4/#visited-privacy)
-   Explainer
    -   A proposal to partition :visited link history by top-level site and frame origin.
        -   [https://github.com/explainers-by-googlers/Partitioning-visited-links-history](https://github.com/explainers-by-googlers/Partitioning-visited-links-history)
-   Requirements Doc
...
-   TAG Design Review
    -   Partitioning :visited links history · Issue #896 · w3ctag/design-reviews
        -   [https://github.com/w3ctag/design-reviews/issues/896](https://github.com/w3ctag/design-reviews/issues/896)
-   Intents
    -   Intent to Experiment: Partitioning :visited links history Phase 1
        -   [https://groups.google.com/a/chromium.org/g/blink-dev/c/U5AX0OXaxM8](https://groups.google.com/a/chromium.org/g/blink-dev/c/U5AX0OXaxM8)
    -   Intent to Experiment: Partitioning :visited links history Phase 2
...
-   Chrome Platform Status
    -   Partitioning :visited links history - Chrome Platform Status
        -   [https://chromestatus.com/feature/5101991698628608](https://chromestatus.com/feature/5101991698628608)
...
-   Issues
    -   Partition :visited links history \[40064793\] - Chromium
        -   [https://issues.chromium.org/issues/40064793](https://issues.chromium.org/issues/40064793)
-   Other
    -   webappsec/meetings/2023/2023-06-21-minutes.md at main · w3c/webappsec
        -   [https://github.com/w3c/webappsec/blob/main/meetings/2023/2023-06-21-minutes.md](https://github.com/w3c/webappsec/blob/main/meetings/2023/2023-06-21-minutes.md)