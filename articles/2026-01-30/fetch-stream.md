---
title: "Fetch での Stream を用いたプログレス取得とキャンセル"
source: "https://blog.jxck.io/entries/2016-07-21/fetch-progress-cancel.html"
...
現在の Promise の仕様では、非同期処理に対してあくまで _fulfilled(完了した)_ か _rejected(失敗した)_ の二つの状態を返すことしかできない。
...
Stream は、I/O 処理を chunk ごとに返し、非同期処理の _途中_ に処理を挟むための仕様である。
...
## [Promise の cancel](#promise-の-cancel)
...
Stream での progress と cancel は可能になったが、まだ _ブラウザが実装しているか_ という問題もある。
...
-   [@hirano\_y\_aa](https://twitter.com/hirano_y_aa)
