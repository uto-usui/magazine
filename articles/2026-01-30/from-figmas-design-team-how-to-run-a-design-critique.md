---
title: "From Figma's design team: How to run a design critique"
...
![](data:image/png;base64,)![](https://cdn.sanity.io/images/599r6htc/regionalized/da70942b82e3aff8098733a89d2a2667b4c91c97-2029x1295.png?rect=0,1,2029,1294&w=1080&h=689&q=75&fit=max&auto=format)

Ongoing suggestions in the #design-crit-crit channel

## [Aligning on goals](#aligning-on-goals)
...
## [Six critique methods](#six-critique-methods)
...
### [1\. Standard critiques](#_1-standard-critiques)

##### [Standard format. Present context, receive feedback.](#standard-format-present-context-receive-feedback)
...
###### [Step 1: Sharing context & internalizing feedback (~10–15m)](#step-1-sharing-context-internalizing-feedback-10)
...
Rather than present on a big screen, we often send everyone a Figma link and have them jump into [Observation Mode](https://www.figma.com/blog/figma-feature-highlight-observation-mode/)

. We find it much easier to see details this way, it works great for remote participants, is more reliable connectivity-wise, and better for high frame-rates than most screen-sharing software. You run the small risk of people wandering in the file rather than observing, but we’ve found that can also sometimes be a good thing if someone missed something but didn’t want to stop the full group for it.

###### [Step 2: Clarifying questions (~2–5m)](#step-2-clarifying-questions-2-5m)
...
![three people talking around a table](data:image/jpeg;base64,)![three people talking around a table](https://cdn.sanity.io/images/599r6htc/regionalized/e703d40414edbc9908c7c4c778ed0ff5c4e273c1-2048x1366.jpg?rect=0,1,2048,1365&w=528&h=352&q=75&fit=max&auto=format)

![person talking while two others look on](data:image/jpeg;base64,)![person talking while two others look on](https://cdn.sanity.io/images/599r6htc/regionalized/58e8524bb46e350832dbce7a2edaa8a8211e9ee2-1366x2048.jpg?rect=1,0,1365,2048&w=528&h=792&q=75&fit=max&auto=format)

###### [Step 3: Receiving feedback (10m+)](#step-3-receiving-feedback-10m)
...
###### [Step 4: Thanks & follow-ups (1m)](#step-4-thanks-follow-ups-1m)
...
### [2\. Jams & workshops](#_2-jams-workshops)

##### [Brainstorms, Crazy 8's, mood boarding, sketching, etc.](#brainstorms-crazy-8-s-mood-boarding-sketching-etc)
...
![hand writing on a piece of paper that says framework](data:image/jpeg;base64,)![hand writing on a piece of paper that says framework](https://cdn.sanity.io/images/599r6htc/regionalized/f5f577c12bddc244e1268472a020898832eebeca-2048x1366.jpg?rect=0,1,2048,1365&w=390&h=260&q=75&fit=max&auto=format)

![distorted figma screen with many cursors](data:image/jpeg;base64,)![distorted figma screen with many cursors](https://cdn.sanity.io/images/599r6htc/regionalized/62680c258f8342f0b771d61a0c87027a488987fd-2048x1366.jpg?rect=0,1,2048,1365&w=804&h=536&q=75&fit=max&auto=format)
...
![](data:image/png;base64,)![](https://cdn.sanity.io/images/599r6htc/regionalized/b6882f2ed2fea29ab6a409498f0bc25e423f8229-1210x650.png?w=1080&h=580&q=75&fit=max&auto=format)
...
### [3\. Pair design critique](#_3-pair-design-critique)

##### [Work in small groups of two or three.](#work-in-small-groups-of-two-or-three)
...
![two people working at a computer](data:image/jpeg;base64,)![two people working at a computer](https://cdn.sanity.io/images/599r6htc/regionalized/dcd41c1e20b238e638aeaabe166a3fccdda9e738-1291x1366.jpg?rect=1,0,1290,1366&w=528&h=559&q=75&fit=max&auto=format)

![person leaning across a table smiling](data:image/jpeg;base64,)![person leaning across a table smiling](https://cdn.sanity.io/images/599r6htc/regionalized/a8bb7aa1cd3abc80ab5a715986b7860de8bfbc95-1366x2048.jpg?rect=1,0,1365,2048&w=528&h=792&q=75&fit=max&auto=format)
...
### [4\. Silent critiques](#_4-silent-critiques)

##### [Everyone stays silent and reviews a document and adds feedback digitally. Similar to art gallery, except context may actually be given, and there's no verbal discussion.](#everyone-stays-silent-and-reviews-a-document-and)
...
![screen with cursors leaving stickies](data:image/jpeg;base64,)![screen with cursors leaving stickies](https://cdn.sanity.io/images/599r6htc/regionalized/29d3c70fbf34dfa6d3831f0fa2e47ce547ceb4ca-1483x1366.jpg?rect=0,1,1483,1365&w=528&h=486&q=75&fit=max&auto=format)

![hands typing on a keyboard](data:image/jpeg;base64,)![hands typing on a keyboard](https://cdn.sanity.io/images/599r6htc/regionalized/9e97840202661a895ffcf79d821072b9b63fcca2-1481x1163.jpg?rect=1,0,1480,1163&w=528&h=415&q=75&fit=max&auto=format)
...
### [5\. Paper (“print-out”) critiques](#_5-paper-print-out-critiques)

##### [Print out work on paper and hang it up around the room.](#print-out-work-on-paper-and-hang-it-up-around-the)
...
![person standing next to stickies on a glass wall](data:image/jpeg;base64,)![person standing next to stickies on a glass wall](https://cdn.sanity.io/images/599r6htc/regionalized/8cd50ea603c66d1404a8c2fbd7f5955d76154801-2697x3325.jpg?w=528&h=651&q=75&fit=max&auto=format)
...
### [6\. FYI critiques](#_6-fyi-critiques)

##### [Sharing quick context on a project. No feedback necessary.](#sharing-quick-context-on-a-project-no-feedback)
...
![people in discussion at a conference table](data:image/jpeg;base64,)![people in discussion at a conference table](https://cdn.sanity.io/images/599r6htc/regionalized/0e5eaec3237fe9522f764619960f3c1d6a01a3ca-1363x1241.jpg?w=804&h=732&q=75&fit=max&auto=format)

![man giving a knowing smiling to collaborator](data:image/jpeg;base64,)![man giving a knowing smiling to collaborator](https://cdn.sanity.io/images/599r6htc/regionalized/fda872747ad64789d353b54dc1be38b1783526f7-1366x1242.jpg?w=804&h=731&q=75&fit=max&auto=format)

## [Ten tips for running effective critiques](#ten-tips-for-running-effective-critiques)
...
#### [1\. Match methods to problems](#_1-match-methods-to-problems)
...
#### [2\. Schedule topics early](#_2-schedule-topics-early)
...
#### [3\. Use smaller rooms](#_3-use-smaller-rooms)
...
#### [4\. Buy a timer and keep diligent time](#_4-buy-a-timer-and-keep-diligent-time)
...
#### [6\. Think about what you need from the room](#_6-think-about-what-you-need-from-the-room)
...
#### [7\. Consider HOW you deliver feedback](#_7-consider-how-you-deliver-feedback)
...
#### [8\. Be vulnerable](#_8-be-vulnerable)
...
#### [9\. Remember to critique OUTSIDE of weekly meetings](#_9-remember-to-critique-outside-of-weekly-meetings)
...
#### [10\. Experiment and iterate](#_10-experiment-and-iterate)
...
-   [Brain Tree Critiques with Figma
    
    ![](data:image/png;base64,)![](https://cdn.sanity.io/images/599r6htc/regionalized/1e8bc8bf02ac14d45d7021df24bdf2aa71446a32-2120x1000.png?w=2120&h=1000&q=75&fit=crop&crop=focalpoint&auto=format)
    
    ### How Braintree cut time spent on design critiques by 50%
    
    Most design critiques are inefficient, lumbering beasts. A designer presents their work, receiving an avalanche of feedback. They then return to their computer and toil away in solitude. Another meeting is scheduled, where the designer and reviewers realize the feedback was miscommunicated, or the design didn’t work as well as expected, or that new issues cropped up with the change. Here's how Figma streamlined the process for Braintree.
    
    
    
    ](https://www.figma.com/blog/how-braintree-cut-time-spent-on-design-critiques-by-50/), Carmel DeAmicis
