...
source: "https://kentcdodds.com/blog/make-your-test-fail"
publishedDate: "2020-02-01"
category: "frontend"
feedName: "Kent C. Dodds"
---

**[Watch "Make Your Test Fail" on egghead.io](https://egghead.io/lessons/jest-make-your-test-fail?pl=kent-s-blog-posts-as-screencasts-eefa540c&af=5236ad)**
...
You can avoid these common mistakes with [`eslint-plugin-jest`](https://github.com/jest-community/eslint-plugin-jest)'s rules:
...
Also, in general, if you can find a better assertion than snapshots: [use it](https://kentcdodds.com/blog/effective-snapshot-testing).
...
P.S. [Here's a codesandbox of those tests](https://codesandbox.io/s/make-your-tests-fail-gifj8).