...
## [How does npm audit work?](#how-does-npm-audit-work)
...
Now say there’s a vulnerability discovered in `[[email protected]](https://overreacted.io/cdn-cgi/l/email-protection)`:
...
You run `npm audit fix`, and npm tries to install the latest `[[email protected]](https://overreacted.io/cdn-cgi/l/email-protection)` with the fix in it. As long as `database-layer` specifies that it depends not on _exactly_ on `[[email protected]](https://overreacted.io/cdn-cgi/l/email-protection)` but some permissible range that includes `1.0.1`, the fix “just works” and you get a working application:
...
Alternatively, maybe `[[email protected]](https://overreacted.io/cdn-cgi/l/email-protection)` depends strictly on `[[email protected]](https://overreacted.io/cdn-cgi/l/email-protection)`. In that case, the maintainer of `database-layer` needs to release a new version too, which would allow `[[email protected]](https://overreacted.io/cdn-cgi/l/email-protection)` instead:
...
## [Why is npm audit broken?](#why-is-npm-audit-broken)
...
### [First “vulnerability”](#first-vulnerability)
...
### [Second “vulnerability”](#second-vulnerability)
...
### [Third “vulnerability”](#third-vulnerability)
...
### [Fourth “vulnerability”](#fourth-vulnerability)
...
### [Fifth “vulnerability”](#fifth-vulnerability)
...
### [Shall we keep going?](#shall-we-keep-going)
