...
source: "https://zenn.dev/uhyo/articles/rewrite-relative-import-extensions-read-before-use"
...
言い方を変えれば、バンドラというのは`.ts`のインポートをランタイムに理解できる実行環境だと言えます[\[1\]](#fn-4acf-1)。
...
1.  もちろんバンドラはJavScriptランタイムではありませんが、importの解決を事前に行うという意味では、モジュール解決において部分的にJavaScriptのランタイムの役割を担っていると言えます。 [↩︎](#fnref-4acf-1)