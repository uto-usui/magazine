...
-   [Epic Web Community on Discord](https://kentcdodds.com/discord)
-   [Email](https://kentcdodds.com/contact)
-   [My AMA](https://github.com/kentcdodds/ama)
-   Replies to [my newsletter](https://kentcdodds.com/subscribe)
...
People have questions about the stuff I create or have experience with and want help with it. Totally understandable. When I have a question, I'd much rather talk to an expert on the subject than read generic documentation or outdated tutorials (this is one of the reasons that I've done my [tech chats](https://github.com/kentcdodds/ama/issues/125)).
...
## [So... what are you saying, Kent?](#so-what-are-you-saying-kent)

What I'm saying is that I'm making a change. I'm reducing my involvement in open source. I've archived [my AMA](https://github.com/kentcdodds/ama). I'm going to respond less on Twitter and Discord. I'll ignore most emails. Stuff like that.
...
## [What if I need help with EpicReact.dev or TestingJavaScript.com?](#what-if-i-need-help-with-epicreactdev-or-testingjavascriptcom)
...
If it's a question about the material, then take it to the appropriate channel on the [Epic Web Community on Discord](https://kentcdodds.com/discord). Our community is _thousands_ strong (and growing all the time) and so many super helpful and knowledgeable folks in there. If you're all stumped, then bring it to [office hours](https://kentcdodds.com/office-hours) and I'll see if I can help.
...
-   Join the [Epic Web Community on Discord](https://kentcdodds.com/discord). Questions pop up in there constantly.
-   ["Watch"](https://docs.github.com/en/free-pro-team@latest/github/getting-started-with-github/be-social#watching-a-repository) some of [my OSS repositories](https://github.com/kentcdodds) (especially [Testing Library ones](https://github.com/testing-library)).

Heck, you could even [add this search](https://x.com/search?q=to%3Akentcdodds&src=typed_query&f=live) to [your tweet deck](https://tweetdeck.twitter.com/) and chime in with "I know you didn't ask me, but how about this..."
...
![hand wave](https://res.cloudinary.com/kentcdodds-com/image/upload/f_auto,q_auto,dpr_2.0,w_1600/v1625032759/kentcdodds.com/content/blog/hi-thanks-for-reaching-out-to-me/wave.png)