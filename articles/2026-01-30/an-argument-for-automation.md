...
source: "https://kentcdodds.com/blog/automation"
...
[![Chart calculating whether something is worth the time to automate](https://res.cloudinary.com/kentcdodds-com/image/upload/f_auto,q_auto,dpr_2.0,w_1600/v1625032519/kentcdodds.com/content/blog/automation/is_it_worth_the_time.png)](https://xkcd.com/1205/)

[![Graph showing that you spend forever automating a task](https://res.cloudinary.com/kentcdodds-com/image/upload/f_auto,q_auto,dpr_2.0,w_1600/v1625032519/kentcdodds.com/content/blog/automation/automation.png)](https://xkcd.com/1319/)
...
[My blog is open source on GitHub](https://github.com/kentcdodds/kentcdodds.com). The content is stored in [`mdx`](https://mdxjs.com/) files with metadata for the post stored as frontmatter (`yaml` syntax between two `---` lines) at the top of the file (things like title, date, description, keywords, etc.). I get a tangentially related and memorable banner image from [unsplash.com](https://unsplash.com/) which is stored next to the `mdx` file in an `images` directory.
...
From there, everything is automated to get the blog post built and deployed thanks to [Netlify](https://www.netlify.com/) and [Gatsby Cloud](https://www.gatsbyjs.com/cloud/).
...
However, if you automate something that's general enough to be used by more developers, you could open source your solution and tons of developers can use it. This is something that [Stephan Bönnemann](https://x.com/boennemann) did with [semantic-release](http://npm.im/semantic-release), and I can't tell you how much time that's saved me; it's amazing.
...
You could learn how to build desktop or web apps by making a GUI for your automation. Or, you could build your own CLI tool using something like [inquirer](http://npm.im/inquirer). Using a variety of APIs can help you learn different ways to design APIs to solve problems and may help you design APIs to solve your future problems. You also learn the specific tools which can help you automate things more quickly in the future.

Then if you open source your solution you'll learn a ton about what it means to open source a project: add testing, continuous integration, releases (I recommend you automate that with the aforementioned [semantic-release](http://npm.im/semantic-release) module), and so much more.
...
If you've automated something and want to open source it, you might check out my egghead.io series of over 20 free 5 minute lessons called “[How to Write an Open Source JavaScript Library](https://egghead.io/series/how-to-write-an-open-source-javascript-library?af=5236ad)”

P.S. I've rewritten my website quite a bit since this post was originally written. You can [check out my original blog post automation script here](https://github.com/kentcdodds/old-kentcdodds.com/blob/main/generate/blogpost.js). You can [check out my new blog post automation script here](https://github.com/kentcdodds/.kenv/blob/main/scripts/new-post.js).