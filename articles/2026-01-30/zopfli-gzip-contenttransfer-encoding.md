...
source: "https://blog.jxck.io/entries/2016-02-17/content-encoding-zopfli.html"
...
また、このヘッダは _コネクションに対する設定_ であるが、HTTP2 ではこうしたコネクションに対する設定は、代わりに _SETTINGS Frame_ を利用することになったため、こうしたヘッダは設定不可とされている。
...
### [send-gzip ディレクティブ](#send-gzip-ディレクティブ)
...
_圧縮結果が gzip 互換_ であるため、方式そのものは実質 gzip である。
...
## [zopfli + send-gzip](#zopfli--send-gzip)
...
動作は、HTTP ヘッダで確認できる。
  ...
  ![圧縮が有効である場合、 content-encoding: gzip が追加されていることを確認](https://blog.jxck.io/entries/2016-02-17/zopfli.png?200901_002432 "Content-Encoding Support Before/After")
