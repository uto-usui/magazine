---
title: "3PCA 14 日目: Partitioning"
source: "https://blog.jxck.io/entries/2023-12-14/partitioning.html"
publishedDate: "2023-12-14"
category: "web-standards"
feedName: "blog.jxck.io"
---

## [様々な Partitioning](#様々な-partitioning)
...
HTTP Cache の Partitioning は _Network State Partitioning_ や _Cache Partitioning_ などと呼ばれ、だいたいのブラウザが似たような実装を進めている。

Cookie 含めた LocalStorage や IndexedDB その他もろもろは、_Storage Partitioning_ と呼ばれ、この辺はブラウザによって微妙に異なる実装になっている。
...
-   privacycg/CHIPS: A proposal for a cookie attribute to partition cross-site cookies by top-level site
    -   [https://github.com/privacycg/CHIPS](https://github.com/privacycg/CHIPS)
