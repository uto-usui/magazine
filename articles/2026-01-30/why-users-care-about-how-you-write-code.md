...
source: "https://kentcdodds.com/blog/why-users-care-about-how-you-write-code"
publishedDate: "2019-12-01"
category: "frontend"
feedName: "Kent C. Dodds"
---

Back in October of 2011 [Ryan Dahl](http://tinyclouds.org/) wrote a blogpost entitled "[I hate almost all software](http://tinyclouds.org/rant.html)" in which he asserts:
...
Now, consider if the component had been built with [SOLID programming principles](http://butunclebob.com/ArticleS.UncleBob.PrinciplesOfOod) (DRY, SRP, etc. etc.). I probably could have finished that feature in a day or less.
...
#### [So why does this matter?](#so-why-does-this-matter)
...
I'll just add this because I have to: Delete `eslint-config-react` and `eslint-config-airbnb` and use `eslint-config-react-app` instead. Also... Use [prettier](https://prettier.io/)...

* * *

Big thanks to the people who helped review and edit this post, especially [Kyle Robinson](https://x.com/ksr583) for basically being the article's editor.