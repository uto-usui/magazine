---
title: "AbortSignal.any(), AbortSignal.timeout(), そして addEventListener() の Signal"
source: "https://blog.jxck.io/entries/2023-06-01/abort-signal-any.html"
...
-   Warn on EventTarget maxListeners > THRESHOLD · Issue #35990 · nodejs/node
    -   [https://github.com/nodejs/node/issues/35990](https://github.com/nodejs/node/issues/35990)

## [AbortController.prototype.follow(signal)](#abortcontroller.prototype.followsignal)
...
-   Consider adding AbortController.prototype.follow(signal) · Issue #920 · whatwg/dom
    -   [https://github.com/whatwg/dom/issues/920](https://github.com/whatwg/dom/issues/920)
...
## [AbortSignal in addEventListener](#abortsignal-in-addeventlistener)
...
-   Support `AbortSignal`s in `addEventListener`s options to unsubscribe from events? · Issue #911 · whatwg/dom
    -   [https://github.com/whatwg/dom/issues/911](https://github.com/whatwg/dom/issues/911)
...
-   add signal to addEventListener by benjamingr · Pull Request #919 · whatwg/dom
    -   [https://github.com/whatwg/dom/pull/919](https://github.com/whatwg/dom/pull/919)
...
-   Introduce AbortSignal.timeout() by domenic · Pull Request #1032 · whatwg/dom
    -   [https://github.com/whatwg/dom/pull/1032](https://github.com/whatwg/dom/pull/1032)
...
-   abort-signal-any/README.md at main · shaseley/abort-signal-any · GitHub
    -   [https://github.com/shaseley/abort-signal-any/blob/main/README.md](https://github.com/shaseley/abort-signal-any/blob/main/README.md)
...
-   Intent to Ship: AbortSignal.any()
    -   [https://groups.google.com/a/chromium.org/g/blink-dev/c/-tY85-WOCD8/m/QaG6qaVSBgAJ](https://groups.google.com/a/chromium.org/g/blink-dev/c/-tY85-WOCD8/m/QaG6qaVSBgAJ)

Safari も実装済。

-   256176 - Implement AbortSignal.any()
    -   [https://bugs.webkit.org/show\_bug.cgi?id=256176](https://bugs.webkit.org/show_bug.cgi?id=256176)

Firefox は Positive だが実装はまだのようだ。

-   Request for Mozilla Position: AbortSignal.any() · Issue #774 · mozilla/standards-positions
    -   [https://github.com/mozilla/standards-positions/issues/774](https://github.com/mozilla/standards-positions/issues/774)

## [Abort Handling Practice](#abort-handling-practice)
...
-   AbortSignal.any DEMO | labs.jxck.io
    -   [https://labs.jxck.io/promise/abortsignal-any/](https://labs.jxck.io/promise/abortsignal-any/)
-   AbortSignal.timeout DEMO | labs.jxck.io
    -   [https://labs.jxck.io/promise/abortsignal-timeout/](https://labs.jxck.io/promise/abortsignal-timeout/)

## [Resources](#resources)

-   Spec
    -   DOM Standard
        -   [https://dom.spec.whatwg.org/#dom-abortsignal-any](https://dom.spec.whatwg.org/#dom-abortsignal-any)
-   Explainer
    -   abort-signal-any/README.md at main · shaseley/abort-signal-any · GitHub
        -   [https://github.com/shaseley/abort-signal-any/blob/main/README.md](https://github.com/shaseley/abort-signal-any/blob/main/README.md)
-   Requirements Doc
    -   AbortSignal.any() - Chrome Platform Status
        -   [https://chromestatus.com/feature/5202879349522432](https://chromestatus.com/feature/5202879349522432)
    -   Design review: AbortSignal.any() · Issue #737 · w3ctag/design-reviews
        -   [https://github.com/w3ctag/design-reviews/issues/737](https://github.com/w3ctag/design-reviews/issues/737)
-   Mozilla Standard Position
    -   Request for Mozilla Position: AbortSignal.any() · Issue #774 · mozilla/standards-positions
        -   [https://github.com/mozilla/standards-positions/issues/774](https://github.com/mozilla/standards-positions/issues/774)
-   Webkit Position
    -   AbortSignal.any() · Issue #166 · WebKit/standards-positions
        -   [https://github.com/WebKit/standards-positions/issues/166](https://github.com/WebKit/standards-positions/issues/166)
-   TAG Design Review
    -   Design review: AbortSignal.any() · Issue #737 · w3ctag/design-reviews
        -   [https://github.com/w3ctag/design-reviews/issues/737](https://github.com/w3ctag/design-reviews/issues/737)
-   Intents
    ...
    -   Intent to Prototype: AbortSignal.any()
        -   [https://groups.google.com/a/chromium.org/g/blink-dev/c/FSH6hrJMaxM](https://groups.google.com/a/chromium.org/g/blink-dev/c/FSH6hrJMaxM)
...
-   Issues
    -   1323391 - Implement AbortSignal.any()
        -   [https://bugs.chromium.org/p/chromium/issues/detail?id=1323391](https://bugs.chromium.org/p/chromium/issues/detail?id=1323391)
    -   Add AbortSignal.any() · whatwg/dom@6c02df2
        -   [https://github.com/whatwg/dom/commit/6c02df28ffe592dda901fd29a924906c648baa54](https://github.com/whatwg/dom/commit/6c02df28ffe592dda901fd29a924906c648baa54)
-   Other
    -   once() and on() async utilities for EventTarget · Issue #1038 · whatwg/dom
        -   [https://github.com/whatwg/dom/issues/1038](https://github.com/whatwg/dom/issues/1038)