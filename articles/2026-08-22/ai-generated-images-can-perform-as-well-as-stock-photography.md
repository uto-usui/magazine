...
source: "https://www.nngroup.com/articles/ai-generated-images/"
...
We analyzed the open-ended responses using [thematic analysis](https://www.nngroup.com/articles/thematic-analysis/).

![Screenshot labeled "Full Webpage" showing the complete homepage of a fictional consulting firm, Momentum, from navigation bar through hero image, headline and calls to action, statistics band, three service cards, client logos, and footer.](https://media.nngroup.com/media/editor/2026/08/20/website-page.png)

_Example of the fictional consulting-company webpage used in the study. Participants viewed versions of this page that differed only in the hero image._

![Six stock-style photographs of business meetings arranged in a two-column grid, labeled "Images Shown During the Study." The left column is labeled AI 1, AI 2, and AI 3 in purple; the right column is labeled Real 1, Real 2, and Real 3 in yellow.](https://media.nngroup.com/media/editor/2026/08/20/template-a1-no-round-corner.png)

_AI images were generated using ChatGPT Images 2.0. Real 1 and Real 2 were photographed by Vitaly Gariev and obtained on Unsplash+. Real 3 was photographed by Jana Murr and obtained on iStock._
...
Thus, even though across all 3 measures, websites with AI-generated images received slightly higher ratings, because the differences were small and our study included only 6 images, we cannot conclude that AI images are categorically better than [stock images](https://www.nngroup.com/articles/photos-as-web-content/). What our results show is that **the AI-generated images were not at disadvantage.**
...
![Grouped bar chart, "Average Ratings for Each Image," showing Trust, Professionalism, and Authenticity scores on a 7-point scale for three AI-generated and three real photos. Scores are close across all six, but the AI images rate slightly higher on every measure, with the widest gap on Authenticity.](https://media.nngroup.com/media/editor/2026/08/20/ai-generated-images-can-perform-as-well-as-stock-photography-2.png)

_Participants rated each webpage on trust, professionalism, and authenticity. Webpages with AI-generated images scored at least as high as real photos on all three dimensions. Ratings were given on a scale of 1 to 7, with 7 being the most favorable rating._

![Bar chart, "Average Ratings: AI vs. Real Images," comparing the two conditions on Trust, Professionalism, and Authenticity. AI images score slightly higher on all three, by 0.2 points on Trust and Professionalism and 0.4 on Authenticity, with overlapping error bars throughout.](https://media.nngroup.com/media/editor/2026/08/20/ai-generated-images-can-perform-as-well-as-stock-photography-1.png)

_Ratings were slightly higher for webpages with AI-generated images on all three measures. However, the difference between AI and stock images was statistically significant only for authenticity, and the estimated rating increase due to the AI image was very small (only 0.4 points on a scale from 1 to 7)._
...
This is an important [inclusive-design](https://www.nngroup.com/articles/inclusive-design/) consideration. Users often value seeing people similar to themselves, and their perceptions of trust with an organization can be driven partly by whether its imagery reflects diversity and inclusion.
...
That distinction is becoming increasingly relevant as legal requirements for AI transparency continue to evolve. For example, the [European Union’s AI Act](https://www.lemonde.fr/en/international/article/2026/07/28/eu-tells-firms-to-label-ai-generated-content-from-sunday_6755910_4.html) includes requirements for identifying or disclosing certain AI-generated content. Related research suggests that AI disclosure could matter; across 13 experiments, Schilke and Reimann found that participants trusted people and organizations less when their use of AI was disclosed.
...
The _output_ itself can largely be evaluated using the same design criteria as any other image. However, the _method_ used to produce AI-generated imagery introduces additional considerations.
...
Le Monde with AFP. 2026. EU tells firms to label AI-generated content from Sunday. _Le Monde_. (July 28, 2026). Retrieved August 10, 2026 from [](https://www.lemonde.fr/en/international/article/2026/07/28/eu-tells-firms-to-label-ai-generated-content-from-sunday_6755910_4.html)[https://www.lemonde.fr/en/international/article/2026/07/28/eu-tells-firms-to-label-ai-generated-content-from-sunday\_6755910\_4.html](https://www.lemonde.fr/en/international/article/2026/07/28/eu-tells-firms-to-label-ai-generated-content-from-sunday_6755910_4.html)

Oliver Schilke and Martin Reimann. 2025. The transparency dilemma: How AI disclosure erodes trust. _Organizational Behavior and Human Decision Processes 188_ (May 2025), _104405_. https://doi.org/10.1016/j.obhdp.2025.104405