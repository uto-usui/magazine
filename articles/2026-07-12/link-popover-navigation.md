...
Technically still the same day, but I was already away from screens and am only adding it today. Kirk Loretz did _not_ fork my pen, but he made a new one to [test popover positioning with different writing modes](https://codepen.io/kirk-l/pen/dPNdBLy). Then he went to the CSS Working Group repo and filed [#14159 \[css-anchor-position-1\] Popover text direction/writing-mode bugs](https://github.com/w3c/csswg-drafts/issues/14159). If you have expertise in this area, it might be worth checking the issue.