...
![The Vertical Codebase](https://tkdodo.eu/.netlify/images?w=640&h=427&fit=cover&url=%2Fblog%2F_astro%2Fvertical.CtSiXO2j.jpg)
...
![Code colocation](https://tkdodo.eu/blog/_astro/GEg89DDXsAA8DC.DbrOSQsh.jpeg)
...
```
export type WidgetProps = { id: string }export function Widget(props: WidgetProps) {}
```
...
```
export type WidgetProps = { id: string }export function Widget(props: WidgetProps) {  const { data } = useSuspenseQuery(widgetQueryOptions(props.id))}
```
...
![Separation of concerns](https://tkdodo.eu/blog/_astro/separation_of_concerns.CHn-okft.jpeg)
