...
source: "https://remix.run/blog/remix-3-release-candidate"
...
The last time we shared updates about Remix 3 was when we announced our [beta preview](https://remix.run/blog/remix-3-beta-preview) 4 months ago. We're incredibly proud of what we've built and all the improvements we've made since our first beta, and we're excited to start sharing with you why exactly we think Remix is so awesome.
...
We're going to dig into all the details in the coming weeks and months, and we'll release Remix 3 on October 2 at [Remix Jam](https://remix.run/jam/2026) (tickets are still available).
...
The journey of Remix 3's development has been a lot like planting a tree. Last year at [Remix Jam](https://remix.run/jam/2025), we metaphorically invited you into our "garage" to hear our [demo tape](https://remix.run/jam/2025/gallery?photo=120). We talked about the ideas we love from React and React Router (previously [Remix v2](https://remix.run/remix-history)). We also talked about the things we don't love so much about those projects, and where we want to take Remix. With Remix we want to provide a fully stacked web framework, unapologetically built on web primitives and productive out the gate in an agentic programming landscape.

From that point up until we released our first beta, we were focused on establishing and rooting all of those ideas and APIs. We were giving every piece its proper place, making sure the packages would work well together and that the majority of them [could be used independently](https://github.com/solidjs/templates/blob/8de24f5f769429c9c030721f2a454edd20501f3a/solid-v2/fullstack/package.json#L30).
...
The Release Candidate marks the end of feature development (if we can help it) and allows us to clean up known bugs, perform thorough security audits, gather feedback from early adopters, write more docs, and, oh yeah, prepare for [Remix Jam](https://remix.run/jam/2026) (where we will release Remix 3).

![Michael Jackson presenting onstage to an audience at Remix Jam 2025](https://remix.run/assets/blog-images/posts/remix-3-release-candidate/remix-jam-2025-photo-139.@xUi68t.jpg?transform=webp-1600)
...
-   [Our newsletter](https://remix.run/newsletter) to receive monthly updates

Alright, back to work for us, we've gotta ship this thing! See you in person or online at [Remix Jam](https://remix.run/jam/2026)!