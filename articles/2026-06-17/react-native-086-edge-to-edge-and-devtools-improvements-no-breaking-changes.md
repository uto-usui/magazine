...
source: "https://reactnative.dev/blog/2026/06/11/react-native-0.86"
...
-   [A New Home for React Native](https://reactnative.dev/blog/2026/06/11/react-native-0.86#a-new-home-for-react-native)
-   [Edge-to-Edge on Android](https://reactnative.dev/blog/2026/06/11/react-native-0.86#edge-to-edge-on-android)
-   [React Native DevTools Improvements](https://reactnative.dev/blog/2026/06/11/react-native-0.86#react-native-devtools-improvements)

### A New Home for React Native[​](#a-new-home-for-react-native "Direct link to A New Home for React Native")
...
### Edge-to-Edge on Android[​](#edge-to-edge-on-android "Direct link to Edge-to-Edge on Android")
...
![React Native DevTools Command Palette showing the light/dark mode emulation options](https://reactnative.dev/assets/images/0.86-devtools-light-dark-emulation-ea42961a7796506c761efed1f05d365d.png)
...
### Runtime & Web Spec Alignment[​](#runtime--web-spec-alignment "Direct link to Runtime & Web Spec Alignment")
...
### Rendering, Layout & Animation[​](#rendering-layout--animation "Direct link to Rendering, Layout & Animation")
...
### Infrastructure & Dependencies[​](#infrastructure--dependencies "Direct link to Infrastructure & Dependencies")
...
### JSI (Native Interface)[​](#jsi-native-interface "Direct link to JSI (Native Interface)")
...
### Android Input, Navigation & Images[​](#android-input-navigation--images "Direct link to Android Input, Navigation & Images")
...
### Android Networking[​](#android-networking "Direct link to Android Networking")
...
## Upgrade to 0.86[​](#upgrade-to-086 "Direct link to Upgrade to 0.86")

info

0.86 is now the latest stable version of React Native and 0.83.x moves to unsupported. For more information see [React Native's support policy](https://reactnative.dev/releases).
