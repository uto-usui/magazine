---
title: "text-scale によるユーザ指定倍率での文字拡大"
source: "https://blog.jxck.io/entries/2026-02-11/text-scale.html"
...
> 
> — [https://www.w3.org/TR/WCAG22/#resize-text](https://www.w3.org/TR/WCAG22/#resize-text)
...
今回検証するのは、iPhone 16e iOS 26.2 および Pixel 8a Android 16 の、以下の設定を対象とする。
  ...
  ![iPhone と Android で文字サイズを最大まで拡大設定](https://blog.jxck.io/entries/2026-02-11/setting.png?260211_231147)

それぞれ最大まで拡大した状態で同一のコンテンツを開いても、iOS Safari / Android Chrome は拡大されず、Android Firefox だけ拡大されていることがわかる。

  ![default を拡大設定で表示すると Firefox のみ拡大される](https://blog.jxck.io/entries/2026-02-11/default.png?260211_231146)
...
## [Apple Dynamic Type](#apple-dynamic-type)

Apple は iOS で最適なシステムフォントを選択できる Dynamic Type という仕組みを用意している。

-   Using the System Font in Web Content | WebKit
    -   [https://webkit.org/blog/3709/using-the-system-font-in-web-content/](https://webkit.org/blog/3709/using-the-system-font-in-web-content/)
...
```
  ...
  ![Dynamic Type を指定することで、拡大率を反映できる](https://blog.jxck.io/entries/2026-02-11/dynamic-type.png?260211_231146)
...
-   csswg-drafts/css-env-1/explainers/env-preferred-text-scale.md at main · w3c/csswg-drafts
    -   [https://github.com/w3c/csswg-drafts/blob/main/css-env-1/explainers/env-preferred-text-scale.md](https://github.com/w3c/csswg-drafts/blob/main/css-env-1/explainers/env-preferred-text-scale.md)
...
現状では Android Chrome のみ対応している。
  ...
  ![preferred-text-scale での拡大](https://blog.jxck.io/entries/2026-02-11/preferred-text-scale.png?260211_231145)
...
-   \[css-env\]\[css-values\] UAs inconsistent in how OS font settings affect the default font-size `medium` · Issue #10674 · w3c/csswg-drafts
    -   [https://github.com/w3c/csswg-drafts/issues/10674](https://github.com/w3c/csswg-drafts/issues/10674)
...
-   \[css-env-1\] remove pem/bsem unit by davidsgrogan
    -   [https://github.com/w3c/csswg-drafts/pull/13281](https://github.com/w3c/csswg-drafts/pull/13281)
...
-   \[css-fonts-5\] Should absolute font size keywords scale at different rates depending on user's preferred text scale?
    -   [https://github.com/w3c/csswg-drafts/issues/12475](https://github.com/w3c/csswg-drafts/issues/12475)
...
```
  ...
  ![text-scale に合わせて調整](https://blog.jxck.io/entries/2026-02-11/scale.png?260211_231145)
...
-   Text Scale DEMO
    -   [https://labs.jxck.io/text-scale/](https://labs.jxck.io/text-scale/)

## [Resources](#resources)

-   Spec
    -   CSS Fonts Module Level 5
        -   [https://drafts.csswg.org/css-fonts-5/#text-scale-meta](https://drafts.csswg.org/css-fonts-5/#text-scale-meta)
    -   CSS Environment Variables Module Level 1
        -   [https://drafts.csswg.org/css-env-1/#text-zoom](https://drafts.csswg.org/css-env-1/#text-zoom)
-   Explainer
    -   Explainer: env(preferred-text-scale)
        -   [https://davidsgrogan.github.io/env-explainer.html](https://davidsgrogan.github.io/env-explainer.html)
    -   Explainer: meta tag for text scaling behavior
        -   [https://github.com/w3c/csswg-drafts/blob/main/css-env-1/explainers/meta-text-scale.md](https://github.com/w3c/csswg-drafts/blob/main/css-env-1/explainers/meta-text-scale.md)
-   Requirements Doc
-   Mozilla Standard Position
    -   Text-Scale `<meta>` element · Issue #1326 · mozilla/standards-positions
        -   [https://github.com/mozilla/standards-positions/issues/1326](https://github.com/mozilla/standards-positions/issues/1326)
-   WebKit Position
    -   Text-Scale `<meta>` element · Issue #587 · WebKit/standards-positions
        -   [https://github.com/WebKit/standards-positions/issues/587](https://github.com/WebKit/standards-positions/issues/587)
-   TAG Design Review
    -   `env(preferred-text-scale)`
        -   [https://github.com/w3ctag/design-reviews/issues/1101](https://github.com/w3ctag/design-reviews/issues/1101)
    -   Other Spec Review: `<meta name="text-scale" content="scale" />`
        -   [https://github.com/w3ctag/design-reviews/issues/1172](https://github.com/w3ctag/design-reviews/issues/1172)
-   Intents
    -   Intent to Ship: meta name="text-scale"
        -   [https://groups.google.com/a/chromium.org/g/blink-dev/c/0yp2ygJK5HE/](https://groups.google.com/a/chromium.org/g/blink-dev/c/0yp2ygJK5HE/)
    -   Intent to Prototype: meta name="text-scale"
        -   [https://groups.google.com/a/chromium.org/g/blink-dev/c/2F5g2dqy9\_Q/](https://groups.google.com/a/chromium.org/g/blink-dev/c/2F5g2dqy9_Q/)
    -   Intent to Ship: CSS env variable for OS-level font scale
        -   [https://groups.google.com/a/chromium.org/g/blink-dev/c/bZuQAcwcEig/](https://groups.google.com/a/chromium.org/g/blink-dev/c/bZuQAcwcEig/)
    -   Intent to Prototype: CSS env variable for OS-level font scale
        -   [https://groups.google.com/a/chromium.org/g/blink-dev/c/OmEsGUUenqY](https://groups.google.com/a/chromium.org/g/blink-dev/c/OmEsGUUenqY)
-   Chrome Platform Status
    -   CSS env variable for OS-level font scale
        -   [https://chromestatus.com/feature/5328467685801984](https://chromestatus.com/feature/5328467685801984)
    -   meta name="text-scale"
        -   [https://chromestatus.com/feature/5112244702674944](https://chromestatus.com/feature/5112244702674944)
...
-   Issues
    ...
    -   \[css-env\]\[css-fonts-5\] New `<meta text-scale>` tag to make UA initial font size respond to OS text scale setting · Issue #12380 · w3c/csswg-drafts
        -   [https://github.com/w3c/csswg-drafts/issues/12380](https://github.com/w3c/csswg-drafts/issues/12380)
-   Other
-   Spec
    -   CSS Environment Variables Module Level 1
        -   [https://drafts.csswg.org/css-env-1/#text-zoom](https://drafts.csswg.org/css-env-1/#text-zoom)
