...
## [Link to heading](#all-agents-are-starting-to-look-like-coding-agents)All agents are starting to look like coding agents
...
## [Link to heading](#what-goes-wrong-without-boundaries)What goes wrong without boundaries
...
## [Link to heading](#four-actors-in-an-agentic-system)Four actors in an agentic system

An agentic system has four distinct actors, each with a different trust level.

### [Link to heading](#agent)Agent
...
### [Link to heading](#agent-secrets)Agent secrets
...
### [Link to heading](#generated-code-execution)Generated code execution
...
### [Link to heading](#filesystem)Filesystem
...
## [Link to heading](#zero-boundaries:-today's-default)Zero boundaries: today's default
...
## [Link to heading](#secret-injection-without-sandboxing)Secret injection without sandboxing
...
### [Link to heading](#why-sandboxing-everything-together-isn't-enough)Why sandboxing everything together isn't enough
...
## [Link to heading](#separating-agent-compute-from-sandbox-compute)Separating agent compute from sandbox compute
...
## [Link to heading](#application-sandbox-with-secret-injection)Application sandbox with secret injection
