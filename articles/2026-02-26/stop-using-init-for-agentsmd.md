...
The ETH Zurich paper discovered something that reframes the whole debate: when they stripped all documentation from the repos - READMEs, docs folders, markdown files - and _then_ tested with LLM-generated context files, those files suddenly improved performance by 2.7%. The auto-generated content isn’t useless. It’s redundant. The agent could find all of it anyway by reading the repo. Hand it the same information twice and you’ve just added noise.
...
> You should delete your CLAUDE․md/AGENTS․md file. I have a study to prove it. [pic.twitter.com/jOUNE53y7m](https://t.co/jOUNE53y7m)
> 
> — Theo - t3.gg (@theo) [February 23, 2026](https://twitter.com/theo/status/2025900730847232409?ref_src=twsrc%5Etfw)