---
title: "How OpenEvidence built a healthcare AI that physicians actually trust"
...
## [Link to heading](#when-failure-isn't-an-option)**When failure isn't an option**
...
## [Link to heading](#a-frontend-engineer-and-a-team-of-python-developers)**A frontend engineer and a team of Python developers**
...
## [Link to heading](#prototyping-at-speed)**Prototyping at speed**
...
## [Link to heading](#the-90%-surprise)**The 90% surprise**
...
## [Link to heading](#threading-the-needle)**Threading the needle**
