---
title: "Information Seeking in China: A Different Ecosystem, Familiar Behavior"
source: "https://www.nngroup.com/articles/information-seeking-china/?utm_source=rss&utm_medium=feed&utm_campaign=rss-syndication"
...
Our recent research on information-seeking behavior found that generative [AI (genAI) is meaningfully reshaping how people search](https://www.nngroup.com/articles/ai-changing-search-behaviors/) — cutting through the friction of [keyword foraging](https://www.nngroup.com/articles/ai-information-seeking-keyword-foraging/), accelerating habit change, and exposing a wide spectrum of [AI literacy](https://www.nngroup.com/articles/ai-literacy/) among everyday users. But those studies focused mainly on English-speaking participants from North America. A natural question follows: do these patterns hold elsewhere?
...
-   [How Information Seeking Differs in China vs. North America](#toc-how-information-seeking-differs-in-china-vs-north-america-1)
-   [Why Chinese Users Are Abandoning Search](#toc-why-chinese-users-are-abandoning-search-2)
-   [Social Apps Over Search for Validating GenAI Results](#toc-social-apps-over-search-for-validating-genai-results-3)
-   [Similar Behaviors and Literacy Patterns](#toc-similar-behaviors-and-literacy-patterns-4)
...
In China, [Baidu](http://www.baidu.com/) is the dominant search engine, though usage has dipped in recent years. (Publicly available stats show that [Baidu’s market share has steadily dropped](https://gs.statcounter.com/search-engine-market-share/all/china/) from 85% in Dec 2021 to just over 50% in recent months.)
...
He first came across short videos of the town on [Douyin](https://www.douyin.com/), which sparked his interest. He then used Baidu (the search engine) to find out where it was, before switching to Deepseek to plan a rough itinerary, determine how many days to spend, and get a sense of his budget. Throughout the process, he jumped to [Rednote](https://www.xiaohongshu.com/explore) multiple times to check posts about Wuzhen — a hand-drawn map of must-sees, photos of local food he'd heard about from Deepseek, pictures of nearby attractions he could fold into the same trip. The entire process happened on his phone.

![A Chinese User's Trip Planning Journey Across Apps. A horizontal timeline showing 7 sequential steps, each with an app icon, app name, app category, and the action taken:  Douyin (Social media app) — Discovered new destination Baidu (Search engine) — Checked destination's location Deepseek (GenAI chatbot) — Learned more about destination Rednote (Social media app) — Browsed photos of destination Deepseek (GenAI chatbot) — Researched nearby attractions Rednote (Social media app) — Browsed photos of recommended attraction Deepseek (GenAI chatbot) — Finalized itinerary & budget](https://media.nngroup.com/media/editor/2026/05/01/a-chinese-users-trip-planning-journey-across-apps-horizontal.png)

_Information seeking in action: one study participant's trip-planning journey reconstructed across platforms, from a social-channel discovery (Douyin) to a finalized itinerary on the genAI chatbot Deepseek._

![A Chinese User's Trip Planning Journey Across Apps. A horizontal timeline showing 7 sequential steps, each with an app icon, app name, app category, and the action taken:  Douyin (Social media app) — Discovered new destination Baidu (Search engine) — Checked destination's location Deepseek (GenAI chatbot) — Learned more about destination Rednote (Social media app) — Browsed photos of destination Deepseek (GenAI chatbot) — Researched nearby attractions Rednote (Social media app) — Browsed photos of recommended attraction Deepseek (GenAI chatbot) — Finalized itinerary & budget](https://media.nngroup.com/media/editor/2026/05/01/a-chinese-users-trip-planning-journey-across-apps-vertical.png)

_Information seeking in action: one study participant's trip-planning journey reconstructed across platforms, from a social-channel discovery (Douyin) to a finalized itinerary on the genAI chatbot Deepseek._

This single session captured the key patterns we observed consistently across our China study. First, **information seeking happened entirely on mobile:** all our participants chose to use their phones for their information-seeking tasks. This behavior mirrors findings from our [previous ecommerce studies](https://www.nngroup.com/articles/livestream-ecommerce-china/) with Chinese users and data from the China Internet Network Information Center, which shows that [99.7% of internet users in China access the web via their phones](https://www.cnnic.com.cn/IDR/ReportDownloads/202505/P020250514564119130448.pdf). Desktop use, when it occurs, tends to be a reluctant concession to the workplace rather than a genuine preference.
...
## Why Chinese Users Are Abandoning Search

In our study, very few participants used search engines such as Baidu during their information-seeking tasks, even when looking up a simple fact, such as _“_How tall is Eileen Gu?_”_ When users did use them, it was because they didn’t trust AI or because they wanted to quickly check a fact. This differed from our Western study, where [Google remained the go-to tool for validating genAI results](https://www.nngroup.com/articles/ai-search-infoseeking/).
...
![Three annotated Baidu mobile screenshots show search results for Wuzhen travel routes, highlighting promotional content, AI-generated summaries, related keyword suggestions, and video results.](https://media.nngroup.com/media/editor/2026/04/30/baidu-serp.jpg)

![Three more annotated Baidu mobile screenshots (Screens #4–6) continue the Wuzhen travel route search results, highlighting video search results, organic search results, and promotional content.](https://media.nngroup.com/media/editor/2026/04/30/baidu_serp-1_HG4RC8V.jpg)

_The first few screens of Baidu’s search results for_ best travel itinerary for Wuzhen _included mostly promotional content. With extended results like AI-generated summary and video-search results, the first organic search result showed up on the 6th screen._
...
![A comparison of Qwen (a genAI chatbot) versus Rednote (an image-sharing app). Qwen is all text, while Rednote shows large pictures that people have uploaded on a topic.](https://media.nngroup.com/media/editor/2026/04/20/china_info-seeking_-_qwen_vs__rednote.jpg)

_Responses from genAI like Qwen (left) are typically in plain text; a study participant preferred seeing before-and-after photos on Rednote (right) when learning how to remove oil stains from white clothes._

This behavior has a [cultural dimension](https://www.nngroup.com/articles/crosscultural-design/) worth acknowledging. Unlike the US, [China is a](https://www.theculturefactor.com/country-comparison-tool?countries=china%2Cunited+states) [collectivist society](https://www.theculturefactor.com/country-comparison-tool?countries=china%2Cunited+states), and other people's experiences carry particular weight in decision making; they're not just useful anecdotes, they're a form of trusted shared knowledge. Social apps don't just supplement the research process in China; they validate it.
...
## Similar Behaviors and Literacy Patterns

While our Chinese users chose to use different devices and apps in the information-seeking process, the way they used genAI chatbots mirrored patterns we've documented in our studies with English-speaking users.
...
### People Still Don't Think of AI as Human — with One Interesting Exception

Finally, Chinese participants generally did not anthropomorphize genAI chatbots. They treated them as tools, not conversational partners.
...
> Prompt: _Doubao, I want to start working out. Do you have any advice?_
...
![The icons for Doubao (a cartoonish woman) and Deepseek (a blue whale outline) are shown as a comparison.](https://media.nngroup.com/media/editor/2026/04/20/china-info-seeking-doubao-vs-deepseek.jpg)

_Doubao’s icon (left) is a cartoonish female character. Participants used its name before making their request. This didn’t happen with Deepseek (right), whose icon was a blue whale._
...
![Two screenshots from a viral meme is shown. A couple are standing facing the video camera in plain clothes. They ask the chatbot, “Doubao, would this work?” and change their outfits.](https://media.nngroup.com/media/editor/2026/04/20/china_info-seeking_-_video-calling_with_doubao.jpg)

_An example of a viral video on Rednote: A couple calls Doubao, the genAI chatbot, to get feedback on an outfit._
...
#### Perceptions Shaped by the Parent Company’s Brand Image

Finally, some of our participants chose or stuck with a particular genAI tool because of their perception of the parent company's [brand](https://www.nngroup.com/articles/brand-experience-ux/).
