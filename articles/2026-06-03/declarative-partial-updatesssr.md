...
source: "https://zenn.dev/uhyo/articles/declarative-partial-updates-react"
...
色々な使い道があるかもしれませんが、1つ明確な答えがあります。**Reactが使います**[\[1\]](#fn-3d2c-1)。Reactでなくても、SSR機能を備えたUIライブラリなら活用できるでしょう。
...
1.  現実には、Reactは後方互換性を重視するので、DPUをすぐに活用するのは難しいかもしれません。ここで言いたいのは、Reactは明確なユースケースの1つであるということです。 [↩︎](#fnref-3d2c-1)