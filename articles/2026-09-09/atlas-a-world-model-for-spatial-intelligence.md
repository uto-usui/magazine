...
-   [**Camera-Controlled Generation**](#camera-controlled-generation): Atlas generates images and videos from one or more images with pixel-perfect camera control, outputting up to 1 minute of video at 1440p.
-   [**Spatial Reconstruction**](#spatial-reconstruction): Atlas reconstructs real world scenes from one to dozens of input images. It generates both image frames from novel views and explicit 3D outputs, outperforming state-of-the-art models specialized for 3D reconstruction.
-   [**Space-Time Simulation**](#space-time-simulation): Atlas models space and time from input videos, reframing videos for dramatic visual effects and enabling [Real-to-Sim](https://www.worldlabs.ai/blog/real-to-sim-to-real) workflows for robotics.
-   [**Image Generation**](#image-generation): Atlas generates images and 360 panoramas from text; it can follow complex prompts, render text, and generate a wide variety of visual styles.

Atlas will power future versions of [Marble](https://marble.worldlabs.ai/) and other products from World Labs.

## Camera-Controlled Generation[](#camera-controlled-generation "Copy link to this section")
...
### Pixel-Perfect Camera Control[](#pixel-perfect-camera-control "Copy link to this section")
...
### Generating with Spatial Context[](#generating-with-spatial-context "Copy link to this section")
...
### Controllable Long Videos[](#controllable-long-videos "Copy link to this section")
...
## Spatial Reconstruction[](#spatial-reconstruction "Copy link to this section")
...
### Reconstructing from Multiple Images[](#reconstructing-from-multiple-images "Copy link to this section")
...
### Reconstructing Diverse Paths[](#reconstructing-diverse-paths "Copy link to this section")
...
### Explicit 3D Outputs[](#explicit-3d-outputs "Copy link to this section")
...
Point clouds estimate a scene's geometry, but 3D Gaussian splats make it usable. Atlas fills the remaining gaps and turns the point cloud into a complete splat scene that renders on-device at high resolution and frame rates. This is the same representation used in [Marble](https://marble.worldlabs.ai/), enabling Atlas to integrate naturally with the rest of our products.

## Space-Time Simulation[](#space-time-simulation "Copy link to this section")
...
### Reframing Video[](#reframing-video "Copy link to this section")
...
### Robotics Simulation[](#robotics-simulation "Copy link to this section")

Atlas opens up new ways to scale [Real-to-Sim](https://www.worldlabs.ai/blog/real-to-sim-to-real) for both navigation and manipulation.
...
## Image Generation[](#image-generation "Copy link to this section")
...
## Technical Details[](#technical-details "Copy link to this section")

### Model Architecture[](#model-architecture "Copy link to this section")
...
### Benchmarks[](#benchmarks "Copy link to this section")
...
← Other model preferredAtlas preferred →MiniMax H375%Gemini Omni Flash81%Happy Horse 1.186%FLUX 393%Seedance 2.594%05060708090100Share of voters choosing Atlas
...
### Model Scaling[](#model-scaling "Copy link to this section")
...
## Build with Atlas[](#build-with-atlas "Copy link to this section")
...
_This post was produced by the World Labs team. Please cite as:_
