...
source: "https://www.smashingmagazine.com/2026/04/practical-guide-design-principles/"
...
-   5 min read
-   [Design](https://www.smashingmagazine.com/category/design), [UX](https://www.smashingmagazine.com/category/ux), [UI](https://www.smashingmagazine.com/category/ui), [Design Patterns](https://www.smashingmagazine.com/category/design-patterns)

Design principles with references, examples, and methods for quick look-up. Brought to you by [Design Patterns For AI Interfaces](https://ai-design-patterns.com/), **friendly video courses on UX** and design patterns by Vitaly.
...
There is no shortage of principles out there. But the good ones are more than just being _visionary_ — they **have a point of view**, and they explain what we _don’t do_ as much as what we do. They also explain what **we stand for** in the world — beyond profits, stock prices, and all the hype and noise around us.

[![10 legendary principles for good design](https://res.cloudinary.com/indysigner/image/fetch/f_auto,q_80/w_400/https://files.smashing.media/articles/stop-endless-debates-design-principles/1-principles-good-design.jpg)](https://www.vitsoe.com/gb/about/good-design#good-design-is-innovative)

10 legendary principles for good design, by [Dieter Rams](https://www.vitsoe.com/gb/about/good-design#good-design-is-innovative). Still relevant, after all these years. ([Large preview](https://files.smashing.media/articles/stop-endless-debates-design-principles/1-principles-good-design.jpg))
...
-   [18F](https://guides.18f.org/)
-   [Audi](https://styleguide.audi.com/document/2440#/-/experience-principles)
-   [Carbon (IBM)](https://www.ibm.com/design/language/philosophy/principles/)
-   [Firefox](https://acorn.firefox.com/latest/get-started/firefox-design-principles-5ezPvNdo)
-   [Gov.uk](https://www.gov.uk/guidance/government-design-principles)
-   [Intuit](https://contentdesign.intuit.com/style-and-usage/our-principles/)
-   [NHS](https://service-manual.nhs.uk/design-system/design-principles)
-   [Nordhealth](https://nordhealth.design/principles/)
-   [Uber](https://base.uber.com/6d2425e9f/p/434f39-principles)

## How To Establish Design Principles

Design principles can be personal, but usually they are committed to and shaped by the **entire product team**. Design principles **aren’t just for designers**. User’s experience is _everything_ from performance to support to customer service, and ideally, participants would cover these areas as well.
...
[![Workshop kit for a design principles workshop](https://res.cloudinary.com/indysigner/image/fetch/f_auto,q_80/w_400/https://files.smashing.media/articles/stop-endless-debates-design-principles/2-design-principles-workshop.png)](https://www.figma.com/community/file/1051212964426062558)

[One of many workshop kits](https://www.figma.com/community/file/1051212964426062558) for a design principles workshop. ([Large preview](https://files.smashing.media/articles/stop-endless-debates-design-principles/2-design-principles-workshop.png))
...
6.  **Value Statements**  
    We write _‘We want X because of Y’_ sentences that express the rationale behind our thinking.
...
[![Variants of sentences for establishing design principles](https://res.cloudinary.com/indysigner/image/fetch/f_auto,q_80/w_400/https://files.smashing.media/articles/stop-endless-debates-design-principles/3-design-principles.jpg)](https://www.better.care/blog-en/establishing-design-principles-for-a-design-system-and-what-it-taught-us/)

Voting for the most relevant sentences in keyword groups. From [Better](https://www.better.care/blog-en/establishing-design-principles-for-a-design-system-and-what-it-taught-us/). ([Large preview](https://files.smashing.media/articles/stop-endless-debates-design-principles/3-design-principles.jpg))
