...
source: "https://tombh.co.uk/longest-line-of-sight"
...
The place on Earth from which you can, in theory[1](#footnotes), see further than any other is between [an unnamed Himalayan ridge near the Indian-Chinese border and Pik Dankova in Kyrgyzstan](https://map.alltheviews.world/longest/78.76539611816406-36.31400680541992). It is just over 530km.

![](https://tombh.co.uk/images/longest_line.webp#wide)

Up until now this view has only been speculated[2](#footnotes) to be the longest. But we can now empirically prove it. With the help of my good friend [Ryan Berger](https://ryan.berge.rs/) we have literally calculated _every single line of sight on Earth_. This involved in the order of 1015, or a million billion, calculations. Which outputs around 200GB of individual longest lines. We present our findings in an interactive map at [map.alltheviews.world](https://map.alltheviews.world/).
...
![](https://tombh.co.uk/images/merapi.webp#wide)
...
![](https://tombh.co.uk/images/alltheviews_logo.webp#wide)
...
![](https://tombh.co.uk/images/dem_points.webp#wide)
...
![](https://tombh.co.uk/images/tile-packing-red.webp#wide)
...
![](https://tombh.co.uk/images/south-korea-tvs.webp#wide)
...
2.  The main source of this speculation comes from [a post on the Summit Post forum from 2012](https://www.summitpost.org/phpBB3/longest-lines-of-sight-photographed-t44409-150.html). Forum member jbramel speculates that the view from Pik Dankova to China’s Kunlun range may be the longest in the world.
3.  Astute readers will notice that this also assumes _no other higher elevations exist within the region_. And you would be right. There are a number of details I’m glossing over in this short overview. Check out the blog post for more details [tombh.co.uk/packing-world-lines-of-sight](https://tombh.co.uk/packing-world-lines-of-sight)