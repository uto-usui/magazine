...
Back in 2023, I decided to build a toast library called [Sonner](https://sonner.emilkowal.ski/). It’s now downloaded over 8,000,000 times per week from npm and used by companies like Cursor, X, and Vercel. It’s also the default toast component in shadcn/ui.
...
Inherited from Old French _soner_, _suner_, from Latin sonāre.
...
This was also extremely important to get right. If the component is not easy to use, people will give up before they even try it. Developer experience is _key_.
...
Good documentation and clear instructions can drastically lower the barrier to use _any_ product, not just a component. I think it’s often overlooked and done as an afterthought when it shouldn’t be.
...
![Theo](https://emilkowal.ski/_next/image?url=%2Fbuilding-a-toast-component%2Ftheo.jpg&w=96&q=75)
...
![Theo's tweet](https://emilkowal.ski/_next/image?url=%2Fbuilding-a-toast-component%2Ftheo-tweet.jpeg&w=3840&q=75)

5:16 AM · Jul 15, 2024 · Twitter Web App

](https://x.com/theo/status/1812778167121354878)
