...
-   [New Animation Backend](https://reactnative.dev/blog/2026/04/07/react-native-0.85#new-animation-backend)
-   [React Native DevTools Improvements](https://reactnative.dev/blog/2026/04/07/react-native-0.85#react-native-devtools-improvements)
-   [Metro TLS Support](https://reactnative.dev/blog/2026/04/07/react-native-0.85#metro-tls-support)

### Breaking Changes[​](#breaking-changes "Direct link to Breaking Changes")

-   [Jest Preset Moved to New Package](https://reactnative.dev/blog/2026/04/07/react-native-0.85#jest-preset-moved-to-new-package)
-   [Dropped Support for EOL Node.js Versions](https://reactnative.dev/blog/2026/04/07/react-native-0.85#dropped-support-for-eol-nodejs-versions)
-   [`StyleSheet.absoluteFillObject` Removed](https://reactnative.dev/blog/2026/04/07/react-native-0.85#stylesheetabsolutefillobject-removed)
-   [Other Breaking Changes](https://reactnative.dev/blog/2026/04/07/react-native-0.85#other-breaking-changes)

## Highlights[​](#highlights-1 "Direct link to Highlights")

### New Animation Backend[​](#new-animation-backend "Direct link to New Animation Backend")
...
In Animated, you can now animate layout props with native driver (the [limitation once stated here](https://reactnative.dev/docs/animations#caveats) no longer applies).

iOS

Android

![Animation Backend demo on iOS](https://reactnative.dev/blog/assets/0.85-animation-backend-ios.gif)

![Animation Backend demo on Android](https://reactnative.dev/blog/assets/0.85-animation-backend-android.gif)
...
To opt in, you can enable the experimental channel of React Native [as described in this page](https://reactnative.dev/docs/releases/release-levels).
...
#### How to animate layout props[​](#how-to-animate-layout-props "Direct link to How to animate layout props")
...
### React Native DevTools Improvements[​](#react-native-devtools-improvements "Direct link to React Native DevTools Improvements")
...
![DevTools native tabs on macOS](https://reactnative.dev/blog/assets/0.85-devtools-macos-tabs.png)
...
### Metro TLS Support[​](#metro-tls-support "Direct link to Metro TLS Support")
...
```
const fs = require('fs');config.server.tls = {  ca: fs.readFileSync('path/to/ca'),  cert: fs.readFileSync('path/to/cert'),  key: fs.readFileSync('path/to/key'),};
```
...
### Jest Preset Moved to New Package[​](#jest-preset-moved-to-new-package "Direct link to Jest Preset Moved to New Package")
...
```
- preset: 'react-native',+ preset: '@react-native/jest-preset',
```

### Dropped Support for EOL Node.js Versions[​](#dropped-support-for-eol-nodejs-versions "Direct link to Dropped Support for EOL Node.js Versions")
...
### `StyleSheet.absoluteFillObject` Removed[​](#stylesheetabsolutefillobject-removed "Direct link to stylesheetabsolutefillobject-removed")
...
```
- const styles = StyleSheet.absoluteFillObject;+ const styles = StyleSheet.absoluteFill;
```
...
## Upgrade to 0.85[​](#upgrade-to-085 "Direct link to Upgrade to 0.85")
