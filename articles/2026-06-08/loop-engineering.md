...
**Loop engineering is replacing yourself as the person who prompts the agent. You design the system that does it instead.** It’s roughly five building blocks and Claude Code and Codex both have all five now. I believe this may be the future of how we work with coding agents. However, its still early, I’m skeptical and you absolutely _have_ to be [careful](https://x.com/weswinder/status/2063700289710964906) about token costs (usage patterns can vary wildly if you are token rich or poor), so I want to unpack what it is and what it means.
...
[Automations tab](https://developers.openai.com/codex/app/automations): pick project, prompt, cadence, environment; results land in a Triage inbox

Scheduled tasks and cron, `/loop`, hooks, GitHub Actions
...
[Agent Skills](https://developers.openai.com/codex/skills) (`SKILL.md`), invoked with `$name` or implicitly

[Agent Skills](https://addyosmani.com/blog/agent-skills/) (`SKILL.md`)
...
[Subagents](https://developers.openai.com/codex/subagents) defined as TOML in `.codex/agents/`
...
I’m intrigued. I definitely think this is a preview of how our work is going to evolve.

However, you have to remember that many prescriptive AI best practices can vary heavily depending on whether you have an unlimited token budget or not. Many of us aren’t in that position, so I encourage experimentation, but keep an eye on costs.
