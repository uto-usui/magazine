...
_AI Gateway Production Index — September 2026_
...
### [Copy link to heading](#september-2026-summary)**September 2026 summary**
...
#### [Copy link to heading](#latest-index-updates)Latest Index updates

The monthly report covers data through August. We add notable developments here between editions.

-   September 17: [OpenAI launched Astra](#special-report:-astra-took-a-third-of-openai-spend-within-48-hours-and-outpaced-fable-5.1-two-to-one-at-launch) on September 3, and **it took a third of OpenAI's spend within two days and twice Fable 5.1's share of gateway spend.** Astra took 7.7% of all gateway spend in its first twelve days while Fable 5.1, launched two days earlier at the same price, took 3.7%.
    
-   September 18: Jev is now the [fastest-adopted model](https://vercel.com/blog/ai-gateway-jev-model-launch) in AI Gateway history. Within its first 24 hours, it was being used by nearly 13% of paid teams, 2x as many as the GPT-5.6 family and over 6x as many as Fable 5.1.
    

## [Copy link to heading](#open-weight-models-take-a-majority-of-token-volume-for-the-first-time)Open-weight models take a majority of token volume for the first time
...
## [Copy link to heading](#frontier-plateaus-as-fable-spend-goes-to-opus-5)Frontier plateaus as Fable spend goes to Opus 5
...
## [Copy link to heading](#customer-loyalty-follows-the-model-profile,-not-the-lab)Customer loyalty follows the model profile, not the lab
...
## [Copy link to heading](#special-report:-astra-took-a-third-of-openai-spend-within-48-hours-and-outpaced-fable-5.1-two-to-one-at-launch)Special report: Astra took a third of OpenAI spend within 48 hours and outpaced Fable 5.1 two to one at launch
...
## [Copy link to heading](#also-in-august’s-data-)Also in August’s data
...
### [Copy link to heading](#previous-ai-gateway-production-index-reports)**Previous AI Gateway Production Index reports**
