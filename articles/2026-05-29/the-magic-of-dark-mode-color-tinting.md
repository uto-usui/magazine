---
title: "The Magic of Dark Mode Color Tinting"
source: "https://uxmovement.medium.com/the-magic-of-dark-mode-color-tinting-9b62b0b93cb9?source=rss-40dd56d8f87d------2"
...
![UX Movement](https://miro.medium.com/v2/resize:fill:32:32/1*0hVXTjSwlD8Kje1OlclpDg.png)



](https://uxmovement.medium.com/?source=post_page---byline--9b62b0b93cb9---------------------------------------)
...
![](https://miro.medium.com/v2/resize:fit:1000/0*D0L7b-fHPrjs1iCL.png)
...
## Creating a Default Dark Mode

The first step to color tinting is to create a dark mode with the default grays. You should have two surface colors: background and foreground. The background should be darker than the…