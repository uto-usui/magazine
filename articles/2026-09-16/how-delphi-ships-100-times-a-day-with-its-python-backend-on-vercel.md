...
### [Copy link to heading](#delphi-on-vercel)Delphi on Vercel
...
[Delphi](https://www.delphi.ai/) builds digital minds. They capture what someone has written, recorded, and taught, so anyone can tap that expertise on demand. Delphi is “a destination where you can find and interact with interesting minds,” says founding engineer Spencer Schoeben.
...
## [Copy link to heading](#building-a-python-backend-that's-easy-to-work-on)Building a Python backend that's easy to work on

### [Copy link to heading](#the-backend-slowed-every-change)The backend slowed every change
...
## [Copy link to heading](#workflows-and-queues-made-the-move-possible)Workflows and Queues made the move possible

When Delphi was founded, [Vercel Workflows](https://vercel.com/workflows) and [Vercel Queues](https://vercel.com/docs/queues) didn't exist. Without them, Spencer says, the move would have been much harder, if possible at all.
...
> 
> ![](https://assets.vercel.com/image/upload/f_auto,c_fill,w_32,h_32,q_75/contentful/image/e5382hct74si/46W0eajVS8z6evyvziJHy4/a48fcb445878b9dc25481fccf47e69f0/spencer_photo.jpeg)— Spencer Schoeben Founding Engineer @ Delphi

## [Copy link to heading](#100+-deploys-a-day,-straight-to-production)100+ deploys a day, straight to production
...
[Vercel Agent's](https://vercel.com/docs/agent) anomaly detection watches production at that pace, flagging when something is misbehaving and why. Before, Spencer says, they often would not have known.
...
## [Copy link to heading](#infrastructure-built-for-agents-and-engineers)Infrastructure built for agents and engineers

### [Copy link to heading](#preview-deployments-are-how-agents-check-their-work)Preview deployments are how agents check their work
...
## [Copy link to heading](#an-internal-agent-on-sandbox-for-customer-success)An internal agent on Sandbox for customer success

Delphi's own agents run on Vercel as well. One of them, an internal agent on [Vercel Sandbox](https://vercel.com/sandbox), simplifies working with the company's codebase. The customer success team uses Slack to ask it about reported issues, find the problem, and hand an engineer a root cause and a proposed fix.
...
## [Copy link to heading](#ai-gateway-picks-the-model-for-each-mind)AI Gateway picks the model for each mind

Delphi's chat traffic runs through [AI Gateway.](https://vercel.com/ai-gateway) Every digital mind is different, and some come out better on one model than another, so Delphi picks the model for each customer and adjusts as its own evals change. When a new model ships, open-source or otherwise, Delphi can route to it the same day.
...
**About** [**Delphi**](https://www.delphi.ai/discover/perspectives)**:** Delphi is a platform that turns a person's knowledge, thinking, and voice into a digital mind others can talk to. Anyone can create their own Delphi to make their expertise discoverable and accessible, part of a network of minds people can seek out, learn from, and converse with.