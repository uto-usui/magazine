---
title: "Protecting against inference theft"
source: "https://vercel.com/blog/protecting-against-inference-theft"
...
We deploy [Vercel BotID](https://vercel.com/botid) on our AI endpoints, gating every request. BotID is an invisible CAPTCHA with [deep analysis](https://vercel.com/docs/botid#deep-analysis) powered by Kasada that uses client-side machine learning to distinguish humans from bots without showing a visible challenge, which means it can run on every request rather than only at session start.
...
Get started in our AI endpoint protection [Knowledge Base Guide](https://vercel.com/kb/guide/how-to-protect-ai-endpoints-with-vercel-botid).