---
title: "What to do after a design critique ends"
source: "https://www.nngroup.com/articles/after-design-critique/"
publishedDate: "2026-05-29"
category: "design"
feedName: "Sidebar"
---

Summary:  Most designers invest in running critiques but skip the followup. That missing step is often why feedback culture breaks down.

[Design critiques](https://www.nngroup.com/articles/design-critiques/) generate feedback. But feedback is valuable only if someone closes the loop on it: telling people what changed because of what they said, what didn’t change, and why. This article covers two concrete followup tactics, when to use them, and what you’re quietly risking every time you skip them.

-   [Design Critiques Don’t End After the Session](#toc-design-critiques-dont-end-after-the-session-1)
-   [How to Close the Loop](#toc-how-to-close-the-loop-2)
-   [When to Follow Up](#toc-when-to-follow-up-3)
-   [What Happens When You Skip Followups](#toc-what-happens-when-you-skip-followups-4)
...
If your critiques feel pointless, the problem may not be [your facilitation](https://www.nngroup.com/articles/derailed-design-critiques/). It may be that your stakeholders don’t know what happened with their feedback.
...
“Here’s the new version” shares the output. “_This_ changed because you said _that_” closes the loop. When you share only the update, the people who gave feedback are left guessing: Did my comment land? Did it influence anything? Did the designer even remember it? Over time, that uncertainty erodes engagement. People stop showing up with careful observations because the feedback doesn’t seem to connect to anything.
...
![Before-and-after comparison of a financial dashboard UI, showing a condensed navigation with a prominent call-to-action button and a visually prominent savings progress section, versus the original cluttered nav and buried progress bar.](https://media.nngroup.com/media/editor/2026/04/29/show-before-after.png)

_The two changes called out in the strong followup are both annotated in the image: a condensed navigation that surfaces the primary action, and a savings progress section with enough visual weight to get noticed by users._

### Tactic: Acknowledge What You _Didn’t_ Act On
...
[Stakeholders notice](https://www.nngroup.com/articles/stakeholder-engagement/) when their feedback wasn’t addressed. If no one explains why, they fill in the gaps themselves — usually with something like “they didn’t care” or “critiques are just a formality.” Being transparent about what _didn’t_ change and why builds more credibility than sharing only what did. It signals that all the feedback was considered and not just the convenient parts.
...
2.  **Before handing off to development.** Stakeholders should know what the final decisions were _before_ they encounter the product in a demo or in the wild. The handoff phase is a natural critique checkpoint. Skipping it means people sometimes first see the outcome of their feedback when the product ships.
