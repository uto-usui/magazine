...
source: "https://remix.run/blog/brand-new"
...
![Brand evolution board mapping Remix's Past, Present, and Future across three rows of context cards.](https://remix.run/blog-images/posts/brand-new/frames-brand-thinking.avif)

Ultimately, the trigger — the moment we decided we needed a new brand — was when we established [our philosophy for building Remix 3](https://remix.run/blog/wake-up-remix) and beyond.
...
![Logo evolution board grouped into three rows: Evolving the Logo, Preserving the DNA, and Logo in use, showing wordmark explorations and applications.](https://remix.run/blog-images/posts/brand-new/frames-logo-evolution.avif)
...
![A browser window showing the finished Remix website, scrolled down to the second section that highlights a particle model of a racecar, with text that talks about closing the gap between the initial spark and shipping the idea](https://remix.run/blog-images/posts/brand-new/safari-remix-run.avif)
...
![A browser window featuring the Remix Particle Visualizer tool, with configuration and debug panels.](https://remix.run/blog-images/posts/brand-new/safari-remix-particle-visualizer.avif)
