...
[Write-first design (opens in new tab)](https://karlkoch.me/writing/write-first-design) breaks the loop, and it breaks it at the only point where breaking it is cheap.
